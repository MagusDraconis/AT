...
///
/// TQM-146: Physical Scaling Laws from Topological Charge
/// </summary>
...
1. THE QUESTION:
   ...
   TQM-145: m_eff∝Q², E∝Q, Δ∝1/Q², ξ∝Q, D∝1/Q², C∝log(Q).
...
";
    ...
    public static string HostileReview(ScalingLawCandidate.ScalingReport report)
    {
        ...
        sb.AppendLine("  → NO. All correspondences are known. TQM derives them from Q.");
