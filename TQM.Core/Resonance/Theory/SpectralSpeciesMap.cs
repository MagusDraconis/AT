...
/// and maps TQM-139 attractor species to spectral modes.
///
...
public static class SpectralSpeciesMap
{
        ...
        List<ThetaEigenmode.Eigenmode> modes)
    {
        ...
        // Each k corresponds to one graph component in TQM-139.
    ...
    // ══════════════════════════════════════════════════════════════════
    // Map TQM-139 attractors to spectral eigenmodes.
    // ══════════════════════════════════════════════════════════════════

    public static List<ThetaEigenmode.SpeciesModeMap> MapSpeciesToModes(
        List<AttractorBasin.AttractorBasinInfo> tqm139Attractors,
        List<ThetaEigenmode.Eigenmode> eigenmodes)
    {
        ...
        foreach (var attractor in tqm139Attractors)
        {
    ...
    // ══════════════════════════════════════════════════════════════════
    // Build the spectral graph and compare with TQM-139 attractor graph.
    // ══════════════════════════════════════════════════════════════════
    ...
    public static (int PredictedAttractorCount, bool FamiliesMatch,
        ...
        CompareWithTQM139(
            ...
            AttractorBasin.AttractorGraphInfo tqm139Graph)
    {
        ...
        bool familiesMatch = componentFamilies >= 3
            && Math.Abs(componentFamilies - tqm139Graph.ConnectedComponents) <= 2;
