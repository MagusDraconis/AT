...
1. THE QUESTION:
   ...
   TQM-135: Selection exists. Species have different fitness.
...
2. CANDIDATE FITNESS FUNCTIONS:
   ...
   w3  = r/c            (resource efficiency — TQM-135 default)
   w4  = C              (coherence)
...
6. VALIDATION:
   ...
   Predict TQM-135 species rankings using the best fitness function.
...
";
    ...
    public static string HostileReview(FitnessCandidate.FitnessLawReport report)
    {
        ...
        sb.AppendLine("ATTEMPT 2: Are we just re-discovering the TQM-135 efficiency definition?");
        sb.AppendLine("  → TQM-135 used w = r/c as fitness by DESIGN.");
