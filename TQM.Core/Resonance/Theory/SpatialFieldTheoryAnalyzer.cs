...
4. DERIVATION OF ∂R/∂t:
   ...
   Following TQM-104 mean-field but with spatial dependence:
...
5. DERIVATION OF ∂M/∂t:
   ...
   Following TQM-105 but with spatial redistribution:
...
";
    ...
    public static SPHEReport RunFieldTheoryAnalysis()
    {
        ...
        if (solutions.Any(s => s.IsStable && s.Type.Contains("Two")))
        {
            ...
            interpretation =
                "THE TQM SYSTEM IS A SPATIAL FIELD THEORY. The PDE admits stable " +
