...
/// (TQM-070), which increases coupling. Growth saturates as
/// M → K (all oscillators coalesce).
///
/// TQM-105: Mean Coupling First-Principles Derivation
/// </summary>
...
5. MEAN-FIELD SUBSTITUTIONS:
   ...
   ⟨cos(θ_j-θ_i)⟩ → R²  (alignment = R², TQM-075)
...
";
    ...
    public static FieldClosureReport RunClosureAnalysis(int baseSeed = 105_000_001)
    {
        ...
        // Run TQM-100 style attacks for the best law.
        ...
        string closedSystem = $@"
CLOSED EFFECTIVE FIELD THEORY (TQM-104 + TQM-105):

  dR/dt = c₀ · M · R · (1 − R²)    [TQM-104, derived from Kuramoto mean-field]
  dM/dt = {best.Law.Equation}       [TQM-105, derived from position dynamics]
