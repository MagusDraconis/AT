...
public static class FitnessCandidate
{
    ...
    public sealed record SpeciesMeasurements(
        ...
        double ResourceConsumption,         // total consumption (from TQM-135)
        double ReproductionRate,            // intrinsic growth (from TQM-135)
        double DeathRate,                   // baseline mortality (from TQM-135)
        ...
        double ObservedSelectionCoefficient, // s_i from TQM-135
        double ObservedDeltaFrequency,      // Δf from TQM-135
    ...
    /// <summary>
    /// Complete fitness law report for TQM-136.
    /// </summary>
    public sealed record FitnessLawReport(
        ...
        string BestFormula,
        double PredictionAccuracy,          // fraction of TQM-135 rankings correctly predicted
