...
///
/// TQM-116: Topological Charge Dynamics
/// </summary>
...
3. DISCRETE CHARGE TRANSITIONS:
   ...
   MERGER (TQM-012, discrete coupling):
   ...
   COLLAPSE (catastrophic):
     ...
     Q → 0. Requires external perturbation (TQM-011: density -50%).
...
";
    ...
    public static ChargeConservationReport AnalyzeChargeDynamics()
    {
        var transitions = new List<ChargeTransitionProfile>
        {
            ...
            new("Collapse", 1, 0, -1, false,
                "Catastrophic: peak R forced below 0.5 (density -50%, TQM-011)"),
    ...
    public static Dictionary<string, string> ReinterpretExperiments()
    {
        ...
        {
            ["TQM-010"] = "Proto-matter states = Q≥1 configurations. " +
                          "Multiple clusters = Q>1. Global R<0.5 = Q≥1 with incoherent background.",

            ["TQM-011"] = "96% survival = Q conserved in 24/25 runs. " +
            ...
            ["TQM-050"] = "Identity exclusion = separate Q=1 domains maintain " +
            ...
            ["TQM-107"] = "Multi-condensate survival = Q>1 stable when " +
            ...
            ["TQM-114"] = "Single species: all condensates are Q=+1 units. " +
                          "Differences in width/mass are continuous (parameter-dependent), " +
                          "not discrete species.",

            ["TQM-115"] = "Charge robustness confirmed: plateau of Q=1 spans " +
