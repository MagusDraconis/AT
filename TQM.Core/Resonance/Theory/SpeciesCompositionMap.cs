...
/// into composite species, and maps TQM-139 attractors to their composite origins.
///
...
public static class SpeciesCompositionMap
{
    ...
    // ══════════════════════════════════════════════════════════════════
    // Get the eigenmode basis from TQM-140.
    // ══════════════════════════════════════════════════════════════════
    ...
    // ══════════════════════════════════════════════════════════════════
    // Map TQM-139 attractors to composite modes.
    // ══════════════════════════════════════════════════════════════════

    public static List<CompositeMode.SpeciesComposition> MapToComposites(
        List<AttractorBasin.AttractorBasinInfo> tqm139Species,
        List<CompositeMode.CompositeModeInfo> composites)
    {
        var mappings = new List<CompositeMode.SpeciesComposition>();

        foreach (var species in tqm139Species)
        {
