...
/// <summary>
/// Repairs the rejected TQM-083 {R, M} theory using failure modes
/// identified by TQM-100. Preserves state variables, repairs equations.
///
/// TQM-101: Theory Repair Program
/// </summary>
public static class TheoryRepairAnalyzer
{
    ...
    // ══════════════════════════════════════════════════════════════════
    // Generate training data (same as TQM-083 but with parameter diversity)
    // ══════════════════════════════════════════════════════════════════
        ...
        List<TrainPoint> trainData)
    {
        ...
        // ── Model 0: Baseline (original TQM-083, rejected by TQM-100) ──
        {
    ...
    // ══════════════════════════════════════════════════════════════════
    // Validate a candidate against TQM-100 attacks
    // ══════════════════════════════════════════════════════════════════
