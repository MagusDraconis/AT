...
/// their spectra with the TQM-140 Theta operator.
///
...
public static class OperatorDerivation
{
    ...
    // ══════════════════════════════════════════════════════════════════
    // Get the original TQM-140 Theta operator eigenvalues (analytic).
    // ══════════════════════════════════════════════════════════════════
        ...
        List<ChargeInteractionOperator.QInteractionNetwork> networks)
    {
        ...
        int targetN = 10; // TQM-140 operator dimension
    ...
    // ══════════════════════════════════════════════════════════════════
    // Compare graph topology with TQM-139 landscape topology.
    // ══════════════════════════════════════════════════════════════════
        ...
        CompareTopology(ChargeInteractionOperator.QInteractionNetwork network)
    {
        ...
        // - Sinusoidal eigenvectors (as observed in TQM-140)
        ...
        // The TQM-139 landscape had 5 components.
