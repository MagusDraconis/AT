...
///
/// TQM-113: Topological Charge of Proto-Matter
/// </summary>
...
5. CONSERVATION UNDER PERTURBATIONS:
   ...
   • Mergers: two condensates → one (TQM-012, discrete coupling)
...
TQM-011 condensate stability: condensates cannot be continuously
...
";
    ...
    public static ChargeConservationReport AnalyzeCharges()
    {
        ...
        string interpretation =
            ...
            "This EXPLAINS TQM-011 stability (96% survival under perturbations):\n" +
            ...
            "Only mergers (discrete coupling, TQM-012) can reduce condensate count.";
