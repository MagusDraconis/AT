...
public static class CompositeMode
{
    ...
    /// <summary>
    /// Mapping of a TQM-139 attractor species to its best composite mode.
    /// </summary>
    ...
    public sealed record NonlinearCompositionReport(
        ...
        double MeanReconstructionOverlap,   // average overlap with TQM-139 species
        int SpeciesCountFromComposites,     // how many unique species from composites
        double SpeciesCoverage,             // fraction of TQM-139 species explained
