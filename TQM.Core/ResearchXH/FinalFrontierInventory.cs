...
/// <summary>
/// TQM-QG Phase 280 — Final Frontier Inventory. Review QG223-QG279 and classify every remaining issue:
...
///   BOUNDARY  — the issue is genuinely not derivable within TQM (a structural boundary, e.g. an
...
///      editorial). STATUS: OPEN (external, not derivable within TQM).
///
...
public static class FinalFrontierInventory
{
    ...
    public static FrontierItem[] Items() => new[]
    {
        ...
        new FrontierItem(10, "Publication / external arbitration", "QG250 editorial", Status.Open, 10,
            "no peer review, self-authored evidence base — external, not derivable within TQM"),
    };
