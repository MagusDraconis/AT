...
/// <summary>
/// TQM-QG Phase 249 — Final TOE Audit. Re-evaluates the theory-of-everything status after the
...
public static class FinalToeAudit
{
    ...
    public static Criticism[] TopCriticisms() => new[]
    {
        ...
        new Criticism(6, "Ambiguity",
            ...
            "BOUNDARY", "QG236: all five inflation-motive problems are SOLVED BY TQM; the epoch is REPLACED; the CMB spectrum content is the partial item (criticism 3)"),
