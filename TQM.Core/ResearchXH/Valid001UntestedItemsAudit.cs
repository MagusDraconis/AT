...
/// <summary>
/// TQM-VALID001 — Remaining Untested Items Audit. Analyze the three items the coverage register lists
/// as requiring attention — the S,T,U oblique parameters, the electron g-2 (a_e), and the Majorana
/// character (0νββ) — against the ACCEPTED TQM derivations. No new physics, no parameter fitting, no
...
///           investigation; TQM's Δa_e prediction is below 1e-12 and requires the a_e measurement
...
public static class Valid001UntestedItemsAudit
{
    ...
    public static ItemAudit[] Items() => new[]
    {
        ...
        new ItemAudit(
            ...
            "The fine-structure-constant discrepancy is under active lattice/experimental investigation; TQM's Δa_e < 1e-12 requires the a_e measurement to be lattice-limited."),
