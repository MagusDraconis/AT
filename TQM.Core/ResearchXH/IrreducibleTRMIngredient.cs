...
/// <summary>
/// TQM-QG Phase 34 — identify the irreducible TRM ingredient. TRM reproduces three successes: redshift, regular
...
/// ingredient — none of the three successes needs it. Redshift needs no TRM ingredient at all (TQM's g_00 = −ρ^(2/d)
...
public static class IrreducibleTRMIngredient
{
    ...
    /// redshift — NONE (TQM's g_00 = −ρ^(2/d) already gives gravitational redshift);
