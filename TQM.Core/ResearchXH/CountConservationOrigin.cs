...
/// <summary>
/// TQM-QG Phase 268 — Count Conservation Origin. QG267 showed every conservation law reduces to the
...
public static class CountConservationOrigin
{
    ...
    /// <summary>The Q-event is a REAL-UNDERIVED primitive (not emergent within TQM).</summary>
