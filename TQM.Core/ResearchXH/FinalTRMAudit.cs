...
/// <summary>
/// TQM-QG Phase 42 — final TRM decomposition. Classify every TRM component and compute what percentage is now
/// DERIVED from TQM. Per the arc: the saturation core (QG36/QG38) and the redshift (QG34, g_00 = −ρ^(2/d)) are
