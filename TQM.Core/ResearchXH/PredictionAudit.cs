...
/// <summary>
/// TQM-QG Phase 188 — Prediction Audit. Uses the physics-coverage single source of truth
/// (Docs/TQMQG_PhysicsCoverage.json) to list ALL remaining falsifiable predictions, classify each as
...
{
    // ── Prediction catalog (mirror of Docs/TQMQG_PhysicsCoverage.json) ────────────
    ...
    public static Prediction[] AllPredictions() => new[]
    {
        ...
        new Prediction("P5", "Curvature-sourced Poisson (source = (lnρ)″)", "G4-O0",
            "TQM-SPECIFIC — testable in principle", 4, 2, 3, "INACCESSIBLE",
