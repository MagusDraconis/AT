...
/// <summary>
/// TQM-MONO001 — Quantum Gravity Monograph Assembly. Assembles the complete monograph structure from
...
public static class MonographAssembly
{
    ...
    public static Chapter[] Chapters() => new[]
    {
        new Chapter(1, "Executive Summary",
            "The complete TQM quantum-gravity program at a glance: two primitives, both pillars derived, COMPLETE QG, MONOGRAPH READY.",
