...
/// <summary>
/// TQM-QG Phase 28 — derive the light-propagation law. QG27 showed null geodesics give NO lensing while the TRM
...
/// requires ignoring the spatial g_ii — a temporal-only assumption NOT in TQM's primitives (it is the ψ ≠ 0
