...
/// <summary>
/// TQM-QG Phase 286 — Difference Duality Audit. QG285 established ψ = the anisotropic difference
...
///   into the scalar (count) and tensor (orientation) faces. The two "primitives" of TQM are dual
...
public static class DifferenceDualityAudit
{
    ...
    ///                        duality — the two "primitives" of TQM are the two faces of the single
    ///                        Difference.
    /// </summary>
    ...
    public static string Summary()
    {
        return $"{Classify()} — duality score {DualityScore()}/6: "
             ...
             + $"tensor/orientation face (ψ). The two 'primitives' of TQM are the two faces of the "
