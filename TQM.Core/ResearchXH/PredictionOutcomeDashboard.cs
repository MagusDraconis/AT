...
/// <summary>
/// TQM-QG Phase 202 — Prediction Outcome Dashboard. A single source of truth for the external validation
/// of the three registered predictions (P1, P2, P3). Reads the immutable registry
/// (Docs/TQMQG_Predictions.json) and the physics-coverage single source of truth
/// (Docs/TQMQG_PhysicsCoverage.json), and folds in the evidence audits (QG188A, QG199, QG200, QG201).
///
...
///   • last audit        — the most recent TQM-QG audit phase touching this prediction
