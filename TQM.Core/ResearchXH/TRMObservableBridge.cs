...
/// <summary>
/// TQM-QG Phase 27 — TRM/TQM observable bridge. QG21/26 used GR null-geodesic optics and found NO lensing (γ=−1).
...
{
    /// <summary>TQM geometry: full conformal metric (t=0) — the conformal factor cancels in null propagation.</summary>
    public static double TqmGeometryFraction() => 0.0;
