...
/// <summary>
/// TQM-QG Phase 211 — Frontier Audit. Recomputes ALL remaining unresolved items after QG210, excluding
...
///     Curvature-sourced Poisson    (G4-O0; TQM-specific, testable in principle)
///   GRAVITY:
...
public static class FrontierAudit
{
    ...
    public static FrontierProblem[] Top10() => new FrontierProblem[]
    {
        ...
        new("P5", "Curvature-sourced Poisson equation", "PREDICTION",
            "G4-O0: the Poisson source is (ln ρ)″, not the density value; TQM-specific, testable in principle but no feasible probe.",
            3, 1, 3),
