...
/// MINIMAL ARCHITECTURE of TQM. No observables, no target values, D96 only, deterministic.
///
...
///
/// Classification:
///   FINAL TQM ARCHITECTURE — the canonical minimal architecture is complete: 4 layers, every concept
...
public static class FinalTheoryArchitecture
{
    ...
    ///   FINAL TQM ARCHITECTURE — score 6: the canonical minimal architecture is complete and sound —
    ...
    {
        if (ArchitectureScore() >= 6) return "FINAL TQM ARCHITECTURE";
