...
/// <summary>
/// TQM-QG Phase 198 — Final Open Problems Audit. Uses the physics-coverage single source of truth
/// (Docs/TQMQG_PhysicsCoverage.json) and the immutable prediction registry (Docs/TQMQG_Predictions.json)
...
public static class OpenProblemsFinalAudit
{
    ...
    public static OpenProblem[] All() => new OpenProblem[]
    {
        ...
        new("G4", "Curvature-sourced Poisson equation", "GRAVITY", "G4-O0",
            "Poisson source is (ln ρ)″ (curvature), not the density value — TQM-specific; no Newtonian field in uniform-density / shell-exterior regions; no feasible probe.",
