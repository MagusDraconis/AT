...
/// <summary>
/// TQM-QG Phase 32 — TRM compatibility audit. The TRM kernel is the ψ (non-conformal) sector (QG31). Here we audit
/// which existing TQM derivations survive if that kernel is added. The ψ-perturbation was chosen (MetricAnsatzAudit)
