...
public static class EuclidReadinessAnalyzer
{
    ...
    public sealed record EuclidScenario(
        ...
        string TqmVerdict, string[] Killed,
    ...
    public static List<EuclidScenario> DefineScenarios()
    {
        return new List<EuclidScenario>
        {
            ...
            new(EuclidOutcome.StrongDeviationWrongSign,
                ...
                "TQM PREDICTION WRONG. Sign is opposite to predicted w > −1.",
            ...
            new(EuclidOutcome.Inconsistent,
                ...
                "EXPERIMENTAL CRISIS — not a TQM problem specifically.",
                new string[] { },
                new[] { "Everything — systematic error, not physics" },
                "NO ACTION on TQM. Wait for experimental resolution. This is an instrumentation/analysis problem.",
    ...
    {
        return @"
THE EXACT TQM PREDICTION FOR EUCLID
  ...
  TQM:          w ≠ −1. Λ is emergent and time-varying.
...
";
    ...
    {
        return @"
WHAT IS AT STAKE — TQM SECTORS DEPENDENT ON EUCLID
