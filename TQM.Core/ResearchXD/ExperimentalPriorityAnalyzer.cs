...
/// <summary>
/// Computes experimental priorities for TQM validation 2025-2035.
...
public static class ExperimentalPriorityAnalyzer
{
    public sealed record Experiment(
        ...
        string Measurement, string TQMPrediction,
        string LcdmPrediction, int TimescaleYears,
        double InformationGain, double CostFactor,
        double FalsificationPower, string VerdictIfTQM,
    ...
    public static List<Experiment> DefineExperiments()
    {
        return new List<Experiment>
        {
            new("Dark energy equation of state w(z)",
                ...
                5, 10.0, 1.0, 10.0,
                "TQM SURVIVES — time-varying Λ confirmed.",
                "TQM FALSIFIED — Λ must be constant."),

            new("Expansion history H(z)",
                "DESI (2021+), Euclid, Roman", "H(z) from BAO",
                "H(z) 1-3% higher at z>0.5", "H(z) from ΛCDM",
                4, 8.0, 0.8, 7.0,
                "TQM consistent — less dark energy at high z.",
                "TQM constrained — H(z) deviation not observed."),
            ...
            new("Dark matter direct detection",
                ...
                5, 7.0, 2.0, 5.0,
                "TQM consistent — defect DM too heavy/weak.",
                "WIMP detected → TQM DM identity wrong."),
            ...
            new("Gravitational wave speed",
                ...
                0, 3.0, 0.5, 2.0,
                "TQM passes (no deviation predicted).",
                "TQM passes (same prediction). Not distinguishing."),

            new("CMB spectral distortions",
                "PIXIE, PRISM (proposed)", "μ, y distortions from Λ(t)",
                "μ ~ 10⁻⁸ (Λ was larger in past)", "μ ~ 0 (no early DE)",
                15, 5.0, 3.0, 3.0,
                "TQM supported — early dark energy signature.",
                "No distortion → TQM early DE constrained."),
            ...
            new("Strong lensing time delays",
                ...
                5, 7.0, 0.5, 3.0,
                "TQM's Λ(t) naturally gives higher H₀ from late-time.",
                "H₀=67 confirmed → TQM's H₀ resolution wrong."),
        };
    }
    ...
    {
        return @"
TQM EXPERIMENTAL ROADMAP 2025-2035
...
BY 2030: TQM will be either FALSIFIED or STRENGTHENED at >3σ.
