using System.Text;
using static TQM.Core.Research.MeasurementMetrics;
...
public static class MeasurementAnalyzer
{
    ...
    {
        var sb = new StringBuilder();
        sb.AppendLine("FINAL TQM POSTULATE COUNT (Post-X038)");
        sb.AppendLine();
        ...
        sb.AppendLine();
        sb.AppendLine("  TQM IS A 1-POSTULATE THEORY (+ 1 irreducible element).");
