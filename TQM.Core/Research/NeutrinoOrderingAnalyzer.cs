...
/// TQM-X060: Neutrino Mass Ordering and Oscillation Structure
/// </summary>
    ...
    public static List<NeutrinoOrderingMetrics.OrderingModel> AnalyzeOrdering()
    {
        ...
        return new List<NeutrinoOrderingMetrics.OrderingModel>
        {
            ...
            new("D: No structural ordering",
                ...
                + "(self-interaction attractive vs repulsive). TQM does not\n"
...
TQM's defect potentials come from the PDE reaction term (1-R²)·R,
which gives a φ⁴ potential with λ > 0 (TQM-010, X053). Attractive
...
If future data favors inverted ordering, does TQM collapse?

RESPONSE: If inverted ordering is confirmed at >5σ, Model A is wrong
and Model D (contingent) is correct. TQM would lose predictive power
...
FALSIFIABLE prediction: if inverted ordering is confirmed, TQM's
