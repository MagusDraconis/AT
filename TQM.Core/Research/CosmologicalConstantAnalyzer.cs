...
/// TQM-X046: Origin of the Cosmological Constant
/// </summary>
    ...
    public static List<CosmologicalConstantMetrics.LambdaModel> AnalyzeModels()
    {
        return new List<CosmologicalConstantMetrics.LambdaModel>
        {
            ...
            new("B: Λ ~ 1/ℓ² (natural value)",
                ...
                + "TQM avoids this because Λ is NOT set by ℓ alone.",
                false),
...
COMPARISON WITH STANDARD COSMOLOGY:
  ...
  • TQM: Λ(t) ~ 1/√V(t) — tracks the expansion history.
  • Both are observationally similar today (Λ ~ H₀²) but differ
    at early times (TQM predicts larger Λ in the past).
";
    }
...
quantum gravity, and TQM provides the ontological foundation.
";
    }
}
