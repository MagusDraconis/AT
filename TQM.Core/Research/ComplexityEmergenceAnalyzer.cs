...
/// across the TQM hierarchy from Noise to Evolution.
/// TQM-X018: Complexity Emergence Principle
/// </summary>
...
";
    ...
    public static ComplexityMetric.ComplexityReport Analyze()
    {
        ...
        string verdict = gradual
            ? $"COMPLEXITY EMERGES GRADUALLY. {levels.Count} levels identified. "
              ...
              + $"Level 6 (Open-Ended Evolution, 10.0) has NOT been observed in TQM — "
    ...
    public static string HostileReview(ComplexityMetric.ComplexityReport report)
    {
        ...
        sb.AppendLine("  - Matches TQM's observed progression (L0→L5 confirmed)");
        sb.AppendLine();
        ...
        sb.AppendLine("  - The staircase is a POST-HOC rationalization of TQM's history");
