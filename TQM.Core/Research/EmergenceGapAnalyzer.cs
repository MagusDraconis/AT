...
public static class EmergenceGapAnalyzer
{
    public static List<ConceptMapping> BuildMapping()
    {
        return new List<ConceptMapping>
        {
            ...
            new("Self-Consistency", "IMPLICIT: eigenmode condition L·v=λv", "EXPLICIT: F(x)=x principle",
                ...
                "Main TQM has it but never named it. Every eigenmode IS a fixed point."),
            ...
            new("Carrier classes", "IMPLICIT: eigenvalue spectrum", "EXPLICIT: 16-class taxonomy (X008)",
                ...
                "Main TQM: eigenvalues classify modes. ResearchX: names and counts them."),
            ...
            new("Ecologies", "IMPLICIT: multi-species simulations", "EXPLICIT: ecological level L4-L5",
                ...
                "Main TQM ran ecologies without naming them as such."),
            ...
            new("Information persistence", "IMPLICIT: ||ψ||² conservation", "EXPLICIT: information retention metric",
                ...
                "Reversibility IS information preservation. Main TQM never drew the inference."),
            ...
            new("Complexity Staircase", "ABSENT as formal concept", "DERIVED: L0-L6 hierarchy (X018)",
                ...
                "Main TQM built levels 3-5 (species, ecology, evolution) but never counted them. "
            ...
            new("Finite/Infinite boundary", "ABSENT: never explored", "DERIVED: pigeonhole proof (X027)",
                ...
                "Main TQM assumed finite graphs. ResearchX asked what happens at the limit."),
            ...
            new("Quantum necessity", "NOT PROVEN: QM emerges but could be accidental",
                ...
                "Main TQM showed QM is POSSIBLE. ResearchX proved it's NECESSARY."),
            ...
            new("Reality classification", "NOT CONSTRUCTED", "DERIVED: universal (R,S) map (X016)",
                ...
                "Main TQM explored one path. ResearchX explored all paths and classified them."),
    ...
    public static EmergenceGapReport Analyze()
    {
        ...
        string verdict = allResolved
            ? "ALL ASYMMETRIES RESOLVED. The four gaps from X032 collapse to: "
              ...
              + "Main TQM asks 'what is the operator?' ResearchX asks 'what must any operator satisfy?' "
    ...
    public static string HostileReview(EmergenceGapReport report)
    {
        ...
        sb.AppendLine("  If both frameworks are 'the same theory', why didn't Main TQM discover");
        ...
        sb.AppendLine("  Main TQM asked:  'What is the math of persistent reality?'");
        sb.AppendLine("  ResearchX asked: 'What are the necessary conditions for complex reality?'");
        sb.AppendLine();
        sb.AppendLine("  This is NOT a failure of Main TQM. It is a demonstration that");
        ...
        sb.AppendLine();
        sb.AppendLine("  Main TQM = Schrödinger picture (operator-first, differential equations).");
    ...
    public static string DeriveComplexityStaircaseFromLQ()
    {
        ...
        sb.AppendLine("  Main TQM had all the pieces but never asked the organizational question.");
        sb.AppendLine();
        return sb.ToString();
    }
}
