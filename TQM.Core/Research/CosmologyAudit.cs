...
/// TQM-X046b: Hostile Cosmology Audit
/// </summary>
public static class CosmologyAudit
{
    ...
    public sealed record ObservationalTest(
        string Test, string LcdmPrediction, string TqmPrediction,
    ...
    public static List<ObservationalTest> RunTests()
    {
        return new List<ObservationalTest>
        {
            ...
            new("BAO constraints",
                ...
                + "TQM deviations are ~1%. Consistent within errors."),
            ...
            new("Structure formation",
                ...
                + "S₈ to ~3%. TQM deviations ~1-3%. Not ruled out but constrained."),
            ...
            new("Age of universe",
                ...
                + "TQM with fluctuating Λ can satisfy this if mean Λ tracks H²\n"
                + "with appropriate amplitude."),

            new("Early dark energy",
                "ΛCDM: no early dark energy (w = -1 always).",
                "TQM: Λ was larger in the past → early dark energy component.\n"
