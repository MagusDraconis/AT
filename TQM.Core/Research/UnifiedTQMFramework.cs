...
/// <summary>
/// The unified TQM framework — all concepts classified and connected.
/// TQM-X034: Unified TQM Synthesis
/// </summary>
public static class UnifiedTQMFramework
{
    public static List<UnifiedTQMMetrics.UnifiedConcept> BuildHierarchy()
    {
        return new List<UnifiedTQMMetrics.UnifiedConcept>
        {
            // ===== POSTULATES (Level 0) =====
            new("Q (topological charge)", 0, "TQM-117",
                UnifiedTQMMetrics.ConceptStatus.Postulate,
                "Graph vertices carry integer charge. Foundation of all dynamics.",
                Array.Empty<string>(),
                "Irreducible starting point. Both frameworks begin here."),

            new("Graph (relational structure)", 0, "TQM-117",
                UnifiedTQMMetrics.ConceptStatus.Postulate,
            ...
            // ===== LEVEL 1: Dynamics =====
            new("Dynamics (time evolution)", 1, "TQM-117",
                UnifiedTQMMetrics.ConceptStatus.DerivedTheorem,
            ...
            new("Reversibility (R)", 2, "TQM-152, X011",
                UnifiedTQMMetrics.ConceptStatus.Postulate,
                "d/dt ||ψ||² = 0. Information is never created or destroyed.",
                new[] { "Dynamics" },
                "Postulate 2 in Main TQM. Independent of self-consistency (X011)."),
            ...
            // ===== LEVEL 3: L_Q =====
            new("L_Q (graph Laplacian)", 3, "TQM-142",
                UnifiedTQMMetrics.ConceptStatus.DerivedTheorem,
            ...
            new("Reality Structures", 4, "X014-X015",
                UnifiedTQMMetrics.ConceptStatus.EmergentStructure,
            ...
            new("Hilbert Space", 5, "TQM-142, X012",
                UnifiedTQMMetrics.ConceptStatus.DerivedTheorem,
            ...
            // ===== LEVEL 7: Species =====
            new("Species", 7, "TQM-133, X007",
                UnifiedTQMMetrics.ConceptStatus.EmergentStructure,
                "Stable carrier configurations = attractors in species space.",
                new[] { "Information Carriers" },
                "Observed in TQM-133 as eigenmode attractors. Universal principle in X007."),

            // ===== LEVEL 8: Ecologies =====
            new("Ecologies", 8, "TQM-135, X014",
                UnifiedTQMMetrics.ConceptStatus.EmergentStructure,
            ...
            new("Evolution (L5)", 9, "TQM-134-137, X018",
                UnifiedTQMMetrics.ConceptStatus.EmergentStructure,
                "Darwinian triad: variation + selection + heredity among species.",
                new[] { "Species", "Ecologies" },
                "Observed in TQM-134 (reproduction). Fitness law w=r/c (TQM-138)."),
            ...
            new("Quantum Reality (R=1,S=1)", 13, "X030-X031",
                UnifiedTQMMetrics.ConceptStatus.NecessaryConsequence,
            ...
            new("Schrödinger Equation", 14, "TQM-149-151, X012",
                UnifiedTQMMetrics.ConceptStatus.DerivedTheorem,
                "i∂ψ/∂t = Hψ. Emerges from R+S at (1,1) via J → i mapping.",
                new[] { "Quantum Reality", "Hilbert Space" },
                "Both frameworks derive identical PDE. Main TQM: via J. ResearchX: via Rev∩SC."),

            // ===== LEVEL 15: Born Rule =====
            new("Born Rule", 15, "TQM-153",
                UnifiedTQMMetrics.ConceptStatus.Postulate,
            ...
            new("Measurement", 16, "TQM-154",
                UnifiedTQMMetrics.ConceptStatus.Irreducible,
    ...
    public static List<UnifiedTQMMetrics.ReductionResult> ReductionAnalysis()
    {
        return new List<UnifiedTQMMetrics.ReductionResult>
        {
