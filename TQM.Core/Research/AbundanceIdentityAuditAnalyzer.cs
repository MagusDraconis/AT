...
/// <summary>
/// Audits the identity/abundance split across all TQM results.
/// TQM-X065b: Abundance vs Identity Audit
/// </summary>
public static class AbundanceIdentityAuditAnalyzer
{
    public static List<AbundanceIdentityMetrics.TQMResult> ClassifyResults()
    {
        return new List<AbundanceIdentityMetrics.TQMResult>
        {
            // ===== IDENTITY RESULTS =====
    ...
    public static AbundanceIdentityMetrics.SplitAnalysis AnalyzeSplit(
        List<AbundanceIdentityMetrics.TQMResult> results)
    {
        ...
        {
            AbundanceIdentityMetrics.SplitStatus.FundamentalSplit =>
                "FUNDAMENTAL SPLIT DISCOVERED. TQM is a theory of IDENTITY.\n"
                ...
                + "All of TQM's greatest successes are identity questions.\n"
                + "Almost all 'failures' are abundance questions.\n"
                + "THIS IS THE DEEPEST META-RESULT OF THE TQM PROGRAM.",
...
═══════════════════════════════════════════════════════════════
  ...
  TQM EXPLAINS why identity questions are answerable and
  ...
  (abundance) as fundamental parameters. TQM SEPARATES them:
