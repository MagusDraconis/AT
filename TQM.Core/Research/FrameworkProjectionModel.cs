...
{
    public static ConceptMappingMatrix.FrameworkProjection MainTQM => new(
        Framework: "Main TQM (117-154)",
        ...
        BlindSpot: "Complexity hierarchy — Main TQM never asked how many levels exist",
        NaturalConcepts: new[]
        {
