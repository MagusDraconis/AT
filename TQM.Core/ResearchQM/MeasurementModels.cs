...
public sealed record MeasDef(string Aspect,string StandardQM,string TqmResolution,string Status);
...
public sealed record CollapseComp(string Interpretation,string CollapseMechanism,string AdditionalAxioms,string TqmEquivalent,string Status);
