...
public sealed record BellResult(string Correlation,string ClassicalBound,string QuantumBound,string TqmPrediction,string Status);
public sealed record AxiomReduction(string Axiom,string StandardQM,string TqmStatus,string DerivedFrom,string Classification);
