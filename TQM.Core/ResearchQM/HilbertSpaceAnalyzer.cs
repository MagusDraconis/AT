...
public static class HilbertSpaceAnalyzer
{
    ...
    static string BuildE(TensorStep[] t){
        ...
        sb.AppendLine("  Entanglement = correlated Q-event histories. NATURAL in TQM.");
        return sb.ToString();
    }
    ...
    static string BuildI(){
        ...
        sb.AppendLine("    TQM: Hilbert space = THEOREM (from Q + oscillation).");
        ...
        sb.AppendLine("  With QM-001 (Born Rule), TQM now explains the TWO largest");
