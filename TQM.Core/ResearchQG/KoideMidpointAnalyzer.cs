...
public static class KoideMidpointAnalyzer
{
    ...
    static CrossSystem[] BuildAnalogies()
    {
        return new CrossSystem[]
        {
            ...
            new CrossSystem("TQM generation space (Koide)","Q = sum p_i^2 = 2/3","p_i = amplitude fractions","N_eff = 1.5 effective generations","The SAME participation-ratio structure. 2/3 is N=3-specific."),
        };
    }
    ...
    static string BuildD()
    {
        ...
        sb.AppendLine("      - No TQM generation-sector dynamics is specified.");
