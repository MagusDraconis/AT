...
public static class OntologyCompletionAnalyzer
{
    ...
    static string BuildD()
    {
        ...
        sb.AppendLine("    classify ALL content as contingent. TQM does the first");
        sb.AppendLine("    fully, the second fully.");
        sb.AppendLine();
        sb.AppendLine("  THE RESULT:");
        sb.AppendLine("    TQM derives all STRUCTURE (down to Q + Randomness + triple)");
        ...
        sb.AppendLine("  criterion, and TQM SATISFIES it (structure derived, content");
    ...
    static string BuildG()
    {
        ...
        sb.AppendLine();
        sb.AppendLine("  DOES TQM AVOID IT?  YES — via LOGICAL primitives.");
        sb.AppendLine();
        ...
        sb.AppendLine("    - TQM: stops at LOGICAL primitives (no regress — logic");
        sb.AppendLine("      has no 'deeper layer').");
        sb.AppendLine();
        sb.AppendLine("  VERDICT: TQM AVOIDS infinite regress by grounding in LOGICAL");
    ...
    static string BuildH()
    {
        ...
        sb.AppendLine();
        sb.AppendLine("  1. TQM IS (MOSTLY) ONTOLOGICALLY COMPLETE:");
        ...
        sb.AppendLine("    to correctly CLASSIFY them. TQM does.");
        sb.AppendLine();
        sb.AppendLine("  4. THE DEEPEST RESULT:");
        sb.AppendLine("    The structure/content split (QG-042) is the KEY to");
        sb.AppendLine("    completion. TQM derives ALL structure and classifies ALL");
        ...
        sb.AppendLine("    TQM is MOSTLY COMPLETE (B): structure derived, content");
    ...
    static string BuildI()
    {
        ...
        sb.AppendLine();
        sb.AppendLine("  ═══════════════════════════════════════════════════════════════");
        sb.AppendLine("  TQM IS MOSTLY COMPLETE: STRUCTURE DERIVED, CONTENT CONTINGENT");
        sb.AppendLine("  ═══════════════════════════════════════════════════════════════");
        sb.AppendLine();
        ...
        sb.AppendLine();
        sb.AppendLine("    TQM has reduced reality to 4 primitives:");
        ...
        sb.AppendLine("    is the TQM ontology: Q + Randomness at the bedrock,");
