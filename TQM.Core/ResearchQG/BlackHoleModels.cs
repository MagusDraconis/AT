...
public sealed record EntropyStep(int Step,string Relation,string Derivation,string FromTqm,string Status);
public sealed record InfoFlow(string Aspect,string TqmMechanism,string Outcome,string Status);
...
public sealed record ParaResolution(string Approach,string CoreIdea,string TqmPosition,string Status);
