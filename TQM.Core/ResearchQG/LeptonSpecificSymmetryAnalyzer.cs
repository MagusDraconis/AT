...
public static class LeptonSpecificSymmetryAnalyzer
{
    ...
    static string BuildG()
    {
        ...
        sb.AppendLine("     TQM EXPLAINS the lepton/quark structural difference but");
    ...
    static string BuildH()
    {
        ...
        sb.AppendLine("    TQM explains WHY leptons differ from quarks (topology)");
    ...
    static string BuildI()
    {
        ...
        sb.AppendLine();
        sb.AppendLine("    TQM EXPLAINS the lepton-specificity (integer vs fractional");
