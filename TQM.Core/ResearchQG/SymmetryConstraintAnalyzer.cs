...
public static class SymmetryConstraintAnalyzer
{
    ...
    static string BuildF()
    {
        ...
        sb.AppendLine();
        sb.AppendLine("  PERSISTENCE IS ALREADY IN TQM (QG-020):");
    ...
    static string BuildH()
    {
        ...
        sb.AppendLine("    texture, not a stability band. TQM has NO derivation of");
        ...
        sb.AppendLine("    To reach classification D, TQM must DERIVE (not just");
    ...
    static string BuildI()
    {
        ...
        sb.AppendLine("    To reach D, TQM must FORMALLY derive that the S¹ phase");
