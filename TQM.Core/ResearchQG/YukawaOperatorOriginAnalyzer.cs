...
public static class YukawaOperatorOriginAnalyzer
{
    ...
    static string BuildB()
    {
        ...
        sb.AppendLine("    - No connection to TQM's primitives (Q, phase, architecture).");
    ...
    static string BuildH()
    {
        ...
        sb.AppendLine("    just a matrix. This is TQM's key contribution to flavor.");
        sb.AppendLine();
        ...
        sb.AppendLine();
        sb.AppendLine("  3. THE TQM FLAVOR CHAIN:");
        ...
        sb.AppendLine("    but underived. TQM explains WHAT Y IS (overlap), not WHY");
