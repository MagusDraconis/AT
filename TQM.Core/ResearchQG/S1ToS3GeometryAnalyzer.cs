...
public static class S1ToS3GeometryAnalyzer
{
    ...
    static string BuildC()
    {
        ...
        sb.AppendLine("     potential — which TQM has NOT specified. S¹ does NOT");
        ...
        sb.AppendLine("     3 spatial dimensions → 3 polarization modes. But TQM");
    ...
    static string BuildI()
    {
        ...
        sb.AppendLine("    remains the deepest open problem in the TQM program.");
        sb.AppendLine();
