...
public static class QEventGrowthLawAnalyzer
{
    public static GLResult RunFullAnalysis()
    {
        ...
        var ce = new[]{new CosmoEra("Inflation-like","Rapid causal link creation. dN/dt >> N.","Very high, decreasing.","N/A (pre-geometric).","CMB fluctuations.","QUALITATIVE — early rapid growth."),
            ...
            new CosmoEra("Dark Energy","Causal saturation. dN/dt constant.","H → H_∞.","Λ(t) = α/√V(t).","SNe Ia, w(z).","UNIQUE — TQM w(z) prediction."),
        };
        ...
        var fe = new[]{new FutureEvol("Eternal expansion","N → ∞ slowly.","H → H_∞ > 0.","Never-ending expansion.","Infinite.","DE SITTER — eternal Λ."),
            ...
            new FutureEvol("TQM preferred","N saturates. H → H_∞.","H_∞ small but non-zero.","Ever-expanding, asymptotically static.","~10^100 years.","HONEST — depends on Ṅ_∞ (unknown)."),
        };
    ...
    static string BuildA(GrowthMech[] g){
        ...
        sb.AppendLine("  It is IRREDUCIBLE. TQM does not explain WHY there is randomness —");
    ...
    static string BuildB(GrowthLaw[] g){
        ...
        sb.AppendLine("  This is the most natural form given TQM's causal structure.");
        return sb.ToString();
    }
    ...
    static string BuildI(){
        ...
        sb.AppendLine();
        sb.AppendLine("  TQM provides a coherent PICTURE of cosmic expansion as Q-event growth.");
        sb.AppendLine("  But it does NOT predict N(t) — it takes N(t) from observation");
        sb.AppendLine("  and reinterprets what it means.");
        sb.AppendLine();
        sb.AppendLine("  THE IRREDUCIBLE ELEMENTS OF TQM COSMOLOGY:");
        ...
        sb.AppendLine();
        sb.AppendLine("  TQM reduces cosmic expansion to 2 primitives + 3 parameters.");
