...
public static class GenerationSymmetryAnalyzer
{
    ...
    static string BuildA()
    {
        ...
        sb.AppendLine("    'Why 3' is NOT derived by TQM (nor by the SM).");
    ...
    static string BuildB(GenCount[] counts)
    {
        ...
        sb.AppendLine();
        sb.AppendLine("  WHY TQM CANNOT DERIVE '3':");
        ...
        sb.AppendLine("    TQM mechanism that forces exactly 3 excitation levels.");
        return sb.ToString();
    }
    ...
    static string BuildE()
    {
        ...
        sb.AppendLine("       This is the MOST TQM-CONSISTENT: generations = multiple");
        ...
        sb.AppendLine("  with TQM but the NUMBER of branches (3) is not derived.");
        return sb.ToString();
    }
    ...
    static string BuildH()
    {
        ...
        sb.AppendLine("     from TQM is misleading. It's just math. The REAL content");
        ...
        sb.AppendLine("     empirical exclusion (LEP, LHC). TQM does NOT derive '3'.");
    ...
    static string BuildI()
    {
        ...
        sb.AppendLine("  Q10: S3 NOT derived from deeper TQM structures. It is the");
