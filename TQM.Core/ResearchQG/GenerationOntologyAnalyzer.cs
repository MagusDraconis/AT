...
public static class GenerationOntologyAnalyzer
{
    ...
    {
        var sb = new System.Text.StringBuilder();
        sb.AppendLine("CAN G EMERGE FROM EXISTING TQM PRIMITIVES?");
        sb.AppendLine();
    ...
    static string BuildD()
    {
        ...
        sb.AppendLine("    and now identified as a genuine TQM ontological structure.");
        return sb.ToString();
    }
    ...
    static string BuildF()
    {
        ...
        sb.AppendLine("    - This is the MOST TQM-NATURAL: G = the mode space of");
    ...
    static string BuildH()
    {
        ...
        sb.AppendLine("    TQM's ontology now includes: Q, Random Actualization,");
        sb.AppendLine("    (ℓ, τ, ħ), S¹ phase topology, AND the generation space G.");
        sb.AppendLine();
        sb.AppendLine("  2. G = MODE SPACE (the TQM-natural interpretation):");
        ...
        sb.AppendLine("    its origin is unknown. It is the 'flavor sector' of TQM —");
    ...
    static string BuildI()
    {
        ...
        sb.AppendLine("    fundamental space of the TQM ontology.");
        sb.AppendLine();
