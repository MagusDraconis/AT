...
public static class LocalTimeActualizationTimeAnalyzer
{
    ...
    static string BuildA(TimeLayer[] t){
        ...
        sb.AppendLine("THE LAYERS OF TIME IN TQM");sb.AppendLine();
    ...
    static string BuildI(){
        ...
        sb.AppendLine("         TQM HAS a dual-time structure. This is a FEATURE.");
        sb.AppendLine();
        sb.AppendLine("  ═══════════════════════════════════════════════════════════════");
        sb.AppendLine("  OVERALL VERDICT");
        sb.AppendLine("  ═══════════════════════════════════════════════════════════════");
        sb.AppendLine();
        sb.AppendLine("  TQM HAS A DUAL-TIME STRUCTURE:");
        sb.AppendLine();
