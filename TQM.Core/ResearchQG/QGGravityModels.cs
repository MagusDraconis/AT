...
public sealed record EmergenceStep(int Step,string From,string To,string Mechanism,string TqmPrimitive,string Status);
...
public sealed record QGFramework(string Framework,string Approach,string SpacetimeStatus,string GravityStatus,string TqmComparison);
