...
public static class GenerationMinimalityAnalyzer
{
    ...
    static string BuildC()
    {
        ...
        sb.AppendLine("    G is a NEW STRUCTURE — a 'generation space' that TQM's");
    ...
    static string BuildD()
    {
        ...
        sb.AppendLine();
        sb.AppendLine("  VERDICT: Attractor families are COHERENT (and TQM-natural),");
    ...
    static string BuildE()
    {
        ...
        sb.AppendLine("    the two sectors' mass bases. TQM does not derive them.");
        sb.AppendLine();
    ...
    static string BuildF(GenDim[] dims)
    {
        ...
        sb.AppendLine("    not DERIVED from any TQM principle.");
        sb.AppendLine();
    ...
    static string BuildG()
    {
        ...
        sb.AppendLine("    copies — is a MINIMAL, IRREDUCIBLE structure. TQM must");
    ...
    static string BuildH()
    {
        ...
        sb.AppendLine();
        sb.AppendLine("  1. TQM GAINS A NEW (MINIMAL) STRUCTURE:");
        ...
        sb.AppendLine("    TQM's primitives: Q + Random Actualization + (ℓ, τ, ħ).");
        ...
        sb.AppendLine("    TQM is more honest WITH G than without it.");
        return sb.ToString();
    }
    ...
    static string BuildI()
    {
        ...
        sb.AppendLine("    TQM must ADD the generation space G as a minimal new");
