...
public sealed record ThermAnalysis(string Aspect,string TqmMechanism,string Prediction,string Status);
...
public sealed record ParaComp(string Approach,string PageCurve,string Firewall,string InfoOutcome,string TqmPosition);
