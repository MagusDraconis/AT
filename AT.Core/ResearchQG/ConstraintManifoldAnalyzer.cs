...
public static class ConstraintManifoldAnalyzer
{
    ...
    static string BuildA(Manifold[] manifolds)
    {
        ...
        sb.AppendLine("WHAT IS A CONSTRAINT MANIFOLD IN AT?");
        sb.AppendLine();
    ...
    static string BuildE()
    {
        ...
        sb.AppendLine("    Two mechanisms, both real, both emergent from AT.");
        sb.AppendLine();
    ...
    static string BuildH()
    {
        ...
        sb.AppendLine();
        sb.AppendLine("  3. 'RG FLOW IS NOT AT — IT'S STANDARD QFT':");
        sb.AppendLine("     CORRECT. RG flow, fixed points, asymptotic freedom are");
        sb.AppendLine("     STANDARD QFT, not AT derivations. AT adopts them,");
        sb.AppendLine("     does not derive them. The 'RG = attractor' claim is a");
        sb.AppendLine("     CONCEPTUAL MAPPING, not a AT result.");
        sb.AppendLine();
