...
public static class WindingSignGravityAnalyzer
{
    ...
    static string BuildA()
    {
        ...
        sb.AppendLine();
        sb.AppendLine("  THIS IS THE EQUIVALENCE PRINCIPLE IN AT LANGUAGE:");
    ...
    static string BuildC(TopoGrav[] comps)
    {
        ...
        sb.AppendLine();
        sb.AppendLine("  EINSTEIN EQUATIONS IN AT:");
    ...
    static string BuildD(AntiMatterGrav[] am)
    {
        ...
        sb.AppendLine();
        sb.AppendLine("  AT PREDICTION: Anti-matter falls DOWN.");
        ...
        sb.AppendLine();
        sb.AppendLine("  THIS IS THE WEAK EQUIVALENCE PRINCIPLE IN AT:");
        ...
        sb.AppendLine();
        sb.AppendLine("  ALL ANTI-MATTER FALLS DOWN. AT IS CONSISTENT WITH GR.");
        sb.AppendLine("  If anti-matter were ever observed to fall UP,");
        sb.AppendLine("  that would DISPROVE AT (and GR, and the equivalence principle).");
        return sb.ToString();
    }
    ...
    static string BuildF(AntiMatterGrav[] am)
    {
        ...
        sb.AppendLine();
        sb.AppendLine("  AT PREDICTION: Anti-matter falls at g = 9.8 m/s² downward.");
        sb.AppendLine();
        ...
        sb.AppendLine("    AT: CORRECT prediction. Consistency confirmed.");
        sb.AppendLine();
        ...
        sb.AppendLine("    AT prediction: exactly g. No deviation.");
        sb.AppendLine();
        sb.AppendLine("  AEGIS (CERN, ongoing):");
        sb.AppendLine("    Moire deflectometry for anti-hydrogen.");
        sb.AppendLine("    AT prediction: standard gravity.");
        sb.AppendLine();
        ...
        sb.AppendLine("  AT is fully consistent with all experimental data.");
        return sb.ToString();
    }
    ...
    static string BuildG()
    {
        ...
        sb.AppendLine("     AT RECOVERS the equivalence principle from phase field");
        sb.AppendLine("     structure rather than POSTULATING it.");
        sb.AppendLine("     GR: postulate (all objects fall equally)");
        sb.AppendLine("     AT: derive (gravity couples to |∇θ|², which is sign-blind)");
        ...
        sb.AppendLine("     AT would have a SERIOUS problem:");
        ...
        sb.AppendLine("     The fact that AT FORBIDS this is a STRENGTH, not a weakness.");
        sb.AppendLine();
    ...
    static string BuildH()
    {
        ...
        sb.AppendLine("     that makes AT structurally clean.");
        sb.AppendLine();
        ...
        sb.AppendLine("     AT: Gravity couples to (∇θ)², which depends on |n|²,");
        ...
        sb.AppendLine("     AT clearly distinguishes them.");
        sb.AppendLine();
    ...
    static string BuildI(TopoGrav[] comps)
    {
        ...
        sb.AppendLine("         AT DERIVES the equivalence principle from the");
        ...
        sb.AppendLine("    If anti-matter ever falls UP, AT is FALSIFIED.");
        sb.AppendLine();
        ...
        sb.AppendLine("    It means AT DERIVES the equivalence principle");
