...
public static class QCDYukawaScramblingAnalyzer
{
    ...
    static string BuildE()
    {
        ...
        sb.AppendLine("    which AT does not derive.");
        sb.AppendLine();
    ...
    static string BuildH()
    {
        ...
        sb.AppendLine();
        sb.AppendLine("  2. WHY LEPTONS ARE SPECIAL (AT hypothesis):");
        ...
        sb.AppendLine("    connection. AT should investigate whether G-J emerges");
        ...
        sb.AppendLine("    Three DISTINCT unexplained structures. AT must address");
