...
public static class YukawaGeometryAnalyzer
{
    ...
    static string BuildA()
    {
        ...
        sb.AppendLine("WHAT A YUKAWA COUPLING IS IN AT");
        sb.AppendLine();
    ...
    static string BuildB(YukawaSector[] sectors)
    {
        ...
        sb.AppendLine("  (sqrt(y) = the coupling AMPLITUDE, the natural AT variable.)");
        sb.AppendLine();
    ...
    static string BuildF(MixingGeom[] mixings)
    {
        ...
        sb.AppendLine("    AT does NOT derive them (they are empirical), but the");
    ...
    static string BuildH()
    {
        ...
        sb.AppendLine("    The quark sectors do NOT follow Koide. Any AT claim of");
        ...
        sb.AppendLine("      of the AT lepton architecture + QCD corrections.");
        sb.AppendLine();
