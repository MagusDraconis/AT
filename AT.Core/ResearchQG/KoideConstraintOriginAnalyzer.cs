...
public static class KoideConstraintOriginAnalyzer
{
    ...
    static string BuildB()
    {
        ...
        sb.AppendLine("    - The sqrt(m) is the AT 'amplitude' (QG-039a): m = hbar*omega/c^2");
    ...
    static string BuildH()
    {
        ...
        sb.AppendLine("    - Amplitude: sqrt(m) = the natural AT variable.");
        ...
        sb.AppendLine("    is the AT AMPLITUDE. This suggests the relation lives in");
        ...
        sb.AppendLine("    It is the sharpest single number in the AT program — and");
    ...
    static string BuildI()
    {
        ...
        sb.AppendLine("      AMPLITUDE (the natural AT variable, QG-039a).");
        ...
        sb.AppendLine("    The sqrt(m) (amplitude) structure is natural in AT, but");
        sb.AppendLine("    the value 2/3 is not.");
        sb.AppendLine();
        sb.AppendLine("    AFTER 57 QG EXPERIMENTS, KOIDE IS THE CLEANEST STATEMENT");
        sb.AppendLine("    OF WHAT AT DOES NOT YET EXPLAIN: a single dimensionless");
