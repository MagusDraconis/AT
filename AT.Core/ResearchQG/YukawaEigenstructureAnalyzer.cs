...
public static class YukawaEigenstructureAnalyzer
{
    ...
    static string BuildB()
    {
        ...
        sb.AppendLine("    - The SM (and AT) take Y as an INPUT (free matrix).");
    ...
    static string BuildH()
    {
        ...
        sb.AppendLine("    and mixing (4 params) are FREE inputs. AT does not derive them.");
        sb.AppendLine();
        ...
        sb.AppendLine("    state of the AT flavor sector.");
        return sb.ToString();
    }
