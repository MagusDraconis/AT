...
public static class ActualizationDynamicsAnalyzer
{
    ...
    static string BuildI(){
        ...
        sb.AppendLine("    GRAVITY MANIPULATION IS NOT POSSIBLE IN AT.");
        sb.AppendLine();
