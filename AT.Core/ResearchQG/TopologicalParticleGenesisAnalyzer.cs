...
public static class TopologicalParticleGenesisAnalyzer
{
    ...
    static string BuildF()
    {
        ...
        sb.AppendLine("    In AT: electric charge could be the Noether charge");
    ...
    static string BuildG()
    {
        ...
        sb.AppendLine("    Both needed for full spectrum. AT provides the framework.");
        return sb.ToString();
    }
    ...
    static string BuildH()
    {
        ...
        sb.AppendLine("     AT does not yet derive QCD. This is EXTERNAL physics.");
        ...
        sb.AppendLine("     NOT derived from AT phase field alone.");
        sb.AppendLine();
        ...
        sb.AppendLine("     Despite gaps: AT provides a UNIFIED ONTOLOGY for particles.");
    ...
    static string BuildI(TopoSector[] sectors)
    {
        ...
        sb.AppendLine();
        sb.AppendLine("  AT UNIFIED PARTICLE ONTOLOGY:");
