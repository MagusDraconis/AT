...
public static class KoideArchitectureAnalyzer
{
    ...
    static string BuildA()
    {
        ...
        sb.AppendLine("    - Neither SM nor AT explains it.");
        sb.AppendLine();
    ...
    {
        var sb = new System.Text.StringBuilder();
        sb.AppendLine("FREQUENCY → AMPLITUDE: WHY √m IS NATURAL IN AT");
        sb.AppendLine();
        sb.AppendLine("  AT mass: m = hbar·omega/c^2 (QG-027).");
        ...
        sb.AppendLine();
        sb.AppendLine("  THIS IS A GENUINE AT INSIGHT:");
    ...
    static string BuildE()
    {
        ...
        sb.AppendLine("    This is a NEW testable link: any AT Yukawa derivation");
    ...
    static string BuildG(KoideCheck c, Gen4Test[] tests)
    {
        ...
        sb.AppendLine("      = oscillation amplitude. AT gives sqrt(m) a natural meaning.");
        ...
        sb.AppendLine("      (amplitude) structure is natural in AT, but the 45° value");
        sb.AppendLine("      is unexplained.");
        sb.AppendLine();
        sb.AppendLine("  CLASSIFICATION: B — WEAK CORRESPONDENCE");
        sb.AppendLine();
        sb.AppendLine("    AT provides the ONTOLOGY of sqrt(m) (= amplitude), which");
        ...
        sb.AppendLine("    AT derivation of the Yukawa architecture MUST produce");
        sb.AppendLine("    an amplitude vector at 45°. This is a falsifiable");
        sb.AppendLine("    TARGET, even though AT hasn't hit it yet.");
        sb.AppendLine();
        sb.AppendLine("    Koide = the single most important NUMERICAL CLUE to the");
        sb.AppendLine("    generation/Yukawa architecture. Unexplained by SM and AT.");
        sb.AppendLine();
