...
public static class StructureParameterBoundaryAnalyzer
{
    ...
    static string BuildE()
    {
        ...
        sb.AppendLine();
        sb.AppendLine("  WHY THIS FITS AT PERFECTLY:");
        ...
        sb.AppendLine("    AT can characterize M (the allowed space) but NOT the");
    ...
    static string BuildF()
    {
        ...
        sb.AppendLine("     are found (like Koide), or (b) AT derives the FORM of M");
        ...
        sb.AppendLine("     - A precise division of labor among AT's primitives:");
        sb.AppendLine("       Q → structure, Randomness → selection, triple → scale.");
        sb.AppendLine();
        sb.AppendLine("  5. 'THE DEEPEST TEST':");
        sb.AppendLine("     Does AT predict the EXISTENCE of more Koide-like relations?");
    ...
    static string BuildH()
    {
        ...
        sb.AppendLine();
        sb.AppendLine("  1. AT's PREDICTIVE POWER IS REFINED:");
        sb.AppendLine("    AT can predict STRUCTURE (layer 1) fully.");
        sb.AppendLine("    AT can predict CONSTRAINTS (layer 2) partially —");
        sb.AppendLine("    the FORM of stability bands and relations.");
        sb.AppendLine("    AT CANNOT predict PARAMETERS (layer 3) — these are history.");
        sb.AppendLine();
        ...
        sb.AppendLine("    - Stability bands should emerge from AT dynamics.");
        ...
        sb.AppendLine("    AT's ontology ALREADY contains the three-layer structure.");
        sb.AppendLine("    This is a powerful internal consistency check.");
        sb.AppendLine();
        sb.AppendLine("  5. WHAT 'COMPLETE' WOULD MEAN:");
        sb.AppendLine("    A complete AT would derive ALL of layer 1 and ALL of");
    ...
    static string BuildI()
    {
        ...
        sb.AppendLine("  Q4: YES — AT can derive parameter RELATIONS (constraints)");
