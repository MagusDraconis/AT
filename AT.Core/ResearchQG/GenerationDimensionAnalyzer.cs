...
public static class GenerationDimensionAnalyzer
{
    ...
    static string BuildB(GenDimension[] dims)
    {
        ...
        sb.AppendLine("    This is a MATHEMATICAL fact, not a AT derivation.");
        return sb.ToString();
    }
    ...
    static string BuildD(GenDimension[] dims)
    {
        ...
        sb.AppendLine("  No AT principle forbids N>3. It is observation, not ontology.");
        return sb.ToString();
    }
    ...
    static string BuildH()
    {
        ...
        sb.AppendLine("    AT cannot derive N=3 from Q, oscillation, or phase.");
        ...
        sb.AppendLine("    selection arguments CAN be predictive. The AT/selection");
