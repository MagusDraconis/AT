...
public static class GenerationSpectrumAnalyzer
{
    ...
    static string BuildA()
    {
        ...
        sb.AppendLine();
        sb.AppendLine("  AT'S STARTING POINT (from QG-034):");
        ...
        sb.AppendLine("    Can AT derive 'exactly 3' from the frequency architecture");
    ...
    static string BuildB(GenLevel[] levels)
    {
        ...
        sb.AppendLine("  architecture but has no AT derivation yet.");
        return sb.ToString();
    }
    ...
    static string BuildC(GenLevel[] levels)
    {
        ...
        sb.AppendLine();
        sb.AppendLine("  AT ANALOGY: n=1 VORTEX EXCITATION LEVELS");
        ...
        sb.AppendLine("      potential of the n=1 winding — WHICH AT HAS NOT DERIVED.");
    ...
    static string BuildD()
    {
        ...
        sb.AppendLine();
        sb.AppendLine("  AT CANNOT YET DISTINGUISH THESE.");
    ...
    static string BuildE()
    {
        ...
        sb.AppendLine("  from the charged lepton hierarchy. AT does NOT yet explain");
    ...
    static string BuildF()
    {
        ...
        sb.AppendLine("    AT does NOT derive 3. It OBSERVES 3 and notes");
    ...
    static string BuildG()
    {
        ...
        sb.AppendLine();
        sb.AppendLine("  1. 'AT HAS NOT DERIVED THREE GENERATIONS':");
        sb.AppendLine("     CORRECT. The honest assessment is that AT describes");
        ...
        sb.AppendLine("     potential that AT has NOT specified. The analogy is");
        ...
        sb.AppendLine("     architecture. AT does NOT explain it. This is a");
        ...
        sb.AppendLine("     AT correctly REFUSES to fabricate a pattern.");
        sb.AppendLine();
    ...
    static string BuildH()
    {
        ...
        sb.AppendLine("  Q8: Finite spectrum (3 observed) but AT doesn't derive finiteness.");
        ...
        sb.AppendLine("    but is UNEXPLAINED by AT (and by the SM).");
        sb.AppendLine();
        sb.AppendLine("  CLASSIFICATION: B — QUALITATIVE EXPLANATION");
        sb.AppendLine();
        sb.AppendLine("    AT provides the CORRECT FRAMEWORK:");
        ...
        sb.AppendLine();
        sb.AppendLine("    'Exactly three' remains an EMPIRICAL INPUT to AT,");
