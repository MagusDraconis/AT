...
public static class HiggsMassSelectionAnalyzer
{
    ...
    static string BuildA()
    {
        ...
        sb.AppendLine();
        sb.AppendLine("  HIGGS FREQUENCY (AT interpretation):");
    ...
    static string BuildB()
    {
        ...
        sb.AppendLine();
        sb.AppendLine("  AT: The Higgs is a resonance of the amplitude mode A(x).");
        ...
        sb.AppendLine();
        sb.AppendLine("  AT PROVIDES THE ONTOLOGY:");
        ...
        sb.AppendLine();
        sb.AppendLine("  AT DOES NOT PROVIDE THE VALUE:");
    ...
    static string BuildF()
    {
        ...
        sb.AppendLine("    3. AT has NO mechanism preferring 125 over 140 either.");
        ...
        sb.AppendLine("    AT currently cannot distinguish 'accidental' from");
        sb.AppendLine("    'selected by unknown principle'.");
        sb.AppendLine();
        sb.AppendLine("  THE ONE THING AT ADDS:");
        sb.AppendLine("    In AT, m_H is the amplitude stiffness of the Q-event field.");
    ...
    static string BuildG()
    {
        ...
        sb.AppendLine("    But the EXACT value is NOT derived by AT or the SM.");
        sb.AppendLine("    lambda = 0.13 and v = 246 GeV remain empirical inputs.");
        sb.AppendLine();
        sb.AppendLine("    TO ACHIEVE CLASSIFICATION C/D:");
        sb.AppendLine("    AT must derive the amplitude stiffness lambda from");
