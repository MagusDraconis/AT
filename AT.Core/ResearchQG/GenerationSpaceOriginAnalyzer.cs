...
public static class GenerationSpaceOriginAnalyzer
{
    ...
    static string BuildA()
    {
        ...
        sb.AppendLine();
        sb.AppendLine("  QG-065: G is the ONE unresolved structure in the AT ontology.");
    ...
    static string BuildB()
    {
        ...
        sb.AppendLine("    - No connection to the rest of AT (QG-051/052 showed");
        ...
        sb.AppendLine("  rest of AT (where spaces EMERGE). G should also emerge —");
    ...
    static string BuildE()
    {
        ...
        sb.AppendLine();
        sb.AppendLine("  WHY THIS IS THE MOST AT-NATURAL:");
