...
public static class PhaseEngineeringAnalyzer
{
    ...
    static string BuildI(){
        ...
        sb.AppendLine();
        sb.AppendLine("  WHAT AT CLARIFIES:");
        ...
        sb.AppendLine("    AT: changing phase changes gravity (via same equations).");
        sb.AppendLine("    AT adds no new amplification mechanism.");
        sb.AppendLine();
