...
public static class ScalePairDegeneracyAnalyzer
{
    ...
    static string BuildI(){
        ...
        sb.AppendLine("    Standard (c, G, hbar) <-> AT (l, tau, hbar).");
