...
public static class ParameterStructureAnalyzer
{
    ...
    static string BuildA(DerivedItem[] derived)
    {
        ...
        sb.AppendLine();
        sb.AppendLine("  AT has successfully DERIVED:");
        sb.AppendLine();
    ...
    static string BuildC()
    {
        ...
        sb.AppendLine();
        sb.AppendLine("  WHY THIS MAPS TO AT'S PRIMITIVES:");
        ...
        sb.AppendLine("    AT's ontology ALREADY CONTAINS the structure/parameter");
    ...
    static string BuildD()
    {
        ...
        sb.AppendLine();
        sb.AppendLine("  A PREVIOUS AT RESULT (QG-065b, information program):");
    ...
    static string BuildE()
    {
        ...
        sb.AppendLine();
        sb.AppendLine("  AT ON DIMENSIONFUL CONSTANTS:");
        ...
        sb.AppendLine("    real physics'. This is WHY AT 'derived' G: G is dimensionful!");
        sb.AppendLine();
        sb.AppendLine("  AT ON DIMENSIONLESS CONSTANTS:");
        sb.AppendLine("    α = g²/4π = the ONE truly dimensionless coupling.");
        sb.AppendLine("    α_s, λ, Yukawas — all dimensionless, all empirical.");
        sb.AppendLine("    AT derives NONE of them.");
        sb.AppendLine();
    ...
    {
        var sb = new System.Text.StringBuilder();
        sb.AppendLine("HOSTILE REDUCTION ATTEMPT: CAN AT DERIVE α = 1/137?");
        sb.AppendLine();
        ...
        sb.AppendLine("    AT has NO route to α = 1/137.");
        sb.AppendLine("    The dimensionless couplings are not derivable from");
        sb.AppendLine("    AT's current primitives (Q, Randomness, ℓ, τ, ħ).");
        return sb.ToString();
    }
    ...
    static string BuildG()
    {
        ...
        sb.AppendLine("    begins. AT derives FORM; it does not derive MAGNITUDE.");
        sb.AppendLine();
        ...
        sb.AppendLine("    AT does NOT need a multiverse to explain contingency.");
    ...
    static string BuildH()
    {
        ...
        sb.AppendLine();
        sb.AppendLine("  1. AT'S CLAIM IS REFINED:");
        sb.AppendLine("     OLD CLAIM: 'AT derives everything.'");
        sb.AppendLine("     REFINED CLAIM: 'AT derives all STRUCTURE; parameters");
        ...
        sb.AppendLine("     This is a DEEP consistency check that AT passes.");
        sb.AppendLine();
        sb.AppendLine("  3. PARAMETER REDUCTION IS REAL BUT LIMITED:");
        sb.AppendLine("     AT reduces CONCEPTS (26 → 2 primitives + 3 scales).");
        sb.AppendLine("     AT does NOT reduce NUMBERS (19 couplings stay).");
        sb.AppendLine("     The reduction is ONTOLOGICAL, not NUMERICAL.");
        sb.AppendLine();
        sb.AppendLine("  4. THE COMPLETENESS QUESTION:");
        sb.AppendLine("     Is AT 'complete' if it leaves 19 numbers unexplained?");
        sb.AppendLine("     Answer: AT explains WHAT EXISTS and WHY (structure).");
    ...
    static string BuildI()
    {
        ...
        sb.AppendLine("  Q2: AT derives structure (from Q ontology) but not parameters");
        ...
        sb.AppendLine("    AT does not fail to derive the numbers — it EXPLAINS");
