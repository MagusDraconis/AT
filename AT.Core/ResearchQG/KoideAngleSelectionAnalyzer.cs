...
public static class KoideAngleSelectionAnalyzer
{
    ...
    static string BuildC()
    {
        ...
        sb.AppendLine("    the balanced point (45°). But no such Z2 is evident in AT.");
    ...
    static string BuildD()
    {
        ...
        sb.AppendLine("    - No AT dynamics is specified for the generation sector.");
        ...
        sb.AppendLine("  It requires a AT generation-sector dynamics that does not");
    ...
    static string BuildH()
    {
        ...
        sb.AppendLine();
        sb.AppendLine("  1. KOIDE IS THE SHARPEST UNEXPLAINED NUMBER IN AT:");
        ...
        sb.AppendLine("    To derive Koide, AT must derive WHY the generation");
        ...
        sb.AppendLine("    They all point to a generation ARCHITECTURE that AT");
        ...
        sb.AppendLine("    MECHANISTICALLY unexplained. AT has restated the");
    ...
    static string BuildI()
    {
        ...
        sb.AppendLine();
        sb.AppendLine("    THE DEEPEST UNRESOLVED NUMBER IN AT:");
