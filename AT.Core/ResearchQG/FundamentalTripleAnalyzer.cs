...
public static class FundamentalTripleAnalyzer
{
    ...
    static string BuildI(){
        ...
        sb.AppendLine("  ═══════════════════════════════════════════════════════════════");
        sb.AppendLine();
        sb.AppendLine("  (l, tau, hbar) IS THE IRREDUCIBLE PHYSICAL TRIPLE OF AT.");
        sb.AppendLine();
