...
public static class GenerationDimensionDerivationAnalyzer
{
    ...
    static DerivationAttempt[] BuildAttempts()
    {
        return new DerivationAttempt[]
        {
            ...
            new DerivationAttempt("3 spatial dimensions","N=3 (circular)","NO","FAILS: AT does not derive 3+1 (QG-018 gap). Circular."),
    ...
    static string BuildH()
    {
        ...
        sb.AppendLine("    no deeper derivation of '3' exists within AT.");
        return sb.ToString();
    }
