...
public static class MinimalCausalResolutionAnalyzer
{
    ...
    static string BuildI(NecessityClass[] n){
        ...
        sb.AppendLine("    AT does NOT predict the value — it ACCEPTS it.");
        sb.AppendLine();
        sb.AppendLine("  ═══════════════════════════════════════════════════════════════");
        ...
        sb.AppendLine();
        sb.AppendLine("  AT explains WHY a minimum scale must exist.");
        ...
        sb.AppendLine("    AT: ℓ > 0 is LOGICALLY FORCED. Value remains empirical.");
