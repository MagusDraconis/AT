...
public static class QuantumScaleAmplificationAnalyzer
{
    ...
    static string BuildI(){
        ...
        sb.AppendLine("  AT maps the scale hierarchy but does not derive each transition.");
