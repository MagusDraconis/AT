...
public static class ResonanceLeverageAnalyzer
{
    ...
    static string BuildI(){
        ...
        sb.AppendLine("    AT's emergence chain is built on ATTRACTORS.");
        ...
        sb.AppendLine("    Gravity manipulation via AT is NOT POSSIBLE");
