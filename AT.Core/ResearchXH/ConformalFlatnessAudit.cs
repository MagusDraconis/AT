...
/// <summary>
/// AT-QG Phase 22 — audit conformal-flatness consequences. Tests whether the failures (no lensing, no tensor GWs,
/// no Hawking T) are consequences of the conformal-flatness assumption (ψ=0) or fundamental AT results. The
