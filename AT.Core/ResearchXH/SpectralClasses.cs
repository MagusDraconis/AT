...
/// <summary>
/// AT-QG Phase 106 — Network spectral classes. QG104–105 showed the causal network possesses discrete
...
public static class SpectralClasses
{
    ...
    /// <summary>
    /// Octave-band mode-family grouping (the AT-native family concept, QG00): family k contains the modes
