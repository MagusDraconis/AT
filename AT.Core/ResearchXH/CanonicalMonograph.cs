...
/// from the CANONICAL END-STATE of AT [post-QG319]. Consolidation over exploration: only canonical
...
public static class CanonicalMonograph
{
    ...
    public static string Summary()
    {
        ...
        return $"{Classify()} — monograph score {score}/6. The final canonical monograph assembles the " +
               $"end-state AT across {ChapterCount()} chapters in six parts [Foundation, Derived Dynamics, " +
