...
/// <summary>
/// AT-QG Phase 250 — External Referee Audit. A HOSTILE referee attacks QG0-QG249. The goal is the
/// STRONGEST remaining reasons AT could still fail — hidden assumptions, unjustified selections,
/// parameter leakage, effective-vs-fundamental derivations, boundary classifications, publication
/// weaknesses. This phase does NOT defend AT — it attacks only. Each attack is classified
...
/// "AT is a Theory of Everything" if the referee is right.
///
...
/// AT is NOT protected by its internal audits — the internal audit program is itself part of the
