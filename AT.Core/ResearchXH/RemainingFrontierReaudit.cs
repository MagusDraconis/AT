...
/// <summary>
/// AT-QG Phase 299 — Remaining Frontier Re-Audit. QG280 produced the definitive frontier list; QG281-
...
public static class RemainingFrontierReaudit
{
    ...
    public static FrontierItem[] Items() => new[]
    {
        ...
        new FrontierItem(6, "Publication / external arbitration", Status.Methodology, false,
            "no peer review, self-authored evidence base — external, not derivable within AT — UNCHANGED"),
