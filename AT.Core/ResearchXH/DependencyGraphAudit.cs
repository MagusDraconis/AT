...
/// <summary>
/// AT-QG Phase 225 — Dependency Graph Audit. Verifies the full phase derivation graph over QG0-QG224.
/// The dependency edges are extracted from the coverage single source of truth
/// (Docs/ATQG_PhysicsCoverage.json key_result) plus each phase report's QG references (test-ID tokens
