...
/// <summary>
/// AT-QG Phase 218 — Hilbert Origin. Known: the amplitude MAGNITUDE is derived (QG216: |ψ|² = ρ = μ^k/S
...
///      (AT-149) is the Hilbert space; with complex amplitudes it is the standard ℂ Hilbert space.
///
