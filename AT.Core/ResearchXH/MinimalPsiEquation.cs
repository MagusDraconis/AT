...
/// <summary>
/// AT-QG Phase 44 — minimal ψ field equation. ψ is the spin-2 (graviton) primitive. Its simplest dynamics
...
/// POSTULATED — ψ is a new primitive, so its equation of motion is a new input, not derivable from AT's scalar
...
public static class MinimalPsiEquation
{
    ...
    /// <summary>Is the ψ dynamics DERIVED from AT? No — ψ is a new primitive.</summary>
