...
/// <summary>
/// AT-QG Phase 41 — derive the TRM acceleration law. TRM predicts g_TRM = g_N + √(g_N·a0)/λ. We test whether the
...
/// IMPORTED (a separate MOND ansatz with scale a0). AT's flat rotation curves come from the log-deficit (α=0)
