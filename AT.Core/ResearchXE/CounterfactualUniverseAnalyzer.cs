...
/// <summary>
/// Counterfactual universe audit: modify AT assumptions, measure viability.
    ...
    public static List<CounterfactualUniverse> BuildUniverses()
    {
        return new List<CounterfactualUniverse>
        {
            ...
            new("U0", "Reference (3+1, M²≈5, Randomness)",
                "Standard AT — our universe.", true, true, true,
            ...
            new("U6", "Four stable generations",
                ...
                + "VIABLE: Our universe could have been this. Not selected by AT."),
...
Only a NARROW range of AT parameters supports complexity:
