...
/// whether AT has one foundation or two.
...
";
    ...
    public static ReversibilityVsSelfConsistency.FoundationComparisonReport Analyze()
    {
        ...
        string verdict = independent
            ? $"REVERSIBILITY AND SELF-CONSISTENCY ARE INDEPENDENT. "
              ...
              + $"EXISTENCE of fixed points. AT has TWO irreducible foundations."
    ...
    public static string HostileReview(ReversibilityVsSelfConsistency.FoundationComparisonReport report)
    {
        ...
        sb.AppendLine();
        sb.AppendLine("  WHAT THIS MEANS FOR AT:");
        sb.AppendLine("  AT has TWO irreducible foundations:");
        ...
        sb.AppendLine("  AT uses both — which is why it has both quantum");
        sb.AppendLine("  correspondence AND information carrier structure.");
        sb.AppendLine();
        sb.AppendLine("  This is NOT a weakness. It means AT rests on TWO");
