...
/// in AT or emerges from an even more fundamental mechanism.
...
";
    ...
    public static SelfConsistencyMetric.SelfConsistencyReport Analyze()
    {
        ...
        string verdict = isFundamental
            ? $"SELF-CONSISTENCY IS FUNDAMENTAL. No deeper universal invariant exists. "
              ...
              + $"The AT hierarchy bottoms out at self-consistency."
            : "Deeper layer found.";
    ...
    public static string HostileReview(SelfConsistencyMetric.SelfConsistencyReport report)
    {
        ...
        sb.AppendLine();
        sb.AppendLine("  3. AT has reached the MATHEMATICAL BEDROCK:");
        ...
        sb.AppendLine();
        sb.AppendLine("  AT's reduction is now COMPLETE:");
