...
/// AT-X053: Origin of the Anharmonicity Parameter
/// </summary>
public static class AnharmonicityAnalyzer
{
    ...
    {
        // The AT PDE: ∂R/∂t = c₀·M·R·(1-R²) + D_R·∇²R
    ...
    public static string PotentialTable(List<AnharmonicityMetrics.PotentialAnalysis> potentials)
    {
        ...
        sb.AppendLine("DEFECT POTENTIALS FROM AT PDE");
        sb.AppendLine();
...
THEOREM: The anharmonicity parameter a that governs mass hierarchies
         ...
         CODIMENSION and the coefficients of the AT PDE.

DERIVATION:

  1. The AT reaction-diffusion PDE:
     ∂R/∂t = c₀·M·R·(1-R²) + D_R·∇²R
...
RESPONSE: This is the HARDEST challenge. AT predicts that different
...
RESPONSE: c₀ and M are MEASURABLE parameters of the AT PDE —
they determine soliton width, mass, and interaction strength
(AT-109-115). Once measured from any defect property (e.g.,
...
ratios. AT predicts bare ratios; observed ratios include ~10^16
