...
/// AT-X012: Quantum Information Carrier Principle
/// </summary>
...
2. WHAT MAKES THEM SPECIAL:
   ...
   These are the BEST possible information carriers in AT.
...
";
    ...
    public static QuantumCarrier.QuantumCarrierReport Analyze()
    {
        ...
        string verdict = newClass
            ? $"QUANTUM INFORMATION CARRIER PRINCIPLE DISCOVERED. {qcCount} quantum carrier "
              ...
              + $"Quantum carriers are the OPTIMAL information-bearing structures in AT: "
              ...
              + $"and why AT naturally produces quantum structure at this intersection."
    ...
    public static string HostileReview(QuantumCarrier.QuantumCarrierReport report)
    {
        ...
        sb.AppendLine("  - AT is rediscovering: eigenstates of H are persistent");
        ...
        sb.AppendLine("  - AT DERIVES the Hamiltonian (H = L_Q) from Q charges");
        sb.AppendLine("  - AT shows WHY quantum carriers are optimal information stores");
        sb.AppendLine("  - AT unifies quantum stationary states with nonlinear solitons");
