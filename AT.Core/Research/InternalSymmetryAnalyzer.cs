...
/// AT-X048: Origin of Internal Symmetry
/// </summary>
    ...
    public static List<InternalSymmetryMetrics.SymmetryCandidate> AnalyzeSymmetries()
    {
        return new List<InternalSymmetryMetrics.SymmetryCandidate>
        {
            ...
            new("Diffeomorphism invariance from Q-event relabeling",
                ...
                + "Already present in AT: the graph structure is relational.",
                0, false,
...
SU(3)_C × SU(2)_L × U(1)_Y. AT gives 'U(1), maybe SU(2),
maybe SU(3).' That's not a derivation — it's a MENU.

RESPONSE: Correct. AT provides a MECHANISM for gauge symmetry
...
These are OPEN PROBLEMS, not solved by current AT.
