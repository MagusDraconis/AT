...
/// AT-X060e: Is U(1) Really Irreducible?
/// </summary>
    ...
    public static List<U1IrreducibilityMetrics.U1Argument> BuildArguments()
    {
        return new List<U1IrreducibilityMetrics.U1Argument>
        {
            new("A: Vortex topology is inevitable",
                ...
                + "The AT PDE has M = S¹ (order parameter phase) → π₁(S¹) = ℤ.\n"
            ...
            new("B: Long-range force is necessary for atoms",
                ...
                + "But within AT's complexity maximization principle (X036),\n"
            ...
            new("E: U(1) = vortex moduli space automorphism",
                ...
                + "All three are DERIVED in AT (X042, X036, PDE).",
                true),
        };
    }
...
THEOREM: U(1) gauge symmetry is INEVITABLE in any AT universe.

PROOF:
  1. AT universe has 3+1 spacetime dimensions (X042, DERIVED).
...
and complex dynamics. Both are DERIVED in AT.
