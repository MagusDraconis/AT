...
/// AT-X039: Origin of Quantum Randomness
/// </summary>
    ...
    public static List<RandomnessMetrics.SelectionMechanism> AnalyzeMechanisms()
    {
        return new List<RandomnessMetrics.SelectionMechanism>
        {
            ...
            new(7, "Decision-theoretic (Deutsch-Wallace)",
                ...
                + "MW is INCOMPATIBLE with AT (Q conservation forbids branching).\n"
                ...
                "FAILS: Requires MW (incompatible with AT). Normative, not physical."),
...
But WHICH outcome occurs is NOT determined by any known AT principle.
...
AT has reduced the primitives to TWO:
...
This is the maximally compressed form of AT.
...
";
    ...
    public static string FinalATArchitecture()
    {
        return @"
FINAL AT ARCHITECTURE (Post-X039)

═══════════════════════════════════════════════════════════════
                    AT — THEORY OF EVERYTHING
═══════════════════════════════════════════════════════════════
...
Q → Dynamics (graph adjacency)                            [AT-117]
