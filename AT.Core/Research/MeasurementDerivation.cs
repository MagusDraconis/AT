    ...
    public static List<MeasurementMetrics.MeasurementModel> BuildModels()
    {
        return new List<MeasurementMetrics.MeasurementModel>
        {
            ...
            new("Objective Collapse (GRW, CSL)",
                ...
                + "These are NEW fundamental constants, not derived from AT.\n"
                ...
                + "but AT seeks the REASON for collapse, not just a model.",
                true),  // Survives as a model, but doesn't DERIVE collapse

            // Model 5: Q-Individuation Collapse
            new("Q-Individuation Collapse (AT-X038)",
                ...
                + "  2. Q is conserved: dQ/dt = 0 (AT-116).\n"
...
2. Q is conserved under dynamics: dQ/dt = 0 (AT-116).
...
(AT-116). Does it hold in the quantum regime?
...
real and Q is not conserved globally. AT says Q IS conserved
