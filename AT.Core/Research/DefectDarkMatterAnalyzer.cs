...
/// <summary>
/// Identifies AT defect candidates for dark matter.
/// AT-X064: Dark Matter as Hidden Topological Defects
/// </summary>
public static class DefectDarkMatterAnalyzer
{
    ...
    public static List<DefectDarkMatterMetrics.DMRequirement> AuditRequirements()
    {
        return new List<DefectDarkMatterMetrics.DMRequirement>
        {
            ...
            new("Correct relic abundance Ω_DM ≈ 0.27",
                ...
                false,
                "ABUNDANCE NOT PREDICTED by AT alone.\n"
    ...
    {
        return @"
DARK MATTER FROM AT DEFECTS — THE VERDICT

THE QUESTION: Can AT's already-derived defect sector provide dark matter?

THE ANSWER: YES — with one important caveat.

AT provides NATURAL dark matter candidates from its defect taxonomy:
...
WHAT AT PREDICTS (independent of particle DM models):
...
WHAT AT DOES NOT PREDICT (same as all DM models):
...
CLASSIFICATION C: Strong candidate identified within existing AT ontology.
  NO new particles or primitives needed. Dark matter = neutral topological
  defects already predicted by AT (X047, X059). The relic abundance is
