...
/// AT-X065: Relic Abundance of Defect Dark Matter
/// </summary>
    ...
    public static List<DefectRelicAbundanceMetrics.AbundanceModel> AnalyzeModels()
    {
        return new List<DefectRelicAbundanceMetrics.AbundanceModel>
        {
            ...
            new("B: Freezeout (annihilation equilibrium)",
                ...
                + "But ⟨σv⟩ is NOT predicted by AT — must be measured.\n"
...
WHY THIS IS NOT A FAILURE:
  ...
  • AT defects: defect production density is contingent on early-universe
...
CLASSIFICATION A: Relic abundance is CONTINGENT.
  AT provides the NATURAL SCALE (Ω ~ 0.1-1) but not the precise value.
