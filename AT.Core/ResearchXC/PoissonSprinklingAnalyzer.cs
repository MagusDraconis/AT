...
THE EMERGENT POISSON PROPERTY:
  Poisson sprinkling is NOT a primitive of AT.
...
PROOF SKETCH:
  1. Correlations in AT arise from causal connections.
    ...
    public static List<PoissonSprinklingModel.ConvergenceCondition> ConvergenceConditions()
    {
        return new List<PoissonSprinklingModel.ConvergenceCondition>
        {
            ...
            new("C4: Lorentz invariance of continuum limit",
                ...
                "NONE — this is a known theorem. AT inherits it once Poisson is proven."),
            ...
            new("C5: Manifold reconstruction",
                ...
                true,
                "The causal order plus volume element (event count) uniquely determines the metric up to conformal factor. This is a theorem of mathematical relativity — not dependent on AT.",
                "NONE — this is an established theorem applied to the AT causal set."),
...
CHALLENGE 4: X046 assumed Poisson, it didn't derive it.
  AT's Λ derivation uses Poisson fluctuations as an INPUT, not an
...
IF THE CONJECTURE HOLDS:
  Poisson sprinkling is a THEOREM of AT.
...
WHAT THIS MEANS FOR THE AT GRAVITY CHAIN:
  ...
  AT does NOT 'assume' Poisson sprinkling.
  AT DERIVES it (up to one correlation bound).
  The physics is robust: even if the conjecture is wrong,
  Poisson behavior still emerges at macroscopic scales.

CLASSIFICATION OF THE AT GRAVITY BRIDGE (post-XC008):
