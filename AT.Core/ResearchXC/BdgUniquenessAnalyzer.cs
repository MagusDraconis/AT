...
WHY THIS IS THE CRITICAL DEPENDENCY:
  The entire gravitational dynamics of AT flows through B.
  If B is unique → BDG is a theorem, not a postulate.
  If B is one of many → AT needs an additional selection principle.
";
    }
    ...
    // ════════════════════════════════════════════════════════════════
    // SECTION F: AT-native interpretation
    // ════════════════════════════════════════════════════════════════

    public static string AtNativeInterpretation()
    {
        return @"
AT-NATIVE INTERPRETATION OF BDG

THE KEY INSIGHT:
  BDG's layer structure L_k(x) has a natural AT interpretation.
...
WHAT THIS MEANS FOR AT:
  ...
  The chain Q → causal set → BDG → Einstein equations is:
    ...
    ONTOLOGY: Q-events form the causal set (AT-native).
  ...
  THE BOTTOM LINE:
    AT does not 'import BDG.'
    AT adopts finite-difference calculus on causal sets.
