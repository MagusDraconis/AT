...
/// <summary>
/// Phase portrait and fixed point analysis of the closed AT field theory:
///   dR/dt = c₀ · M · R · (1 − R²)    [AT-104]
///   dM/dt = a · R²                     [AT-105]
///
/// AT-106: Phase Portrait and Fixed Point Analysis
/// </summary>
public static class PhasePortraitAnalyzer
{
    ...
    // ══════════════════════════════════════════════════════════════════
    // System parameters (from AT-104 and AT-105)
    // ══════════════════════════════════════════════════════════════════

    public const double C0 = 0.0047;   // from AT-104 mean-field fit
    public const double A = 0.00975;    // from AT-105 best fit (Law A: R²·M)
    // Note: AT-105 best Law C gives a = 0.00976 for dM/dt = a·R².
    // We use the R²·M form (Law A) since it matches the full derivation better.

    // Actually, AT-105 found Law C (dM/dt = a·R²) was the best.
    ...
    public static PhasePortraitReport GeneratePhasePortrait()
    {
        ...
        string physInterp =
            "The closed AT field theory predicts INEVITABLE SYNCHRONIZATION " +
            ...
            "(AT-052, AT-053): the dynamics create a positive feedback loop " +
