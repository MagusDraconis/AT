...
1. THE CROSSOVER HYPOTHESIS:
   ...
   — Q=+1 charges are independent (AT-123).
   — Phase locking is local and fragile (AT-125).
   — Interference is pairwise (AT-126).
