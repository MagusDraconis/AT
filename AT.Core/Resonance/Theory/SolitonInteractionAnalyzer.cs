    ...
    public static SolitonInteractionReport RunInteractionAnalysis()
    {
        ...
        if (fused > survived && threshold <= 3 * W)
        {
            ...
            interpretation =
                ...
                "Behavior matches AT-012: merges at close range, coexistence at large separation. " +
