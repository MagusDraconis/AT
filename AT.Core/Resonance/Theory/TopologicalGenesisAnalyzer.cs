...
///
/// AT-118: Topological Charge Creation
/// </summary>
...
4. CRITICAL THRESHOLD:
   ...
   clustering creates M₀ > M_critical. This is AT-006's ρc≈0.09.
...
Once created, Q=1 is topologically protected (AT-117).
";
    }
    ...
    public static GenesisReport AnalyzeGenesis()
    {
        ...
        string mechanism =
            ...
            "  5. Once created, Q=1 is topologically protected (AT-117).\n\n" +
            $"  Critical N: fluctuations must produce R > {D_R / (C0 * 0.1 * 0.01):F3}\n" +
            "  This corresponds to AT-006's critical density ρc≈0.09.";
        ...
        string verdict =
            ...
            "c₀·M₀·R₀ > D_R·R₀/w². This is the SAME condition as AT-006's " +
