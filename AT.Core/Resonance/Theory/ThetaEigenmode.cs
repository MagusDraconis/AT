...
public static class ThetaEigenmode
{
    ...
    public sealed record SpectralFamily(
        ...
        bool CorrespondsToGraphComponent,   // maps to a AT-139 graph component?
        string MappedComponentName);        // which component

    /// <summary>
    /// Mapping between a AT-139 attractor and a Theta eigenmode.
    /// </summary>
    public sealed record SpeciesModeMap(
        string SpeciesName,                 // AT-139 attractor name
    ...
    public sealed record SpectralLandscapeReport(
        ...
        int TotalEigenmodes,
        int TotalFamilies,
        int MappedSpecies,                  // how many AT-139 species were mapped
