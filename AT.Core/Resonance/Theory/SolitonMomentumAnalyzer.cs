...
/// <summary>
/// Derives soliton momentum from the AT field theory and tests
/// conservation laws via moving soliton and collision experiments.
///
/// AT-112: Soliton Momentum and Conservation Laws
/// </summary>
public static class SolitonMomentumAnalyzer
{
    ...
    private const double M_EFF = 347.0; // from AT-111
...
3. FOR A SOLITON MOVING WITH VELOCITY v:
   ...
   P = v · ∫ [(∂R/∂x)² + (∂M/∂x)²] dx
     = v · m_eff          [from AT-111: m_eff = ∫(∇R)²+(∇M)² dx]
     = m_eff · v
    ...
    public static ConservationLawReport RunConservationAnalysis()
    {
        ...
        if (meanPCons < 0.1 && collisions.All(c => c.Outcome == "passed through"))
        {
            ...
            interpretation =
                ...
                "(AT-111), momentum (AT-112), and undergo elastic scattering.";
        }
