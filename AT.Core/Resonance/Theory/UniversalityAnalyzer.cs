...
///
/// AT-103: Universality and Scale Invariance
/// </summary>
public static class UniversalityAnalyzer
{
        ...
        List<DataPoint> data, int baseSeed = 103_000_001)
    {
        ...
        // Validate best renormalization against AT-100 attacks.
    ...
    // ══════════════════════════════════════════════════════════════════
    // Validation against AT-100 attacks (using renormalized variables)
    // ══════════════════════════════════════════════════════════════════
