...
1. THE QUESTION:
   ...
   AT-133: 4 information species discovered.
   AT-134: Species reproduce and mutate.
   AT-135/136/137: Selection and universal evolution.
    ...
    public static string HostileReview(InnovationLineage.InnovationReport report)
    {
        ...
        sb.AppendLine(report.OpenEndedEvolution
            ? "  → Persistent novel species are CANDIDATE NEW ATTRACTORS."
              + " The attractor landscape may be richer than AT-133 revealed."
