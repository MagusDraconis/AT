...
/// <summary>
/// Quantitative risk ranking of AT predictions.
...
public static class PredictionRiskAnalyzer
{
    ...
    public static List<ScoredPrediction> ScorePredictions()
    {
        return new List<ScoredPrediction>
        {
            ...
            new("DM = neutral defects (~TeV)",
                6, 5, 6, 4, 7,
                45.0,
                "WIMP detected at LHC/direct → AT DM identity wrong. But DM still needed.",
            ...
            new("Neutrino normal ordering",
                5, 7, 4, 5, 6,
                28.0,
                "Inverted at >5σ → Model A (X060) wrong. Core AT survives.",
                "MEDIUM — partial kill"),

            new("No spacetime singularities",
                8, 1, 3, 1, 5,
                120.0,
                "Untestable. Only kills strong-field AT prediction.",
                "LOW — untestable"),
    ...
    public static string RiskMatrix(List<ScoredPrediction> predictions)
    {
        ...
        sb.AppendLine();
        sb.AppendLine("  SCORING (0-10): Uniqueness to AT | Falsifiability | Kill Power |");
