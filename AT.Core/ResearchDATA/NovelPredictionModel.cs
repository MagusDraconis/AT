...
public sealed record NovelPrediction(string Aspect,string At,string Mond,string Lcdm,string Status,string Testability,string Priority);
...
public sealed record GalaxyTypePred(string Type,string Scatter,string Gdagger,string AtMech,string MondPred,string LcdmPred,string Distinctive);
