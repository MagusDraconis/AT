...
| Field | Detail |
|-------|--------|
| **Full Name** | Vera C. Rubin Observatory / Legacy Survey of Space and Time |
| **Agency / Collaboration** | NSF / DOE, with international contributions |
...
|-----------|:--:|:--:|------------|-----------------|
| **P2: a₀ ≈ cH₀** | XD001 | Medium | Galaxy rotation curves at z ~ 0–2; measure a₀ vs H(z) | a₀ should track H(z): higher H(z) at higher z → larger a₀ at earlier epochs |
| **Correlation gravity** | X063 | Medium | Galaxy dynamics + weak lensing mass comparison | Effective mass from correlation geometry matches dynamics; discrepancy with lensing at cluster scales |
| **H₀ from strong lensing** | XD002 | Medium | Time-delay cosmography | H₀ ≈ 73 km/s/Mpc (resolves tension with CMB H₀ ≈ 67) |
| Growth of structure fσ₈(z) | XD002 | Medium | Weak lensing shear correlation functions | 2–3% lower than ΛCDM at z ~ 0.5–1 |
...
| H₀ (time-delay) | 73 ± 2 km/s/Mpc (H0LiCOW) | ~3% | H₀ ≈ 73 | **Consistent** |
| Weak lensing vs dynamics | Consistent with DM halos | ~5–10% | Correlation halo differs from NFW at cluster scales | **Consistent** (precision insufficient) |
...
| Tier | Impact |
|:--:|--------|
| **Tier 4** | Λ → a₀ link strengthened. Galaxy-scale correlation gravity validated. |
| **Tier 3** | H₀ tension resolution supports Λ(t) framework. |
| **Tier 0-2** | Unaffected. |
...
| Tier | Impact |
|:--:|--------|
| **Tier 4** | a₀ link decoupled from Λ. Correlation gravity weakened or abandoned. |
| **Tier 3** | H₀ resolution lost as supporting evidence. |
| **Tier 0-2** | Unaffected. |
...
|-----------|--------|:--:|:--:|--------|--------|
| a₀ tracks H(z) | Awaiting data | Medium | — | MEDIUM | Rubin needed |
| Correlation gravity (galaxy) | Consistent | Medium | A | MEDIUM | Ongoing |
| H₀ ≈ 73 | Consistent (H0LiCOW) | Medium | A | MEDIUM | Monitor |
| fσ₈(z) | Consistent (low precision) | Medium | A | MEDIUM | Monitor |
...
|-----------|------|-------------|
| Rubin first light | 2024–2025 | Begin survey operations |
| DR1 | ~2026 | First wide-field weak lensing and galaxy catalog |
| Galaxy survey at z~0.5–2 | ~2027–2028 | First a₀(H(z)) measurements |
| Time-delay H₀ (large sample) | ~2028–2030 | H₀ precision to ~1% |
| Full 10-year survey | ~2035 | Definitive weak lensing + dynamics comparison |
| **Decision point** | **~2030** | **a₀(H(z)) correlation test + H₀ tension resolution.** |
...
**Status: YELLOW — Partially consistent, awaiting key data.**

The a₀ ≈ cH₀ prediction is consistent at z=0 but the crucial test — whether a₀ evolves with cosmic time — awaits Rubin/LSST data. The H₀ tension provides circumstantial support. Correlation gravity is consistent with current galaxy dynamics data but not yet distinguished from particle DM.

| Criterion | Assessment |
|-----------|------------|
| Prediction clarity | **Good** — a₀ ∝ H(z) is testable |
...
*Observational Status Report V1 — August 2026. Next update: August 2027 or upon Rubin first data release.*
