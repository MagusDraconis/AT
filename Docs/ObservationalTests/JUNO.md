...
| Field | Detail |
|-------|--------|
| **Full Name** | Jiangmen Underground Neutrino Observatory |
| **Agency / Collaboration** | IHEP (CAS) + 17 countries, ~700 collaborators |
...
|-----------|:--:|:--:|------------|-----------------|
| **P6: Neutrino normal ordering** | XD001 | Medium | Sign of Δm²₃₁ = m²₃ − m²₁ | Δm²₃₁ > 0 (normal ordering: m₁ < m₂ < m₃) |
| Neutrino mass hierarchy pattern | X051-X052 | Medium | Mass splitting ratios | Small Δm² (sub-eV) from weak self-interaction without U(1) gauge localization |
| Delocalized neutral defect identity | X059 | Medium | Consistency of neutrino properties with defect model | No U(1) charge → delocalization → small masses + large PMNS mixing |
...
| Tier | Impact |
|:--:|--------|
| **Tier 2** | Model A supported. Attractive self-interaction mechanism consistent. |
| **Tier 0-1, 3-4** | Unaffected. |

### If Predictions Fail (Inverted at >5σ)
...
|-----------|--------|:--:|:--:|--------|--------|
| Normal ordering | Consistent (global fit ~3σ) | Medium | A (Suggestive) | LOW | Await JUNO |
| Δm² scales from defect | Consistent (semi-quantitative) | Low-Medium | A | LOW | None |
| Delocalized-defect identity | Consistent (qualitative) | Medium | A | LOW | None |
...
|-----------|------|-------------|
| JUNO detector complete | 2024–2025 | Begin data taking |
| First oscillation results | ~2027 | Initial Δm² measurements |
| Ordering at 3σ | ~2027–2028 | First JUNO-only ordering determination |
| Ordering at >5σ (combined) | ~2029–2030 | JUNO + DUNE + Hyper-K combined |
| **Decision point** | **~2030** | **Inverted >5σ → Model Update. Normal >5σ → survive.** |
...
|-----------|------------|
| Prediction clarity | **Good** — specific direction (normal) but not unique |
...
*Observational Status Report V1 — August 2026. Next update: August 2027 or upon JUNO first results.*
