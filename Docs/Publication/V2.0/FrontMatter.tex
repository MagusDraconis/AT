...
\begin{center}
  \vspace*{3cm}
  {\Huge\bfseries The Actualization Theory}\\[1.2em]
  {\Large A Reconstruction of Physics from\\ Difference, Actualization and Spectrum}\\[3cm]
  {\large The Quantum Model \\ (v2.0, canonical)}\\[2cm]
  {\large Fabrice Wieser}\\[1cm]
  {\large \today}
  \vfill
\end{center}
\cleardoublepage
...
\begin{center}
  ...
  {\Large Fabrice Wieser}\\[0.5cm]
  {\large The Quantum Model --- v2.0 (canonical)}\\[1.5cm]
  {\large \today}\\[2cm]
...
\begin{center}
  ...
  {\small Compiled from the canonical TQM-QG research program (QG0--QG321).}
  \vfill
\end{center}
\cleardoublepage
...
This monograph is the canonical v2.0 record of The Quantum Model, now presented under the
