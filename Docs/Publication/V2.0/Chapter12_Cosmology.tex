...
chapter is traced back to the D96 spectral structure \cite{c12:QG230,c12:QG234,c12:QG237,c12:QG238}.
...
\cite{c12:QG237,c12:QG238}. Hence cosmology is a spectrum readout --- emergent, not primitive.
\end{proof}

\begin{corollary}[Cosmology is emergent]
\label{c12:cor:cosmo-emergent}
...
\begin{proof}
By Theorem~\ref{c12:thm:cosmo-emergent}, the cosmological observables are functions of the
spectral structure; by Chapter~\ref{c06:chap:d96} (Theorem~\ref{c06:thm:d96-derived}), the spectrum
...
\begin{proof}
By Theorem~\ref{c12:thm:lambda}, $\Lambda$ is the residual pressure of the critical branching
vacuum. By Theorem~\ref{c12:thm:cosmo-emergent}, it is a read of the spectral/actualization
...
occupancies $[4,4,87]$ with $95$ modes \cite{c12:QG228}. Hence the fractions are derived from
the spectral occupancies.
\end{proof}

\begin{corollary}[The density partition follows the spectrum structure]
\label{c12:cor:density-partition}
...
\begin{proof}
By Theorem~\ref{c12:thm:fractions}, $\Omega_\Lambda$ is the octave-record information fraction
and $\Omega_m$ its complement. Both are functions of the D96 occupancies
(Chapter~\ref{c06:chap:d96}, Corollary~\ref{c06:cor:constants-derived}). Hence the density
...
\begin{proof}
By Theorem~\ref{c12:thm:acoustic}, the peaks are the harmonics of the D96 mode ladder; the peak
ratios are ratios of the spectral harmonics
(Chapter~\ref{c06:chap:d96}, Corollary~\ref{c06:cor:constants-derived}). Hence the peak hierarchy
...
\begin{proof}
The structure-formation result \cite{c12:QG231} and the CMB-acoustic result \cite{c12:QG238}
...
(Theorem~\ref{c12:thm:acoustic}), and the clustering follows the same spectral hierarchy. Hence
...
the spectral/actualization structure. The blind reproduction audit \cite{c12:QG240} confirms
...
\label{c12:cor:no-cosmo-primitive}
...
\begin{proof}
By Theorem~\ref{c12:thm:expansion}, the cosmological evolution is a spectrum consequence; by
Theorem~\ref{c12:thm:cosmo-emergent}, the observables are functions of the spectral content.
...
Consistent with MONO007 \cite{c12:MONO007}, this chapter presents cosmology as emergent and makes
...
\begin{enumerate}
\item \textbf{Cosmology as a spectrum readout} (Theorem~\ref{c12:thm:cosmo-emergent},
Corollary~\ref{c12:cor:cosmo-emergent}): the cosmological observables emerge from the D96
spectral structure, and cosmology is emergent;
\item \textbf{The cosmological constant} (Theorem~\ref{c12:thm:lambda},
Corollary~\ref{c12:cor:lambda-emergent}): $\Lambda$ exists, is positive, and scales with the
actualization structure --- emergent, not fundamental;
\item \textbf{Matter and vacuum fractions} (Theorem~\ref{c12:thm:fractions},
Corollary~\ref{c12:cor:density-partition}): $\Omega_\Lambda$ and $\Omega_m$ are derived from
the D96 octave occupancies;
\item \textbf{The cosmic microwave background} (Theorem~\ref{c12:thm:acoustic},
Corollary~\ref{c12:cor:peak-hierarchy}, Lemma~\ref{c12:lem:seed-spectrum}): the acoustic structure
is the D96 mode-ladder harmonics, with the seed spectrum the counting variance;
\item \textbf{Structure formation} (Theorem~\ref{c12:thm:structure-formation},
Lemma~\ref{c12:lem:clustering}): large-scale organization follows the actualization dynamics,
consistent with the spectral hierarchy;
\item \textbf{The expansion history} (Theorem~\ref{c12:thm:expansion},
Corollary~\ref{c12:cor:no-cosmo-primitive}): cosmological evolution is a spectrum consequence,
with no independent cosmological primitive;
\item \textbf{Consequences} (Theorem~\ref{c12:thm:cosmo-consistent},
Corollary~\ref{c12:cor:canonical-cosmology}): cosmology is consistent with the canonical
