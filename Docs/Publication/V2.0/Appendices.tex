...
\label{app:app:app:universality}
...
\section{Scope}
\label{app:app:app:universality-scope}
...
\chapter{References}
\label{app:app:app:references}

The references of this monograph follow the canonical research-program record. Each chapter
carries its own bibliography of the accepted AT-QG phases that support its results. The
