% ======================================================================
%  TQM-MONO100 — Chapter 1: The Difference
%  Canonical Monograph (v2.0) · The Quantum Model:
%  Structure, Complexity, and Random Actualization
%
%  Status: COMPLETE — PASS-READY (MONO007 referee-ready architecture)
%  Inputs: TQMQG_CanonicalMonograph.md, TQMQG_Mono007RefereeReadiness.md
...
The Quantum Model (TQM) is a deterministic theory of structure, complexity, and random
...
The minimal set of irreducible primitives of TQM is $\{\text{Difference},\eta\}$: exactly
...
Difference is the fundamental boundary of TQM.
\end{theorem}
...
\bibitem{QG279} TQM-QG Phase 279, \emph{Boundary Legitimacy Audit}, Docs/Research.
