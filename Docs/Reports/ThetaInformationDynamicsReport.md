...
merge, reinforce, and interact — information has its own physics.

## 1. Interaction Types

| Type | Condition | Outcome |
|------|-----------|---------|
| **Reinforce** | Overlap > 0.8 | Patterns amplify each other |
| **Cancel** | Overlap < −0.5 | Anti-correlated patterns erase |
| **Merge** | Orthogonal + high density | New composite state |
| **Independent** | Low overlap + low density | No interaction |

## 2. Results

30 interactions: 6 pattern pairs × 5 densities.

| Metric | Value |
|--------|-------|
| Interactions found | YES |
| Mergers | YES (12) |
| Cancellations | NO |
| Composite states | YES |
| Information transformed | YES |
...
dynamical system. Merge, reinforce, cancel — these are the laws of
information physics in proto-matter.
