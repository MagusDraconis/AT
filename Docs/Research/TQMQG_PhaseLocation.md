# TQM-QG Phase 63 — Physical Location of the Quantum Phase

**Program:** TQM-QG (Unification)
**Phase:** 63 — where can a U(1) phase live in the network?
**Status:** COMPLETED — 3/3 xUnit tests pass (192/192 TQM-QG)
...
## 3. Links are canonical, loops derived (TQMQG631)
...
| Test | Verdict |
|---|---|
| TQMQG630 `TQMQG630_ThreeHomes` | PASS (nodes/links/loops) |
| TQMQG631 `TQMQG631_LinksCanonicalLoopsDerived` | PASS (link variable) |
| TQMQG632 `TQMQG632_Classification` | PASS (LINKS) |

Code: `TQM.Core/ResearchXH/PhaseLocation.cs`;
tests `TQM.Tests/ResearchXH/TQMQG_Phase63_PhaseLocationTests.cs`.
