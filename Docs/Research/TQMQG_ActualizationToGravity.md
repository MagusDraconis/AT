# TQM-QG Phase 0 — Actualization → Gravity
...
### (a) The α=0 actualization attractor is exactly the log-deficit density (TQMQG00)
...
### (b) This ρ reproduces all four gravity requirements (TQMQG01)
...
| Test | Verdict |
|---|---|
| TQMQG00 `TQMQG00_EntropyAttractorIsLogDeficit` | PASS (α=0 attractor = log-deficit density) |
| TQMQG01 `TQMQG01_ReproducesGravityRequirements` | PASS (all four requirements reproduced) |
| TQMQG02 `TQMQG02_Classification` | PASS (FULL MATCH + sector caveat) |

Code: `TQM.Core/ResearchXH/ActualizationGravity.cs`;
tests `TQM.Tests/ResearchXH/TQMQG_Phase0_ActualizationToGravityTests.cs`.
