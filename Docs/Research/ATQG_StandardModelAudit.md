# AT-QG Phase 170 — Standard Model Audit

**Status:** COMPLETE — **COVERAGE AUDIT**
**Tests:** ATQG1700, ATQG1701, ATQG1702 (all passed)
**Core class:** `AT.Core/ResearchXH/StandardModelAudit.cs`
...
**all major measured SM quantities** against the AT-QG derivation record,
...
1. The AT-QG derivation record through QG169 is the authoritative catalog.
...
4. **UNTESTED** — no AT-QG derivation exists.
...
| quantity | note |
|----------|------|
| muon g-2 (a_μ) | no AT-QG derivation |
| electron g-2 (a_e) | no AT-QG derivation |
