# TQM-QG Gravity Consolidation Audit
...
1. **Mass-radius discrepancy (QG12/QG13)** — TQM deficit mass ∝ R^d (volume), Schwarzschild M ∝ R
...
From the reports, the observables that would discriminate TQM's gravity claims:

| Observable | TQM prediction | Status |
|---|---|---|
...
| **Curvature-sourced Poisson** | ΔΦ + ... = −ρ^(2/d)R/(2(d−1)) (source = ρ″, curvature) | **TQM-SPECIFIC** — differs from GR's ΔΦ=4πGρ; "testable in principle" (G4-O0) but no concrete experiment proposed. |
...
- **Gap A (mass-radius):** TQM's volume-scaling deficit mass (∝R^d) is incompatible with Schwarzschild's
...
| Phase | Report |
|---|---|
| QG6 | `TQMQG_OriginOfG.md` |
| QG12 | `TQMQG_BlackHoleEntropy.md` |
| QG13 | `TQMQG_HorizonThermodynamics.md` |
| QG21 | `TQMQG_LightPropagation.md` |
| QG22 | `TQMQG_ConformalFlatnessAudit.md` |
| QG25 | `TQMQG_ObservableReconstructionAudit.md` |
| QG26 | `TQMQG_NonTensorLensing.md` |
| QG43 | `TQMQG_ObservationalUniqueness.md` |
| QG103 | `TQMQG_MercuryRevalidation.md` |
| QG181 | `TQMQG_NewtonConstantOrigin.md` |
| QG19 | `TQMQG_GWReconciliation.md` |
| QG24 | `TQMQG_MinimalTensorExtension.md` |
...
| Synthesis | `TQM_Gravity_Reassessment.md` |
