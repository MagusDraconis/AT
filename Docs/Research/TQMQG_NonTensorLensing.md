# TQM-QG Phase 26 — Non-Tensor Explanation of Lensing

**Program:** TQM-QG (Unification)
**Phase:** 26 — can apparent lensing emerge from the scalar machinery?
**Status:** COMPLETED — 3/3 xUnit tests pass (81/81 TQM-QG)
...
### (a) Image shift & magnification (TQMQG260) — NO MATCH
...
### (b) Time delay (TQMQG261) — NO MATCH
...
### (c) Mechanism census (TQMQG262) — all NO MATCH
...
to be tensor — but in TQM's actual conformal geometry, **no scalar mechanism produces it at all** (γ = −1). The
...
| Test | Verdict |
|---|---|
| TQMQG260 `TQMQG260_ImageShiftAndMagnification` | PASS (δ=0, μ=1) |
| TQMQG261 `TQMQG261_TimeDelayAndRedshiftSurvivor` | PASS (Δt=0, z>0) |
| TQMQG262 `TQMQG262_MechanismCensus` | PASS (5/5 NO MATCH) |

Code: `TQM.Core/ResearchXH/NonTensorLensing.cs`;
tests `TQM.Tests/ResearchXH/TQMQG_Phase26_NonTensorLensingTests.cs`.
