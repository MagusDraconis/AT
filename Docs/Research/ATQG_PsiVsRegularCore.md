# AT-QG Phase 35 — Does ψ Alone Reproduce the Regular-Core Structure?

**Program:** AT-QG (Unification)
**Phase:** 35 — can ψ generate M_eff(r)=M(1−e^(−r³/r_c³)) without additional assumptions?
**Status:** COMPLETED — 3/3 xUnit tests pass (108/108 AT-QG)
...
## 3. ψ qualitative vs exact (ATQG351)
...
| Test | Verdict |
|---|---|
| ATQG350 `ATQG350_RegularMassProfile` | PASS (M_eff(0)=0, →M) |
| ATQG351 `ATQG351_PsiQualitativeVsExact` | PASS (qualitative yes, exact needs 2 assumptions) |
| ATQG352 `ATQG352_Classification` | PASS (PARTIAL MATCH) |

Code: `AT.Core/ResearchXH/PsiVsRegularCore.cs`;
tests `AT.Tests/ResearchXH/ATQG_Phase35_PsiVsRegularCoreTests.cs`.
