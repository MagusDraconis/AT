# TQM-QG Phase 120 — Horizon Suppression of Families

**Program:** TQM-QG (Unification)
**Phase:** 120 — does a finite horizon naturally suppress higher-family modes?
**Status:** COMPLETED — 3/3 xUnit tests pass (366/366 TQM-QG verified; COMPUTATIONAL)
...
## 2. Horizon size + family visibility (TQMQG1200)
...
## 3. Mode localization + spectral suppression (TQMQG1201)
...
## 4. Observable count + classification (TQMQG1202)
...
| Test | Verdict |
|---|---|
| TQMQG1200 `TQMQG1200_HorizonSizeAndFamilyVisibility` | PASS (1 at h=8 vs 4 at h=64; small horizon < total) |
| TQMQG1201 `TQMQG1201_ModeLocalizationAndSpectralSuppression` | PASS (IPR ≈ 1/N delocalized; suppression real, not monotone) |
| TQMQG1202 `TQMQG1202_ObservableCountAndClassification` | PASS (PARTIAL SUPPRESSION; suppression real but not monotone) |

Code: `TQM.Core/ResearchXH/HorizonFamilies.cs`;
tests `TQM.Tests/ResearchXH/TQMQG_Phase120_HorizonFamiliesTests.cs`.
