# AT-QG Phase 119 — Local vs Global Attractor Classes

**Program:** AT-QG (Unification)
**Phase:** 119 — do local observers sample only a subset of the network's attractor classes?
**Status:** COMPLETED — 3/3 xUnit tests pass (363/363 AT-QG verified; COMPUTATIONAL)
...
## 2. Local accessibility + global spectrum (ATQG1190)
...
## 3. Hidden classes + suppression (ATQG1191)
...
## 4. Observable vs total families + classification (ATQG1192)
...
| Test | Verdict |
|---|---|
| ATQG1190 `ATQG1190_LocalAccessibilityAndGlobalSpectrum` | PASS (global {2,6} size-invariant; all horizons reach all rungs) |
| ATQG1191 `ATQG1191_HiddenClassesAndSuppression` | PASS (no hidden classes; higher families suppressed at all horizons) |
| ATQG1192 `ATQG1192_ObservableVsTotalAndClassification` | PASS (LOCAL SUBSET; total grows, local saturates) |

Code: `AT.Core/ResearchXH/LocalVsGlobalAttractors.cs`;
tests `AT.Tests/ResearchXH/ATQG_Phase119_LocalVsGlobalAttractorsTests.cs`.
