...
This is the **one statistical postulate**. It is natural (TQM's temporal field has no preferred scale), but it
...
9. **The temporal field** — matter/quantum behavior/gravity emerge from self-organizing oscillations
   (the founding hypothesis of TQM; carried by the QM/QG programs, not the gravity program).
