...
## 3. Observable requirements (ATQG241)
...
The minimal tensor extension of AT is a **single spin-2 field ψ** with **2 degrees of freedom** (the graviton).
This closes the QG arc with a precise cost: AT's conformal core needs exactly one new primitive — the graviton —
...
| Test | Verdict |
|---|---|
| ATQG240 `ATQG240_CandidateCensus` | PASS (ψ minimal & spin-2-capable) |
| ATQG241 `ATQG241_ObservableRequirements` | PASS (minimal = 2 graviton d.o.f.) |
| ATQG242 `ATQG242_Classification` | PASS (MINIMAL NEW PRIMITIVE) |

Code: `AT.Core/ResearchXH/MinimalTensorExtension.cs`;
tests `AT.Tests/ResearchXH/ATQG_Phase24_MinimalTensorExtensionTests.cs`.
