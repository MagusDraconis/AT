...
### (a) The conformal gravity has no free coupling (ATQG60)
...
### (b) G and M are not separable (ATQG61)
...
| Test | Verdict |
|---|---|
| ATQG60 `ATQG60_NoFreeCoupling` | PASS (GM_eff native, no free coupling) |
| ATQG61 `ATQG61_GMDegeneracy` | PASS (G–M non-separable) |
| ATQG62 `ATQG62_Classification` | PASS (IMPORTED BDG −2; DERIVED physical scale) |

Code: `AT.Core/ResearchXH/CouplingOrigin.cs`;
tests `AT.Tests/ResearchXH/ATQG_Phase6_OriginOfGTests.cs`.
