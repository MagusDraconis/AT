# AT-QG Phase 66 — Origin of Spin-1/2

**Program:** AT-QG (Unification)
**Phase:** 66 — can fermionic spin-1/2 emerge from network structure?
**Status:** COMPLETED — 3/3 xUnit tests pass (201/201 AT-QG)
...
## 2. Integer vs half-integer (ATQG660)
...
## 3. Double cover required (ATQG661)
...
| Test | Verdict |
|---|---|
| ATQG660 `ATQG660_IntegerVsHalfInteger` | PASS (spinor ≠ tensor) |
| ATQG661 `ATQG661_DoubleCoverRequired` | PASS (spin structure) |
| ATQG662 `ATQG662_Classification` | PASS (REQUIRES NEW PRIMITIVE) |

Code: `AT.Core/ResearchXH/OriginOfSpinHalf.cs`;
tests `AT.Tests/ResearchXH/ATQG_Phase66_OriginOfSpinHalfTests.cs`.
