# AT-QG Phase 116b — Origin of the Universal Attractor

**Program:** AT-QG (Unification)
**Phase:** 116b — why does actualization converge to this specific attractor?
**Status:** COMPLETED — 3/3 xUnit tests pass (354/354 AT-QG verified; COMPUTATIONAL)
...
## 2. Attractor stability (ATQG1163)
...
## 3. Basin size + universality (ATQG1164)
...
## 4. Fixed-point structure, emergence, parameter dependence (ATQG1165)
...
| Test | Verdict |
|---|---|
| ATQG1163 `ATQG1163_AttractorStability` | PASS (exact fixed point; recovers after 50% perturbation) |
| ATQG1164 `ATQG1164_BasinSizeAndUniversality` | PASS (100% basin; links = N·K at N=48/96/192; featureless stays empty) |
| ATQG1165 `ATQG1165_FixedPointStructureAndClassification` | PASS (DYNAMICAL; radius 6.0 vs 2.0; monotone saturation) |

Code: `AT.Core/ResearchXH/UniversalAttractor.cs`;
tests `AT.Tests/ResearchXH/ATQG_Phase116b_UniversalAttractorTests.cs`.
