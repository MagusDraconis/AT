# TQM-QG Phase 145 — Origin of Up-Sector Enhancement

**Status:** COMPLETED — CLASSIFICATION: **UP-SECTOR ORIGIN**
**Tests:** TQMQG1450, TQMQG1451, TQMQG1452 (3/3 pass)
...
### 1. Spectral × charge coupling (TQMQG1450)

- Pearson r(deviation, Q) = **0.532** — positive coupling to charge.

### 2. Spectral × isospin coupling (TQMQG1450)
...
### 3. Charge-isospin cross terms (TQMQG1451)
