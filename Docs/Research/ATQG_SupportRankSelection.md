# AT-QG Phase 9 — Support Rank Selection
...
> single quality-preferred (minimal dynamical) candidate, not d=4. See `ATQG_InformationDimension.md`.

**Program:** AT-QG (Unification)
**Phase:** 9 — which support rank d is favored inside higher-dimensional D?
**Status:** COMPLETED — 3/3 xUnit tests pass (30/30 AT-QG)
...
### (a) Conformal efficiency is maximized at d=3, independent of D (ATQG90)
...
### (b) Efficiency vs coverage trade-off (ATQG91)
...
| Test | Verdict |
|---|---|
| ATQG90 `ATQG90_ConformalEfficiencyLandscape` | PASS (d=3 optimal, monotonic decrease) |
| ATQG91 `ATQG91_EfficiencyVsCoverage` | PASS (efficiency vs coverage trade-off) |
| ATQG92 `ATQG92_Classification` | PASS (PREFERRED, not uniquely selected) |

Code: `AT.Core/ResearchXH/EffectiveDimension.cs` (added `ConformalEfficiency`, `CurvaturePerDof`);
tests `AT.Tests/ResearchXH/ATQG_Phase9_SupportRankSelectionTests.cs`.
