# AT-QG Phase 121 — Origin of the Attractor Ladder

**Program:** AT-QG (Unification)
**Phase:** 121 — why does the feedback dynamics produce a discrete ladder instead of a continuous family of
geometries?
**Status:** COMPLETED — 3/3 xUnit tests pass (369/369 AT-QG verified; COMPUTATIONAL)
...
## 4. Fixed-point bifurcations + universality + classification (ATQG1212)
...
| Test | Verdict |
|---|---|
| ATQG1210 `ATQG1210_ThresholdEffects` | PASS (ladder {2,6} identical at thresholds 0.3/0.5/0.7) |
| ATQG1211 `ATQG1211_RoundingStructure` | PASS (continuous-weight variant still shows ladder) |
| ATQG1212 `ATQG1212_FixedPointBifurcationsAndClassification` | PASS (FUNDAMENTAL; 7 algebraic rungs; universal across K) |

Code: `AT.Core/ResearchXH/AttractorLadder.cs`;
tests `AT.Tests/ResearchXH/ATQG_Phase121_AttractorLadderTests.cs`.
