# AT-VALID001 — Remaining Untested Items Audit

**Status:** COMPLETE — **ALL DERIVED — EXPERIMENTAL VALIDATION**
**Tests:** ATVALID0010, ATVALID0011, ATVALID0012 (all passed)
**Core class:** `AT.Core/ResearchXH/Valid001UntestedItemsAudit.cs`
**Scope:** analyze the three items listed as "remaining untested" — S,T,U oblique parameters, electron g-2 (a_e), Majorana character (0νββ) — against the ACCEPTED AT derivations. No new physics, no parameter fitting, no speculation.
...
**Validation:** the fine-structure-constant discrepancy is under active lattice/experimental investigation; AT's Δa_e < 1e-12 requires the a_e measurement to be lattice-limited.
