# AT-QG Phase 43 — Observational Uniqueness of ψ

**Program:** AT-QG (Unification)
**Phase:** 43 — which observations require the tensor ψ and cannot be reproduced by a scalar?
**Status:** COMPLETED — 3/3 xUnit tests pass (132/132 AT-QG)
...
## 2. Classification table (ATQG430)
...
| Test | Verdict |
|---|---|
| ATQG430 `ATQG430_ClassificationTable` | PASS (3 SCALAR / 1 PSI / 1 AMBIGUOUS) |
| ATQG431 `ATQG431_PsiCase` | PASS (GW polarization spin-2) |
| ATQG432 `ATQG432_UniquenessSummary` | PASS (ψ unique for GW only) |

Code: `AT.Core/ResearchXH/ObservationalUniqueness.cs`;
tests `AT.Tests/ResearchXH/ATQG_Phase43_ObservationalUniquenessTests.cs`.
