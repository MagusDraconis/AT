# AT-QG Phase 38 — Origin of Finite-Density Saturation

**Program:** AT-QG (Unification)
**Phase:** 38 — why do Q-events saturate at a critical density?
**Status:** COMPLETED — 3/3 xUnit tests pass (117/117 AT-QG)
...
| Test | Verdict |
|---|---|
| ATQG380 `ATQG380_MechanismCensus` | PASS (5/5 discrete root) |
| ATQG381 `ATQG381_ExistenceVsValue` | PASS (existence derived, value imported) |
| ATQG382 `ATQG382_Classification` | PASS (DERIVED) |

Code: `AT.Core/ResearchXH/SaturationOrigin.cs`;
tests `AT.Tests/ResearchXH/ATQG_Phase38_SaturationOriginTests.cs`.
