...
**Tests:** TQMQG1870, TQMQG1871, TQMQG1872 (all passed)
**Core class:** `TQM.Core/ResearchXH/GpsCorrectionOrigin.cs`
...
### 3.1 Gravitational time dilation IS the redshift (TQMQG1870)
...
### 3.2 The full GPS correction matches observation (TQMQG1871)
...
- The core result is that **gravitational time dilation is not a separate
  effect from gravitational redshift** in TQM: both follow from g_00 =
