# AT-QG Phase 122 — Energy Dependence of Attractor Classes
...
**Status:** COMPLETED — 3/3 xUnit tests pass (372/372 AT-QG verified; COMPUTATIONAL)
...
## 2. Energy scaling + actualization-rate regimes (ATQG1220)
...
## 3. Phase transitions + family-count evolution (ATQG1221)
...
## 4. High-energy classes + classification (ATQG1222)
...
| Test | Verdict |
|---|---|
| ATQG1220 `ATQG1220_EnergyScalingAndRateRegimes` | PASS (radius 0→22 with seed energy; ladder to 19.67) |
| ATQG1221 `ATQG1221_PhaseTransitionsAndFamilyEvolution` | PASS (classes 2→8; families compress 3→2) |
| ATQG1222 `ATQG1222_HighEnergyClassesAndClassification` | PASS (NEW CLASSES; high-energy classes exist) |

Code: `AT.Core/ResearchXH/EnergyDependentAttractors.cs`;
tests `AT.Tests/ResearchXH/ATQG_Phase122_EnergyDependentAttractorsTests.cs`.
Note: the prompt's test IDs (1210–1212) were already used by Phase 121; tests use ATQG1220–1222 per convention.
