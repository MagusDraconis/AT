# TQM-QG Phase 218 — Hilbert Origin

**Status:** COMPLETE — **HILBERT ORIGIN**
**Tests:** TQMQG2180, TQMQG2181, TQMQG2182 (all passed)
**Core class:** `TQM.Core/ResearchXH/HilbertOrigin.cs`
...
eigenbasis (TQM-149) is the Hilbert space; with complex amplitudes it is the
