# AT-QG Phase 25 — Observable Reconstruction Audit

**Program:** AT-QG (Unification)
**Phase:** 25 — separate OBSERVED EFFECT from GR EXPLANATION across the failure set
**Status:** COMPLETED — 3/3 xUnit tests pass (78/78 AT-QG)
...
T ∝ 1/M, but AT's ψ-extension horizon thermodynamics has not yet been re-derived.

---

## 4. Minimal-d.o.f. refinement (ATQG252)
...
non-conformal geometry (cheap: 1 scalar ψ), not spin-2. AT's minimal extension therefore has a two-tier cost:
...
| Test | Verdict |
|---|---|
| ATQG250 `ATQG250_SeparateEffectFromExplanation` | PASS (5 scalar, 1 spin-2) |
| ATQG251 `ATQG251_ClassificationCounts` | PASS (1 / 4 / 1) |
| ATQG252 `ATQG252_MinimalDofRefinement` | PASS (scalar 1 vs graviton 2) |

Code: `AT.Core/ResearchXH/ObservableReconstructionAudit.cs`;
tests `AT.Tests/ResearchXH/ATQG_Phase25_ObservableReconstructionAuditTests.cs`.
