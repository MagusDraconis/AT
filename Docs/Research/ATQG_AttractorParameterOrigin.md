# AT-QG Phase 117 — Do Physical Parameters Control the Attractor Geometry?
...
**Status:** COMPLETED — 3/3 xUnit tests pass (357/357 AT-QG verified; COMPUTATIONAL)
...
## 2. Attractor radius + parameter response (ATQG1170)
...
## 4. Parameter sensitivity + classification (ATQG1172)
...
| Test | Verdict |
|---|---|
| ATQG1170 `ATQG1170_AttractorRadiusAndParameterResponse` | PASS (discrete ladder [2.0,6.0]; monotone responses) |
| ATQG1171 `ATQG1171_GeometryClasses` | PASS (2 classes; robust within plateaus; distinct signatures) |
| ATQG1172 `ATQG1172_ParameterSensitivityAndClassification` | PASS (ATTRACTOR ORIGIN; adjacent 0.62 vs intra 0.04) |

Code: `AT.Core/ResearchXH/AttractorParameterOrigin.cs`;
tests `AT.Tests/ResearchXH/ATQG_Phase117_AttractorParameterOriginTests.cs`.
