# TQM-QG Phase 5 — Observable Dimension

**Program:** TQM-QG (Unification)
**Phase:** 5 — why does ρ vary along exactly d observable directions?
**Status:** COMPLETED — 3/3 xUnit tests pass (18/18 TQM-QG)
...
### (a) Entropy per active dimension is monotonic (TQMQG50)
...
### (b) Dilution and branching efficiency are monotonic (TQMQG51)
...
- **TQM-QG2** — d≥3 required for gravity (derived bound).
- **TQM-QG3** — d=4 not native-special; preferred only as minimal propagating gravity (imported).
- **TQM-QG4** — d is emergent as the support rank of ρ; fundamental D unconstrained.
- **TQM-QG5** — the support rank itself is NOT selected; it is a conserved input.
...
| Test | Verdict |
|---|---|
| TQMQG50 `TQMQG50_EntropyPerDimensionMonotonic` | PASS (entropy monotonic) |
| TQMQG51 `TQMQG51_DilutionBranchingMonotonic` | PASS (dilution/branching monotonic) |
| TQMQG52 `TQMQG52_Classification` | PASS (NOT SELECTED, conserved input) |

Code: `TQM.Core/ResearchXH/ObservableDimension.cs`;
tests `TQM.Tests/ResearchXH/TQMQG_Phase5_ObservableDimensionTests.cs`.
