# AT-QG Phase 256 — Selection Principle Audit

**Status:** COMPLETE — **HIGH** selection-principle risk (1 PREFERRED / 1 ARBITRARY / 0 FORCED)
**Tests:** ATQG2560, ATQG2561, ATQG2562 (all passed)
**Core class:** `AT.Core/ResearchXH/SelectionPrincipleAudit.cs`
...
QG238 published:  ℓ₁ = Σm·ln(span)·(5/4)   (5/4 IS a published AT multiplier)
```
