# AT-QG Phase 10 — Information-Theoretic Dimension Selection

**Program:** AT-QG (Unification)
**Phase:** 10 — how much information can an actualization support of dimension d carry?
**Status:** COMPLETED — 3/3 xUnit tests pass (33/33 AT-QG)
...
### (a) Capacity, entropy density, and causal connectivity are monotonic (ATQG100)
...
### (b) Propagation efficiency is dimension-independent (ATQG101)
...
| Test | Verdict |
|---|---|
| ATQG100 `ATQG100_MonotonicInformationQuantities` | PASS (all monotonic) |
| ATQG101 `ATQG101_PropagationEfficiencyDimIndependent` | PASS (propagation d-independent; efficiency peaks at d=3) |
| ATQG102 `ATQG102_Classification` | PASS (NOT SPECIAL; d=3 PREFERRED) |

Code: `AT.Core/ResearchXH/InformationDimension.cs` (+ corrected `DimensionAnalysis.WeylComponents`,
`GravitonPolarizations`); tests `AT.Tests/ResearchXH/ATQG_Phase10_InformationDimensionTests.cs`.
