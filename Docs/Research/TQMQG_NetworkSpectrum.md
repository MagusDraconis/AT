# TQM-QG Phase 104 — Compute Network Spectrum

**Program:** TQM-QG (Unification)
**Phase:** 104 — for a concrete causal network, what are the eigenvalues of the native network operator?
**Status:** COMPLETED — 3/3 xUnit tests pass (315/315 TQM-QG verified; COMPUTATIONAL)
...
## 2. Adjacency & graph Laplacian spectra (TQMQG1040)
...
## 3. Actualization operator, stable modes, spectral ratios (TQMQG1041)
...
## 4. SM hierarchies vs network spectra (TQMQG1042)
...
| Test | Verdict |
|---|---|
| TQMQG1040 `TQMQG1040_AdjacencyAndLaplacianSpectra` | PASS (real adjacency + PSD Laplacian spectra, gap 0.099) |
| TQMQG1041 `TQMQG1041_ActualizationOperatorModesAndRatios` | PASS (PSD Lc, 90 stable modes, span 10.7) |
| TQMQG1042 `TQMQG1042_SMHierarchyComparisonAndClassification` | PASS (PARTIAL MATCH) |

Code: `TQM.Core/ResearchXH/NetworkSpectrum.cs`;
tests `TQM.Tests/ResearchXH/TQMQG_Phase104_NetworkSpectrumTests.cs`.
