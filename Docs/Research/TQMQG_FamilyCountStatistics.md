# TQM-QG Phase 108 — Family Count Statistics

**Program:** TQM-QG (Unification)
**Phase:** 108 — what family counts are statistically preferred in causal networks?
**Status:** COMPLETED — 3/3 xUnit tests pass (327/327 TQM-QG verified; COMPUTATIONAL)
...
## 2. Ensemble & family-count distribution (TQMQG1080)
...
## 3. Hierarchy span & size scaling (TQMQG1081)
...
## 4. Preference for N=3 (TQMQG1082)
...
| Test | Verdict |
|---|---|
| TQMQG1080 `TQMQG1080_EnsembleAndDistribution` | PASS (77 graphs, broad 1–5 distribution) |
| TQMQG1081 `TQMQG1081_HierarchySpanAndSizeScaling` | PASS (grid-class r=0.69 with ln N) |
| TQMQG1082 `TQMQG1082_ThreePreferenceAndClassification` | PASS (WEAK PREFERENCE) |

Code: `TQM.Core/ResearchXH/FamilyCountStatistics.cs`;
tests `TQM.Tests/ResearchXH/TQMQG_Phase108_FamilyCountStatisticsTests.cs`.
