# TQM-QG Phase 31 — Derive the TRM Propagator from Q-Event Network Dynamics

**Program:** TQM-QG (Unification)
**Phase:** 31 — what rule governs propagation of a tick, and is TRM's kernel a propagation law or a correlation?
**Status:** COMPLETED — 3/3 xUnit tests pass (96/96 TQM-QG)
...
### (a) Native tick propagation vs TRM kernel (TQMQG310)
...
native to TQM; it remains the imported ψ (QG23/QG24/QG28/QG30).
...
| Test | Verdict |
|---|---|
| TQMQG310 `TQMQG310_NativeVsTrm` | PASS (M_eff=0 vs e^Φ−1) |
| TQMQG311 `TQMQG311_Derivability` | PASS (not derivable natively) |
| TQMQG312 `TQMQG312_Classification` | PASS (PARTIAL MATCH) |

Code: `TQM.Core/ResearchXH/TRMPropagatorOrigin.cs`;
tests `TQM.Tests/ResearchXH/TQMQG_Phase31_TRMPropagatorOriginTests.cs`.
