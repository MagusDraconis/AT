# TQM-QG Phase 41 — Derive the TRM Acceleration Law

**Program:** TQM-QG (Unification)
**Phase:** 41 — can the √(g_N·a0) term emerge from Q-event saturation?
**Status:** COMPLETED — 3/3 xUnit tests pass (126/126 TQM-QG)
...
## 2. Saturation has a core, not a √ regime (TQMQG410)
...
## 4. Classification (TQMQG412)

**IMPORTED.**

- NOT DERIVED: saturation gives a regular core (suppression), not the √(g_N·a0) ∝ 1/r enhancement, which carries a
  new scale a0.
- TQM DOES derive flat rotation curves, but via the **log-deficit (α=0 scale-free)** profile (G4-ME Phases 3–4) —
...
TQM's derived scalar sector gives the regular core (saturation) and flat curves (log-deficit), while the MOND
...
| Test | Verdict |
|---|---|
| TQMQG410 `TQMQG410_SaturationHasCoreNoSqrt` | PASS (core, Newtonian recovery) |
| TQMQG411 `TQMQG411_OppositeSign` | PASS (suppression vs enhancement) |
| TQMQG412 `TQMQG412_Classification` | PASS (IMPORTED) |

Code: `TQM.Core/ResearchXH/TRMAccelerationOrigin.cs`;
tests `TQM.Tests/ResearchXH/TQMQG_Phase41_TRMAccelerationOriginTests.cs`.
