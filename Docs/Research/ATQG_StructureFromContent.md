# AT-QG Phase 115 — Does Content Determine Structure?

**Program:** AT-QG (Unification)
**Phase:** 115 — can the network emerge dynamically from its own activity?
**Status:** COMPLETED — 3/3 xUnit tests pass (348/348 AT-QG verified; COMPUTATIONAL)
...
## 2. Feedback + activity-driven connectivity (ATQG1150)
...
## 3. Self-organized geometry + structure-from-content (ATQG1151)
...
## 4. Fixed vs adaptive + classification (ATQG1152)
...
| Test | Verdict |
|---|---|
| ATQG1150 `ATQG1150_FeedbackAndActivityDrivenConnectivity` | PASS (feedback grows 130→357 links) |
| ATQG1151 `ATQG1151_SelfOrganizationAndStructureFromContent` | PASS (structured loop; content-dependent; uniform builds nothing) |
| ATQG1152 `ATQG1152_FixedVsAdaptiveAndClassification` | PASS (PARTIAL FEEDBACK) |

Code: `AT.Core/ResearchXH/StructureFromContent.cs`;
tests `AT.Tests/ResearchXH/ATQG_Phase115_StructureFromContentTests.cs`.
