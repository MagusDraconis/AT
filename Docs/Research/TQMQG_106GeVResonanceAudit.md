...
**Tests:** TQMQG188A0, TQMQG188A1, TQMQG188A2 (all passed)
**Core class:** `TQM.Core/ResearchXH/ResonanceEvidenceAudit.cs`
...
ATLAS, CMS, LEP — against that prediction, using only completed TQM results,
