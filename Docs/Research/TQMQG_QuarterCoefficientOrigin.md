# TQM-QG Phase 196 — Quarter Coefficient Origin

**Status:** COMPLETE — **PARTIAL ORIGIN** (impossibility proof for the exact 1/4)
**Tests:** TQMQG1960, TQMQG1961, TQMQG1962 (all passed)
**Core class:** `TQM.Core/ResearchXH/QuarterCoefficientOrigin.cs`
...
### 3.1 Structure derived; natural coefficients definite but ≠ 1/4 (TQMQG1960)
...
### 3.2 The bit-per-cell constraint: 1/4 requires imported π (TQMQG1961)
...
### 3.3 The occ₀ = 4 candidate is a wrong-units coincidence (TQMQG1962)
