# TQM-QG Phase 186 — Frame Dragging Origin

**Status:** COMPLETE — **FRAME-DRAGGING ORIGIN**
**Tests:** TQMQG1860, TQMQG1861, TQMQG1862 (all passed)
**Core class:** `TQM.Core/ResearchXH/FrameDraggingOrigin.cs`
...
### 3.1 Frame dragging is a ψ-sector observable (TQMQG1860)
...
### 3.2 The Lense–Thirring rate matches GP-B and LAGEOS (TQMQG1861)
...
- The numerical rates use the standard Lense–Thirring formula with the
  ...
  here). The TQM content is: (a) the sector structure (which observable lives
