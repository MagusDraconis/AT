# TQM-QG Phase 181 — Newton Constant Origin

**Status:** COMPLETE — **GRAVITY ORIGIN**
**Tests:** TQMQG1810, TQMQG1811, TQMQG1812 (all passed)
**Core class:** `TQM.Core/ResearchXH/NewtonConstantOrigin.cs`
...
- As with all TQM-QG derivations, agreement within ~0.4% demonstrates internal
