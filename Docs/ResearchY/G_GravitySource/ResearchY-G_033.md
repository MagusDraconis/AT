...
> audits are classified on their own. As of **G_041** the counts are **40 classified suites** → **23 in code / 1
...
> **G_041 works with the D96^d family explicitly**, asking whether d = 3 is selected).
