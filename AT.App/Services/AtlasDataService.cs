...
public static class AtlasDataService
{
    ...
    [
        ...
        new("ΩΛ from information", "ΩΛ = I_occ/ln K = 0.6839 — a derived information observable (normalized entropy deficit), matched to the observed dark-energy fraction to 0.12%; its energy reading is hosted (QG234, NP_055–NP_064).", ClassificationKind.Derived),
    ...
    [
        new(
            "researchy-np055-064-dark-energy-ontology",
            "Dark Energy Is a Derived Information Observable, Not a Derived Physical Mechanism: ΩΛ = 0.6839 Is the Normalized Entropy Deficit of the D96 Occupancy, and Its Energy Reading Is Hosted",
            "ResearchY Milestone · NP_055–NP_064 (Dark-Energy Ontology Arc)",
            "Ten audits trace ΩΛ = I_occ/ln K = 0.6839 to its root. ΩΛ is DERIVED — as an information observable: the normalized entropy deficit (the information surplus) of the top-heavy [4,4,87] occupancy over the uniform reference. But it has no derived equation of state, no derived dynamics, and it cannot do work; the step from \"information fraction\" to \"energy-density fraction\" is a HOSTED identification — the definition that energy is the actualization rate (QG89) plus dimensionful anchors. The 0.12% match to the observed dark-energy fraction is therefore a genuine, principled correspondence — real, but not a derived physical relation between information and energy.",
            "NP_055: ΩΛ's ontology is the information-bookkeeping fraction (B = E) — no derived vacuum energy, no derived w = −1 (QG230's Λ∝1/R² gives w = −1/3). NP_056: no unique equation of state — the dynamics are degenerate (64% H² spread across w), and a time-independent ΩΛ would even force deceleration. NP_057: ΩΛ is the normalized entropy deficit, a state descriptor (order parameter) monotone in top-heaviness, not a cause. NP_058: the information→energy bridge originates at QG89, 'energy = actualization rate' — a definition, not a derivation. NP_059: that definition cannot be derived (BOUNDARY) — only the conserved count (Σρ=1, Σm=0) is derived; no Noether route (discrete time). NP_060: ΩΛ cannot perform work (no energy scale, gradient, or temperature); the extractable side is matter (the deficit). NP_061: the 0.12% match is a fragile point-correspondence (only {KL measure, K=3, [4,4,87]} matches). NP_062: the high order is the mandatory shape of the discrete 1D spectrum (top-heavy by construction). NP_063: the equality is a descriptor link via an unproven common origin (ρ). NP_064: the root is the period-3 seed (derived) × the 3-family window (boundary) → N=96 → ΩΛ.",
            "For non-experts: the theory computes a single number — 0.6839 — from how its 96-part ring is occupied, and that number is the observed share of the universe made of 'dark energy', to a fraction of a percent. The audits asked a harder question: is that number actually the dark energy, or just a description of the system? The answer is careful. The number is genuinely derived, and it genuinely matches observation. But it is a description of the system's information structure, not a source of energy — it cannot do work, and the theory does not by itself explain why a description of information should equal an amount of energy. That last step is supplied (hosted) from outside, through one definition and a couple of measurement anchors. So the theory nails the number, and is honest that the physical meaning of the number is borrowed, not derived.",
            "ΩΛ = I_occ/ln K = 0.6839 is a derived information observable (normalized entropy deficit); the physical energy reading is a hosted correspondence rooted at QG89.",
            "“The theory counts dark energy; it does not conjure it.”",
            true,
            [
                new("ResearchY-NP_055", "DARK ENERGY ONTOLOGY AUDIT",
                    "ΩΛ is the information-bookkeeping fraction (B = E); energy reading hosted (no derived w = −1).",
                    "https://github.com/MagusDraconis/AT/blob/feature/v2.2-new-physics/Docs/ResearchY/NP_NewPhysics/ResearchY-NP_055.md"),
                new("ResearchY-NP_056", "EQUATION-OF-STATE AUDIT",
                    "No unique EoS: dynamics degenerate (64% spread); w is BOUNDARY; acceleration hosted.",
                    "https://github.com/MagusDraconis/AT/blob/feature/v2.2-new-physics/Docs/ResearchY/NP_NewPhysics/ResearchY-NP_056.md"),
                new("ResearchY-NP_057", "DARK ENERGY MEANING AUDIT",
                    "ΩΛ = normalized entropy deficit — a DERIVED state descriptor (order parameter), not a cause.",
                    "https://github.com/MagusDraconis/AT/blob/feature/v2.2-new-physics/Docs/ResearchY/NP_NewPhysics/ResearchY-NP_057.md"),
                new("ResearchY-NP_058", "INFORMATION-TO-ENERGY BRIDGE AUDIT",
                    "The bridge originates at QG89, 'energy = actualization rate' — a definition, not a derivation.",
                    "https://github.com/MagusDraconis/AT/blob/feature/v2.2-new-physics/Docs/ResearchY/NP_NewPhysics/ResearchY-NP_058.md"),
                new("ResearchY-NP_059", "ACTUALIZATION RATE AUDIT",
                    "'energy = actualization rate' is BOUNDARY; only the conserved count (Σρ=1) is derived.",
                    "https://github.com/MagusDraconis/AT/blob/feature/v2.2-new-physics/Docs/ResearchY/NP_059.md"),
                new("ResearchY-NP_060", "DARK ENERGY RESOURCE AUDIT",
                    "ΩΛ cannot perform work — a descriptor, not a resource; matter is the extractable side.",
                    "https://github.com/MagusDraconis/AT/blob/feature/v2.2-new-physics/Docs/ResearchY/NP_NewPhysics/ResearchY-NP_060.md"),
                new("ResearchY-NP_061", "ΩΛ COINCIDENCE AUDIT",
                    "The 0.12% match is a fragile point-correspondence (KL × K=3 × [4,4,87]).",
                    "https://github.com/MagusDraconis/AT/blob/feature/v2.2-new-physics/Docs/ResearchY/NP_NewPhysics/ResearchY-NP_061.md"),
                new("ResearchY-NP_062", "HIGH-ORDER UNIVERSE AUDIT",
                    "High order is the mandatory, typical shape of the discrete 1D spectrum.",
                    "https://github.com/MagusDraconis/AT/blob/feature/v2.2-new-physics/Docs/ResearchY/NP_NewPhysics/ResearchY-NP_062.md"),
                new("ResearchY-NP_063", "COSMOLOGICAL COINCIDENCE AUDIT",
                    "The equality is a descriptor link via an unproven common origin (ρ).",
                    "https://github.com/MagusDraconis/AT/blob/feature/v2.2-new-physics/Docs/ResearchY/NP_NewPhysics/ResearchY-NP_063.md"),
                new("ResearchY-NP_064", "CANONICAL STRUCTURE NECESSITY AUDIT",
                    "Root: period-3 seed (derived) × 3-family window (boundary) → N=96 → ΩΛ = 0.6839.",
        ...
        new(
            "researchy-np137-real-world-evidence",
            "The Lab Already Whispered It: A Frequency-Matched Tune That Softens Without Melting",
            "ResearchY · NP_137 (Real-World Evidence Audit)",
            "A theory is not finished when it predicts something; it is finished when someone checks whether nature was already doing it. The theory says a solid's strength hangs on a few load-bearing notes, and that singing those notes back at their own frequency can soften it without melting it. So we looked at what the laboratory already knew — ultrasound spectroscopy, acoustic softening, the way rocks loosen under shaking, ultrasonic welding, the fluid-like flow of vibrating gravel — and asked whether the signature was already there. It is. Ultrasonic energy can weaken metal without matching heat, and the metal stiffens again the moment the sound stops. The loud part — that one touched note drops stiffness by a third — is not yet in the record.",
            "NP_137 asks whether existing laboratory data already contain evidence for coherent critical-mode softening. Verdict: PARTIAL. Inventory of seven phenomena (resonant ultrasound spectroscopy, acoustic softening, nonlinear mesoscopic elasticity, phononic crystals, ultrasonic welding, acoustic fluidization, dynamic modulus reduction). Grade B (partially consistent): acoustic softening, nonlinear elasticity, acoustic fluidization; grade C (thermal): welding, dynamic modulus; neutral: RUS, phononic. The signature (frequency-matched, athermal, reversible acoustic softening) is OBSERVED — Langenecker's acoustoplastic effect lowers flow stress without matching heating and re-hardens on removal. The magnitude (quantized 33–100% elastic steps) is UNTESTED: observed reversible elastic bound ΔE/E ≈ ΔG/G ≤ 0.30, below the predicted 0.33 step; the 0.50–0.90 effects are plastic flow stress, not rigidity. No experiment shows a reversible order-preserving R→0 gel.",
            "For non-experts: the theory claims a solid can be softened by vibrating it at its own natural note, without melting it. When we checked the experiments, we found the signature was already known — ultrasound softens metal without real heating, and the metal firms back up when the sound stops. What no one has yet seen is the exact size the theory predicts: a single touched note cutting stiffness by a third. So the idea is half-confirmed — the tune exists; the volume has not yet been measured.",
            "Real-world evidence PARTIALLY supports coherent softening: the frequency-matched, athermal, reversible signature is observed; the quantized elastic magnitude is untested.",
            "“The tune is real; the dial has not been read.”",
            false,
            [
                new("ResearchY-NP_137", "REAL-WORLD EVIDENCE AUDIT",
                    "Existing data PARTIALLY support coherent critical-mode softening (signature observed; magnitude untested).",
                    "https://github.com/MagusDraconis/AT/blob/feature/v2.2-new-physics/Docs/ResearchY/NP_NewPhysics/ResearchY-NP_137.md"),
            ]),
        new(
            "researchy-np138-quantized-softening",
            "Not Three Clicks, but a Smooth Dial: The Discreteness That Wasn't There",
            "ResearchY · NP_138 (Quantized Softening Audit)",
            "A beautiful staircase is still a staircase only if the stairs are real. The theory had imagined a solid's strength falling in three clean clicks — a third, two thirds, gone — one click per load-bearing note. So we went looking for the clicks. What the laboratory shows instead is a smooth turn of a dial: the stiffness eases continuously as you push the sound harder, no sudden drops at one-third or two-thirds. The steps that do exist in nature are elsewhere — a crystal snapping at a phase transition, or the tiny irregular crackles of plastic slip — and they come in the wrong sizes and the wrong places. The idea of a master key survives; the idea that it clicks three times does not.",
            "NP_138 asks whether resonantly driven materials exhibit discrete modulus steps. Verdict: REFUTED. The NP_136 staircase R(x) = max(0, (1−x−p_c)/(1−p_c)), m = 6, p_c = 0.5 predicts ΔE/E = 0.33/0.67/1.00, but every resonant/acoustic elastic-modulus dataset is CONTINUOUS (nonlinear mesoscopic elasticity, acoustoplastic, DMA). Discrete steps exist in nature only via (a) thermal first-order phase transitions — spin-crossover ~71% (7→2 GPa) at T_c, ferroelastic precursor, α–β quartz — at arbitrary values, and (b) plastic slip avalanches P(S) ~ S⁻ᵗᵃᵘ — wrong channel, values, and statistics. This satisfies NP_136's own falsification condition ('drops continuously, not in ~33% steps'). Classification: quantized ladder REFUTED; continuous athermal softening CORRESPONDENCE; m = 6 staircase DERIVED (idealization artifact).",
            "For non-experts: the theory had pictured a material's strength falling in three clean steps — like a light switch with three positions. When we checked the experiments, we found no steps; the stiffness eases smoothly and continuously instead. The jumps that do exist in nature come from completely different causes — a crystal changing phase at a certain temperature, or the tiny random crackles of plastic slip — in the wrong sizes and places. So the switch is actually a dimmer knob: the idea is right, but it is smooth, not clicky.",
            "Quantized softening REFUTED: resonant elastic response is continuous; the predicted 0.33/0.67/1.00 steps are not observed.",
            "“The master key is a dial, not a three-position switch.”",
            false,
            [
                new("ResearchY-NP_138", "QUANTIZED SOFTENING AUDIT",
                    "Resonant elastic softening is continuous, not a staircase; the 0.33/0.67/1.00 ladder is refuted.",
                    "https://github.com/MagusDraconis/AT/blob/feature/v2.2-new-physics/Docs/ResearchY/NP_NewPhysics/ResearchY-NP_138.md"),
            ]),
        new(
            "researchy-np139-soft-mode-literature",
            "The Key Was Already in the Textbook: Soft Modes, Re-read",
            "ResearchY · NP_139 (Soft Mode Literature Audit)",
            "There is a humbling and useful kind of discovery — the one where you find your new idea already living in an old textbook. The theory said a solid's strength hangs on a few load-bearing notes, and that singing those notes can loosen it. When we asked whether physics already knew this, the answer came back fast: yes, almost all of it. The 'load-bearing notes' are the soft modes that condensed-matter physicists have measured for decades — the vibrations that soften toward zero as a crystal approaches a phase change. What the theory adds is not a new note but a new way to play it: not by heating the crystal toward its change, but by sounding the note at room temperature, reversibly, without letting the structure fall apart. That last part is the genuinely open question.",
            "NP_139 asks whether known condensed-matter physics already contains the equivalent of the AT critical-mode softening mechanism. Verdict: B — an EXTENSION (a new interpretation + extension of known soft-mode physics), not genuinely new physics. All four AT ingredients map onto known phenomena: 'critical modes' = Cochran–Anderson soft modes; 'small mode set controls rigidity' = the soft elastic constant C′ = (C₁₁−C₁₂)/2 / soft acoustic phonon; 'reversible athermal softening' = acoustic softening / nonlinear mesoscopic elasticity; 'continuous softening' = amplitude-dependent modulus reduction. The extension is operational: a fixed-temperature, order-preserving (S ≈ 1), coherent variable-rigidity dial, whereas canonical soft modes soften with temperature and culminate in a phase transition. Strongest correspondence = soft-mode theory + premartensitic C′ anomaly; strongest discrepancy = T-driven transition vs fixed-T order-preserving dial.",
            "For non-experts: the theory's 'critical modes' turned out to be a well-known thing — the 'soft modes' that physicists already use to explain how crystals change shape. So most of the theory is a fresh way of reading existing physics, not a brand-new discovery. The one part that is new is the claim that you can loosen a material by sounding its note at room temperature, reversibly, without it actually changing phase. Whether that works is still an open experiment.",
            "The AT mechanism is an extension (B): its 'critical modes' are known soft modes; only the fixed-T order-preserving coherent dial is new — and unverified.",
            "“The key was already in the textbook; the new part is how you turn it.”",
            false,
            [
                new("ResearchY-NP_139", "SOFT MODE LITERATURE AUDIT",
                    "AT's critical modes are the known soft modes; the fixed-T coherent dial is the unverified extension.",
                    "https://github.com/MagusDraconis/AT/blob/feature/v2.2-new-physics/Docs/ResearchY/NP_NewPhysics/ResearchY-NP_139.md"),
            ]),
        new(
            "researchy-np140-fixed-temperature-softening",
            "A Dimmer, Not a Power Switch: The Dial Exists, but Its Range Is Short",
            "ResearchY · NP_140 (Fixed-Temperature Softening Audit)",
            "The theory had hoped for a power switch: sound a note and turn a solid to jelly at room temperature, then let it snap back. When we checked, the truth was a dimmer with a short throw. The dial is real — sound can loosen a material without heating it, and it firms back up when the sound stops. But the amount you can turn it, at fixed temperature, without a phase change, is small: a few percent, maybe a third in soft grainy rock. The big swings the theory wanted — cut stiffness in half, or to nearly nothing — only happen by heating the crystal toward its change, or by plastically deforming it. So the idea survives, but as a gentle dial, not a power switch.",
            "NP_140 asks whether the fixed-temperature, order-preserving softening dial actually exists. Verdict: PARTIAL. The principle (drive-induced, fixed-T, athermal, reversible softening) is SUPPORTED — acoustic softening (plastic, 0.50–0.90) and nonlinear mesoscopic elasticity (elastic ≤ 0.30, typically ~0.01–0.10). But a large (≥50%) fixed-T ELASTIC-modulus reduction is UNKNOWN: elastic ΔE/E ≈ ΔG/G ≤ 0.30 at fixed T; 0.50–0.90 is plastic flow stress; ≈1.00 is temperature-driven (soft mode / ferroelastic / martensitic, phase transition). Against NP_136's 10/50/90% tiers: 10% partial, 50% plastic-only, 90% temperature-only. Strongest FOR = NME + acoustoplastic; strongest AGAINST = large elastic softening only via phase transition (the modulus is collective, not a few discrete modes).",
            "For non-experts: the theory wanted a material you could soften a lot, at room temperature, by vibrating it — and then have it snap back. The experiments show the softening is real but modest: a few percent, maybe up to a third in soft grainy rock. The big drops — cutting stiffness in half or more — happen only by heating the crystal toward a phase change, or by bending it plastically. So the 'variable stiffness' idea works, but as a small knob, not a big lever.",
            "The fixed-T dial is PARTIAL: the principle is supported, but the large fixed-T elastic magnitude is unknown (≤ ~30% elastic; 50–90% is plastic or thermal).",
            "“A dimmer with a short throw — the dial exists, the big lever does not.”",
            false,
            [
                new("ResearchY-NP_140", "FIXED-TEMPERATURE SOFTENING AUDIT",
                    "Fixed-T softening is PARTIAL: principle supported, large elastic magnitude unknown (≤ ~30% elastic).",
                    "https://github.com/MagusDraconis/AT/blob/feature/v2.2-new-physics/Docs/ResearchY/NP_NewPhysics/ResearchY-NP_140.md"),
            ]),
        new(
            "researchy-np141-yield-stress-softening",
            "The Lever Is on Flow, Not Stiffness: Why Softening Bends Metal, Not Rock",
            "ResearchY · NP_141 (Yield Stress Softening Audit)",
            "A screwdriver does not work by softening the steel's springiness; it works by getting the metal to flow. The theory had pointed its lever at the wrong quantity. Stiffness — how much a solid resists being bent a little — barely moves under sound, a few percent. But the stress at which a solid starts to flow — its yield strength — collapses under the same sound, because the energy goes straight into the defects that let atoms slip past each other. So the practical tool is not a 'soft rock' switch; it is an easier metal to form, cut, and drill. The master key was never the elastic backbone. It is the dislocation.",
            "NP_141 asks whether coherent critical-mode excitation reduces yield stress far more strongly than elastic modulus. Verdict: SUPPORTED — coherent excitation is primarily a YIELD-STRESS technology. Elastic modulus E (bond property, collective) softens ≤ ~30% (typically ~1–10%) at fixed T; yield stress σ_y (defect property, dislocation-gated) softens 20–90% via preferential acoustic absorption at dislocations. A 10% E reduction accompanies a 2–9× larger σ_y reduction. Practical levers (forming 20–50%, machining 15–40%, drilling, cutting, stone shaping) are all yield-stress/fracture processes. Classification: σ_y ≫ E SUPPORTED; dislocation/defect coupling SUPPORTED; yield-stress technology SUPPORTED; NP_131 'critical modes = elastic backbone' REFINED (→ defect modes).",
            "For non-experts: the theory originally aimed at making materials 'soft' — less stiff. That turned out to be the wrong target. Stiffness barely changes under sound. But the force needed to make a material flow — its yield strength — drops a lot, because the sound energy goes into the tiny defects that let atoms slide. So the real, useful effect is easier forming, cutting, and drilling of metal, not a rock that turns soft. The lever moves flow, not stiffness.",
            "Coherent excitation is a yield-stress technology (σ_y reduction 20–90% ≫ E reduction ≤30%), enabling easier forming, machining, and drilling.",
            "“The master key was never the backbone; it is the dislocation.”",
            false,
            [
                new("ResearchY-NP_141", "YIELD STRESS SOFTENING AUDIT",
                    "Coherent excitation is a yield-stress technology: σ_y softens 20–90%, far more than elastic modulus (≤30%).",
                    "https://github.com/MagusDraconis/AT/blob/feature/v2.2-new-physics/Docs/ResearchY/NP_NewPhysics/ResearchY-NP_141.md"),
            ]),
        new(
            "researchy-np142-multiband-resonance-control",
            "Not One Note, Not a Chorus: The Key Is a Loud Broad Hiss",
            "ResearchY · NP_142 (Multi-Band Resonance Control Audit)",
            "A piano key is one note. A chord is several, played in tune. But softening metal turned out to be neither: it is more like turning up a loud, broad hiss. The sound does not need to hit one precise note, and it does not need its notes played in perfect phase. What matters is dumping enough energy, across enough of the defect spectrum, to shake the dislocations loose. One frequency works; a spread of frequencies works better. The fine-tuning — getting the phases just right — matters least of all. The 'master key' was never a single note or a carefully phased chord; it is a broadband push.",
            "NP_142 asks whether coherent material control is a single-frequency problem or a multi-band phase-coherence problem. Verdict: PARTIAL — the 'master key' is NEITHER a single resonance NOR a coordinated multi-band phase-coherence pattern; it is a broadband, amplitude-driven defect coupling. The coupled objects are independent dislocations with a broad, damped resonance spectrum (Granato–Lücke); single-tone works (amplitude is the lever) but multi-tone is more effective (broader spectral coverage). Of {ω_i}, {A_i}, {φ_i}: amplitude dominates, frequency (spectral coverage) second, phase third — phase does NOT matter more than frequency. No small discrete mode set (NP_138); minimum = broadband amplitude above the dislocation breakaway threshold.",
            "For non-experts: the theory had pictured a single magical note, or a few notes played in perfect phase. The experiments say otherwise. Softening metal is about putting in enough loud sound across a wide range, to shake the tiny defects that let atoms slide. One frequency works; several work a bit better. Getting the phases lined up matters least. So the 'key' is not a note or a chord — it is a loud, broad hum.",
            "The master key is broadband amplitude: amplitude > spectral coverage > phase; not a single resonance or a phase-coherent pattern.",
            "“Not one note, not a chorus — a loud broad hiss.”",
            false,
            [
                new("ResearchY-NP_142", "MULTI-BAND RESONANCE CONTROL AUDIT",
                    "The master key is broadband amplitude (amplitude > frequency > phase), not a single resonance or phase-coherent pattern.",
                    "https://github.com/MagusDraconis/AT/blob/feature/v2.2-new-physics/Docs/ResearchY/NP_NewPhysics/ResearchY-NP_142.md"),
            ]),
        new(
            "researchy-np143-dislocation-threshold",
            "A Whisper Is Enough: The Threshold Is Tiny, and the Lab Already Crosses It",
            "ResearchY · NP_143 (Dislocation Threshold Audit)",
            "There is a satisfying moment when a 'far-out' idea turns out to need nothing more than the equipment on a benchtop. To shake a metal's atoms loose, you do not need a factory; you need a strain of a few parts per million — a whisper of stress, a few watts per square centimeter. A standard ultrasonic horn already pushes ten to a thousand times past that. This is why the effect was seen back in 1955 with ordinary transducers. The industrial machines are only for making it fast and at scale; the physics itself is on the lab bench.",
            "NP_143 asks what amplitude/energy density triggers significant defect mobility. Verdict: SUPPORTED — laboratory-accessible. The Granato–Lücke dislocation breakaway threshold ε_c ≈ 10⁻⁶–10⁻⁵ (microstrain) gives σ_c = E·ε_c ≈ 0.06–2 MPa and I_c = σ_c²/(2ρc) ≈ 1–5 W/cm² for aluminum, steel, quartz, granite. Standard equipment crosses this comfortably: piezo ~1–10 W/cm², horn ~10–20+ W/cm², phased array (focused); a 20 kHz horn's 5–20 μm displacement gives 5–1000× the breakaway strain. Industrial scale is needed only for throughput, not threshold access.",
            "For non-experts: to soften metal with sound, you need very little — a strain of a few parts per million and a few watts per square centimeter. Standard lab ultrasonic equipment already delivers ten to a thousand times more than that. So the effect is not a factory-scale wonder; it is a benchtop experiment. The big machines are just for doing it faster and on bigger parts.",
            "Coherent softening is laboratory-accessible: the breakaway threshold (microstrain, ~1–5 W/cm²) is crossed by standard piezo/horn equipment.",
            "“A whisper is enough — the threshold is tiny, and the lab already crosses it.”",
            false,
            [
                new("ResearchY-NP_143", "DISLOCATION THRESHOLD AUDIT",
                    "Softening is laboratory-accessible: breakaway threshold ε_c ~ 1e-6–1e-5, I_c ~ 1–5 W/cm², crossed by standard equipment.",
                    "https://github.com/MagusDraconis/AT/blob/feature/v2.2-new-physics/Docs/ResearchY/NP_NewPhysics/ResearchY-NP_143.md"),
            ]),
        new(
            "researchy-np144-defect-spectrum-fingerprint",
            "Every Metal Has Its Own Tune: The Fingerprint Is Real, but the Lever Is Broad",
            "ResearchY · NP_144 (Defect Spectrum Fingerprint Audit)",
            "Just as a fingerprint identifies a person, a metal's defects leave a signature in how it absorbs vibration — aluminum shows one peak, steel another, stone yet another. That signature is real and measurable, and it can tell you exactly what kind of defects a material carries. But when it comes to using that signature to soften the material more, the payoff is modest: you can save energy by playing the right notes, but you will not soften it much more than by just turning up a broad hum. The fingerprint is a wonderful diagnostic and a small efficiency knob — not a volume control for softening.",
            "NP_144 asks whether different materials have unique defect-spectrum fingerprints usable for targeted yield-stress control. Verdict: PARTIAL. Unique fingerprint SUPPORTED (mechanical spectroscopy: Bordoni dislocation peak in aluminum, Snoek interstitial peak in steel, grain-boundary/Kê and NME features in granite/quartz); universal broadband mobility response SUPPORTED (NP_142). Sensitivity: amplitude > bandwidth > frequency. Tailored excitation is more energy-efficient (~2–5× power saving) but does not increase the softening magnitude (~1×), because softening is set by dislocation mobility once the breakaway threshold is crossed (NP_143).",
            "For non-experts: every material has its own defect 'fingerprint' — a measurable signature in how it absorbs vibration. That fingerprint is great for diagnosing what defects are inside. But using it to soften the material more doesn't buy much: you can save a bit of energy by matching the right frequencies, but you won't get a bigger softening effect than just using a broad, loud hum. So the fingerprint is a diagnostic tool and a small efficiency knob, not a power amplifier.",
            "Unique defect fingerprint SUPPORTED; targeted softening PARTIAL (efficiency ~2–5×, magnitude ~1×). The fingerprint is diagnostic, not a magnitude lever.",
            "“Every metal has its own tune — but the lever stays broad.”",
            false,
            [
                new("ResearchY-NP_144", "DEFECT SPECTRUM FINGERPRINT AUDIT",
                    "Unique defect fingerprint exists (mechanical spectroscopy), but targeted softening gives only efficiency gains.",
                    "https://github.com/MagusDraconis/AT/blob/feature/v2.2-new-physics/Docs/ResearchY/NP_NewPhysics/ResearchY-NP_144.md"),
            ]),
        new(
            "researchy-np145-waveform-control",
            "The Shape Doesn't Matter, the Punch Does: It's an Amplitude Problem",
            "ResearchY · NP_145 (Waveform Control Audit)",
            "People love to ask which 'shape' of sound works best — a smooth hum, a sharp burst, a sweeping chirp. The experiments give a deflating answer: the shape is not the lever. What matters is how hard the sound punches — its peak — and how wide it reaches — its band. A sharp burst beats a smooth hum only because it packs the same energy into a harder, shorter punch that knocks the defects loose. So the question 'sine or chirp or impulse' is really the question 'how do I concentrate the energy into a punch that clears the threshold?' That is an amplitude problem, not a waveform problem.",
            "NP_145 asks whether the temporal waveform matters more than frequency for defect mobilization. Verdict: SUPPORTED — material control is primarily an AMPLITUDE problem. Holding total energy constant, the five waveforms (sine/burst/chirp/noise/impulse train) differ only in peak amplitude + bandwidth; there is no independent shape degree of freedom. Defect mobilization tracks peak amplitude: bursts/impulses outperform sine per unit energy because they concentrate energy into a higher peak that crosses the breakaway threshold σ_c (NP_143) — the shock-loading result (plastic flow driven by peak stress + duration, not shape). Dominance: amplitude > bandwidth > waveform.",
            "For non-experts: everyone asks which 'shape' of sound is best — a smooth hum, a sharp pop, a sweep. The answer is that the shape barely matters. What matters is how hard the sound hits (its peak) and how wide it reaches (its band). A sharp pop beats a hum only because it packs the same energy into a harder, shorter hit that knocks the material's defects loose. So it is not a 'shape' question — it is a 'how hard do you hit' question.",
            "Material control is an amplitude problem: amplitude > bandwidth > waveform; shape is a derived packaging of peak + band.",
            "“The shape doesn't matter; the punch does.”",
            false,
            [
                new("ResearchY-NP_145", "WAVEFORM CONTROL AUDIT",
                    "Material control is primarily an amplitude problem (amplitude > bandwidth > waveform); shape is derived.",
                    "https://github.com/MagusDraconis/AT/blob/feature/v2.2-new-physics/Docs/ResearchY/NP_NewPhysics/ResearchY-NP_145.md"),
            ]),
        new(
            "researchy-np146-energy-pathway",
            "The Energy Goes to Work, Not to Heat: Why Softening Is Not Melting",
            "ResearchY · NP_146 (Energy Pathway Audit)",
            "When sound softens metal, where does the energy actually go? The instinct is to say 'it heats it up.' But the classic experiments say otherwise: if you warm the metal by exactly the amount the sound would have, it does not soften the same way. Most of the sound's energy goes into pushing the material's defects around — nudging dislocations so the metal flows more easily — with only a leftover fraction turning into heat. So the softening is mechanical, not thermal; the energy goes to work, not to warming. That is why softening is not melting.",
            "NP_146 asks where the injected ultrasonic energy goes during yield-stress softening. Verdict: SUPPORTED — the dominant pathway is DEFECT MOTION (mechanical/athermal), not heat. The energy partitions into elastic storage (small, recoverable), defect motion (dominant, recoverable — dislocations in metals, microcracks/contacts in rock), and heat (residual, via internal friction). Decisive evidence: Langenecker's result that the softening is NOT reproduced by the equivalent temperature rise. Ordered metals (Al, steel) have the cleanest dislocation-dominated pathway; quartz/granite have more frictional/contact dissipation.",
            "For non-experts: when sound softens metal, the energy does not just heat it up. The classic experiments show that warming the metal by the same amount does not cause the same softening. Most of the sound's energy goes into nudging the metal's internal defects so it flows more easily, with only a leftover bit becoming heat. So the softening is mechanical, not thermal — the energy goes to work, not to warming.",
            "The softening energy goes into defect motion (mechanical/athermal), not heat; elastic storage is a small side channel.",
            "“The energy goes to work, not to heat — that's why softening is not melting.”",
            false,
            [
                new("ResearchY-NP_146", "ENERGY PATHWAY AUDIT",
                    "The dominant energy pathway is defect motion (mechanical/athermal); heat is residual internal friction.",
                    "https://github.com/MagusDraconis/AT/blob/feature/v2.2-new-physics/Docs/ResearchY/NP_NewPhysics/ResearchY-NP_146.md"),
            ]),
        new(
            "researchy-np147-defect-writing",
            "Sound Can Edit, Not Just Relax: Writing the Defect Score",
            "ResearchY · NP_147 (Defect Writing Audit)",
            "Sound does not only loosen a metal for a moment — it can leave a lasting mark. With enough vibration, the material's internal flaws get rearranged: dislocations cancel out, the grains refine into finer cells, and even tiny cracks can knit back together. So the same tool that softens transiently can also 'write' the material — changing its defects permanently, for better or worse. That turns the resonance 'master key' from a temporary relaxation into a true editing tool: read the material's defect signature, then write a new one.",
            "NP_147 asks whether coherent ultrasonic excitation can create, erase, rearrange, or heal defect populations. Verdict: SUPPORTED — resonance control is a TRUE defect-engineering tool, not only a transient softening lever. Four processes: motion (transient), creation, annihilation, rearrangement (permanent). Sustained high-amplitude excitation permanently reduces dislocation density (annihilation), refines subgrains, and heals microcracks (crack-tip plasticity, e.g. copper 3× fatigue life), with residual hardening or softening. Metals are the richest medium; quartz/granite are crack/contact-limited. The defect fingerprint (NP_144) changes after conditioning.",
            "For non-experts: sound does not just briefly loosen a metal — it can permanently change it. Strong, repeated vibration can erase some defects, refine the material's internal grain structure, and even help tiny cracks close up. So the same tool that softens for a moment can also 'edit' the material's flaws for the long term. The material's defect signature can be read, and then rewritten.",
            "Resonance is a defect-engineering tool: it can create, annihilate, rearrange, and heal defect populations (not just transiently soften).",
            "“Sound can edit, not just relax — the defect score is writable.”",
            false,
            [
                new("ResearchY-NP_147", "DEFECT WRITING AUDIT",
                    "Resonance is a true defect-engineering tool: it writes (creates/annihilates/rearranges/heals) defect populations permanently.",
                    "https://github.com/MagusDraconis/AT/blob/feature/v2.2-new-physics/Docs/ResearchY/NP_NewPhysics/ResearchY-NP_147.md"),
            ]),
        new(
            "researchy-np148-property-programming",
            "From Softening to Specifying: Programming What a Metal Can Do",
            "ResearchY · NP_148 (Property Programming Audit)",
            "Softening is just moving one knob. Programming is moving a whole panel of knobs toward a chosen result. The theory's writable 'resonance score' turns out to be more than a metaphor: industrial ultrasonic peening already reads a metal's defects and writes a new one — hardening the surface, burying a layer of compressive stress, doubling the fatigue life — all by choosing the right amplitude, load, and coverage. So resonance control is not just a way to relax a material for a moment; it is a way to specify what the material should be, at least for metals. The open question is closing the loop automatically, so the machine finds the target on its own.",
            "NP_148 asks whether material properties can be programmed through controlled defect engineering. Verdict: SUPPORTED — resonance control can become TRUE property programming (metal-centric). Target properties (hardness, yield stress, fatigue life, fracture toughness, damping) each map onto a specific defect lever (dislocation density, grain refinement, residual stress, crack closure). Parameter-controlled ultrasonic processes (shot peening, UNSM up to −1400 MPa / fatigue limit up to 2×, USRP) move materials toward specified properties — directed, not random, defect evolution. Open-loop read→write→verify works today; closed-loop convergence is PARTIAL (emerging). Metal-centric: ceramics/quartz/granite lack dislocation/grain levers.",
            "For non-experts: 'softening' is turning one knob; 'programming' is turning many knobs toward a chosen result. The idea that a material's properties can be 'written' is not just a metaphor — industrial ultrasonic peening already does it: it hardens a metal's surface, embeds a layer of protective compression, and can double its fatigue life, by choosing the right settings. So sound can be used to specify what a metal should be, not just loosen it for a moment. The remaining challenge is making the machine find the target automatically.",
            "Resonance control can program properties (metal-centric): directed defect evolution hits hardness/yield/fatigue/toughness/damping targets; closed-loop is emerging.",
            "“From softening to specifying — sound can program what a metal can do.”",
            false,
            [
                new("ResearchY-NP_148", "PROPERTY PROGRAMMING AUDIT",
                    "Resonance control can program material properties (metal-centric): directed defect evolution; closed-loop emerging.",
        ...
        new(
            "researchy-np166-periodic-table",
            "The Periodic Table Cannot Emerge from Resonance Organization Alone: the Shell Counts 2, 8, 18, 32 Are the Hydrogenic Schrödinger Spectrum, Not an AT Derivation",
            "ResearchY · NP_166 (Periodic Table Emergence Audit)",
            "Could Actualization Theory re-derive the periodic table from its own organization — particles as resonance classes, binding as resonance locking, hierarchy as repeated organization — without solving the Schrödinger equation? The audit's answer is a clean no. The element-ordering structure is electron shell structure: shells with maximum occupancies 2, 8, 18, 32 = 2n². And that law is the hydrogenic degeneracy of the central Coulomb field — n² orbitals (the sum of 2l+1 over l) times two spin states. That is the Schrödinger spectrum of the atom, not a pattern the theory's one-dimensional ring can generate. The D96 octave layers hold [4, 4, 87] modes; its shell profile is {1, 12, 12, …}; nothing native matches the observed ladder. Atoms exist in AT (binding) and organize into molecules, crystals, and larger structures (hierarchy) — but the shell ladder that orders the elements is imported quantum mechanics.",
            "NP_166 inventories shell structure, valence structure, and periodicity and tests whether electron shells correspond to resonance layers, organization levels, or locking hierarchies. Verdict: none of the three. Shell capacities 2, 8, 18, 32 = 2n² = 2·Σ(2l+1) are the hydrogenic (central-field Coulomb) degeneracy, imported from the Schrödinger solution; observed period lengths (2, 8, 8, 18, 18, 32, 32) require the Madelung (n+l) ordering of the many-electron central field. D96 octave occupancy [4, 4, 87], C96 BFS shells {1, 12, …}, mirror pairs, and mode counts all fail to reproduce the observed shells H [1], He [2], Li [2, 1], Ne [2, 8], Ar [2, 8, 8]. The structural reason mirrors nuclear shells (NP_087/089): exact (2l+1) degeneracies need exact O(3), which the 1D/cubic D96 does not provide. Classification: atom binding and hierarchy DERIVED (NP_100/101 unchanged); electron shells as resonance layers/organization levels REFUTED; shell capacities BOUNDARY-class (imported hosted values, the 13.6 eV/m_e-anchor pattern); the periodic table CORRESPONDENCE (hosted QM, confirming NP_017 and extending NP_085: chemistry is not derived); 'AT predicts 2, 8, 18, 32 naturally' REFUTED.",
            "For non-experts: the periodic table is the chemical family tree of the elements, ordered by how electrons arrange in shells around the nucleus — shells that hold at most 2, then 8, then 18, then 32 electrons. This audit asks whether the theory could have predicted those exact numbers from its own rules about vibration and organization. The answer is no: the numbers are exactly what quantum mechanics computes for the hydrogen-like atom (each shell fills as 2n²). The theory explains why atoms stick together and form molecules and crystals, but the shell ladder that orders the elements is borrowed, standard quantum content.",
            "The periodic table is CORRESPONDENCE: shell capacities 2, 8, 18, 32 = 2n² are the hydrogenic Schrödinger spectrum, not an AT organization prediction.",
            "“The table of elements is written by the Coulomb atom, not by the ring.”",
            false,
            [
                new("ResearchY-NP_166", "PERIODIC TABLE EMERGENCE AUDIT",
                    "Electron shells are not resonance layers/organization levels/locking capacities; 2, 8, 18, 32 = 2n² is imported hydrogenic content; the periodic table is CORRESPONDENCE.",
                    "https://github.com/MagusDraconis/AT/blob/feature/v2.2-new-physics/Docs/ResearchY/NP_NewPhysics/ResearchY-NP_166.md"),
            ]),
        new(
            "researchy-np167-unknown-organization-states",
            "Unexplored States of Organization: New Territory, Built Entirely from Known Physics",
            "ResearchY · NP_167 (Unknown Organization States Audit)",
            "If matter is really the organization of a deeper network, then the natural question is whether there are whole kinds of organization that no one has ever tried to make. This audit walks the famous list first: crystals, glasses, liquids, granular packings, phononic structures, metamaterials, topological materials, force chains — all deliberately engineered by humanity. Then it asks whether combining their ordering principles in new ways leaves genuinely untouched territory. It does: nobody has deliberately written a periodic lattice of force chains, or carved a phononic band structure into the contacts of a jammed rock, or held a jammed order in place with continuous drive, or built a topological state on a reconfigurable granular lattice. These are real, physically allowed, unexplored states — but every one is a new combination of old physics, not a state that needs new laws.",
            "NP_167 asks whether there exist large-scale organization states of matter/network structures that humanity has never intentionally attempted to create (hostile audit: no archaeology, only physically plausible states). Verdict: criterion B MET — physically allowed, never-deliberately-engineered states EXIST, but they are combinations/scales of known ordering axes (long-range-ordered force-chain lattices; phononic structure in jammed contact networks; persistently driven jammed order; granular–topological hybrids), expressible in ordinary condensed-matter terms. The 8 known organization classes are all deliberately engineered; every AT ordering axis (coherence, phase alignment, force-chain order, resonance locking, occupancy/actualization ordering) maps onto known physics (BECs/phase-locked arrays; granular force chains; mode-locked oscillators; the defect/contact state space of NP_157). The strongly AT-specific candidate — a phase ordered only in occupancy/actualization variables — has NO observable separable from ordinary ordered matter (NP_151 re-label; NP_157 no new ontology): criterion C is NOT met (SPECULATIVE at best). Ranking by detectability/reversibility/stability/energy puts the force-chain lattice highest among unexplored states (12), below the KNOWN fixed-T coherent dial (17, NP_132/140). Resonance CAN move a material between organization states without chemistry change, reversibly sub-damage (NP_155/156); magnitude bounded by the small fixed-T dial (NP_140). Classification: known-state inventory CORRESPONDENCE; unexplored combinations EMERGENT; AT-only phase SPECULATIVE; 'no unknown states' REFUTED; 'organization is a new ontology' REFUTED (NP_157).",
            "For non-experts: are there forms of internal order — new 'kinds of arrangement' of a material — that nobody has ever tried to build? The famous arrangements are all made on purpose: crystals, glasses, liquids, packed sand, metamaterials, topological materials. But combine them in new ways and you reach territory nobody has deliberately explored: a regular lattice of load-carrying chains, a wave-filtering pattern carved into a rock's grain contacts, a granular state held ordered by steady vibration, or a topological state built on a reconfigurable pile. All are real and physically possible — yet all are new combinations of old, well-understood physics. Nothing here needs new laws; the theory's distinctive vocabulary remains a naming of the same known orderings.",
            "Unexplored organization states EXIST (criterion B) but are combinations of known axes; an AT-only organization phase is SPECULATIVE — no independent observable (criterion C not met); 'no unknown states' REFUTED.",
            "“New combinations of old order — territory unexplored, physics unchanged.”",
            false,
            [
                new("ResearchY-NP_167", "UNKNOWN ORGANIZATION STATES AUDIT",
                    "Criterion B MET (unexplored states = known-axis combinations); AT-only phase SPECULATIVE (no discriminator); inventory CORRESPONDENCE.",
        ...
        new(
            ...
            [
                new("ResearchY-NP_169", "NATURAL SCALING VS MASS GAP AUDIT",
                    ...
                    "https://github.com/MagusDraconis/AT/blob/feature/v2.2-new-physics/Docs/ResearchY/NP_NewPhysics/ResearchY-NP_169.md"),
            ]),
        new(
            "researchy-np170-lock-lattice-phase-memory",
            "Lock-Lattice Phase Memory: the Lock Law Gets Its First Physical Test — a Pre-Registered Ring Experiment Whose State Variable Is Which Modes Are Locked, Not How Much Charge Is Stored",
            "ResearchY Milestone · NP_170 (V2.2 New Physics — Lock-Lattice Program Proposal)",
            "Every existing lock-law result (QG307–QG319) is a statistic computed on datasets or synthetic cohorts — and AT's own Ch14 concedes that standard complexity measures match or beat the lock rule on an evolving cohort, so no further statistical audit can settle the question. NP_170 proposes the one experiment that can: an engineered circulant C₉₆(1..6) oscillator ring, charged into a locked mode configuration and predicted to retain its state longer than a degeneracy-matched control, with the retention difference produced by the actualization barrier (QG120) and readable through Δθ interference (QG126). This is a PROPOSAL, not a result — no experiment has been performed and nothing is claimed. Energy storage is explicitly abandoned; the locking nonlinearity (NP_005) and the coupling network (NP_007/NP_011) are declared imported BOUNDARY inputs.",
            "NP_170 specifies one experiment — LLPM (Lock-Lattice Phase Memory) — plus the pre-registration, metrics and kill criteria that make either outcome informative. Why now: the lock law (Ch8) has only statistical evidence, so a hardware ring is the only place where it must produce a DYNAMICAL PHASE TRANSITION instead of a table statistic. THE CANONICAL BASIS the hardware must realize: attractor C₉₆(1..6) (degree 12), λ₂ = 0.386350893377790, ω₁ = 0.621571309969974, span = 6.402515, bands [4,4,87], 47 mirror pairs, multiplicities {2×42, 5, 6}. THREE REASONS, ranked by expected value: (1) THEORY FALSIFICATION (strongest) — metric: existence of a threshold in the PHYSICAL coupling with sharpness ≥ 3 and width ≤ 0.4 (QG316 criticality criteria); bar: hysteresis area A > 0 at ≥ 5σ over ≥ 30 runs, absent in all three controls; pass ⇒ the lock structure is physically realizable and the lock law stops being a candidate descriptive statistic, fail ⇒ the lock law is downgraded to a descriptive statistic (consistent with QG312 partial-fake and QG319 FP = 96.9 % / FN = 66.1 %) and the storage claim is withdrawn permanently. (2) PHASE / COHERENCE MEMORY — metric: energy per write (fJ), retention (s), read-out visibility, variability σ/μ; bar: < ~10 fJ/write, variability < 5 % (competitive with MRAM/PCM/FeRAM); plausible because the state variable is PHASE, not charge, so writing is phase-pinning (M_002) and the write-energy floor is set by phase noise rather than Coulomb energy; may fail because decoherence and thermal phase diffusion erase phase memory. (3) NEUROMORPHIC THRESHOLD ELEMENT — the lock transition is a sigmoidal threshold with hysteresis, and its threshold POSITION and SHARPNESS are PREDICTED by the operator/lock structure rather than fitted, which memristor and phase-change devices cannot offer. EXPLICITLY NOT A REASON: energy storage — a 96-node lattice holds µJ-scale energy at kW-scale overhead if cryogenic, 10⁶–10⁹× behind Li-ion (0.9 MJ kg⁻¹, ~5000 cycles, ~€100 kWh⁻¹); that framing is closed. APPARATUS TIERS: Tier 1 bench electronic (days, low cost — the deciding experiment), Tier 2 photonic chip (months), Tier 3 superconducting (~1 year). REV. 2 CHANGES (after the post-fetch results NP_169 and T_007–T_015): (1) T_015 (robustness is controlled by degeneracy structure; 'D96 outperforms random' REFUTED) forces a MANDATORY degeneracy-matched control (d) scored on R4, with every control reporting ΔA and an anchored < 1 % spread tolerance tied to Δλ₂/λ₂ and ΔA — no superiority claim; (2) T_010/T_012/T_014 (D96 is the COMPRESSED lattice: 5 survivors vs 17 random, only 2 modes within 2λ₂, D96³ 16 survivors) force a FRAMING change — D96 is chosen for DERIVABILITY, not capacity, and D96³ is offered as an explicitly non-canonical engineering variant, with the legacy ~19 unused (T_011/T_012 refute it from D96); (3) NP_169 (λ_gap = 4π²·91/N² + O(N⁻⁴); no AT-native scaling preserves a positive gap) forces the ring's nonzero gap to be declared an IMPORTED kinematic finite-size gap, λ₂ no longer being described as a physical mass-gap scale; (4) T_014 refines the protocol into per-mode ε (ε_j = 0.01 ω_j) with near-gap and global lock fractions reported separately. UNCHANGED by the revision: the core experiment (R1–R5), the three reasons, the kill criteria, the density argument, the AT-P043 draft, and every verified D96 number. STATUS: PLANNED — rev. 2, no result claimed; no canonical AT statement modified, no new primitive, and nothing in the prediction/classification/coverage registries touched (AT-P043 remains unclaimed; QG313/QG316 citations remain current).",
            "For non-experts: the theory's chapter on locking has, so far, only ever been checked against datasets and simulated populations — never against a physical device. This proposal argues that only a real ring can settle the question, because a real device either shows a sharp physical threshold or it does not. So the plan is to build a small ring of 96 coupled oscillators, drive it into a locked configuration, and ask one concrete question: does the locked state hold longer than an otherwise identical, carefully matched control? Two things keep this honest rather than hopeful. First, the proposal refuses the tempting story that this would be a battery — the arithmetic kills it outright, so the claim is about remembering a configuration, not storing energy — and the memory idea itself is explicitly labelled an analogy awaiting test rather than something derived. Second, the proposal was revised after newer results landed, and those results were unkind in places: they showed the theory's own ring is the compressed, low-capacity choice, that a random lattice keeps more states, and that the stability differences the proposal once leaned on are governed by a different property entirely. The response was to add a properly matched control group and to forbid any claim that the ring beats randomness. The proposal also states plainly what it cannot do: it can fail to falsify the theory, or it can falsify the physical realizability of the lock — it can never confirm the theory.",
            "PLANNED — proposal only, rev. 2: no experiment performed and no result claimed. The Ch8 lock law gets its first PHYSICAL test (a C₉₆(1..6) ring as phase memory, not an energy store); both outcomes are informative; the nonlinearity and coupling network are imported BOUNDARY inputs; D96 is chosen for derivability, not capacity.",
            "“A lock is a state variable — not an amount of energy.”",
            true,
            [
                new("ResearchY-NP_170", "LOCK-LATTICE PHASE MEMORY PROPOSAL (PLANNED — NO RESULT CLAIMED)",
                    "Proposal, rev. 2: test the Ch8 lock law as a DYNAMICAL PHASE TRANSITION on an engineered C₉₆(1..6) ring (threshold sharpness ≥ 3, width ≤ 0.4; hysteresis A > 0 at ≥ 5σ over ≥ 30 runs, absent in all controls). Energy storage abandoned; the locking nonlinearity (NP_005) and the coupling network (NP_007/NP_011) are imported BOUNDARY inputs.",
                    "https://github.com/MagusDraconis/AT/blob/feature/v2.2-new-physics/Docs/ResearchY/NP_NewPhysics/ResearchY-NP_170.md"),
                new("ResearchY-T_015", "SPECTRAL ROBUSTNESS AUDIT",
                    "Forces a mandatory DEGENERACY-MATCHED control: robustness is set by degeneracy structure and 'D96 outperforms random' is refuted — no superiority claim is allowed.",
                    "https://github.com/MagusDraconis/AT/blob/feature/v2.2-new-physics/Docs/ResearchY/T_SpectralBlueprint/ResearchY-T_015.md"),
                new("ResearchY-T_010", "D96 SURVIVOR COMPRESSION",
                    "D96 is the COMPRESSED lattice (~5 survivors vs ~17 random) — it is proposed for derivability, not state richness; D96³ is the capacity-oriented engineering variant.",
                    "https://github.com/MagusDraconis/AT/blob/feature/v2.2-new-physics/Docs/ResearchY/T_SpectralBlueprint/ResearchY-T_010.md"),
                new("ResearchY-T_014", "NEAR-GAP DENSITY",
                    "D96 keeps only 2 modes / 1 distinct eigenvalue within 2λ₂ — refines the protocol into per-mode ε (ε_j = 0.01 ω_j) with separate near-gap and global lock fractions.",
                    "https://github.com/MagusDraconis/AT/blob/feature/v2.2-new-physics/Docs/ResearchY/T_SpectralBlueprint/ResearchY-T_014.md"),
                new("ResearchY-NP_169", "NATURAL SCALING VS MASS GAP AUDIT",
                    "Forces the framing fix: the ring's nonzero gap is an IMPORTED kinematic finite-size gap (λ_gap = 4π²·91/N² + O(N⁻⁴)); λ₂ is not a physical mass-gap scale.",
                    "https://github.com/MagusDraconis/AT/blob/feature/v2.2-new-physics/Docs/ResearchY/NP_NewPhysics/ResearchY-NP_169.md"),
                new("ResearchY-M_002", "MEASUREMENT DISTURBANCE AUDIT",
                    "Writing the memory element is PHASE-PINNING, not charge transfer — the write-energy floor is set by phase noise, which is what makes reason 2 plausible.",
                    "https://github.com/MagusDraconis/AT/blob/feature/v2.2-new-physics/Docs/ResearchY/M_Measurement/ResearchY-M_002.md"),
                new("ResearchY-NP_005", "SYNCHRONIZATION MECHANISM AUDIT",
                    "The cross-phase locking nonlinearity is ABSENT from the canonical chain (BOUNDARY) — the proposal must import it and declares it as such.",
                    "https://github.com/MagusDraconis/AT/blob/feature/v2.2-new-physics/Docs/ResearchY/NP_NewPhysics/ResearchY-NP_005.md"),
            ]),
        new(
            "researchy-np171-lock-lattice-simulator",
            "The Lock Lattice, Simulated Before It Is Built: a Sharp Threshold at 1.6× the Board's Reach — and No Significant Hysteresis",
            "ResearchY Milestone · NP_171 (V2.2 New Physics — Deterministic Lock-Lattice Simulator)",
            "NP_170 pre-registered a hardware test whose pass/fail turns on H1: sharpness ≥ 3 AND width ≤ 0.4 with a hysteresis loop A > 0 at ≥ 5σ. This audit runs the cheapest possible version of that test first — a deterministic Adler/Kuramoto evolution of the canonical C₉₆(±1..±6) ring with NO noise, fixed seeds and metrics taken verbatim from the protocol. The model's transition is decisively sharp (23.69 ≥ 3) and narrow (0.132 ≤ 0.4) at g_c = 1.607 ± 0.030, but the hysteresis criterion FAILS at 3.4σ, and at the board's nominal maximum coupling nothing locks at all (f(g=1) = 0). It also finds — again — that the D96 lattice is not the easiest to lock: the random-coupling control locks earlier, with exactly zero hysteresis.",
            "NP_171 simulates NP_170's R3 protocol rather than performing it. LATTICE: canonical C₉₆(±1..±6), degree 12, node i carrying eigenmode i, ω_i = √λ_i from the exact closed form λ_k = 2Σ_{d=1..6}(1 − cos 2πdk/96) (no eigensolver, so mirror pairs are degenerate to machine precision), normalized by ω_max — the mirror pairing λ_k = λ_{96−k} thereby becomes a spatial reflection of the ring, with the zero mode k = 0 as the reference node. DYNAMICS: dθ_i/dτ = ω_i + g·(1/deg)·Σ_{j∈N(i)} sin(θ_j − θ_i); the nonlinearity is IMPORTED (NP_005) and the network engineered (NP_007/NP_011), so only the lock STRUCTURE is tested. NO stochastic term: fixed-seed LCG streams set the initial phases only, 30 enumerated seeds = the protocol's ≥ 30 repetitions; RK4 with dt = 0.1 (≈ 63 steps per period of the fastest mode), verified against dt = 0.05 rather than assumed. LOCK CRITERION: mean slip |d(θ_i − Ψ)/dτ| < ε against the continuously tracked collective phase Ψ = arg Σ_j e^{iθ_j}, with the primary rule ε = 0.01·ω₁ plus the T_014 per-mode refinement ε_i = 0.01·ω_i. SWEEP: g ∈ [0, 3] in 40 steps each way (Δg = 0.075), carrying the state up→down, range fixed after a 3-seed pilot at g_max = 4 located the transition in [1.4, 2.1]. RESULTS (30 seeds for D96, 12 for each variant/control): D96 g_c = 1.607 ± 0.030, sharpness 23.69 ± 5.28, width 0.132 ± 0.083, A = 0.0251 ± 0.0074 (A/σ = 3.38). H1 sub-criteria: sharpness PASS, width PASS, hysteresis FAIL (3.4σ < 5σ) — the loop is real and directly visible (at g = 1.6 the up-sweep gives f = 0.22 while the down-sweep still holds 0.62) but not at the pre-registered significance, so the noiseless ideal ring cannot supply H1's bistability. HARDWARE-RELEVANT: f(g = 1) = 0.0000 — at the board's nominal maximum coupling NOTHING locks; the threshold sits at 1.61× that, i.e. the per-node lock term must reach K ≥ 6.394 rad/time = 1.61·ω_max = 10.29·ω₁ = 15.17·⟨|ω_i − Ω|⟩ (≈ 10.3× the fundamental frequency). CONTROLS (all must fail H1 per §7; all do, for different reasons): random-coupling locks EARLIEST (g_c = 0.863) and is the only lattice fully locked at g = 1, with EXACTLY zero hysteresis (A = 0.0000); detuned locks latest (1.986) with the largest hysteresis area (0.0342) but only 2.5σ; linear-ramp and the T_015 degeneracy-matched control never lock inside g ≤ 3 (f(3) = 0.010 and 0.167), so the multiplicity pattern alone does not reproduce D96 — the VALUES matter. Arrangement sensitivity: canonical (1.607) versus the same multiset sorted ascending (1.746) differ by 9%. MODE-SPECIFIC (T_014): the near-gap doublet {1, 95} locks at g = 1.688, AFTER the global half-lock point — its detuning from Ω = 0.851 is among the largest and the largest detuning is captured last — with the class spread only 1.635–1.688, so the transition is collective and a near-gap lock is a different event from a global one. Canonical basis independently reproduced (λ₂ = 0.386350893377790, ω₁ = 0.621571309969974, ω_max = 3.979619638484919, span = 6.402515, 47 mirror pairs, 45 levels = 1 + 42×2 + 5 + 6), with one LABEL CORRIGENDUM to NP_170 §3: ω_max = √λ_max is attained at k = 11/85 with λ_max = 15.837372, not at 'k = 48, λ = 12' (λ₄₈ = 12 exactly); no value changes. CLASSIFICATION: dynamics/nonlinearity IMPORTED/BOUNDARY; sharp-threshold existence EMERGENT (standard synchronization physics, not new AT content); g_c EMERGENT and domain-specific (QG313 — not comparable to QG316's 0.31); 'AT predicts a physical phase transition' remains OPEN/UNTESTED; D96 lock superiority REFUTED again. No canonical claim changed; no reclassification (D_040 registry untouched); no new primitive.",
            "For non-experts: the theory's chapter on locking says that a ring of coupled oscillators should snap into a locked configuration once the coupling is strong enough. Until now that idea had only ever been tested on datasets and simulated populations — never on a physical device. This audit does the next best thing: it runs the experiment as a pure mathematical simulation, with no randomness at all, and measures exactly the quantities the hardware proposal says will decide the question. The result is unusually informative. The snap is real and it is sharp: the theory's own 96-site ring jumps from nothing to fully locked over a very narrow band of coupling strengths, comfortably meeting two of the three pre-registered criteria. But the third criterion — that the locked state should linger when the coupling is reduced again, leaving a visible memory loop — falls short: the loop is genuinely there, but far too weak and too variable to clear the significance bar the proposal itself set. Two further findings matter for anyone building the device. First, the required coupling is about 1.6 times more than the board's nominal maximum — so a device built exactly as specified would measure nothing at all, and the audit explains why before the money is spent. Second, the theory's ring is not the easiest structure to lock: a randomly wired network of the same size snaps into lock earlier and shows no memory loop whatsoever. That is consistent with what earlier audits already found — the ring is chosen because it can be derived from the theory's primitives, not because it locks especially well — and it means the existence of a threshold cannot by itself distinguish the theory's lattice from a random one. The distinguishing test, as this audit concludes, has to be retention.",
            "DETERMINISTIC MODEL, NO NOISE: the C₉₆(±1..±6) lock transition is SHARP (23.69 ± 5.28 ≥ 3 PASS) and NARROW (0.132 ± 0.083 ≤ 0.4 PASS) at g_c = 1.607 ± 0.030, but H1's hysteresis criterion FAILS (A = 0.0251 ± 0.0074 = 3.4σ < 5σ); f(g = 1) = 0.0000, so the board needs K ≥ 10.29·ω₁, and the random-coupling control locks earlier with exactly zero hysteresis — H1's existence test is not a discriminator.",
            "“The cheapest hardware test is the one you run before the hardware.”",
            true,
            [
                new("ResearchY-NP_171", "DETERMINISTIC LOCK-LATTICE SIMULATOR",
                    "Model prediction: sharp 23.69 ± 5.28 PASS, width 0.132 ± 0.083 PASS, hysteresis A = 0.0251 ± 0.0074 FAIL at 3.4σ; g_c = 1.607 ± 0.030; f(g = 1) = 0 → K ≥ 6.394 = 10.29·ω₁; random-coupling control locks earlier (0.863) with A = 0.0000; deg-matched control never locks within g ≤ 3; near-gap doublet locks LAST (1.688); ω_max → k = 11/85, λ_max = 15.837372 (label corrigendum).",
                    "https://github.com/MagusDraconis/AT/blob/feature/v2.2-new-physics/Docs/ResearchY/NP_NewPhysics/ResearchY-NP_171.md"),
                new("ResearchY-NP_170", "LOCK-LATTICE PHASE MEMORY PROPOSAL (PLANNED — NO RESULT CLAIMED)",
                    "Supplies the H1 criteria and the R3 protocol this audit simulates (§6 R3 metrics, §5.1 normalization, §7 statistics); no hardware has been built.",
                    "https://github.com/MagusDraconis/AT/blob/feature/v2.2-new-physics/Docs/ResearchY/NP_NewPhysics/ResearchY-NP_170.md"),
                new("ResearchY-T_014", "NEAR-GAP DENSITY",
                    "D96 keeps only 2 modes / 1 distinct eigenvalue within 2λ₂ — hence the per-mode ε and the finding that the near-gap doublet is NOT the first to lock (g = 1.688 vs g_c = 1.607).",
                    "https://github.com/MagusDraconis/AT/blob/feature/v2.2-new-physics/Docs/ResearchY/T_SpectralBlueprint/ResearchY-T_014.md"),
                new("ResearchY-T_015", "SPECTRAL ROBUSTNESS AUDIT",
                    "Robustness is degeneracy-controlled and 'D96 outperforms random' is refuted — the degeneracy-matched control required by T_015 here fails H1 by never locking at all within g ≤ 3.",
                    "https://github.com/MagusDraconis/AT/blob/feature/v2.2-new-physics/Docs/ResearchY/T_SpectralBlueprint/ResearchY-T_015.md"),
                new("ResearchY-NP_005", "SYNCHRONIZATION MECHANISM AUDIT",
                    "The locking nonlinearity is ABSENT from the canonical chain (BOUNDARY) — the simulated dynamics are an imported input, so the model tests the lock structure only.",
                    "https://github.com/MagusDraconis/AT/blob/feature/v2.2-new-physics/Docs/ResearchY/NP_NewPhysics/ResearchY-NP_005.md"),
                new("ResearchY-NP_169", "NATURAL SCALING VS MASS GAP AUDIT",
                    "The ring's nonzero gap is an imported kinematic finite-size gap — g_c here is a coupling threshold, not a physical mass-gap scale.",
                    "https://github.com/MagusDraconis/AT/blob/feature/v2.2-new-physics/Docs/ResearchY/NP_NewPhysics/ResearchY-NP_169.md"),
            ]),
        new(
            "researchy-np172-retention-null",
            "Can Retaining State Require a Barrier? No — Two-Time-Scale Retention Is Generic, and the Ring and a Random Lattice Give the Same Retention Ratio",
            "ResearchY Milestone · NP_172 (V2.2 New Physics — Retention Null Audit)",
            "NP_170's H2 claims a locked configuration retains state longer than its controls, with the pre-registered signature of a two-time-scale ring-down and R = τ_slow/τ_fast ≥ 10, appealing to the AT-120 one-way barrier — which NP_170 itself flags as an analogy, not a derivation. This audit asks the null question: can that signature arise with no barrier at all? Five deterministic models are charged and ringed down — the D96 lock lattice, a random lattice, a high-Q linear ring, and weakly and strongly nonlinear rings — containing only damping, a reactive coupling and amplitude-dependent (saturating) damping: no topological charge, no one-way term, no memory, no noise. The answer is decisive. The generic strongly nonlinear ring PASSES H2 (R = 10.248) with no barrier of any kind, while the D96 lock lattice and the random lattice give R = 6.358 — identical to four significant digits — and neither reaches R ≥ 10 at the reference parameters. The closed form behind it shows τ_slow → 1/(2γ) for every saturation strength and that the whole shape depends on one dimensionless ratio β·u₀/γ, in which topology does not appear. A second candidate mechanism is ruled out too: a 100× spread in Q (linear, both topologies) produces no detectable two-time-scale signature at all.",
            "NP_172 is a NULL audit of NP_170's H2. MODEL (all five): da_i/dτ = (−γ_i + iω_i)·a_i + i·g·(Σ_j w_ij a_j)/deg_i − β·|a_i|²·a_i — damping γ = 1/(2Q), a REACTIVE coupling (the factor i matters: a real coupling would add to the growth rate and pump the ring), and saturating damping β|a|²a. No topological charge (QG120), no one-way term, no memory, NO NOISE. PROTOCOL (§6 R4 in spirit): charge into the locked configuration (the fundamental k = 1 mode, A₀ = 1), remove the drive, record E(τ) = Σ|a_i|²/2 as a moving-window envelope (window 10) so the carrier does not alias the fit; fit single versus two exponentials on a fixed τ-grid with amplitudes solved linearly (variable projection), decided by BIC/AIC with the SIMPLER model as the null (§7); RK4 dt = 0.05, bit-identical repeat runs. REFERENCE PARAMETERS: γ = 0.005 (Q = 100), g = 1.7 (just above NP_171's g_c = 1.607), β = 0.05; models 1 and 2 are identical apart from topology. FIVE MODELS (τ_fast | τ_slow | R | ΔBIC): D96 lock lattice 15.398 | 97.901 | 6.358 | 378.9; random lattice 13.665 | 86.888 | **6.358** | 439.3; high-Q linear ring 979.014 | 1039.210 | 1.061 (the τ-grid FLOOR — an R at the floor IS a single exponential, as the closed form requires for β = 0) | 17798.8*; weakly nonlinear 29.683 | 110.311 | 3.716 | 460.3; strongly nonlinear 0.779 | 7.987 | **10.248** | 548.1 → the ONLY model that passes H2's R ≥ 10, with no barrier. (*The high-Q two-exponential preference is a resolution artefact of a curve that is exactly single-exponential.) KEY NON-DISCRIMINATION: D96 and the random lattice give R = 6.358 to four significant digits — the AT lattice contributes NOTHING to the retention ratio — and at the reference parameters NEITHER passes R ≥ 10, while the two-time-scale fit is preferred for every model with β > 0, controls included: both halves of H2's discriminating expectation fail. DERIVED CLOSED FORM (verified against its own ODE to < 1e−6 and against a coherent-ring simulation to 8.5e−4): for a coherent uniform-amplitude charge in a uniform-Q ring, E(τ) = u₀·e^(−2γτ)/(1 + (β·u₀/γ)(1 − e^(−2γτ))), so (i) the late-time rate is 2γ for EVERY β (τ_slow → 1/(2γ) — the slow tail is automatic once any saturation exists), (ii) the early decay is accelerated by βu₀ (which is what makes the curve look two-time-scale), (iii) the shape depends only on the single dimensionless ratio β·u₀/γ — TOPOLOGY DOES NOT APPEAR; with β = 0 the decay is single-exponential exactly at any Q. β SWEEP (canonical lattice): R = 1.06 (β = 0) → 2.927 (0.005) → 6.358 (0.05) → 13.811 (0.25, PASS) → 10.248 (0.5); R crosses 10 once β·u₀/γ ≳ 50 and then FALLS BACK because τ_fast ≈ 0.78 leaves the envelope/sampling resolution (window 10, sample 2) — the fitted R is a LOWER BOUND once τ_fast is unresolved, a limitation that applies to NP_170's R4 as written. Q-CONTRAST PROBE (second candidate mechanism; linear, β = 0, deterministic 100× spread γ ∈ [0.0005, 0.05] with log-mean = γ_ref, both topologies): R at the grid floor with ΔBIC NEGATIVE (−10.1 ring, −9.6 random) — the single exponential is PREFERRED, so realistic mode-dependent loss supplies NO retention signature (the reactive coupling keeps the energy equipartitioned, so the decay follows the mean damping). DEVIATION FROM THE COHERENT FORM: the coherent ring reproduces the closed form to 8.5e−4 while the D96 and random lattices deviate ~30% — their nodes carry different natural frequencies (the D96 spectrum), so the charge dephases; a property of the spectrum, not of any barrier. CONSEQUENCE FOR NP_170: NP_171 left R4 retention as the only remaining discriminating test; its signature is now shown to be generic, so a positive R4 on hardware would demonstrate that the board's oscillators SATURATE, not that the lock law or the one-way barrier works. R4 must therefore be scored against a degeneracy-matched (T_015) AND a saturation-matched control (same β·u₀/γ) and must resolve τ_fast; NP_170 §6 R4 now carries that requirement. CLASSIFICATION: closed form, τ_slow → 1/(2γ) and β = 0 exactness DERIVED; D96's signature reproduced by a random non-AT lattice (R identical to 4 digits) CORRESPONDENCE, hence non-discriminating; 'two-time-scale retention requires the AT barrier / is AT-specific' REFUTED; H2's discriminating expectation REFUTED; 'a Q contrast supplies the signature' REFUTED; the AT-120 barrier remains an ANALOGY — now for a quantified reason. No canonical AT claim changed; no reclassification (D_040 registry untouched); no new primitive.",
            "For non-experts: the theory's proposal for a device said that a locked ring should 'remember' its state for longer than ordinary rings do — a two-stage decay, fast at first and then slow, with the slow stage at least ten times longer. That claim rested on an analogy with a one-way barrier in the theory: once a configuration is locked, the idea went, it cannot easily unlock. This audit asks the fair, sceptical version of the question: can that same two-stage behaviour show up in ordinary oscillators that have no barrier at all? It builds five such models — the theory's ring, a randomly wired ring, an exceptionally high-quality ring, and weakly and strongly nonlinear rings — and gives each of them the identical charge-and-fade test. The answer is blunt. A plain nonlinear ring, with no barrier and nothing from the theory in it, passes the retention criterion outright. And the theory's own ring and a completely random ring produce exactly the same retention ratio, identical to four significant digits, because the ratio is set by how strongly the oscillators saturate, not by how they are wired. The audit also derives why: a simple formula shows the slow stage is always set by the ring's quality factor, while the early drop is set by the saturation — and the topology never enters. To be thorough it also tests the other obvious explanation, a spread in component quality, and finds that this produces nothing at all. The practical upshot is important for the proposed experiment: its retention test cannot tell the difference between the theory working and the hardware simply saturating, so that test must be run against an instrument matched to the saturation, not only to the structure — and the audit says so explicitly.",
            "NULL AUDIT: two-time-scale retention (R = τ_slow/τ_fast ≥ 10) is GENERIC — the barrier-free strongly nonlinear ring passes H2 at R = 10.248, D96 and a random lattice give R = 6.358 identically, neither passes R ≥ 10 at the reference parameters, a 100× Q contrast gives no signature at all (ΔBIC < 0), and the closed form shows R depends only on β·u₀/γ, not on topology → H2 as AT-specific evidence is REFUTED.",
            "“The ring does not remember anything special — ordinary saturation looks exactly the same.”",
            true,
            [
                new("ResearchY-NP_172", "RETENTION NULL AUDIT",
                    "Five models, no barrier anywhere: strongly nonlinear ring PASSES R = 10.248; D96 lock lattice 6.358 and random lattice 6.358 (identical to 4 digits); high-Q linear 1.061 (grid floor = single exponential); weakly nonlinear 3.716. Closed form E(τ) = u₀e^(−2γτ)/(1 + (βu₀/γ)(1 − e^(−2γτ))): τ_slow → 1/(2γ) for every β, R set by β·u₀/γ alone. Q-contrast probe: ΔBIC < 0. Verdict: signature GENERIC, AT-specificity REFUTED.",
                    "https://github.com/MagusDraconis/AT/blob/feature/v2.2-new-physics/Docs/ResearchY/NP_NewPhysics/ResearchY-NP_172.md"),
                new("ResearchY-NP_170", "LOCK-LATTICE PHASE MEMORY PROPOSAL (PLANNED — NO RESULT CLAIMED)",
                    "Supplies H2 and the §6 R4 ring-down protocol being tested; §6 now carries the NP_172 requirement of a saturation-matched control and τ_fast resolution.",
                    "https://github.com/MagusDraconis/AT/blob/feature/v2.2-new-physics/Docs/ResearchY/NP_NewPhysics/ResearchY-NP_170.md"),
                new("ResearchY-NP_171", "DETERMINISTIC LOCK-LATTICE SIMULATOR",
                    "Left R4 retention as the only discriminating test for the lock lattice (H1's hysteresis failed at 3.4σ); fixes the locked coupling g = 1.7 used here.",
                    "https://github.com/MagusDraconis/AT/blob/feature/v2.2-new-physics/Docs/ResearchY/NP_NewPhysics/ResearchY-NP_171.md"),
                new("ResearchY-T_015", "SPECTRAL ROBUSTNESS AUDIT",
                    "Supplies the degeneracy-matched control logic — NP_172 adds the requirement that R4 also be scored against a saturation-matched control.",
                    "https://github.com/MagusDraconis/AT/blob/feature/v2.2-new-physics/Docs/ResearchY/T_SpectralBlueprint/ResearchY-T_015.md"),
                new("ResearchY-NP_005", "SYNCHRONIZATION MECHANISM AUDIT",
                    "The locking nonlinearity is an IMPORTED input (BOUNDARY) — which is exactly why an imported saturation can impersonate the retention signature.",
                    "https://github.com/MagusDraconis/AT/blob/feature/v2.2-new-physics/Docs/ResearchY/NP_NewPhysics/ResearchY-NP_005.md"),
            ]),
        new(
            "researchy-np173-discriminator",
            "Which Observable Separates the D96 Ring From Every Control? Four Do — and None of Them Is Evidence That the Lock Law Is Real",
            "ResearchY Milestone · NP_173 (V2.2 New Physics — Discriminator Audit)",
            "With H1 failing on hysteresis (NP_171) and H2's retention signature shown to be generic (NP_172), the program's last hope was an observable that separates the canonical D96 lattice from all of its controls. This audit measures eight of them against five controls — random, degeneracy-matched, saturation-matched, linear-ramp and detuned — and asks two questions in sequence: does D96 differ from every control by more than 5σ, and if so, is the difference reproduced by a control that shares the property invoked to explain it? The literal answer to the first question is yes: the lock threshold, the mode ordering, near-gap participation and the attractor shift all separate D96 from everything. The answer to the second is no: each separation turns on a generic property that a control lacks — how well mixed the coupling is, how sparse the graph is, or D96's own input spectrum — while the observables that would carry evidence about the lock law itself fail outright. The detuned control, notably, has a LARGER hysteresis area than D96.",
            "NP_173 is a two-stage discriminator test. STAGE 1: D96 vs every control, separation z = |Δ| / √(σ²_D96/n + σ²_ctl/n), n = 16 fixed seeds, phase sweeps over g ∈ [0, 8] in 60 steps each way with the state carried (wide enough that the late-locking controls saturate), spectral observables from the T_015/D_048 machinery (4 perturbation kinds × 5 doses × 3 seeds, connectivity-guarded; control graphs rebuilt from their spectra by inverse DFT). RESULT — FOUR OF EIGHT OBSERVABLES SEPARATE D96 FROM EVERY CONTROL AT ≥ 5σ: lock threshold g_c (z = 128.4 random, 93.8 deg-matched, 102.9 linear-ramp, 12.2 detuned), mode ordering ρ between onset and detuning (z = 9.6 / 6.5 / 9.8 / 11.8), near-gap participation (z = 9.8 / 7.7 / 8.7 / 5.2), attractor shift ΔA (z = 342.4 / 5.4 / 5.7 / 5.7). THE OTHER FOUR FAIL: hysteresis area A (z = 13.1 / 2.3 / 4.3 / 1.6 — the DETUNED control has a LARGER area, 0.01583 vs D96's 0.01225), locking sequence dispersion (detuned z = 1.9), spectral splitting Δλ₂/λ₂ (z = 2.2…4.4 against EVERY control), retention R (z = 0 against the saturation-matched control). TABLE (D96 | random | deg-matched | linear-ramp | detuned): g_c 1.682 ± 0.025 | 0.8667 | 3.059 | 3.160 | 2.002 · A 0.01225 | 0 | 0.00813 | 0.00440 | 0.01583 · ρ 0.420 ± 0.180 | 0 (exactly) | 0.056 | −0.078 | −0.197 · sequence dispersion 0.0693 | 1.2e−16 | 0.0160 | 0.0098 | 0.0523 · near-gap participation 0.285 ± 0.089 | 0.0667 | 0.0956 | 0.0813 | 0.1065 · ΔA 50.5 ± 1.1 | 0 ± 0 | 36 ± 21 | 37.7 ± 17 | 35.3 ± 21 · Δλ₂/λ₂ 0.445 | 0.032 | 2.34 | 0.97 | 1.70 · R 6.358 vs saturation-matched 6.358. STAGE 2 — MECHANISM (why none of the four is evidence for the AT structure): (a) the attractor shift is a SPARSE-CIRCULANT CLASS property, not D96's — a different sparse circulant of the same degree, C96(±1..±5,±11), gives ΔA = 47 ± 0 versus D96's 50.5 ± 1.1 and the random graph's EXACT 0 (D_047's degeneracy-lock theorem, seen from the lock-lattice side); (b) the threshold is set by each lattice's own detuning scale AND mixing — g_c/mean|ω−Ω| spans 8.2…17.3 (63 %), and with IDENTICAL frequencies the random graph locks at half D96's coupling because its local field is well mixed rather than local; D96 is not extreme (controls span 0.867…3.160, a factor 3.6); (c) mode ordering and near-gap participation read back D96's OWN frequency multiset — the derived spectrum the hardware is built to have (the fundamental pair carries one of the largest detunings, ω₁ = 0.156 vs Ω = 0.851, and Adler dynamics captures the largest detuning last, NP_171) — i.e. an INPUT, not an outcome. CLASSIFICATION: DERIVED — the random graph's ΔA ≡ 0 exactly (an all-singleton spectrum has nothing to split) and the β = 0 uniform-Q single-exponential baseline whose R the saturation-matched control reproduces exactly; EMERGENT — the four separating observables, real and ≥5σ but properties of the (spectrum, topology) pair; REFUTED — 'one of these observables is evidence that the AT lock law is real', and consequently the program's claim to a discriminating measurement. NOTE (stated, not hidden): the phase model has no independent saturation parameter, so the saturation-matched control coincides with the random control for the phase observables and is a distinct control only for retention. PROGRAM CONSEQUENCE: with H1 failing on hysteresis (NP_171, 3.4σ), H2's signature generic (NP_172) and the four separating observables all reading back inputs (this audit), the Tier-1 lock-lattice experiment has NO measurement whose result would distinguish the lock law from ordinary coupled-oscillator physics. The lock law's consequences are generic exactly where they would be evidence and D96-specific exactly where they are not. A finding about the TEST, not about canonical AT. No canonical claim changed; no reclassification (D_040 registry untouched); no new primitive.",
            "For non-experts: the theory had proposed a hardware experiment whose value rested on the idea that its own 96-part ring would behave differently from anything ordinary. This audit puts that idea on trial with eight different measurements — where the ring snaps into synchrony, how big its memory loop is, the order in which its parts lock, how the ring's frequencies rearrange under damage, and so on — each compared against five deliberately matched control rings, and each difference judged with a strict statistical bar. The first result is genuinely good news for the ring: on four of the eight measurements it stands clearly apart from every control, and by wide margins. The second result is the one that matters. When each of those four differences is traced to its cause, the cause is never anything specifically from the theory: it is how well mixed the connections are, or how sparse the ring is, or simply which frequency list the ring was given in the first place. That last point is the crux. Two of the four measurements essentially ask 'is this ring built with the theory's frequency list?' — which is true by construction and therefore cannot be evidence about anything the experiment would discover. And the measurements that could have been evidence — the size of the memory loop and the retention ratio — fail: a deliberately detuned control ring actually has the LARGER memory loop, and a saturation-matched control reproduces the retention number exactly. The audit's conclusion is therefore about the experiment rather than the theory: as specified, the proposed board has no measurement whose outcome could distinguish the lock law from ordinary coupled-oscillator physics, and the honest next step is to say so before building it.",
            "FOUR of eight observables separate D96 from EVERY control at ≥ 5σ — lock threshold (z = 12…128), mode ordering ρ (z = 6.5…11.8), near-gap participation (z = 5.2…9.8), attractor shift ΔA (z = 5.4…342) — but NONE is evidence for the AT structure: ΔA is a sparse-circulant class property (another sparse circulant gives 47 ± 0 vs D96's 50.5 ± 1.1, random is exactly 0), the threshold is set by each lattice's own detuning and mixing, and mode ordering + near-gap participation read back D96's own input spectrum. Hysteresis and retention fail outright (the detuned control's A is larger; R's z = 0).",
            "“Four measurements tell the ring apart from every control — and every one of them is reading back an input.”",
            true,
            [
                new("ResearchY-NP_173", "DISCRIMINATOR AUDIT",
                    "Eight observables × five controls, 16 seeds, two stages. Stage 1: lock threshold, mode ordering, near-gap participation and attractor shift separate D96 from every control at ≥5σ. Stage 2: ΔA is a sparse-circulant class property (C96(±1..±5,±11) → 47 ± 0 vs D96 50.5 ± 1.1; random exactly 0), the threshold follows each lattice's detuning/mixing (g_c/mean|ω−Ω| spans 8.2…17.3), and mode ordering + near-gap participation read back D96's own spectrum. Hysteresis A and retention R fail Stage 1 (detuned A larger; R z = 0). Classification: DERIVED (random ΔA ≡ 0; β = 0 baseline), EMERGENT (the four separating observables), REFUTED (any of them as evidence for the lock law).",
                    "https://github.com/MagusDraconis/AT/blob/feature/v2.2-new-physics/Docs/ResearchY/NP_NewPhysics/ResearchY-NP_173.md"),
                new("ResearchY-NP_171", "DETERMINISTIC LOCK-LATTICE SIMULATOR",
                    "Supplies the lattices, the metrics (f(g), A, sharpness, width, onsets) and the H1 verdict this audit builds on; near-gap-last locking is its result.",
                    "https://github.com/MagusDraconis/AT/blob/feature/v2.2-new-physics/Docs/ResearchY/NP_NewPhysics/ResearchY-NP_171.md"),
                new("ResearchY-NP_172", "RETENTION NULL AUDIT",
                    "Supplies retention R and the saturation-matched control (z = 0) — the observable that was supposed to be the last discriminator.",
                    "https://github.com/MagusDraconis/AT/blob/feature/v2.2-new-physics/Docs/ResearchY/NP_NewPhysics/ResearchY-NP_172.md"),
                new("ResearchY-T_015", "SPECTRAL ROBUSTNESS AUDIT",
                    "Supplies the degeneracy-matched control logic and the spectral-fragility picture used for the attractor-shift attribution.",
                    "https://github.com/MagusDraconis/AT/blob/feature/v2.2-new-physics/Docs/ResearchY/T_SpectralBlueprint/ResearchY-T_015.md"),
                new("ResearchY-D_047", "DEGENERACY-SPLITTING AMPLIFICATION AUDIT",
                    "The degeneracy-lock theorem explains the derived end of the ΔA scale: an all-singleton spectrum has nothing to split, so the random graph's shift is exactly zero.",
                    "https://github.com/MagusDraconis/AT/blob/feature/v2.2-new-physics/Docs/ResearchY/D_ResonanceStructure/ResearchY-D_047.md"),
            ]),
        new(
        ...
        new(
            ...
            "Canonical D96 produces correlation but never Bell-type entanglement: its primitives (Difference, Actualization, Occupancy, Information, Phase) are all single-DOF or classical, so every canonical operation reaches Schmidt rank ≤ 1 and CHSH ≤ 2 (NP_038/043/048). Yet the loophole-free Bell/CHSH violation (S = 2√2 > 2) is an empirical fact (NP_045). The complete minimal extension is exactly TWO irreducible primitives: (1) the Joint State — a normalized rank-2 complex 2×2 matrix (a coherent two-qubit amplitude, the 'joint link state' of QG70/71); and (2) the Entangling Gate — the non-local two-body interaction H_int = J·σ⊗σ generating U = e^{−iH_int t} (CNOT/CZ/iSWAP/√SWAP). These two reproduce Bell, CHSH, teleportation, GHZ, W, entanglement swapping, contextuality, and the Hardy paradox; everything else is a single-DOF phase phenomenon or a composition. The sector is non-local in correlations but no-signalling — fully relativistic.",
            "NP_038–NP_054 (17 audits) resolve the entanglement question end-to-end. NP_038: canonical D96 yields only correlation — genuine Bell-type entanglement ABSENT (product ψA⊗ψB is Schmidt rank 1, shared events give MI>0 but diagonal-separable, single-DOF interference is an observable not an entangler). NP_039–040: the minimal entangling extension is the JOINT STATE — a rank-2 complex 2×2 matrix (a new state object), 1 new primitive. NP_041–042: it closes under two-body phenomenology (Bell/CHSH/teleportation, DERIVED) but genuine tripartite states need a 3-body joint state (GHZ τ₃=1, W genuinely tripartite). NP_043: joint states are IRREDUCIBLE (no canonical object reaches rank 2). NP_044–045: optional for the derived chain, but REQUIRED by the observed Bell violation. NP_046: WHY nature contains them — non-separability is primitive (each part ρ=I/2, the joint pure). NP_047–050: the gate is the creation primitive (local unitaries cannot create entanglement), IRREDUCIBLE (NP_048), UNIQUELY REQUIRED as a kind with LU-equivalent representatives CNOT≡CZ≡iSWAP≡√SWAP (NP_049), and its physical meaning is a coherent two-body interaction (NP_050). NP_051: the correspondence layer is an unavoidable consequence of observation itself. NP_052–054: the two primitives are COMPLETE (no third primitive — swapping is composition, delayed-choice/eraser single-DOF, contextuality implied, many-body tensor products, Hardy paradox a Bell-type witness), and FULLY RELATIVISTIC (no-signalling: marginals I/2, teleportation needs a 2-bit classical channel). Net: canonical AT unchanged; the quantum extension is exactly {Joint State, Entangling Gate}.",
            "For non-experts: earlier audits found AT's core structure explains gravity-like geometry, masses, and the cosmic energy split — but it never produced the strange 'spooky action at a distance' of quantum entanglement (its parts only ever correlated classically). This program asks what the smallest missing piece is. The answer is two pieces: first, a 'joint state' — a single wave shared by two particles that cannot be split into one-per-particle (each particle alone is completely random, yet together they are perfectly locked); second, an 'entangling gate' — a real two-body interaction that creates such shared waves. With just those two, every known quantum phenomenon appears: Bell tests, teleportation, the GHZ and W states, even the subtle Hardy paradox. Crucially, none of this lets you send a signal faster than light — the lock is in the correlations, not in any message. So quantum weirdness is not an add-on AT already had: it is exactly two new building blocks, and nothing more.",
            "Two irreducible primitives — a joint state and an entangling gate — are the complete minimal quantum extension; canonical AT stays unchanged.",
            "“One ring explains the world's structure; two primitives finish the world's correlations.”",
            true,
            [
                new("ResearchY-NP_038", "ENTANGLEMENT AUDIT",
                    "Canonical D96 yields only correlation; genuine Bell entanglement ABSENT (success criterion A).",
                    "https://github.com/MagusDraconis/AT/blob/feature/v2.2-new-physics/Docs/ResearchY/NP_NewPhysics/ResearchY-NP_038.md"),
                new("ResearchY-NP_039", "MINIMAL ENTANGLEMENT SECTOR AUDIT",
                    "The minimal extension is the joint link state — 1 new primitive (phase/tensor/occupancy REFUTED).",
                    "https://github.com/MagusDraconis/AT/blob/feature/v2.2-new-physics/Docs/ResearchY/NP_NewPhysics/ResearchY-NP_039.md"),
                new("ResearchY-NP_040", "JOINT LINK FORMALIZATION AUDIT",
                    "The joint state is a normalized rank-2 complex 2×2 matrix — a new state object (NEW PRIMITIVE).",
                    "https://github.com/MagusDraconis/AT/blob/feature/v2.2-new-physics/Docs/ResearchY/NP_NewPhysics/ResearchY-NP_040.md"),
                new("ResearchY-NP_042", "MULTIPARTITE ENTANGLEMENT AUDIT",
                    "The 3-body joint state hosts GHZ (τ₃=1) and W; pairwise links are biseparable.",
                    "https://github.com/MagusDraconis/AT/blob/feature/v2.2-new-physics/Docs/ResearchY/NP_NewPhysics/ResearchY-NP_042.md"),
                new("ResearchY-NP_048", "ENTANGLING GATE ORIGIN AUDIT",
                    "The gate is IRREDUCIBLE — no canonical operation raises rank 1→2.",
                    "https://github.com/MagusDraconis/AT/blob/feature/v2.2-new-physics/Docs/ResearchY/NP_NewPhysics/ResearchY-NP_048.md"),
                new("ResearchY-NP_052", "QUANTUM PRIMITIVE COMPLETENESS AUDIT",
                    "Two primitives are COMPLETE — no third primitive; ontology size 2.",
                    "https://github.com/MagusDraconis/AT/blob/feature/v2.2-new-physics/Docs/ResearchY/NP_NewPhysics/ResearchY-NP_052.md"),
            ]),
        new(
            "researchy-np037-role-of-three",
            "The Recurring Exponent Three Is Not One Unified Origin: Family Count, the Planck Cube, and the 3D Dimension Are Independent Appearances",
            "ResearchY Milestone · NP_037 (V2.3 — Role of Three Audit)",
            "Is the recurring 3 — A³ in M_Pl = v·A³, the blackbody DOS ω³, and the spatial dimension d = 3 — a single DERIVED consequence of AT, or only a numerical CORRESPONDENCE? They are MULTIPLE UNRELATED APPEARANCES (success criterion C): the family/octave VALUE 3 is DERIVED from the N=96 ring (floor(log₂ span)+1, window [4,8) BOUNDARY); the cube-exponent VALUE 3 in M_Pl = v·A³ is a numeric read of the OBSERVED Planck–weak ratio (QG183 p = 2.99984) with no structural generator of the power; and d=3 plus the ω³ DOS are hosted GEOMETRIC content (CORRESPONDENCE). A new rung-ladder falsifier confirms there is no common generator: e(N) = ln(M_Pl/v(N))/ln A(N) = 3.735/2.9998/2.502/2.138 across the octave rungs {48,96,192,384} is monotone decreasing and equals the octave-band count ONLY at N=96.",
            "NP_037 decomposes the recurring exponent 3 into three INDEPENDENT appearances. (1) STRUCTURAL: the family/octave count 3 = floor(log₂ span)+1 with span(96)=6.4025 — a VALUE DERIVED given the span window [4,8) (BOUNDARY, D_040 unchanged); period-3 seed p=3 and N=96=3·2⁵ are DERIVED siblings. (2) DIMENSIONAL/NUMERICAL: the cube exponent in M_Pl = v·A³ = v·(95·44·87)³ = 1.2234e19 GeV is a read of the OBSERVED Planck–weak ratio (QG183 p=2.99984) — value-level DERIVED but law-level CORRESPONDENCE (no structural generator of the power). (3) GEOMETRIC (hosted): d=3 and the ω³ DOS are CORRESPONDENCE (unchanged NP_035/036; only p=d and d≥3 DERIVED). NEW RUNG-LADDER FALSIFIER (verified): generalizing the QG183 exponent read across the pairing-complete octave rungs gives e(N)=ln(M_Pl/v(N))/ln A(N) = 3.735 (N=48, 2 bands), 2.9998 (N=96, 3 bands), 2.502 (N=192, 4 bands), 2.138 (N=384, 5 bands) — monotone decreasing, equal to the octave-band count ONLY at N=96, so the QG183 'cube = three octave bands' anatomy is a VALUE COINCIDENCE at the canonical rung, NOT a causal generator. AXIS/FAMILY DECOUPLING (verified): single-ring family=3/4/5 always has DOS p=1.000; the 3-family ring's tensor ⊗1/⊗2/⊗3 gives p=1/2/3; the cube exponent e(N) is independent of both. REMOVAL ANALYSIS (verified): remove the cube → A¹/A²/A⁴ fail the Planck scale by 100%/99.9997%/3.6e7%; remove the 3-family window → the QG209 lepton ratio m_μ/m_e=206.77 matches only at N=96 (N=48→102.3, N=192→416.3); remove the third axis → wrong 2D Weyl law (π/4)R²; remove the exact value 3 of d → NOTHING breaks (Einstein prefactor (d−1)(d−2) non-zero for every d≥3). Classification: family/octave VALUE 3 DERIVED (window BOUNDARY); triple A=95·44·87 DERIVED; cube-exponent 3 value DERIVED / law-level CORRESPONDENCE (rung ladder); d=3 and ω³ DOS CORRESPONDENCE; a UNIFIED structural origin FALSIFIED. No reclassification; no new primitive; canonical AT unchanged.",
            "For non-experts: the number three keeps appearing in the theory — the Planck scale is a cube, the blackbody needs frequencies spread in a 3D way, and space has three dimensions. The tempting story is that one deep 'three-ness' explains them all. This audit shows they are actually three different threes that merely share a digit. The 'three families' is genuinely baked into the ring (its span naturally gives three frequency bands). The 'cube' in the Planck formula is a numerical read of a measured ratio, not a deep law (checked across four ring sizes, the cube only lines up with 'three bands' at the special size 96). And 'three dimensions' is a hosted geometric fact, not something one ring produces. So the recurring three is a coincidence of appearances, not a single origin.",
            "The recurring three is three independent threes: family count (derived), Planck cube (a measured-ratio read), and spatial dimension (hosted).",
            "“Three appears everywhere — but it is three different threes wearing the same number.”",
            true,
            [
                new("ResearchY-NP_035", "DENSITY-OF-STATES ORIGIN AUDIT",
                    "Exponent p = number of mode indices — the ω³ DOS needs three independent directions.",
                    "https://github.com/MagusDraconis/AT/blob/feature/v2.2-new-physics/Docs/ResearchY/NP_NewPhysics/ResearchY-NP_035.md"),
                new("ResearchY-NP_036", "3D EMERGENCE AUDIT",
                    "D96⊗3 reproduces the 3D blackbody DOS — as hosted CORRESPONDENCE, not emergence.",
                    "https://github.com/MagusDraconis/AT/blob/feature/v2.2-new-physics/Docs/ResearchY/NP_NewPhysics/ResearchY-NP_036.md"),
                new("ResearchY-D_040", "BOUNDARY RECLASSIFICATION AUDIT",
                    "Family count VALUE DERIVED, window [4,8) BOUNDARY — the registry NP_037 respects.",
        ...
        new(
            "researchy-np036-3d-emergence",
            "3D Physics from Three D96 Rings: the Blackbody DOS Is Reproduced by D96⊗D96⊗D96 — but as Hosted Geometry, Not Emergence",
            "ResearchY Milestone · NP_036 (V2.3 — 3D Emergence Audit)",
            "Can observed 3D physics emerge from multiple D96 structure sectors? Three independent D96 coordinates (tensor product D96⊗D96⊗D96) reproduce the observed blackbody DOS exactly: N(ω)∝ω³, g(ω)∝ω², Weyl count (π/6)R³ — identical to the 3D cavity. But canonical AT is ONE ring (p=1 at every N,K), the metric g=ρ^(2/d)η is dimension-generic (only d≥3 derived), so the ω³ DOS is a HOSTED CORRESPONDENCE, not an EMERGENT product of one D96 sector. The hidden triple A=Σm·#g·occ₂=95·44·87 cubed to M_Pl=v·A³ (exponent 3.0000) is a frequency-content triple, not three spatial axes.",
            "NP_036 asks whether observed 3D is naturally explained as D96⊗D96⊗D96. THE FIVE STEPS (verified): (1) DOS EXPONENTS — D96 (single ring): p=1 (octave doubling); D96⊗D96: p→2 (2D Weyl count); D96⊗D96⊗D96: p→3 (3D Weyl count: positive-octant ball exponent →3, coefficient →(π/6)R³). (2) COMPARISON — the blackbody DOS g∝ω², free-field 3D counting, and the 3D-cavity spectrum all give N(ω)∝ω³ with the same (π/6)R³ coefficient as D96⊗3; 2D gives the wrong (π/4)R² law; Stefan-Boltzmann ∫x³/(e^x−1)dx=π⁴/15=6.4939. (3) SUFFICIENCY — the tensor eigenvalues are separable Λ=λ_k1+λ_k2+λ_k3 ⇒ ω≈c|k| with k∈Z³: three independent D96 coordinates are MINIMALLY sufficient for N∝ω³ (fewer axes give R¹ or R²). (4) 'OBSERVED 3D = ONE D96 AXIS × THREE' — the three-axis tensor reproduces the 3D Weyl DOS, but canonical AT is ONE D96 ring (p=1 at every N,K, NP_032/035), the metric g=ρ^(2/d)η is dimension-generic (only d≥3 derived via the (d−2) Einstein factor, QG290), and nothing derives three independent stacked copies ⇒ CORRESPONDENCE (hosted 3D geometry), NOT EMERGENT. (5) HIDDEN TRIPLE-FACTOR STRUCTURE — AT already contains A=Σm·#g·occ₂=95·44·87=363,660 (mode count × distinct freqs × top-octave modes of the single ring), cubed to M_Pl=v·A³=1.2234e19 GeV (cube exponent 3.0000, QG181/183) — a FREQUENCY-CONTENT triple, NOT three spatial axes; the three octave families [4,4,87] are octave BANDS within one frequency coordinate. Classification: DOS exponent p=d of the d-fold D96 tensor DERIVED (Weyl); three independent D96 coordinates → N∝ω³ DERIVED (as a construction); observed 3D DOS as D96⊗3 CORRESPONDENCE (hosted 3D geometry, NP_028/034/035 unchanged); 3D from a single D96 sector FALSIFIED (p=1); d=3 as a canonical output FALSIFIED (metric dimension-generic, d≥3); hidden triple A→M_Pl=v·A³ DERIVED. No new primitive; canonical AT unchanged.",
            "For non-experts: earlier audits found one D96 ring gives a one-dimensional spread of frequencies, while the glow-curve of a hot body needs frequencies spread in a three-dimensional way (density growing like frequency²). This audit asks: if you multiply three D96 rings together at right angles, do you get the 3D spread? The answer is mathematically YES — three independent D96 axes produce exactly the 3D density the blackbody needs, including its famous total energy integral. But this is like building a 3D box out of three rulers: the rulers are real, but nothing in one ruler alone forces you to use three of them. AT's basic structure is a single ring, and its own geometry treats the number of dimensions as a free setting (it only proves three or more, not exactly three). So the 3D world is not something a single D96 ring grows into by itself — you have to host three copies, which is exactly what a '3D box' means physically.",
            "Three D96 rings at right angles give the blackbody's 3D frequency spread — but only because three copies are hosted; one ring stays 1D.",
            "“Three rulers make a box; one ruler is still just a line.”",
            true,
            [
                new("ResearchY-NP_035", "DENSITY-OF-STATES ORIGIN AUDIT",
                    "The ring is 1D (p=1); only adding independent directions (tensor products) raises p — NP_036 tests the 3-axis case.",
                    "https://github.com/MagusDraconis/AT/blob/feature/v2.2-new-physics/Docs/ResearchY/NP_NewPhysics/ResearchY-NP_035.md"),
                new("ResearchY-NP_034", "BOSE WITHOUT BLACKBODY AUDIT",
                    "The ω² DOS (3D host) is the content the blackbody needs — NP_036 shows D96⊗3 supplies it as hosted geometry.",
                    "https://github.com/MagusDraconis/AT/blob/feature/v2.2-new-physics/Docs/ResearchY/NP_NewPhysics/ResearchY-NP_034.md"),
                new("ResearchY-NP_032", "THERMAL-N SEARCH AUDIT",
                    "No single ring is 3D — the ω³ DOS needs three independent D96 axes, not a bigger ring.",
                    "https://github.com/MagusDraconis/AT/blob/feature/v2.2-new-physics/Docs/ResearchY/NP_NewPhysics/ResearchY-NP_032.md"),
            ]),
        new(
            "researchy-np035-dos-origin",
            "The D96 DOS Is 1D Because the Ring Is 1D: Dimensionality, Not Count, Topology, or Coupling, Is the Origin of the Blackbody DOS Mismatch",
            "ResearchY Milestone · NP_035 (V2.3 — Density-of-States Origin Audit)",
            "Why does the D96 mode set produce a 1D-chain DOS g(w)~const (N(w)∝w, p=1) instead of the observed blackbody g(w)∝w² (N∝w³, p=3)? Because D96 is a 1D ring: its spectrum is indexed by a SINGLE integer k with an exactly linear low-frequency dispersion w_k≈c·k (c=2π√91/N). One integer mode index forces p=1. Larger N, larger K, coupled rings, and the circulant structure all keep p=1 — only adding an INDEPENDENT direction (tensor product) raises the exponent. The minimal w³ construction preserving the D96 ±1..±6 local rule is the 3D tensor product of three D96 rings, C_96(±1..±6)^⊗3.",
            "NP_035 identifies the exact structural origin of the blackbody DOS mismatch between D96 and g_BB∝w². ANALYTIC DOS: λ_k≈(2πk/N)²·91 ⇒ ω_k≈c·k with c=2π√91/N (ratio →1.000 at N=6144, k=1..4); equal frequency spacing ⇒ N(w)∝w, p=1. The octave occupancy [4,4,87] confirms it: low octaves hold 4 modes each (constant 1D density per unit w); the top octave holds 87 only because the band ends at w_max=3.98 — the NP_028 mid-band 'exponent ~1.5' is a finite-band artifact, NOT an asymptotic DOS exponent. EXPONENT = NUMBER OF MODE INDICES (verified): 1D lattice → p=1, 2D → p=2, 3D → p=3. ORIGIN: A) DIMENSIONALITY — YES, the origin (one integer index k ⇒ p=1); B) topology — NO (a 1D open chain also has p=1); C) finite count — NO (p=1 at N=96..6144); D) circulant structure — NO (p=1 for C_N(±1..±K), K=1..12 — K changes band width, not the index count); E) hosted higher-layer geometry — YES for w² (the blackbody w² DOS is the DOS of a genuinely 3D host, hosted content, NP_032). EXTENSIONS: larger N → p=1; larger K → p=1; coupled/longer rings → p=1; tensor products C_N^⊗2 → p≈2, C_N^⊗3 → p≈3. MINIMAL w³ CONSTRUCTION: C_96(±1..±6)^⊗3 (3D tensor of three D96 rings, same ±1..±6 local rule per axis) — separable eigenvalues, ω≈c|k| with k∈Z³, N∝w³, DOS∝w². Classification: 1D DOS of the D96 ring DERIVED (single index, linear dispersion); exponent p = number of mode indices DERIVED; dimensionality as origin DERIVED (answer A CONFIRMED); w² DOS as hosted 3D geometry CORRESPONDENCE (NP_028/034 unchanged); any C_N(±1..±K) ring as blackbody DOS host FALSIFIED (NP_032 unchanged); finite count/topology/circulant as cause FALSIFIED; C_N^⊗3 → N∝w³ DERIVED. No new primitive; canonical AT unchanged.",
            "For non-experts: the blackbody glow curve needs frequencies to spread out in a 3D way (density growing like frequency²). AT's D96 structure is a ring — a one-dimensional circle of connections — and one-dimensional lines spread their frequencies evenly (density flat). The audit shows that this is the whole reason: a ring has only one counting direction, so its frequency list can never have the 3D density the blackbody needs. Making the ring bigger, coupling rings together in a line, or changing how far each point reaches along the circle never helps — it is still one-dimensional. What WOULD give the right 3D density is stacking three rings at right angles (a 3D grid using the same local rule), which is exactly the '3D cavity' physicists use for the blackbody. So the mismatch is not a defect of the counting or the connections — it is simply that one ring lives on a line.",
            "The D96 frequency list is 1D because the ring is 1D; the blackbody's 3D density needs three independent directions.",
            "“One ring counts along one line; three rings at right angles count a volume.”",
            true,
            [
                new("ResearchY-NP_034", "BOSE WITHOUT BLACKBODY AUDIT",
                    "The mode set (not the occupation) blocks the blackbody — NP_035 identifies the mode set is 1D.",
                    "https://github.com/MagusDraconis/AT/blob/feature/v2.2-new-physics/Docs/ResearchY/NP_NewPhysics/ResearchY-NP_034.md"),
                new("ResearchY-NP_032", "THERMAL-N SEARCH AUDIT",
                    "Every C_N(±1..±K) ring is a 1D chain — the DOS exponent is K- and N-independent.",
                    "https://github.com/MagusDraconis/AT/blob/feature/v2.2-new-physics/Docs/ResearchY/NP_NewPhysics/ResearchY-NP_032.md"),
                new("ResearchY-NP_028", "BLACKBODY RECONSTRUCTION AUDIT",
                    "D96 DOS is sub-power-law; NP_035 proves the low-frequency exponent is exactly 1 (1D).",
                    "https://github.com/MagusDraconis/AT/blob/feature/v2.2-new-physics/Docs/ResearchY/NP_NewPhysics/ResearchY-NP_028.md"),
            ]),
        new(
            "researchy-np034-bose-without-blackbody",
            "Bose Statistics Is Sufficient: a D96 Ensemble Produces the Exact Planck Occupation — Only Its Mode Set Blocks the Blackbody",
            "ResearchY Milestone · NP_034 (V2.3 — Bose Without Blackbody Audit)",
            "Why does a D96 ensemble produce Bose occupation statistics n(ω)=1/(e^βω−1) yet fail to reproduce the blackbody? Because the radiance is a product u=g·n·ω, and only the occupation n is correct. Replacing the D96 occupations with exact Planck occupations is a NO-OP (they are already exact Bose, NP_033); replacing only the mode set with the ideal ω² DOS reproduces the blackbody exactly (π⁴/15, peak x=2.821, Wien tail, Rayleigh–Jeans) with the SAME occupation. The minimal obstruction is the D96 mode set: DOS exponent ≈1.0–1.51 vs 3, hard UV cap (40.7% of blackbody energy above ω_max=3.98 at β=1), and top-heavy clustering — not the occupation, not the 95-mode count.",
            "NP_034 isolates the minimal obstruction between D96's emergent Bose statistics and the observed blackbody. TEST 1 — FACTORIZATION: u(ω)=g(ω)·n(ω)·ω, U(1)=12.588 factorizes exactly over the 95 modes / 44 distinct freqs; the Boltzmann identity ln(n/(1+n))=−βω holds exactly on every D96 mode (NP_033). TEST 2 — REPLACE OCCUPATIONS WITH EXACT PLANCK: no-op (already exact Bose); blackbody still fails (Σω³/(e^ω−1)=120.70≠π⁴/15) ⇒ occupation is NOT the obstruction. TEST 3 — REPLACE MODE SET WITH IDEAL ω² DOS (keep Bose n): u=ω³/(e^βω−1), the exact Planck law (Stefan-Boltzmann π⁴/15=6.4939, Wien displacement x=2.821, Rayleigh-Jeans x², Wien tail) ⇒ Bose is SUFFICIENT (answer A). TEST 4 — SENSITIVITY: (a) UV cutoff — 40.7% of blackbody energy lies above ω_max=3.98 at β=1 (no modes above ⇒ no Wien tail); (b) DOS exponent — D96 cumulative p≈1.0 low / 1.51 mid vs 3 needed; a p=1.51 power host integrates to 1.79 (< π⁴/15/3, >3× suppression); (c) clustering — 44 distinct freqs, 8-bin [2,2,2,0,2,2,33,52] (empty interior bin, dense top); (d) finite count — NOT an obstruction (ideal ω²-distributed 95-mode set reproduces the in-band blackbody to ~0.05%). TEST 5 — MINIMAL DEFORMATION: keep the Bose occupation fixed, change ONLY the mode set (exponent → 3, redistribute the 95 modes ω³-uniformly, unbind the band) ⇒ ω² DOS, Wien tail, π⁴/15 restored. Classification: Bose occupation from the D96 ensemble EMERGENT (unchanged, NP_033); occupation as blackbody factor SUFFICIENT (answer A); D96 mode set as blackbody host FALSIFIED (unchanged, NP_028/033); UV cap + DOS exponent + clustering of the D96 mode set DERIVED as the minimal obstruction; finite mode count NOT an obstruction; additional occupation-level obstruction NONE (answer B refuted); new primitive/layer NOT REQUIRED (hosted ω² DOS suffices, answer C refuted); temperature scale β BOUNDARY (unchanged). The paradox is resolved: an ensemble of D96 systems gives the exact Bose occupation, and that occupation times the ideal ω² DOS IS the blackbody — only the D96 mode-set geometry (sub-power DOS, hard cap, top-heavy clustering) stands in the way. No new primitive; canonical AT unchanged.",
            "For non-experts: earlier audits found that many D96 structures sharing energy settle into the exact Bose occupation formula of statistical mechanics — but the light curve of a hot body still did not appear. This audit asks WHY. The answer: the glow-curve is the occupation times the list of allowed frequencies, and only the occupation part is right. Giving the system the 'perfect' occupation changes nothing — it already has it. But if you swap the frequency list for the smooth one a 3D cavity has (density growing like frequency²), the exact same occupation produces the perfect blackbody curve, including its famous total π⁴/15, its peak position, and its fading tail. So the heat statistics is not the problem at all: it is the D96 frequency list itself — it bunches too many levels at the top, stops at a hard ceiling, and is too sparse at low frequency. With 95 levels spread the right way, the curve appears; the number of levels was never the issue.",
            "Heat's statistics from many D96 systems are already the exact Bose occupation; the blackbody is blocked only by the D96 frequency list, not by its statistics.",
            "“The occupation is perfect; the score on the page is the wrong list of notes.”",
            true,
            [
                new("ResearchY-NP_033", "D96 ENSEMBLE AUDIT",
                    "The ensemble already yields the exact Bose occupation NP_034 proves is sufficient.",
                    "https://github.com/MagusDraconis/AT/blob/feature/v2.2-new-physics/Docs/ResearchY/NP_NewPhysics/ResearchY-NP_033.md"),
                new("ResearchY-NP_028", "BLACKBODY RECONSTRUCTION AUDIT",
                    "The mode-set obstruction NP_034 isolates as the single minimal obstruction.",
                    "https://github.com/MagusDraconis/AT/blob/feature/v2.2-new-physics/Docs/ResearchY/NP_NewPhysics/ResearchY-NP_028.md"),
                new("ResearchY-NP_032", "THERMAL-N SEARCH AUDIT",
                    "No ring size supplies the ω² DOS that Bose occupations need (NP_034 test 3).",
                    "https://github.com/MagusDraconis/AT/blob/feature/v2.2-new-physics/Docs/ResearchY/NP_NewPhysics/ResearchY-NP_032.md"),
            ]),
        new(
        ...
        new(
            ...
            "AT's four candidate 'temperatures' — actualization density, occupancy disorder, information density, spectral crowding — are each anti-thermal or an order-only scalar. The canonical branching (μ=2) GROWS the population (ρ₇/ρ₀=128), and plugging μ=2 into the Planck-form occupation gives a NEGATIVE occupation — population inversion, not Bose statistics. Temperature is not derived or emergent in AT; it remains a BOUNDARY import (x=ℏω/kT), as NP_027/028 classified.",
            "NP_030 asks what object in AT plays the role of thermodynamic temperature — does any canonical object generate a mode-occupation law? Verdict: NO. THE FOUR CANDIDATES (tested): (1) ACTUALIZATION DENSITY — the canonical branching (A_003) is growth: μ=2, ρ_{k+1}=2·ρ_k, S=Σ2^k=255, ρ₇/ρ₀=128 (population grows 128× across 8 generations); ln(ρ_{k+1}/ρ_k)=ln μ=+0.6931>0 per step — a would-be β=ln(1/μ)=−0.6931<0, a population inversion. A thermal occupation must decay; AT's actualization density grows. (2) OCCUPANCY DISORDER — the octave record [4,4,87] is top-heavy: occupancy rises 21.75× into the top octave (87/4), the anti-thermal direction (a thermal spectrum thins at high ω; D96 crowds). (3) INFORMATION DENSITY — I_occ=KL(ρ‖uniform)=0.7513 nats (QG_228), giving ΩΛ=I_occ/ln K=0.6839 (QG_234): a DERIVED order parameter, but a FIXED scalar that measures non-uniformity — it has no scale to vary and generates no occupation law. (4) SPECTRAL CROWDING — the mode density rises into the band top (83/95 modes above ω=3.3, the top 20% of the band [0.622,3.98]; 0 modes in [3.0,3.1), more in [3.9,4.0)) — the same anti-thermal top-heaviness. MODE-OCCUPATION LAW TEST (decisive): the Bose occupation n=1/(e^x−1) requires a DECAYING rate μ<1 (NP_027: ⟨n_k⟩=1/(e^(k·ln(1/μ))−1)). Substituting the canonical μ=2 gives n_k=1/(2^(−k)−1)<0 for every k≥1 — NEGATIVE occupation (population inversion), NOT Bose statistics. A valid Bose occupation needs μ<1, exactly the free parameter of NP_027 — not fixed by canonical AT. Classification: temperature as a derived object of AT REFUTED (no canonical candidate generates a thermal mode-occupation law); actualization density (μ=2) as temperature source REFUTED (growth = inversion, would-be β=−ln 2<0); occupancy disorder ([4,4,87]) as temperature REFUTED (top-heavy); information density I_occ=0.7513 as temperature REFUTED — DERIVED as an order parameter (ΩΛ=0.6839, QG_234); spectral crowding as temperature REFUTED; thermal (Bose) occupation from canonical structure NOT GENERATED (canonical μ=2 gives negative occupation); temperature as the import scale x=ℏω/kT BOUNDARY (unchanged, NP_027/028); Hawking T∝1/R DERIVED in form (QG_184/208) with coefficient BOUNDARY (2π, QG_185/196) — not a mode-occupation temperature. Temperature remains a BOUNDARY import used to compare AT's derived frequency ratios to measured thermal spectra — never a canonical object that generates a mode-occupation law. No new primitive; canonical AT unchanged.",
            "For non-experts: temperature, in physics, is the number that sets how a hot object's glow spreads across frequencies (the 'blackbody' spectrum). This audit asks whether AT — built from a fixed 96-step resonance structure — contains anything that plays that role. It tests four candidate objects. The count-structure that generates AT's generations and masses grows with each step (like a crowd getting denser toward the top), which is the OPPOSITE of temperature's behavior — temperature spreads energy out. AT's information measure is a single fixed number (it gives the dark-energy fraction ΩΛ=0.6839), but it does not vary, so it cannot set a temperature. And AT's crowding concentrates modes at the top of the band, again opposite to a thermal spectrum. The decisive test: AT's own growth constant, when substituted into the formula for a thermal spectrum, gives NEGATIVE occupations — an 'inverted' population, the signature of the opposite of heat. So temperature is not something AT derives: it is an external scale physicists use to compare AT's frequencies to measured glow spectra.",
            "Temperature is neither derived nor emergent in AT — every candidate is anti-thermal (growing, top-heavy) or a fixed order-only scalar (I_occ=0.7513 → ΩΛ=0.6839).",
            "“AT's count structure is an inverted population, not a heat bath.”",
            true,
            [
                new("ResearchY-NP_027", "PLANCK SPECTRUM EMERGENCE AUDIT",
                    "The Bose occupation form needs μ<1 — the free parameter NP_030 shows canonical μ=2 fails.",
                    "https://github.com/MagusDraconis/AT/blob/feature/v2.2-new-physics/Docs/ResearchY/NP_NewPhysics/ResearchY-NP_027.md"),
                new("ResearchY-NP_028", "BLACKBODY RECONSTRUCTION AUDIT",
                    "Top-heavy + truncated spectrum — the same anti-thermal structure NP_030 classifies.",
                    "https://github.com/MagusDraconis/AT/blob/feature/v2.2-new-physics/Docs/ResearchY/NP_NewPhysics/ResearchY-NP_028.md"),
                new("ResearchY-NP_029", "ħ NECESSITY AUDIT",
                    "Companion audit: what is imported (ħ, temperature) vs derived (anchors × dimensionless ratios).",
                    "https://github.com/MagusDraconis/AT/blob/feature/v2.2-new-physics/Docs/ResearchY/NP_NewPhysics/ResearchY-NP_029.md"),
            ]),
        new(
        ...
        new(
            "researchy-m011-effective-o3",
            "No Exact O(3): the D96 Ring Is Dihedral, and Every Rotational Hallmark Is Refuted",
            "ResearchY Milestone · M_011 (V2.2 New Physics — Measurement)",
            "Can effective O(3) emerge from D96 actualization dynamics? The automorphism group of the seed ring is the finite dihedral group D96 — order 192, irreps of dimension at most two. Its spectrum has multiplicities {2, 5, 6}, not a 2l+1 ladder. Spherical-harmonic degeneracies, shell patterns, π values, the Bekenstein quarter, and nuclear magic numbers are all REFUTED.",
            "M_011 asks whether an effective O(3) can emerge from D96 actualization dynamics. Verdict: NO exact effective O(3). Aut(C96(±1..±6)) = D₉₆ (dihedral, order 192 = ⟨r, s⟩; r an order-96 rotation and s an order-2 reflection, both verified graph automorphisms of the 12-regular ring; the ONLY multiplier stabilizing the connection set S = {±1..±6} is a = ±1, so there is no non-dihedral affine symmetry; the 32 units act only as discrete permutations within gcd classes, NP_023). D96's irreps are 4 × 1D + 47 × 2D — no irrep of dimension ≥ 3, so no O(3)/spherical multiplet can exist. THE DEGENERACY STRUCTURE (computed from λ_k = Σ_s 2(1−cos(2πks/96))): 95 positive modes, 44 distinct eigenvalues, multiplicity histogram {2×42, 5, 6} (42 mirror doublets + the octave 5-fold λ=12 {16,32,48,64,80} + the octave 6-fold λ=14 {8,24,40,56,72,88}); mirror pairing λ_k = λ_{96−k} exact with zero mismatches. COMPARED TO SPHERICAL HARMONICS (2l+1 = 1,3,5,7,…): the D96 multiplicity set {2,5,6} intersects the 2l+1 ladder only at {5} (an accidental octave coincidence) — no odd-degeneracy tower, no l = 0/1/3 sectors. SHELL PATTERNS: D96 octave closures are [4,8,95]; the harmonic-oscillator closures (2,8,20,40,70) and nuclear magic numbers (2,8,20,28,50,82,126) are NOT reproduced (only 8 coincides, trivially, by four doublets). APPEARANCE OF π: the D96 Laplacian is an integer matrix, so the spectrum is ALGEBRAIC; π is transcendental and can never equal a D96 eigenvalue or any rational combination of them (approximants span/2 ≈ 3.201 and √10 ≈ 3.162 are NOT π). Its role (circumference ratio, 2π phase advance) is EMERGENT; its value is BOUNDARY (B_002). HORIZON-AREA SCALING: the S ∝ A STRUCTURE is EMERGENT/derived (QG185: boundary counting, M ∝ R, T ∝ 1/R), but the exact Bekenstein quarter 1/4 is REFUTED — deficit first-law gives 1/(8π) ≈ 0.040 and boundary counting ln2/(4π) ≈ 0.055, while 1/4 forces an imported π (QG196). NUCLEAR SHELL CLOSURES: magic numbers are NOT reproduced — the ring hosts only planar doublets and octahedral blocks, confirming NP_087/089 and NP_109's weakest-link verdict. DETERMINATION: exact O(3) REFUTED (Aut = D96 is finite and planar; max irrep dimension 2; no 2l+1 content anywhere); effective O(3) as a leading-order LARGE-SCALE isotropy is EMERGENT only (NP_089: the cubic anisotropy is O((ka)²) and never vanishes). CLASSIFICATION: Aut = D₉₆ and the degeneracy structure DERIVED; Z₂ mirror doublets DERIVED (QG155/161); exact O(3)/2l+1 sectors, spherical-harmonic tower, shell patterns, π value, exact horizon quarter, nuclear closures REFUTED; S ∝ A structure and leading-order isotropy EMERGENT; the QM-like rotational world CORRESPONDENCE. M_011 confirms NP_087/088/089 from the automorphism side; no reclassification; no new primitive; canonical AT unchanged.",
            "For non-experts: three-dimensional rotations are the symmetry of the everyday world — a ball looks the same from any angle. This audit asks whether that symmetry can be a genuine, exact property of the theory's own structure, or only an approximation. The answer is precise: the theory's seed ring has exactly 192 symmetries — rotations and mirror flips of a 96-sided polygon — and none of its irreducible building blocks is three-dimensional. Its frequencies come in doublets, plus two accidental blocks of five and six; the odd multiplicities 1, 3, 5, 7 of true spherical harmonics are almost entirely absent. That is why the exact magic numbers of nuclear physics are not reproduced, why π never appears as a number (the spectrum is algebraic), and why the exact Bekenstein entropy law cannot be derived without borrowing π. What remains is an approximate rotational look at very large scales — suppressed but never exactly zero. The rotational world is real, but it is a correspondence, not a derived exact symmetry.",
            "The D96 ring's symmetry is the finite dihedral group D96 — exact O(3), spherical-harmonic towers, shells, π values, the quarter law, and nuclear closures are all REFUTED.",
            "“The ring rotates in 96 steps; it never turns into a sphere.”",
            true,
            [
                new("ResearchY-NP_089", "ROTATIONAL SYMMETRY EMERGENCE AUDIT",
                    "O(3) is approximate only — the leading-order isotropy that M_011 re-derives from the automorphism side.",
                    "https://github.com/MagusDraconis/AT/blob/feature/v2.2-new-physics/Docs/ResearchY/NP_NewPhysics/ResearchY-NP_089.md"),
                new("ResearchY-NP_088", "D96 NETWORK GEOMETRY AUDIT",
                    "The 3D network is cubic (O_h), irreps {1,2,3} — the group-theoretic floor beneath M_011.",
                    "https://github.com/MagusDraconis/AT/blob/feature/v2.2-new-physics/Docs/ResearchY/NP_NewPhysics/ResearchY-NP_088.md"),
                new("ResearchY-NP_087", "NUCLEAR STRUCTURE AUDIT",
                    "Nuclear shells need exact (2l+1) — M_011 confirms from the automorphism group why they are absent.",
                    "https://github.com/MagusDraconis/AT/blob/feature/v2.2-new-physics/Docs/ResearchY/NP_NewPhysics/ResearchY-NP_087.md"),
                new("ResearchY-D_041", "TIME-ORIGIN AUDIT",
                    "The D96 spectrum λ_k = Σ_s 2(1−cos(2πks/N)) whose degeneracy structure M_011 computes.",
                    "https://github.com/MagusDraconis/AT/blob/feature/v2.2-new-physics/Docs/ResearchY/D_ResonanceStructure/ResearchY-D_041.md"),
            ]),
        new(
            "researchy-m012-network-o3",
            "Three Rings Make a Real 3D Rotation Sector — But Only One: the p-Wave Triplet",
            "ResearchY Milestone · M_012 (V2.2 New Physics — Measurement)",
            "A single D96 ring has no 3-dimensional representation (M_011). Three coupled rings on orthogonal axes do: their point group is the octahedral group O_h, which carries an irreducible 3D vector/p-wave sector — degeneracy 3 = 2l+1 for l=1. Exact O(3) is still REFUTED; every higher spherical observable is too.",
            "M_012 asks whether a NETWORK of coupled D96 systems can produce effective O(3), spherical symmetry, or shell degeneracies that the single ring (M_011 = NO) cannot. Verdict: EMERGENT for the genuine 3D (vector/p-wave, l = 1) sector; REFUTED for exact O(3) and every higher spherical observable. The three-ring triad D96⊗D96⊗D96 (cubic lattice) has axis point group O_h — the signed-permutation group on the three coordinates, order 48, a finite subgroup of O(3). ITS IRREDUCIBLE CONTENT: dims {1,1,2,3,3,1,1,2,3,3} with Σd² = 48 and 10 conjugacy classes = 10 irreps — genuine 3-dimensional irreps (T₁u etc.) exist, which the single ring's Aut = D₉₆ (max irrep dim 2) never had. The DEFINING VECTOR REPRESENTATION of O_h on ℝ³ is irreducible (character inner product ⟨χ,χ⟩ = 1) — the restriction of the O(3) l = 1 (p-wave) representation. SPHERICAL-HARMONIC SUBDUCTION to O_h (verified by character norms²): l = 0 → A₁g (1, full); l = 1 → T₁u (3, FULL — the p-wave triplet cannot be split by an octahedral field, the textbook crystal-field fact); l = 2 → E_g⊕T₂g (2+3, split); l = 3 → A₂u⊕T₁u⊕T₂u (1+3+3, split); l = 4 → norm² = 4. So the only exact spherical multiplets of the network are s (1) and p (3 = 2l+1 for l = 1). JOINT SPECTRUM (λ_a+λ_b+λ_c over 96³ states): 16,080 distinct levels; the first-excited level has degeneracy 6 = {±x̂,±ŷ,±ẑ} — an O_h orbit, NOT a (2l+1) shell; deeper levels carry O_h orbit sizes {12, 8, …}. SHELL CLOSURES / MAGIC NUMBERS: only s, p survive octahedral symmetry; d/f/g split (2+3, 1+3+3), so nuclear magic numbers are NOT reproduced (confirms NP_087/088/109). APPEARANCE OF π: the joint spectrum is algebraic (sums of algebraic ring eigenvalues); no joint level equals π, 2π, or 4π/3 (min |E−π| = 0.095); π's ROLE is EMERGENT only through asymptotic lattice-point/Weyl counting, its VALUE is BOUNDARY (B_002). HORIZON AREA: the S ∝ A structure is EMERGENT (QG185); the exact Bekenstein quarter 1/4 is REFUTED — the network adds no O(3) sphere geometry and cannot supply the imported 2π (QG196). CRITICAL ANSWERS: can three coupled D96 produce a genuine 3D representation? YES — EMERGENT, as the O_h vector/p-wave (l = 1) irrep, the upgrade the single ring lacks; does O(3) emerge only in the thermodynamic limit? exact O(3) never does (O_h is finite at every size) — only the NP_089 leading-order (a→0) isotropy is EMERGENT; can spherical harmonics be collective modes? only l = 0 and l = 1; can π arise from network topology? no value (algebraic spectrum), role only. CLASSIFICATION: Aut content (D96³⋊S₃, order 42,467,328) and O_h irreps DERIVED; the genuine 3D p/vector sector EMERGENT; the p-triplet (l=1 → T₁u) DERIVED; exact O(3), the full (2l+1) ladder, d/f/g degeneracies, shell closures/magic numbers, π value, and the exact quarter REFUTED; π role EMERGENT. M_011's single-ring NO is confirmed and NOT reclassified; no prior-audit reclassification; no new primitive; canonical AT unchanged.",
            "For non-experts: a single loop of the theory can never make a true three-dimensional rotation — its largest symmetry block is only two-dimensional. But if you couple three loops on three perpendicular axes, something genuinely new appears: their joint symmetry is the symmetry of a cube, and a cube DOES have a genuine three-dimensional block. It is the three 'p-wave' directions (left-right, up-down, forward-back), which stay perfectly three-fold degenerate — the same reason electrons in p-orbitals keep their three states even inside a cubic crystal. That is a real, exact three-dimensional sector, the first the theory has produced. But the cube is not a sphere: the five-fold d-shell and seven-fold f-shell split apart, so the full ladder of spherical harmonics, the nuclear magic numbers, and π as a number still do not appear. One true 3D rotation sector — and then it stops.",
            "Three orthogonal rings give a genuine irreducible 3D p-wave sector (O_h, T₁u); exact O(3), higher shells, π value, and the quarter law stay REFUTED.",
            "“The cube is real; the sphere is not.”",
            true,
            [
                new("ResearchY-M_011", "EFFECTIVE O(3) SYMMETRY AUDIT",
                    "The single-ring NO that M_012 upgrades: Aut = D₉₆ (max irrep dim 2) — the 3D sector needs the network.",
                    "https://github.com/MagusDraconis/AT/blob/feature/v2.2-new-physics/Docs/ResearchY/M_Measurement/ResearchY-M_011.md"),
                new("ResearchY-NP_088", "D96 NETWORK GEOMETRY AUDIT",
                    "The 3D network is the cubic lattice with O_h point group — the arena M_012 analyses representation-theoretically.",
                    "https://github.com/MagusDraconis/AT/blob/feature/v2.2-new-physics/Docs/ResearchY/NP_NewPhysics/ResearchY-NP_088.md"),
                new("ResearchY-NP_089", "ROTATIONAL SYMMETRY EMERGENCE AUDIT",
                    "Approximate O(3) only — exact O(3) is the unattained a→0 boundary; M_012 confirms from the O_h subduction side.",
                    "https://github.com/MagusDraconis/AT/blob/feature/v2.2-new-physics/Docs/ResearchY/NP_NewPhysics/ResearchY-NP_089.md"),
                new("ResearchY-NP_087", "NUCLEAR STRUCTURE AUDIT",
                    "Magic numbers need the full (2l+1) ladder — only s,p survive octahedral symmetry, so they remain absent.",
                    "https://github.com/MagusDraconis/AT/blob/feature/v2.2-new-physics/Docs/ResearchY/NP_NewPhysics/ResearchY-NP_087.md"),
            ]),
        new(
            "researchy-m013-axis-count",
            "Three Axes Are Not a Law: the Count Is Hosted, but Only Three Makes Rotations a Vector",
            "ResearchY Milestone · M_013 (V2.2 New Physics — Measurement)",
            "Why exactly 3 coupled D96 axes? Answer: the number is not dynamically forced — 2, 4, N all give consistent d-dimensional tensors (DOS p = d). Three is merely sufficient as the hosted spatial dimension, but it is uniquely the count where rotation generators equal the vector dimension: d(d−1)/2 = d ⇒ d = 3, so(3) ≅ ℝ³.",
            "M_013 asks why Actualization selects exactly 3 coupled D96 axes — is 3 unique or merely sufficient? Verdict: MERELY SUFFICIENT as a hosted value; UNIQUE in exactly one derived sense, rotation self-duality. SYMMETRY (verified): d rings on d orthogonal axes give point group B_d (signed permutations, order 2^d·d!): d=1 Z₂ (2), d=2 D₄ (8), d=3 O_h (48), d=4 B₄ (384) — no member of the sequence is distinguished. IRREDUCIBLE CONTENT (verified): D₄ (2 axes) has max irrep dim 2 — NO genuine 3D irrep; O_h (3 axes) has genuine 3D irreps {1,1,2,3,3,…}; the defining/coordinate rep of B_d is irreducible of dimension d (verified for d=2..5) — so the observed 3-component spatial vector (the p-wave triplet, M_012) requires exactly d = 3 axes. ROTATION SELF-DUALITY (verified): dim(rotation generators) = d(d−1)/2; d(d−1)/2 = d has the UNIQUE integer solution d = 3 ⇒ so(3) ≅ ℝ³ — only in three axes do the rotations form a vector of the same dimension as the space (angular momentum a vector, cross product, su(2) ≅ so(3) on 3-vectors). INFORMATION COMPRESSION (verified): d·log₂95 = 6.57, 13.14, 19.71, 26.28 bits — strictly additive per axis, no extremum at 3. FAMILY STRUCTURE (verified): family count 3 is a SINGLE-RING span-window [4,8) quantity (D_020), decoupled from the axis count (NP_037: value-equality 3 = 3 is not identity; family-3 ≠ axis-3). SPECTRAL EFFICIENCY (verified): DOS p = d identity (lattice-ball doubling exponents 0.97, 1.95, 2.92 for d=1,2,3 — d=3 merely matches the observed ω³ law); distinct joint levels 44, 987, 22,562, 338,413 with ratio 0.46 → 0.11 → 0.026 → 0.0042 — monotone, no extremum at 3. GRAVITY: only d ≥ 3 is load-bearing (QG197 (d−2) Einstein factor); removing the exact value 3 breaks nothing (NP_037). DETERMINATION: the exact axis count 3 is NOT selected by any internal quantity — it is merely sufficient to host the observed 3D world (CORRESPONDENCE, NP_036/037), and it is UNIQUE only via the derived self-duality identity d(d−1)/2 = d (so(3) ≅ ℝ³), the group-theoretic condition behind vectorial rotations and M_012's genuine 3D sector (EMERGENT at d = 3). CLASSIFICATION: point groups B_d and DOS p = d DERIVED; rotation self-duality ⇒ d = 3 DERIVED (unique); axis count 3 as dynamically forced REFUTED; information/family/spectral-efficiency extremum at 3 REFUTED; axis-3 = family-3 REFUTED (NP_037); exact 3 as hosted spatial dimension CORRESPONDENCE (unchanged); genuine 3D p/vector sector at d = 3 EMERGENT (M_012, unchanged). No reclassification of NP_036/037/M_011/M_012; no new primitive; canonical AT unchanged.",
            "For non-experts: a natural question after we found the cube's 3D block: why does the theory use THREE loops and not two or four? This audit runs the honest check. It turns out the theory does not 'decide' to use three — two loops make a self-consistent plane and four make a consistent four-dimensional space; each gives its own clean physics. The number three is simply the one our world happens to host. But there is one genuinely special thing about three: it is the only count where the number of independent rotations (three: pitch, yaw, roll) equals the number of directions (also three). In two dimensions there is only one rotation; in four there are six. Only in three do rotations themselves form a vector — that is why angular momentum can be a vector and why a p-orbital triplet exists at all. So: three is not a law of the theory, but it is the unique number where rotation and direction become the same kind of object.",
            "The axis count 3 is merely sufficient (hosted) — but uniquely the self-dual count d(d−1)/2 = d where rotations become a vector (so(3) ≅ ℝ³).",
            "“Three is hosted; self-duality is why it is not arbitrary.”",
            true,
            [
                new("ResearchY-M_012", "NETWORK O(3) SYMMETRY AUDIT",
                    "The genuine 3D p/vector sector that exists at d = 3 — EMERGENT at the self-dual axis count.",
                    "https://github.com/MagusDraconis/AT/blob/feature/v2.2-new-physics/Docs/ResearchY/M_Measurement/ResearchY-M_012.md"),
                new("ResearchY-NP_037", "THE ROLE OF THREE AUDIT",
                    "Axis/family decoupling and the hosted exact-3 verdict that M_013 confirms from the axis-count side.",
                    "https://github.com/MagusDraconis/AT/blob/feature/v2.2-new-physics/Docs/ResearchY/NP_NewPhysics/ResearchY-NP_037.md"),
                new("ResearchY-NP_036", "3D EMERGENCE AUDIT",
                    "The ω³ DOS hosted on D96⊗3 — why d=3 is merely sufficient, verified by M_013 across 2/3/4/N.",
                    "https://github.com/MagusDraconis/AT/blob/feature/v2.2-new-physics/Docs/ResearchY/NP_NewPhysics/ResearchY-NP_036.md"),
                new("ResearchY-NP_088", "D96 NETWORK GEOMETRY AUDIT",
                    "The d-axis cubic-lattice network whose point groups B_d M_013 compares across counts.",
                    "https://github.com/MagusDraconis/AT/blob/feature/v2.2-new-physics/Docs/ResearchY/NP_NewPhysics/ResearchY-NP_088.md"),
            ]),
        new(
            "researchy-m014-ring-size-scan",
            "96 Wins an Exhaustive Scan: No Hand-Picked Candidate Is Needed",
            "ResearchY Milestone · M_014 (V2.2 New Physics — Measurement)",
            "Earlier audits picked candidates by hand — windows, octave ladders, natural sizes. M_014 evaluates EVERY ring N = 16..512 with no preselection and scores them all. N = 96 is the unique maximum (Score 4): zero unpaired modes, 3 families, 6-divisibility, and the seed-3 octave rung all hold only at 96.",
            "M_014 asks: which ring size does the D96 attractor occupy when every N in [16,512] is evaluated AUTOMATICALLY, with NO manual candidate selection? Prior selection audits used hand-picked candidate sets — D_029 the window [32,300], D_030 the octave-rung chain n = p·2^k, D_031 natural sizes in [60,120). M_014 removes ALL manual preselection and scores every integer N from 16 to 512 (497 rings) with the explicit composite Score(N) = [0 unpaired] + [3 families ∧ span < 8] + [6|N] + [N = 3·2^k]. SCORE DISTRIBUTION (verified exhaustively): {4: 1, 3: 14, 2: 101, 1: 255, 0: 126} — all 497 rings evaluated. UNIQUE MAXIMIZER: N = 96 is the ONLY Score-4 ring in [16,512] (A B C D = 1 1 1 1; 3 families; 44 distinct eigenvalues; multiplicity pattern {2×42, 5×1, 6×1}; span 6.403 < 8; 96 = 3·32; 0 unpaired; 6|96). The Score-3 rings (14) are exactly the seed-3 rungs at the wrong family count (24, 48, 192, 384 with 1, 2, 4, 5 families) plus the D_029 zero-defect rings {60, 66, …, 120} minus 96. DROP ANALYSIS (which criteria are load-bearing): removing the 3-family window criterion admits the 5 seed-3 rungs {24, 48, 96, 192, 384} at the top; removing the octave-rung criterion admits the 11 zero-defect rings {60..120}; removing pairing completeness or 6-divisibility leaves 96 unique. So the two discriminators that isolate N = 96 are the 3-family window and the octave rung; both are canonical D_020/D_029/D_030 criteria, now applied over the whole range with no manual candidate selection. CONSISTENCY: the D_029 zero-defect set, D_030's unique zero-defect rung, and D_031's period-3 → 96 selection are all reproduced exactly; M_014 shows they are not artifacts of the earlier hand-picked windows/ladders. CLASSIFICATION: score components DERIVED (canonical criteria); exhaustive non-manual scan DERIVED (methodological); unique Score-4 maximizer N = 96 DERIVED (global, over the full closed range); Score-3 sets DERIVED (reproduce D_029/D_030); 3-family window and octave rung as the load-bearing discriminators DERIVED (drop analysis). No reclassification of D_029/D_030/D_031/D_040; no new primitive; canonical AT unchanged.",
            "For non-experts: earlier work chose which ring sizes to test — sizes that doubled like 3, 6, 12, 24, 48, 96 — and then found 96 was special. A skeptic could ask: did you find 96 because you only looked at sizes you already suspected? This audit closes that gap. It tests EVERY ring size from 16 to 512 — 497 of them — with a simple scoring rule: give a point for each of four good properties (all frequencies paired, three frequency families, divisible by six, and sitting on the doubling ladder of three). Only ONE ring scores all four points: size 96. Nothing was hand-picked: every size was given the same test, and 96 won outright. The two properties that really single it out are the three-family window and the octave rung — if you drop either, other sizes tie for first.",
            "Every ring N = 16..512 was scored automatically; N = 96 is the unique Score-4 winner — no manual candidate selection.",
            "“Ninety-six rings win even when nothing is chosen by hand.”",
            true,
            [
                new("ResearchY-D_029", "CLOSURE-DEFECT AUDIT",
                    "The zero-defect set {60..120} reproduced exactly as the M_014 Score-3 (A∧B∧C) rings.",
                    "https://github.com/MagusDraconis/AT/blob/feature/v2.2-new-physics/Docs/ResearchY/D_ResonanceStructure/ResearchY-D_029.md"),
                new("ResearchY-D_030", "OCTAVE-RUNG AUDIT",
                    "The octave rung 3·2^k — one of the two load-bearing discriminators isolating N = 96.",
                    "https://github.com/MagusDraconis/AT/blob/feature/v2.2-new-physics/Docs/ResearchY/D_ResonanceStructure/ResearchY-D_030.md"),
                new("ResearchY-D_031", "SEED-ORIGIN AUDIT",
                    "Period-3 seed → natural size 96; confirmed by the exhaustive M_014 scan.",
                    "https://github.com/MagusDraconis/AT/blob/feature/v2.2-new-physics/Docs/ResearchY/D_ResonanceStructure/ResearchY-D_031.md"),
                new("ResearchY-D_040", "CLASSIFICATION REGISTRY",
                    "The canonical D96 classification that M_014 confirms from a non-manual global scan.",
                    "https://github.com/MagusDraconis/AT/blob/feature/v2.2-new-physics/Docs/ResearchY/D_ResonanceStructure/ResearchY-D_040.md"),
            ]),
        new(
            "researchy-m015-score-robustness",
            "The Ranking Survives Perturbing the Score: N = 96 Is Not a Threshold Artifact",
            "ResearchY Milestone · M_015 (V2.2 New Physics — Measurement)",
            "Could N = 96 win only because the scoring rule happened to be tuned just right? M_015 removes each criterion, changes its value, and shifts its thresholds by ±5%, ±10%, ±20% — recomputing the entire ranking over all 497 rings each time. N = 96 stays on top in 24 of 26 variants and stays the UNIQUE winner under every reasonable perturbation.",
            "M_014 showed N = 96 is the unique Score-4 maximizer over all rings N = 16..512. M_015 asks the referee's question: does that result depend on the precise form of the score function Score(N) = [0 unpaired] + [3 families ∧ span < 8] + [6|N] + [N = 3·2^k]? For each criterion the audit (1) REMOVES it, (2) perturbs its VALUE, and (3) shifts its THRESHOLD by ±5%, ±10%, ±20%, recomputing the full rank table over all 497 rings (N = 16..512, no manual candidate selection) under each of 26 score variants. WINNER STABILITY: N = 96 is in the argmax set at rank 1 in 24/26 variants — every single-criterion removal (removing the pairing or 6-divisibility criterion leaves {96} unique; removing the 3-family window admits the 5 octave rungs {24,48,96,192,384}; removing the octave rung admits the 11 zero-defect rings {60..120}) and every value/threshold perturbation that preserves the physical family-3 requirement. The two variants where 96 leaves the top are the family-req → 2 and family-req → 4 re-targets: they REPLACE criterion B by a different physical requirement (two families, or four), so they select the family-2 rung 48 and family-4 rung 192 — that is a question change, not a robustness failure. UNIQUENESS: N = 96 is the unique top in 16/26 variants and in ALL ±5%/±10% threshold variants (window U ∈ [7.2, 8.8], pairing ≤ 2, divisors 4/8/12 dividing 96, rung tolerance ≤ 0.08 octaves). SCORE STABILITY: Score(96) is 4 in 17 variants and 3 in 9 (the removals and razor-edge drops), never below 3 and never beaten by any other ring. RAZOR EDGES (they break uniqueness, not winner status): the 3-family window upper edge U must stay above span(96) = 6.4025 — the exact tipping point is a −19.97% shift, so the −20% value U = 6.40 just excludes 96 and produces an 11-ring tie at score 3 in which 96 is still present; the octave-rung tolerance must stay below ≈ 0.10 octaves (0.10 admits {90, 96, 102}); and the divisor must divide 96 (divisors 5 and 7 break uniqueness but 96 stays in the argmax). DETERMINATION: ROBUST — under every removal, every value perturbation that keeps the family-3 requirement, and every ±5%/±10% (and most ±20%) threshold change, N = 96 remains the top-ranked ring; the M_014 unique-maximizer verdict is not an artifact of the score function's precise form. No reclassification of M_014/D_029/D_030/D_031/D_040; no new primitive; canonical AT unchanged.",
            "For non-experts: M_014 used a four-point scoring rule to rank every ring size from 16 to 512, and size 96 won outright. But suppose the rule itself was tuned unfairly — maybe with slightly different thresholds another size would win? This audit stress-tests the rule: it deletes each of the four criteria one at a time, changes them, and moves their thresholds up and down by 5%, 10%, and 20%, recomputing the full ranking every time (26 different versions of the rule). Size 96 stays the winner in 24 of the 26 versions, and remains the ONLY winner under every mild (5% or 10%) change. The two versions where 96 loses are not really perturbations: they replace 'three frequency families' with 'two families' or 'four families', which is asking a different question — and the answer correctly becomes size 48 or size 192, the ring on the doubling ladder with that many families. So the 96 result is robust: it does not depend on finely tuned details of the scoring rule.",
            "N = 96 stays the winner under every removal and every ±5%/±10% threshold change; the M_014 result is not a threshold artifact.",
            "“Perturb the rule 26 ways — ninety-six still wins.”",
            true,
            [
                new("ResearchY-M_014", "AUTOMATIC RING-SIZE RANK SCAN AUDIT",
                    "The audited score function and its unique N=96 maximizer over N = 16..512.",
                    "https://github.com/MagusDraconis/AT/blob/feature/v2.2-new-physics/Docs/ResearchY/M_Measurement/ResearchY-M_014.md"),
                new("ResearchY-D_020", "THREE-FAMILY WINDOW",
                    "The [4,8) 3-family span window whose upper edge U is the load-bearing razor (U > span(96) = 6.4025).",
                    "https://github.com/MagusDraconis/AT/blob/feature/v2.2-new-physics/Docs/ResearchY/D_ResonanceStructure/ResearchY-D_020.md"),
                new("ResearchY-D_029", "CLOSURE-DEFECT AUDIT",
                    "The zero-defect set {60..120} admitted when the octave-rung criterion is removed.",
                    "https://github.com/MagusDraconis/AT/blob/feature/v2.2-new-physics/Docs/ResearchY/D_ResonanceStructure/ResearchY-D_029.md"),
                new("ResearchY-D_030", "OCTAVE-RUNG AUDIT",
                    "The seed-3 rung ladder 3·2^k whose exactness tolerance is a razor edge (≥ 0.10 oct admits 90/102).",
                    "https://github.com/MagusDraconis/AT/blob/feature/v2.2-new-physics/Docs/ResearchY/D_ResonanceStructure/ResearchY-D_030.md"),
            ]),
        new(
            "researchy-m016-criterion-independence",
            "The Four Criteria Are Partially Redundant: {B, D} Alone Selects 96",
            "ResearchY Milestone · M_016 (V2.2 New Physics — Measurement)",
            "Do the four M_014 score criteria each carry independent information? No — A, C, D form a deterministic chain D ⊆ C ⊆ A (5.5% total-correlation redundancy), yet none is a function of the others, and N = 96 is selected by just the pair {B, D}: the 3-family window intersected with the seed-3 rung ladder.",
            "M_014 scored every ring N = 16..512 with four criteria (A = 0 unpaired; B = 3 families ∧ span < 8; C = 6|N; D = N = 3·2^k) and found N = 96 the unique Score-4 maximizer. M_016 asks whether those four criteria are truly independent, computing over all 497 rings: marginal and joint entropies, total correlation, pairwise mutual information, the phi correlation matrix, PCA on the standardized criteria, conditional entropy H(X_i|others) (unique-information fraction), and per-criterion predictability from the other three. MEASUREMENTS: A/B/C/D hold on 354/61/83/5 rings; H_joint = 2.017 bits vs ΣH = 2.135 bits → total correlation 0.1179 bits = 5.5% of the entropy budget. DETERMINISTIC NESTING: D ⊆ C ⊆ A (every seed-3 rung is 6-divisible and zero-unpaired; every 6-divisible ring in [16,512] is zero-unpaired) is the structural source of the redundancy; pairwise MI is small (max I(A;C) = 0.0912 bits) and B is statistically near-independent (I(B;·) ≤ 0.0004 bit); pairwise phi reaches 0.285 (A–C) and 0.225 (C–D). UNIQUE INFORMATION: no criterion is a deterministic function of the others — unique fractions H(X_i|others)/H(X_i) = 0.895 (A), 0.999 (B), 0.827 (C), 0.672 (D); only C is predictable from the others beyond majority (+1.0%); PCA eigenvalues [1.397, 1.001, 0.935, 0.667] give a participation ratio of 3.744 ≈ 4 effective dimensions (no dominant factor). WHICH CRITERION SELECTS N = 96: the PAIR {B, D} — B is true exactly on the 3-family window [60,120] (61 rings), D on the seed-3 rung ladder {24, 48, 96, 192, 384} (5 rings), and B∧D = {96}; A and C add no further selection power (A∧B∧D = B∧C∧D = {96}) because they are implied by D at rungs. DETERMINATION: PARTIALLY REDUNDANT — the criteria are not independent (deterministic nesting D ⊆ C ⊆ A, 5.5% redundancy) but no criterion is redundant given the other three (all unique fractions > 0.67, ~4 effective dimensions); N = 96 is selected by {B, D}. This confirms from information theory and minimal-selector analysis the M_014/M_015 conclusion that B (3-family window) and D (octave rung) are the load-bearing discriminators while A (pairing) and C (6-divisibility) are implied. No reclassification of M_014/M_015/D_029/D_030/D_031/D_040; no new primitive; canonical AT unchanged.",
            "For non-experts: M_014 used a four-part scoring rule (A, B, C, D) and N = 96 won on all four. This audit asks: do the four parts measure four different things, or are some of them secretly saying the same thing twice? Answer: partly both. Parts A, C and D are nested — if a ring is on the special doubling ladder D, then it automatically satisfies C and A (like a special object automatically having ordinary properties), so together they carry about 5.5% repeated information. But none of the four is completely predictable from the other three, so each adds something real. And the punchline: to single out N = 96 you do not need all four parts — you only need B and D. B says 'the ring must lie in the three-family window' (sizes 60 to 120), and D says 'the ring must be on the 3-doubling ladder'; the only ring satisfying both is 96. The other two parts are automatic once those hold.",
            "N = 96 is selected by the pair {B, D}; the criteria are partially redundant but none is implied by the others.",
            "“Two of the four criteria do the selecting; the other two come along for free.”",
            true,
            [
                new("ResearchY-M_014", "AUTOMATIC RING-SIZE RANK SCAN AUDIT",
                    "The four-criterion score whose independence M_016 analyzes.",
                    "https://github.com/MagusDraconis/AT/blob/feature/v2.2-new-physics/Docs/ResearchY/M_Measurement/ResearchY-M_014.md"),
                new("ResearchY-M_015", "SCORE-FUNCTION ROBUSTNESS AUDIT",
                    "The robustness companion: perturbing the score leaves 96 on top — B and D load-bearing.",
                    "https://github.com/MagusDraconis/AT/blob/feature/v2.2-new-physics/Docs/ResearchY/M_Measurement/ResearchY-M_015.md"),
                new("ResearchY-D_020", "THREE-FAMILY WINDOW",
                    "The [4,8) window that defines criterion B, true exactly on [60,120] over the scan range.",
                    "https://github.com/MagusDraconis/AT/blob/feature/v2.2-new-physics/Docs/ResearchY/D_ResonanceStructure/ResearchY-D_020.md"),
                new("ResearchY-D_030", "OCTAVE-RUNG AUDIT",
                    "The seed-3 rung ladder {24,48,96,192,384} that defines criterion D.",
                    "https://github.com/MagusDraconis/AT/blob/feature/v2.2-new-physics/Docs/ResearchY/D_ResonanceStructure/ResearchY-D_030.md"),
            ]),
        new(
        ...
        new(
            "researchy-d047-degeneracy-amplification",
            "A Degeneracy Is a Lock: Splitting the D96 Doublets Releases Exactly 0.80231 Nats — Independently of How Weak the Perturbation Is",
            "ResearchY Milestone · D_047 (V2.2 New Physics — Degeneracy-Splitting Amplification Audit)",
            "Can D96 degeneracy splitting amplify weak perturbations? YES — divergently, but only on degeneracy-indexed observables. The DEGENERACY-LOCK THEOREM: full resolution gives E₁ = ln N, so any symmetry-breaking perturbation of amplitude ε > 0 releases EXACTLY ΔE_lock = (1/N)·Σ_{m_i>1} m_i·ln m_i nats — a closed form in the multiplicity structure — and unlocks up to ΔA_max = N − A₀ attractors, both INDEPENDENT of ε. Hence G_A, G_E ∝ 1/ε → ∞. D96 releases 0.80231 nats / 51 attractors; K96 releases 4.50644 / 94; random (all-singleton) releases exactly nothing. The continuous spectrum is NOT amplified (G_λ = 0.0562 for D96 ≈ 0.0523 for random), and D96³, the hardest amplifier (peak G_A ≈ 3.5e12), is capped at 15.7 % of its headroom by factor-permutation symmetry.",
            "D_047 asks whether D96's degeneracy structure can amplify weak perturbations without bound. SETUP: L(ε) = L + ε·P with P a deterministic ±1 edge-sign Laplacian (LCG seed 12345, row sums zero), swept over 9 decades (10⁻⁹…10⁻¹); observables ΔA (number of distinct eigenspaces = attractors), ΔE (Shannon entropy of the basin distribution p_i = m_i/N), Δλ_rms (the continuous spectrum). Cases: D96 (44 degenerate groups [42×2,5,6]), random (seeded sparse p=0.3), complete K96 (one 95-fold block), D96³ (96³ = 884 736 modes, Minkowski sums of three factor spectra). DEGENERACY-LOCK THEOREM (DERIVED): after full resolution every multiplicity is 1 so E₁ = ln N; subtracting E₀ = −Σ(m_i/N)ln(m_i/N) gives exactly ΔE_lock = (1/N)·Σ_{m_i>1} m_i·ln m_i — independent of ε. Verified to 6 decimals: D96 (42·2ln2 + 5ln5 + 6ln6)/96 = 0.802314 nats; K96 (95/96)·ln95 = 4.506441; random 0. Headroom ΔA_max = Σ(m_i−1) = N − A₀ = 51 (D96), 94 (K96), 868 656 (D96³). Because both release exactly and are ε-independent, the response is a STEP FUNCTION at ε = 0 and G_A, G_E = ΔX/ε ∝ 1/ε → divergent: G_A(D96) = 2.600e10 at ε=10⁻⁹ vs 5.100e04 at ε=10⁻³ (a 5.1e5× rise over 6 decades); ΔA saturates at 51 and ΔE at 0.802314 from ε ≈ 10⁻⁷ downward, with partial resolution at 10⁻⁸ (48) and 10⁻⁹ (26) reflecting only the numerical tolerance. NEGATIVE RESULTS — (a) NO spectral amplification: G_λ is finite and ε-independent, 0.0562 (D96) vs 0.0523 (random) — the two agree to ~7 %, so D96's continuous response equals the degeneracy-free control's and the amplification is purely a degeneracy effect; (b) RANDOM IS AN EXACT NULL — A ≡ 96, E ≡ ln 96, ΔA ≡ ΔE ≡ 0 and G ≡ 0 for every ε in the grid AND at ε = 1.0 (its minimum level spacing 0.0123 is an ε-independent barrier); (c) D96³ AMPLIFIES HARDEST BUT IS CAPPED — peak G_A ≈ 3.5e12 (≳ 2000× D96 at the same ε) yet the unlock saturates at 136 005 of 868 656 = 15.7 % of headroom, because a factor-wise perturbation leaves the factor-permutation symmetry exact and every permuted triple sum λ_i+λ_j+λ_k stays exactly degenerate; entropy recovers 57.5 % of its ceiling since the unsplit permutation orbits carry large multiplicities. CLASSIFICATION: ΔE_lock and ΔA_max DERIVED (closed forms in the multiplicity structure); first-order splitting DERIVED (degenerate perturbation theory); the ε-independence / step response EMERGENT; 'D96 amplifies its continuous spectrum' REFUTED; case selection and the resolution floor ε* ≈ 10⁻⁷ (numerical, no intrinsic physical scale) BOUNDARY. NO reclassification of any prior result — the D_040 ClassificationRegistry is untouched and D_028's span/family-window classification is unaffected. No new primitives; canonical AT unchanged.",
            "For non-experts: the ring's frequency spectrum is full of exact coincidences — forty-two pairs, one five-way and one six-way pile-up. This audit asks whether those coincidences act as an amplifier: if something nudges the system even a tiny bit, do the pile-ups collapse into many separate levels and produce an outsize effect? The answer is yes, and in a strikingly clean way. The math says — and the simulation confirms to six decimals — that ANY nudge, however small, releases exactly the same fixed amount of 'locked' structure: 0.80231 units for D96, 4.50644 for the fully merged graph. Nothing about the nudge's size matters: a hundredth of a percent does the same job as ten percent. That is why the amplification factor (effect ÷ nudge) grows without limit as the nudge shrinks. Two important qualifications keep this honest. First, only the structural quantities amplify — the plain frequency spectrum responds in exact proportion and shows no amplification at all, matching a completely random graph. Second, a random graph is a perfect control: it has no coincidences, so it shows zero effect no matter how hard you push. And when three rings are stacked into a cube, the amplification is the strongest of all — but it tops out at about one-sixth of what is theoretically available, because a nudge applied equally to all three rings cannot break the symmetry that makes switching them around irrelevant.",
            "Degeneracy is a lock: any symmetry-breaking nudge releases exactly (1/N)·Σ m ln m nats, independently of the nudge's strength — so G = Δ/ε diverges, but only structurally.",
            "“Weakest nudge, same release: a lock does not care how softly you turn the key.”",
            true,
            [
                new("ResearchY-D_047", "DEGENERACY-SPLITTING AMPLIFICATION AUDIT",
                    "Degeneracy-lock theorem: ΔE_lock = (1/N)·Σ_{m>1} m·ln m released exactly for any ε > 0 → G_A, G_E ∝ 1/ε (D96: 0.80231 nats, 51 attractors); random is an exact null; G_λ finite (0.0562 ≈ random); D96³ peaks at ~3.5e12 but saturates at 15.7 % of headroom.",
                    "https://github.com/MagusDraconis/AT/blob/feature/v2.2-new-physics/Docs/ResearchY/D_ResonanceStructure/ResearchY-D_047.md"),
                new("ResearchY-D_028", "SPAN / FAMILY-WINDOW AUDIT",
                    "span(96) = 6.4025 fixes the family count — the same multiplicity structure D_047 shows is the amplifier reservoir.",
                    "https://github.com/MagusDraconis/AT/blob/feature/v2.2-new-physics/Docs/ResearchY/D_ResonanceStructure/ResearchY-D_028.md"),
                new("ResearchY-T_015", "SPECTRAL ROBUSTNESS AUDIT",
                    "Robustness is controlled by the DEGENERACY count, not the gap — D_047 quantifies the same mechanism as a divergent gain in the weak-ε limit.",
                    "https://github.com/MagusDraconis/AT/blob/feature/v2.2-new-physics/Docs/ResearchY/T_SpectralBlueprint/ResearchY-T_015.md"),
            ]),
        new(
            "researchy-d048-latent-adaptability",
            "Latent Degeneracy Does Not Predict Adaptability — the Spectral Gap Does, Inversely",
            "ResearchY Milestone · D_048 (V2.2 New Physics — Latent-Degeneracy Adaptability Audit)",
            "Does latent degeneracy predict adaptability? Define the latent fraction L = (N − A₀)/N — the share of the spectrum that is degenerate. Across six 96-node graphs (D96, D96-3D, random, physical, unphysical, complete) under edge deletion, addition, rewiring and weight perturbation at five doses, the NORMALIZED adaptive capacity is uncorrelated with L (ρ = −0.03) even though L spans 0 → 0.98, while the RAW gains do scale with L (ρ(ΔA,L) = +0.43, ρ(ΔE,L) = +0.83). L is the ceiling, not the response. The spectral gap λ₂ is the real (inverse) predictor: ρ(capacity, λ₂) = −0.84 — a SMALLER gap means a MORE adaptable graph. Random graphs are exact nulls: L = 0, capacity = 0, ΔA ≡ ΔE ≡ 0. Quantitative only; no AT assumptions.",
            "D_048 asks whether latent degeneracy predicts adaptability, defining L = (N − A₀)/N (the fraction of the spectrum that is degenerate) and an adaptive capacity = mean ΔA/(N − A₀) over 4 perturbation types × 5 doses (0.5–10 % of the graph's own edge count) × 3 deterministic seeds, with a connectivity guard (zero samples excluded — no missing data). CASES (all N = 96): D96 (circulant C96(±1..±6), A₀=45, λ₂=0.3864, L=0.5312), D96-3D (4×4×6 torus, 13, 1.0, 0.8646), random (sparse p=0.3, 96, 17.19, 0.0), physical (λ_m = m circulant, 49, 1.0, 0.4896), unphysical (5/25/60 circulant, 4, 5.0, 0.9583), complete (K96, 2, 96.0, 0.9792). MEASURES: (1) reachable attractor increase ΔA; (2) entropy increase ΔE; (3) recovery R = 1 − ‖λ′−λ‖₂/‖λ‖₂ (spectral retention); (4) structural diversity gain ΔA/(N − A₀). H1 'adaptive capacity scales with latent degeneracy' PARTIALLY REFUTED: the normalized capacity does not scale (ρ = −0.029) but the raw gains do (ρ(ΔA,L) = +0.429, ρ(ΔE,L) = +0.829) — L is a ceiling (ΔA ≤ N − A₀ by construction), not a response. Complete has the largest reservoir (L = 0.979) and the LOWEST capacity (0.286); D96 a moderate one (0.531) and the HIGHEST (0.990). H2 'L predicts adaptability better than λ₂' REFUTED: ρ(capacity,λ₂) = −0.841 versus ρ(capacity,L) = −0.029 (≈29× larger), and the sign is INVERTED — a SMALLER gap ⇒ a MORE adaptable graph. Near-degeneracy, not degeneracy count, indexes adaptability: D96's gap is 248× smaller than complete's and its capacity 3.5× larger. H3 'random graphs have low latent capacity' SUPPORTED: L = 0 and capacity = 0 exactly, ΔA ≡ ΔE ≡ 0 at every dose and type, because an all-singleton spectrum has nothing to unsplit. DOSE RESPONSE: D96 saturates immediately (0.962 at 0.5 %, 1.000 by 5 %); D96-3D rises 0.363 → 1.000; complete 0.149 → 0.378; physical and unphysical plateau at 0.750; random flat zero. TYPE RESPONSE: weight perturbation is the universally strongest lever (1.000 on every structured case); exact structural zeros mark impossible perturbations (add on K96 — no non-edge exists; rewire on K96 — its only non-edge is the edge just removed; add on the unphysical profile — its spectrum is weight-configured). SIDE FINDING: recovery and adaptability trade off — the least adaptable graph (random, recovery 0.9792) is nearly the most stable, while the most latent graphs are the least recovered. RELATION TO D_047: the lock's RELEASE is a step in ε (D_047); WHICH graph collects the most of its lock is set by λ₂, not by L (D_048) — the proximity of a degeneracy beats its size. CLASSIFICATION: the L-bound and the two rank relations DERIVED; the two rejected hypotheses REFUTED; per-case capacities and plateaus EMERGENT; protocol choices (case set, dose grid, seeds, connectivity guard) BOUNDARY. Quantitative only; no AT theoretical assumption is used; no AT claim, value, equation or registry entry is changed.",
            "For non-experts: a graph's frequency spectrum can contain exact coincidences — many levels sharing the same value. The tempting idea is that a graph with more coincidences is more 'adaptable': you nudge it, the coincidences break apart, and lots of new structure appears. This audit tests that idea directly on six very different 96-part graphs, damaging them in four different ways at five different strengths. The result is a clean surprise. How MUCH structure appears does grow with the number of coincidences — but the FRACTION of the available structure that a nudge actually unlocks does not. Knowing how many coincidences you have tells you the size of the prize, not how much you will collect. What predicts collection is something subtler: how close the levels are to coinciding without actually coinciding. A graph whose smallest frequency gap is tiny is far more adaptable than one whose levels merely pile up exactly. The extreme case makes it vivid: the fully connected graph has by far the most coincidences and is among the least adaptable, while the ring — with a gap 250 times smaller — unlocks 99 % of its potential at the very first nudge. A completely random graph is the control: no coincidences, no adaptation at all, at any strength. And the audit notes a trade-off: the unshakeable graphs are the ones that adapt least.",
            "Latent degeneracy is the ceiling on adaptability, not its predictor: raw gains scale with L (ρ = +0.43 / +0.83) but normalized capacity does not (ρ = −0.03) — the spectral gap does, inverted (ρ = −0.84).",
            "“How many locks you own does not tell you how many you can open — how close the key fits does.”",
            true,
            [
                new("ResearchY-D_048", "LATENT-DEGENERACY ADAPTABILITY AUDIT",
                    "H1 partially refuted (L is the ceiling, not the response), H2 refuted (λ₂ beats L by ~29×, inverted), H3 supported (random is an exact null).",
                    "https://github.com/MagusDraconis/AT/blob/feature/v2.2-new-physics/Docs/ResearchY/D_ResonanceStructure/ResearchY-D_048.md"),
                new("ResearchY-D_047", "DEGENERACY-SPLITTING AMPLIFICATION AUDIT",
                    "D_047 fixes the release law (a step in ε); D_048 shows which graph collects the most of its lock — the gap, not the size.",
                    "https://github.com/MagusDraconis/AT/blob/feature/v2.2-new-physics/Docs/ResearchY/D_ResonanceStructure/ResearchY-D_047.md"),
                new("ResearchY-T_015", "SPECTRAL ROBUSTNESS AUDIT",
                    "Robustness is controlled by degeneracy structure under finite perturbation; D_048 sharpens it to the spectral gap.",
                    "https://github.com/MagusDraconis/AT/blob/feature/v2.2-new-physics/Docs/ResearchY/T_SpectralBlueprint/ResearchY-T_015.md"),
            ]),
        new(
            "researchy-d049-adaptability-robustness-frontier",
            "Adaptability × Robustness Is Not Constant: the Frontier Has Exactly Two Members, and a Single Perturbation Family Can Dissolve It",
            "ResearchY Milestone · D_049 (V2.2 New Physics — Adaptability–Robustness Frontier Audit)",
            "Is there a universal tradeoff Adaptability × Robustness = const? NO. Across six 96-node graphs the product spans 0 → 0.956 — the degenerate-free null gives exactly 0 — with a 3.39× span and CV 0.33 among the non-null cases, and the conserved-product law has the wrong sign entirely: capacity RISES with damage (fitted C = 7.98·Δ^(+0.737), R² = 0.72), so forcing the constant-product exponent −1 collapses the fit to R² = −3.28, worse than predicting the mean. What does hold is a two-member Pareto frontier: D96 (maximum adaptability) and complete (maximum robustness), with the other four graphs strictly dominated. One structural quantity — the degeneracy count, equivalently the inverse gap — governs both axes with opposite signs. Quantitative only; no AT assumptions.",
            "D_049 asks whether adaptability and robustness are related by a conserved product. Using the shared D_048 ensemble (4 perturbation types × 5 doses × 3 seeds, connectivity-guarded, zero exclusions) it measures capacity = mean ΔA/(N − A₀), recovery = mean 1 − ‖λ′−λ‖₂/‖λ‖₂, λ₂ and the degeneracy structure for D96, D96³ (the 3-D variant, 4×4×6 torus, N = 96), random, complete, physical and unphysical. THE AXES: D96 capacity 0.9902 / recovery 0.9659; D96³ 0.7207 / 0.9625; random 0.0000 / 0.9792; physical 0.8011 / 0.9558; unphysical 0.7228 / 0.9443; complete 0.2858 / 0.9868. **REFUTED — 'Adaptability × Robustness = const' is not a universal law.** The product spans 0 → 0.956 (the all-singleton null gives exactly 0, an unbounded ratio) and 0.282 → 0.956 among the five non-null cases: span 3.39×, CV 0.326, worst deviation from the mean over 50 %. More decisively, the conserved-product law has the WRONG SIGN: the free power law is C = 7.98·Δ^(+0.737) (R² = 0.720) — capacity RISES with damage, sub-linearly, so a doubling of damage buys only 1.666× capacity — whereas C·Δ = const demands exponent −1; forcing −1 gives R² = −3.282, worse than predicting the mean. **DERIVED — the frontier.** Maximizing both axes, the Pareto frontier of the six cases has EXACTLY TWO members: D96 (max adaptability, 0.9902) and complete (max robustness, 0.9868). D96³, random, physical and unphysical are STRICTLY DOMINATED — each gives up adaptability without buying any robustness. So a tradeoff EXISTS, but it is a 2-point frontier, not a conserved quantity. **DERIVED — the mechanism.** ONE structural quantity governs both axes with OPPOSITE signs: the degeneracy COUNT (ρ(capacity) = +0.886, ρ(recovery) = −0.543), equivalently the inverse spectral gap (ρ(capacity, λ₂) = −0.841, ρ(recovery, λ₂) = +0.464, with ρ(degeneracy, λ₂) = −0.814). The degeneracy FRACTION L = (N − A₀)/N is a far weaker predictor (ρ(capacity, L) = −0.029) — the COUNT indexes the tradeoff, not the share, sharpening D_048's negative result. Linear fit: C = 16.48 − 16.46·R, R² = 0.475. **EMERGENT — and the frontier is NOT universal.** Membership depends on the perturbation family, and under edge deletion the frontier COLLAPSES TO A SINGLE CASE ({physical} is best on both axes — under that family there is no tradeoff at all); edge addition gives four members {D96, physical, unphysical, complete}, rewiring three {D96, physical, complete}, weight three {D96, random, complete}. No single family reproduces the aggregate frontier, and the null appears on one family frontier while being dominated in aggregate. Universality therefore fails TWICE: no conserved constant, and no family-invariant frontier. The fitted exponent β ≈ 0.74 and constant k ≈ 7.98 are ensemble numbers with no derivation and are classified EMERGENT. No AT claim, value, equation or registry entry is changed.",
            "For non-experts: a graph can be good at one of two things — it can adapt when you damage it (many hidden coincidences break apart and reveal new structure) or it can simply resist damage (its structure barely moves). The natural guess is that these two are traded off against each other by a fixed exchange rate, like a conserved budget. This audit tests that idea directly. It is false. The 'budget' is not fixed: across six different 96-part graphs the product of adaptability and robustness varies by a factor of over three, and one graph — the completely random one — has zero adaptability yet is one of the most stable, which already breaks any universal exchange rate. Worse, the relationship has the wrong shape entirely: a graph that is damaged more does not become proportionally less adaptable; adaptability actually grows with damage, and it grows more slowly than proportionally. The constant-budget formula fits worse than simply guessing the average. What the audit does find is a much thinner structure: only two of the six graphs are 'efficient' — the ring (best at adapting) and the fully connected graph (best at resisting) — while the other four are simply worse in both respects. And even that two-point frontier is not dependable: if you restrict to one specific kind of damage — deleting edges — a single graph turns out to be best on both counts, and the whole tradeoff disappears.",
            "No conserved Adaptability × Robustness: the product spans 0 → 0.956, the conserved-product law fits at R² = −3.28 (wrong sign), and the 2-member frontier can collapse to one case.",
            "“Adaptability and robustness are not a budget — they are a frontier with only two efficient points.”",
            true,
            [
                new("ResearchY-D_049", "ADAPTABILITY–ROBUSTNESS FRONTIER AUDIT",
                    "REFUTED: no universal constant product (span 0→0.956, CV 0.33; forcing exponent −1 gives R² = −3.28 vs +0.72). DERIVED: a 2-member Pareto frontier {D96, complete} with the other four strictly dominated, governed by the degeneracy count with opposite signs. EMERGENT: β ≈ 0.74, k ≈ 7.98, and frontier instability (deletion collapses it to one case).",
                    "https://github.com/MagusDraconis/AT/blob/feature/v2.2-new-physics/Docs/ResearchY/D_ResonanceStructure/ResearchY-D_049.md"),
                new("ResearchY-D_048", "LATENT-DEGENERACY ADAPTABILITY AUDIT",
                    "Supplies both axes: latent degeneracy is a ceiling, not a predictor; the degeneracy COUNT (D_049) beats the fraction L by ~30× in |ρ|.",
                    "https://github.com/MagusDraconis/AT/blob/feature/v2.2-new-physics/Docs/ResearchY/D_ResonanceStructure/ResearchY-D_048.md"),
                new("ResearchY-D_047", "DEGENERACY-SPLITTING AMPLIFICATION AUDIT",
                    "The release law behind the adaptability axis: any symmetry-breaking ε releases a fixed locked entropy, independent of ε.",
                    "https://github.com/MagusDraconis/AT/blob/feature/v2.2-new-physics/Docs/ResearchY/D_ResonanceStructure/ResearchY-D_047.md"),
            ]),
        new(
            "researchy-t001-t015-spectral-blueprint",
            "The Spectral Blueprint: on a ring the spectrum IS the coupling, so a target spectrum designs backwards into a physical topology — and selection on that landscape has a finite, derivable species ceiling",
            "ResearchY Milestone · T_001–T_015 (V2.2 New Physics — Spectral Blueprint Program)",
            "Fifteen audits close the spectral-blueprint program. On a circulant (ring) topology the spectrum IS the discrete Fourier transform of the coupling, so design runs backwards EXACTLY — target spectrum → generating function — and AT's D96 is the sparse, all-physical solution, sitting in the maximally rigid (R = 1) class where a general graph is not (isospectral non-isomorphic graphs exist from n = 6). T_005–T_015 then read the SAME landscape evolutionarily and find a finite species count S∞ = min(A, N_fit(μ, β, {w})) that is bounded by mutation–selection balance: D96 compresses to ~5 survivors, so the historical ~19 does NOT come from D96 (it is nearest the random landscape's 17); D96³ raises the count to 16 by landscape SIZE (20,811 eigenvalues), not by fitness peakedness; and spectral robustness turns out to be set by the DEGENERACY structure, not by near-gap density or gap size. Two of the program's own headline claims are refuted.",
            "The T program asks three questions in sequence. DESIGN: on Z_N the Laplacian spectrum is the DFT of the edge-weight generating function, so target spectrum → topology is an inverse DFT (T_001) — exact and optimally robust for rings; D96 is the sparse, all-physical realization, while band-gap/clustered/extreme-octave targets require repulsive (negative) couplings. The physical/unphysical boundary is exactly the cone of negative-definite functions on Z_N, crossed when the smallest generator coefficient w_d changes sign; D96 (6 sparse positive edges) sits deep inside it (T_002). UNIQUENESS: a general graph is NOT determined by its spectrum — isospectral non-isomorphic graphs exist (none at n = 5, four at n = 6) — so the blueprint is a SPECIAL property of circulant structure, where the labeled spectrum is bijective with the coupling (T_003). Rigidity is graded, R = 1 for complete/path/cycle/grid/circulant/D96, R < 1 for bipartite and random sparse; D96 is maximally rigid (T_004). EVOLUTION ON THE LANDSCAPE: D96 COMPRESSES the attractor count (45; 13 in the 3D variant, vs ~96 random) but produces NO dominant attractor — its largest basin is ~6 %, because octave/doublet degeneracy spreads the state space evenly; D > 0.5 requires massive degeneracy (complete graph), and 'fewest attractors' can even favor unphysical clustered spectra (T_005). Dominance is therefore a DYNAMICAL result of resource competition, not of spectral structure: the model-free fitness w = m/λ drives every model to one fittest eigenspace (D → 1, N_eff → 1), with the complete graph the degenerate exception (T_006). Finite diversity is DERIVED (finite landscape + positive mutation + crowding), its value EMERGENT; unbounded innovation is REFUTED (T_007). The limit is the mutation–selection balance S∞ = min(A, N_fit(μ, β, {w})) with ∂S∞/∂μ ≥ 0, ∂S∞/∂β ≥ 0, ∂S∞/∂A ≈ 0 — neither fitness variance nor spectral rigidity alone predicts it (T_008). N_fit is analytically EXACT in the two solvable limits (μ = 0 crowding threshold; β = 0 Perron/linear equilibrium), both reproduced by simulation, but the general (μ > 0, β > 0) interior has no closed form and a single scalar gap Δw is insufficient — the FULL fitness spectrum is required (T_009). D96 compresses survivors to ~5 (random ~17) because its sparse near-gap spectral tail makes a PEAKED fitness field (T_010); the historical ~19 is REFUTED as a D96 output (D96's ceiling is ~5; 19 is nearest the random landscape's 17 survivors / 18 discoveries) (T_011). D96³ does not reproduce ~19 cleanly but gets much closer: survivors 5 → 16 (distance 3), a DERIVED effect of the 3D density of states, with 21 in the cubic 3-axis sector alone; 16 is within the legacy ±5 tolerance, i.e. CORRESPONDENCE at order-of-magnitude level (T_012). The compression 20,811 → 16 is driven by landscape SIZE: A ≈ 20k distinct eigenvalues with w = m/λ keeping only the ~16 near-gap modes, so C = A/S∞ is DERIVED as a deterministic function of the spectrum while its value (≈ 1300 for D96³, ~9 for D96, ~6 random) is EMERGENT and dominated by A — fitness peakedness is REFUTED as the driver (D96 is the most peaked yet compresses least) (T_013). Near-gap density is exact counting, N_gap(k) = Σ_{λ≤kλ₂} m(λ), whose k-growth follows the Weyl law of the tensor-product dimension (1D ∝ k^{1/2}, 3D ∝ k^{3/2}) with magnitude set by the symmetry class — D96 has only 2 modes / 1 distinct eigenvalue within 2λ₂ (T_014). Finally, spectral robustness is NOT controlled by near-gap density ρ(k) nor by gap size λ₂: it is set by the DEGENERACY structure — the number of levels with multiplicity > 1 that split under a symmetry-breaking perturbation (D96 Δλ₂/λ₂ = 0.0077 with ΔA = 30; random 0.0003 with ΔA = 0), and all three proposed hypotheses are overturned (T_015). No canonical AT claim is changed; D96's numbers (λ₂ = 0.386351, ω₁ = 0.621571, span = 6.402515) are untouched, and the D_040 ClassificationRegistry is unaffected.",
            "For non-experts: this program asked whether a desired set of vibration frequencies can be engineered into a physical ring, and what happens when you let competition run on top of such a spectrum. The first answer is surprisingly clean: for a ring, the frequencies and the couplings are two views of the same data, so a target frequency list converts straight back into the couplings needed — and the theory's own 96-site ring is the sparse version of that solution, sitting in the most rigid class, where the frequency list pins down the structure uniquely. The second answer is more deflating, and the audits report it honestly. When you let a population compete on these landscapes, diversity does not grow without limit: it saturates, and the ceiling is fixed by the balance between mutation and selection. The theory's ring turns out to be the COMPRESSED case, keeping only about five survivors — so a historical figure of around nineteen species, often quoted from the theory, does not come from the ring at all, and is in fact closest to what a fully random structure gives. Stacking three rings into a cube raises the count to sixteen, but only because the landscape is enormous, not because the frequencies are unusually peaked. The last audit overturns the program's own expectation about which structures are stable: stability is governed by how many frequencies come in equal bunches, not by how close together the lowest ones sit.",
            "Design on a ring is exact (spectrum = DFT of coupling, D96 the sparse all-physical solution); D96 compresses survivors to ~5 and the historical ~19 is REFUTED as a D96 output (D96³ → 16 by landscape size, C ≈ 1300 EMERGENT); S∞ = min(A, N_fit) is DERIVED; spectral robustness is set by degeneracy structure, not by ρ(k) or λ₂.",
            "“On a ring the spectrum is the coupling — so a blueprint can be read backwards into matter.”",
            true,
            [
                new("ResearchY-T_001", "INVERSE SPECTRAL DESIGN",
                    "For a circulant ring the spectrum IS the DFT of the coupling: target spectrum → topology is an inverse DFT, exact and optimally robust; D96 is the sparse, all-physical solution.",
                    "https://github.com/MagusDraconis/AT/blob/feature/v2.2-new-physics/Docs/ResearchY/T_SpectralBlueprint/ResearchY-T_001.md"),
                new("ResearchY-T_002", "PHYSICAL SPECTRUM AUDIT",
                    "The physical/unphysical boundary is the cone of negative-definite functions on Z_N, crossed when the smallest generator coefficient w_d changes sign; D96 sits deep inside it.",
                    "https://github.com/MagusDraconis/AT/blob/feature/v2.2-new-physics/Docs/ResearchY/T_SpectralBlueprint/ResearchY-T_002.md"),
                new("ResearchY-T_003", "GENERAL INVERSE SPECTRAL GRAPH AUDIT",
                    "A general graph is NOT determined by its spectrum (isospectral non-isomorphic graphs: none at n = 5, four at n = 6); circulants are the special bijective case.",
                    "https://github.com/MagusDraconis/AT/blob/feature/v2.2-new-physics/Docs/ResearchY/T_SpectralBlueprint/ResearchY-T_003.md"),
                new("ResearchY-T_004", "SPECTRAL RIGIDITY AUDIT",
                    "Rigidity is graded: R = 1 for complete/path/cycle/grid/circulant/D96, decaying for bipartite and random sparse; D96 is maximally rigid — its spectrum is a complete, unique description.",
                    "https://github.com/MagusDraconis/AT/blob/feature/v2.2-new-physics/Docs/ResearchY/T_SpectralBlueprint/ResearchY-T_004.md"),
                new("ResearchY-T_005", "ATTRACTOR DOMINANCE AUDIT",
                    "D96 compresses the attractor count (45, and 13 in 3D, vs ~96 random) but has NO dominant attractor — its largest basin is ~6 %; D > 0.5 requires massive degeneracy.",
                    "https://github.com/MagusDraconis/AT/blob/feature/v2.2-new-physics/Docs/ResearchY/T_SpectralBlueprint/ResearchY-T_005.md"),
                new("ResearchY-T_006", "DARWINIAN DOMINANCE EMERGENCE",
                    "Dominance is the product of resource competition, not spectral structure: w = m/λ drives every model to a single fittest eigenspace (D → 1); resolves the T_005 arc.",
                    "https://github.com/MagusDraconis/AT/blob/feature/v2.2-new-physics/Docs/ResearchY/T_SpectralBlueprint/ResearchY-T_006.md"),
                new("ResearchY-T_007", "BOUNDED INNOVATION AUDIT",
                    "Evolution on a spectral landscape produces a FINITE species count: boundedness is DERIVED (finite landscape + mutation + crowding), the saturation value EMERGENT; unbounded innovation REFUTED.",
                    "https://github.com/MagusDraconis/AT/blob/feature/v2.2-new-physics/Docs/ResearchY/T_SpectralBlueprint/ResearchY-T_007.md"),
                new("ResearchY-T_008", "ASYMPTOTIC DIVERSITY LIMIT",
                    "S∞ = min(A, N_fit(μ, β, {w})): mutation widens the cloud (∂S∞/∂μ ≥ 0), crowding levels the field (∂S∞/∂β ≥ 0), the landscape is a ceiling S∞ does not track (∂S∞/∂A ≈ 0).",
                    "https://github.com/MagusDraconis/AT/blob/feature/v2.2-new-physics/Docs/ResearchY/T_SpectralBlueprint/ResearchY-T_008.md"),
                new("ResearchY-T_009", "FITNESS-REACH LAW",
                    "N_fit is analytically exact in the two solvable limits (μ = 0 crowding threshold; β = 0 Perron equilibrium); the general (μ > 0, β > 0) interior has no closed form and needs the full fitness spectrum.",
                    "https://github.com/MagusDraconis/AT/blob/feature/v2.2-new-physics/Docs/ResearchY/T_SpectralBlueprint/ResearchY-T_009.md"),
                new("ResearchY-T_010", "D96 SURVIVOR COMPRESSION",
                    "D96 compresses survivors to ~5 (random ~17) because its sparse near-gap spectral tail makes a PEAKED fitness field kept by the mutation–selection balance.",
                    "https://github.com/MagusDraconis/AT/blob/feature/v2.2-new-physics/Docs/ResearchY/T_SpectralBlueprint/ResearchY-T_010.md"),
                new("ResearchY-T_011", "SPECIES CEILING",
                    "REFUTED: the historical ~19 does NOT emerge from D96 — D96's ceiling is ~5, and ~19 is nearest the random landscape's signature (17 survivors, 18 discoveries).",
                    "https://github.com/MagusDraconis/AT/blob/feature/v2.2-new-physics/Docs/ResearchY/T_SpectralBlueprint/ResearchY-T_011.md"),
                new("ResearchY-T_012", "ORIGIN OF 19",
                    "D96³ raises survivors 5 → 16 (the cubic 3-axis sector alone gives 21) — a DERIVED effect of the 3D density of states; 16 is within the legacy ±5 tolerance (CORRESPONDENCE).",
                    "https://github.com/MagusDraconis/AT/blob/feature/v2.2-new-physics/Docs/ResearchY/T_SpectralBlueprint/ResearchY-T_012.md"),
                new("ResearchY-T_013", "COMPRESSION ORIGIN",
                    "D96³ compresses 20,811 → 16 because the landscape is huge (A ≈ 20k) with w = m/λ keeping only near-gap modes: C = A/S∞ DERIVED, its value (≈ 1300) EMERGENT — fitness peakedness REFUTED as the driver.",
                    "https://github.com/MagusDraconis/AT/blob/feature/v2.2-new-physics/Docs/ResearchY/T_SpectralBlueprint/ResearchY-T_013.md"),
                new("ResearchY-T_014", "NEAR-GAP DENSITY",
                    "N_gap(k) = Σ_{λ≤kλ₂} m(λ) is exact counting (DERIVED), growing per the Weyl law of the tensor dimension (1D ∝ k^{1/2}, 3D ∝ k^{3/2}); D96 has only 2 modes / 1 distinct eigenvalue within 2λ₂.",
                    "https://github.com/MagusDraconis/AT/blob/feature/v2.2-new-physics/Docs/ResearchY/T_SpectralBlueprint/ResearchY-T_014.md"),
                new("ResearchY-T_015", "SPECTRAL ROBUSTNESS AUDIT",
                    "Robustness is set by the DEGENERACY structure — levels with multiplicity > 1 that split — NOT by near-gap density ρ(k) or gap size λ₂ (D96 Δλ₂/λ₂ = 0.0077, ΔA = 30; random 0.0003, ΔA = 0).",
                    "https://github.com/MagusDraconis/AT/blob/feature/v2.2-new-physics/Docs/ResearchY/T_SpectralBlueprint/ResearchY-T_015.md"),
            ]),
        new(
