        ...
        [
            ...
            new("resonances", "Resonances",
                ...
                [
                    ...
                    new("Complete pairing derived from complex observability", "The self-conjugate mode k=N/2 is REAL-ONLY (sin(πn)=0); its eigenvalue λ=12 is 1D at N=64/80/128 (isolated singlet) and 5D at N=96/192. Complex observability (every frequency carries [magnitude, phase], QG218/D_034) requires multiplicity ≥ 2 — at N=96 all eigenvalues qualify. Complete pairing (0 unpaired) is DERIVED; the boundary is 'the observable sector is complex'.", TheoryBadge.Derived, ["ResearchY-D_035"]),
