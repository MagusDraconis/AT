        ...
        [
            ...
            new("resonances", "Resonances",
                ...
                [
                    ...
                    new("Reciprocity from observability", "Observability = complete state reconstruction: the complex state's two DOFs need BOTH quadrature channels. The {cos, sin} pair (eigenfunctions at λ_k=λ_{N−k}, orthogonal, equal norm) IS the reciprocal measurement basis — z=a+ib reconstructs exactly, a alone leaves θ ambiguous. A singlet's phase is unobservable. Reciprocity EMERGENT; complete pairing DERIVED; pairing input BOUNDARY (D_020).", TheoryBadge.Partial, ["ResearchY-D_037"]),
