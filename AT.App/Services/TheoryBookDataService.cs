    ...
    private static readonly TheorySection Parameters = new(
        ...
        [
            ...
            new("resonances", "Resonances",
                "The network has normal modes; mass = resonance frequency is a structural analogy. The D96 standing-wave structure is fully derived — including the Z2 pairing origin (ResearchY-D_021) and the derived su(2) selector (ResearchY-D_027).",
                [
