...
public class AT_DATA008_HighZRarFeasibilityAudit:ResearchTestBase{
    public AT_DATA008_HighZRarFeasibilityAudit(ITestOutputHelper o):base(o){}
    [Fact]public void DATA008_Run(){
        ...
        S(sb,"Section B — MOND vs AT Difference");sb.AppendLine(r.SB);
