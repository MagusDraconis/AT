...
public class AT_DATA005_RarScatterAudit : ResearchTestBase
{
    public AT_DATA005_RarScatterAudit(ITestOutputHelper o) : base(o) { }
    ...
    private void RunTest()
    {
        ...
        sb.AppendLine("2π ORIGIN CANDIDATES (from AT structure):");
        sb.AppendLine();
