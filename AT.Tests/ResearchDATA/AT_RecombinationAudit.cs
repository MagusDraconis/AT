...
public class AT_RecombinationAudit : ResearchTestBase
{
    public AT_RecombinationAudit(ITestOutputHelper o) : base(o) { }
    ...
    private void Run()
    {
        ...
        sb.AppendLine("  z*     : IMPORTED -> now COMPUTABLE (not AT-derived)");
        sb.AppendLine();
