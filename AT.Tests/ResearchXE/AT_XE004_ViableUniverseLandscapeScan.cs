...
public class AT_XE004_ViableUniverseLandscapeScan : ResearchTestBase
{
    public AT_XE004_ViableUniverseLandscapeScan(ITestOutputHelper o) : base(o) { }
    ...
    private void RunTest()
    {
        ...
        // 8. Landscape map
        Sec(sb, "AT Universe Landscape Map");
        ...
        sb.AppendLine($"  AT landscape: SMALL but FINITE island of viable universes.");
        sb.AppendLine(new string('=', 100));
