...
public class AT_QG048_YukawaGeometryAudit:ResearchTestBase{
    public AT_QG048_YukawaGeometryAudit(ITestOutputHelper o):base(o){}
    [Fact]public void QG048_Run(){
        ...
        S(sb,"Section A -- What Yukawas Represent in AT");sb.AppendLine(r.SA);
