...
public class AT_RandomActualizationEnsembleAudit : ResearchTestBase
{
    public AT_RandomActualizationEnsembleAudit(ITestOutputHelper o) : base(o) { }
    ...
    private static string SectionB()
    {
        ...
        sb.AppendLine("  AT cannot derive exact values: they are random variables, not fixed constants.");
        sb.AppendLine();
