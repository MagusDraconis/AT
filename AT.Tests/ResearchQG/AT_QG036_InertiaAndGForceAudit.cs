...
public class AT_QG036_InertiaAndGForceAudit:ResearchTestBase{
    public AT_QG036_InertiaAndGForceAudit(ITestOutputHelper o):base(o){}
    [Fact]public void QG036_Run(){
        ...
        S(sb,"Section A -- What Is Inertia in AT?");sb.AppendLine(r.SA);
