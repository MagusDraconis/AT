...
public class AT_QG010_CausalitySpeedAudit:ResearchTestBase{
    public AT_QG010_CausalitySpeedAudit(ITestOutputHelper o):base(o){}
    [Fact]public void QG010_Run(){
        ...
        S(sb,"Section A — What Is c in AT?");sb.AppendLine(r.SA);
