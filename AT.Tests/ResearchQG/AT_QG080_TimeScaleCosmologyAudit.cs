...
public class AT_QG080_TimeScaleCosmologyAudit : ResearchTestBase
{
    public AT_QG080_TimeScaleCosmologyAudit(ITestOutputHelper o) : base(o) { }
    ...
    public void QG080_TimeScaleCosmology()
    {
        ...
        foreach (double z in zs)
        {
            ...
            double gAt = GdaggerTimeDerivation.GdaggerFromClock(h); // identical by construction
            points.Add(new TimeScalePoint(z, a, h, gamma, CosmicClock.ClockDrift(z), gTsc, gAt));
        }
    ...
    private static string SectionG()
    {
        return
            ...
            "it yields no distinct testable prediction, so it does not independently confirm AT.";
    }
