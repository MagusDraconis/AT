...
public class AT_KoideHiddenStructureAudit : ResearchTestBase
{
    public AT_KoideHiddenStructureAudit(ITestOutputHelper o) : base(o) { }
    ...
    private static string SectionE()
    {
        return
            ...
            "  correlation' for Koide — and it is a AT prediction (QG-068/069), already in the falsification\n" +
            "  roadmap (priority #3).";
    }
