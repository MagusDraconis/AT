...
public class AT_QG037_HiggsMechanismAudit:ResearchTestBase{
    public AT_QG037_HiggsMechanismAudit(ITestOutputHelper o):base(o){}
    [Fact]public void QG037_Run(){
        ...
        S(sb,"Section A -- What Is Mass in AT?");sb.AppendLine(r.SA);
        ...
        S(sb,"Section E -- Particle Spectrum: AT + Higgs");sb.AppendLine(r.SE);
