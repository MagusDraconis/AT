...
public class AT_MultiplicityThreeAudit : ResearchTestBase
{
    public AT_MultiplicityThreeAudit(ITestOutputHelper o) : base(o) { }
    ...
    private static string SectionB()
    {
        return
            ...
            "    peak at M²≈5, giving d=3+1. This is the STRONGEST '3' in AT — a derivation, though\n" +
