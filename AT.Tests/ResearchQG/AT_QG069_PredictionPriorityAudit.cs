...
public class AT_QG069_PredictionPriorityAudit:ResearchTestBase{
    public AT_QG069_PredictionPriorityAudit(ITestOutputHelper o):base(o){}
    [Fact]public void QG069_Run(){
        ...
        S(sb,"Section G -- Hostile Review: Assume AT Is Wrong");sb.AppendLine(r.SG);
