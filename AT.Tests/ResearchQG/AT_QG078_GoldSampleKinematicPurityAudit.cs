...
public class AT_QG078_GoldSampleKinematicPurityAudit : ResearchTestBase
{
    public AT_QG078_GoldSampleKinematicPurityAudit(ITestOutputHelper o) : base(o) { }
    ...
    public void QG078_GoldSample()
    {
        ...
        S(sb, "Section C — Intrinsic scatter vs AT signal"); sb.AppendLine(r.SC);
        S(sb, "Section D — Gold-sample g†(z) refit"); sb.AppendLine(r.SD);
        S(sb, "Section E — MOND vs AT (gold)"); sb.AppendLine(r.SE);
