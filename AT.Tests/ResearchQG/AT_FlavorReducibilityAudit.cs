...
/// </summary>
public class AT_FlavorReducibilityAudit : ResearchTestBase
{
    public AT_FlavorReducibilityAudit(ITestOutputHelper o) : base(o) { }
    ...
    private static string SectionC(double q, double angle, double ent, double entRatio)
    {
        ...
        sb.AppendLine();
        sb.AppendLine("RESULT: all four origins fail to derive Q=2/3 from AT's primitives.");
        return sb.ToString();
    }
    ...
    private static string SectionF()
    {
        return
            ...
            "  irreducible-CONTINGENT: its value is not computable from AT's primitives. (Proved by\n" +
            ...
            "  AT, and specifying one would be a new primitive.";
    }
