...
public class AT_XD_WP001_ExperimentalPriorities : ResearchTestBase
{
    public AT_XD_WP001_ExperimentalPriorities(ITestOutputHelper o) : base(o) { }
    ...
    private void RunTest()
    {
        ...
        PrintHeader("ResearchXD-WP001 AT White Paper — Experimental Priorities 2025-2035");
        ...
        sb.AppendLine("  AT is a zero-parameter theory of fundamental physics.");
        ...
        sb.AppendLine();
        sb.AppendLine("  AT makes 8 testable predictions distinguishable from ΛCDM+SM.");
        ...
        sb.AppendLine();
        sb.AppendLine("  SM: ~19 parameters. AT: Q + Randomness. Compression ~95%.");
        sb.AppendLine();
        ...
        sb.AppendLine("    AT: w ≈ -0.985 (z=0), w ≈ -0.96 (z=1).");
        sb.AppendLine("    ΛCDM: w = -1.000 (all z).");
        sb.AppendLine("    IF w = -1.00 ± 0.01 → AT FALSIFIED at >3σ.");
        sb.AppendLine();

        // 6. Dark energy program
        Sec(sb, "Section 6: Dark Energy Program");
        sb.AppendLine("  AT prediction: Λ(t) = α/√V(t) → w(z) ≠ -1.");
        ...
        sb.AppendLine("  DISTINGUISHING FEATURE: AT predicts Λ tracks cosmic volume.");
        sb.AppendLine();

        // 7. Galaxy dynamics
        Sec(sb, "Section 7: Galaxy Dynamics Program");
        sb.AppendLine("  AT prediction: a₀ ≈ cH₀/(2π) from Λ.");
        ...
        sb.AppendLine("  AT prediction: DM = neutral topological defects (~TeV, stable).");
        ...
        sb.AppendLine("  DISTINGUISHING: defect DM is a SUBSET of existing AT ontology.");
        sb.AppendLine();

        // 9. Neutrino program
        Sec(sb, "Section 9: Neutrino Program");
        sb.AppendLine("  AT prediction: NORMAL ordering (m₁<m₂<m₃).");
        ...
        sb.AppendLine("    tests of AT's most distinctive prediction: w(z) ≠ -1.");
        sb.AppendLine();
        ...
        sb.AppendLine();
        sb.AppendLine("  By 2030, AT will be either FALSIFIED or STRENGTHENED.");
        sb.AppendLine("  This is how science progresses.");

        sb.AppendLine(new string('=', 100));
        sb.AppendLine($"  ResearchXD-WP001 COMPLETE.");
        sb.AppendLine($"  AT White Paper: Experimental Priorities 2025-2035.");
        sb.AppendLine($"  Priority #1: Euclid w(z). Falsifiable by 2030.");
        sb.AppendLine($"  AT is complete, predictive, and FALSIFIABLE.");
        sb.AppendLine(new string('=', 100));
