...
public class AT_XD003_EuclidReadinessAssessment : ResearchTestBase
{
    public AT_XD003_EuclidReadinessAssessment(ITestOutputHelper o) : base(o) { }
    ...
    private void RunTest()
    {
        ...
        // 1. The prediction
        Sec(sb, "The Exact AT Prediction for Euclid");
        ...
        foreach (var s in scenarios)
        {
            sb.AppendLine($"  [{s.Outcome}] {s.AtVerdict}");
        ...
        sb.AppendLine($"  Readiness: 10/10. AT knows exactly how to respond to Euclid.");
