...
public class AT_X052_ParticleMassHierarchies : ResearchTestBase
{
    public AT_X052_ParticleMassHierarchies(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void AT_X052_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("AT-X052 Origin of Particle Mass Hierarchies");
        ...
        sb.AppendLine();
        sb.AppendLine("  AT predicts: gen-4 exists but decays before detection.");
        ...
        sb.AppendLine($"  AT-X052 COMPLETE.");
