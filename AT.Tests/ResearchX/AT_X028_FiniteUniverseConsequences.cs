...
public class AT_X028_FiniteUniverseConsequences : ResearchTestBase
{
    public AT_X028_FiniteUniverseConsequences(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void AT_X028_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("AT-X028 Finite Universe Consequences");

        Sec(sb, "0. Assumptions");
        sb.AppendLine("  1. AT-X027: all finite systems saturate. L6 requires infinity.");
        ...
        sb.AppendLine($"  AT-X028 complete. Classification: {report.Classification}");
        sb.AppendLine(new string('=', 100));
