...
public class AT_X002_DynamicGraphPhysics : ResearchTestBase
{
    public AT_X002_DynamicGraphPhysics(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void AT_X002_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("AT-X002 Dynamic Graph Physics");

        Sec(sb, "0. Assumptions");
        sb.AppendLine("  1. AT-X001: static graph is the #1 untested assumption.");
        ...
        Sec(sb, "3. AT Results — What Survives?");
        ...
        sb.AppendLine($"  AT-X002 complete. Classification: {report.Classification}");
        sb.AppendLine(new string('=', 100));
