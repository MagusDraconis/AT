...
public class AT_X049_GaugeGroupSelection : ResearchTestBase
{
    public AT_X049_GaugeGroupSelection(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void AT_X049_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("AT-X049 Selection of Gauge Symmetry");
        ...
        sb.AppendLine("  AT does NOT uniquely predict this group.");
        sb.AppendLine();
        ...
        sb.AppendLine($"  AT-X049 COMPLETE.");
        sb.AppendLine($"  Classification: A — No Preferred Gauge Group.");
        sb.AppendLine($"  SU(3)×SU(2)×U(1) is CONSISTENT with AT but NOT DERIVED.");
        sb.AppendLine($"  The gauge group selection problem is the largest");
        sb.AppendLine($"  remaining open challenge in the AT program.");
        sb.AppendLine(new string('=', 100));
