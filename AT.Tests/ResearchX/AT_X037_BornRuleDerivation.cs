...
public class AT_X037_BornRuleDerivation : ResearchTestBase
{
    public AT_X037_BornRuleDerivation(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void AT_X037_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("AT-X037 Born Rule from Complexity Preservation");
        ...
        sb.AppendLine($"  AT-X037 COMPLETE.");
