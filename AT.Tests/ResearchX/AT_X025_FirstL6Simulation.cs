...
public class AT_X025_FirstL6Simulation : ResearchTestBase
{
    public AT_X025_FirstL6Simulation(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void AT_X025_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("AT-X025 First L6 Simulation");

        Sec(sb, "0. Assumptions");
        sb.AppendLine("  1. AT-X024: meta-operator tower theoretically enables L6.");
        ...
        sb.AppendLine($"  AT-X025 complete. Classification: {report.Classification}");
