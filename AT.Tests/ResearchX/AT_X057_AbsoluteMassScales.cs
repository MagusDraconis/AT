...
public class AT_X057_AbsoluteMassScales : ResearchTestBase
{
    public AT_X057_AbsoluteMassScales(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void AT_X057_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("AT-X057 Origin of Absolute Mass Scales");
        ...
        sb.AppendLine("  Can AT derive the absolute mass scale?");
        sb.AppendLine();
        ...
        // 4. What AT predicts vs measures
        Sec(sb, "What AT Derives vs Measures");
        ...
        sb.AppendLine("    AT:             ~6 free parameters (1 scale + 5 dimensionless)");
        ...
        sb.AppendLine($"  AT-X057 COMPLETE.");
        ...
        sb.AppendLine($"  AT: that scale is the defect correlation length ξ.");
