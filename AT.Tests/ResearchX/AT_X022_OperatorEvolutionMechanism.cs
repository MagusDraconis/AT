...
public class AT_X022_OperatorEvolutionMechanism : ResearchTestBase
{
    public AT_X022_OperatorEvolutionMechanism(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void AT_X022_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("AT-X022 Operator Evolution Mechanism");

        Sec(sb, "0. Assumptions");
        sb.AppendLine("  1. AT-X021: operator evolution is necessary for L6.");
        ...
        sb.AppendLine("    • AT: carrier population → effective α");
        sb.AppendLine();
        ...
        sb.AppendLine($"  AT-X022 complete. Classification: {report.Classification}");
