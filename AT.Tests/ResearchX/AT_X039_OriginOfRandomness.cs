...
public class AT_X039_OriginOfRandomness : ResearchTestBase
{
    public AT_X039_OriginOfRandomness(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void AT_X039_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("AT-X039 Origin of Quantum Randomness");
        ...
        Sec(sb, "Final AT Architecture");
        sb.AppendLine(RandomnessAnalyzer.FinalATArchitecture());

        // 7. Verdict
        sb.AppendLine(new string('=', 100));
        sb.AppendLine($"  AT-X039 COMPLETE.");
        ...
        sb.AppendLine($"  AT: 1 postulate (Q) + 1 irreducible (randomness).");
        sb.AppendLine(new string('=', 100));
