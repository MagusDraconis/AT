...
public class AT_X016_RealityClassificationTheory : ResearchTestBase
{
    public AT_X016_RealityClassificationTheory(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void AT_X016_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("AT-X016 Reality Classification Theory");

        Sec(sb, "0. Assumptions");
        sb.AppendLine("  1. R+S is the minimal reality foundation (AT-X015).");
        ...
        sb.AppendLine(new string('=', 100));
        sb.AppendLine($"  AT-X016 complete. Classification: {report.Classification}");
        sb.AppendLine(new string('=', 100));
