...
public class AT_X018_ComplexityEmergencePrinciple : ResearchTestBase
{
    public AT_X018_ComplexityEmergencePrinciple(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void AT_X018_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("AT-X018 Complexity Emergence Principle");

        Sec(sb, "0. Assumptions");
        sb.AppendLine("  1. AT-X015: R+S is the minimal reality foundation.");
        ...
        sb.AppendLine("  The AT program has demonstrated Levels 0-5 conclusively.");
        sb.AppendLine("  Level 6 (Open-Ended Evolution) has NOT been observed.");
        sb.AppendLine();
        sb.AppendLine("  AT-X002-X004 attempted: node motion, phase sweep, graph growth.");
        ...
        sb.AppendLine($"  AT-X018 complete. Classification: {report.Classification}");
