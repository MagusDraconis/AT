...
public class AT_X008_InformationCarrierTaxonomy : ResearchTestBase
{
    public AT_X008_InformationCarrierTaxonomy(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void AT_X008_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("AT-X008 Information Carrier Taxonomy");

        Sec(sb, "0. Assumptions");
        sb.AppendLine("  1. AT-X007: species = persistent information carriers.");
        ...
        sb.AppendLine();
        sb.AppendLine("  The true core of AT is INFORMATION CARRIER PHYSICS.");
        ...
        sb.AppendLine($"  AT-X008 complete. Classification: {report.Classification}");
        sb.AppendLine(new string('=', 100));
