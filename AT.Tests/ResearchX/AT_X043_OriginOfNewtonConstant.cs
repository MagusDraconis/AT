...
public class AT_X043_OriginOfNewtonConstant : ResearchTestBase
{
    public AT_X043_OriginOfNewtonConstant(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void AT_X043_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("AT-X043 Origin of Newton's Constant G");
        ...
        sb.AppendLine("  This is the AT resolution of the hierarchy problem.");
        sb.AppendLine();
        ...
        sb.AppendLine($"  AT-X043 COMPLETE.");
