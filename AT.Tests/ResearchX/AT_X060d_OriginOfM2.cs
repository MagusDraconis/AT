...
public class AT_X060d_OriginOfM2 : ResearchTestBase
{
    public AT_X060d_OriginOfM2(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void AT_X060d_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("AT-X060d Origin of the Nonlinearity Parameter M²");
        ...
        Sec(sb, "The Ultimate AT Parameter Count");
        sb.AppendLine("  ┌─────────────────────────────────────────────────────┐");
        sb.AppendLine("  │              AT — MAXIMALLY COMPRESSED              │");
        sb.AppendLine("  ├─────────────────────────────────────────────────────┤");
        ...
        sb.AppendLine("  │  AT:            1 number + 1 binary + 1 unit       │");
        ...
        sb.AppendLine($"  AT-X060d COMPLETE.");
        ...
        sb.AppendLine($"  AT: 1 number + 1 binary + 1 unit. ~95% SM reduction.");
