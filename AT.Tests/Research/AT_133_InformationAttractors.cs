...
public class AT_133_InformationAttractors : ResearchTestBase
{
    public AT_133_InformationAttractors(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void AT_133_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("AT-133 Information Attractors and Stable Information Species");

        Sec(sb, "0. Assumptions");
        sb.AppendLine("  1. Θ is an autonomous information layer (AT-132).");
        ...
        Sec(sb, "1. AT-132 Recap & Attractor Theory");
        ...
        sb.AppendLine("    → This is EXPECTED — Θ is not autonomous at low density (AT-128).");
        sb.AppendLine("    → Convergence REQUIRES field autonomy, confirming AT-128's threshold.");
        sb.AppendLine();
        ...
        sb.AppendLine($"  Experiment AT-133 completed.");
