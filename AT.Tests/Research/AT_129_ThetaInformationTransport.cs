...
public class AT_129_ThetaInformationTransport : ResearchTestBase
{
    public AT_129_ThetaInformationTransport(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void AT_129_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("AT-129 Information Transport in the Theta Field");

        Sec(sb, "0. Assumptions");
        sb.AppendLine("  1. Θ is autonomous at high density (AT-128).");
        sb.AppendLine("  2. Θ supports collective waves (AT-127).");
        ...
        Sec(sb, "1. AT-128 Recap & Information Transport Theory");
        ...
        sb.AppendLine($"  Experiment AT-129 completed.");
