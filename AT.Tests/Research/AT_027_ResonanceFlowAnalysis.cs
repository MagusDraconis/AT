...
public class AT_027_ResonanceFlowAnalysis : ResearchTestBase
{
    ...
    public AT_027_ResonanceFlowAnalysis(ITestOutputHelper output) : base(output) { }

    [Fact]
    public void AT_027_RunFlowAnalysis()
    {
    ...
    private void ExecuteExperiment()
    {
        ...
        PrintHeader("AT-027 Resonance Flow Analysis");
        report.AppendLine("AT-027: Does Dynamic Resonance Flow Drive Condensation?");
        report.AppendLine();
        ...
        report.AppendLine();
        report.AppendLine("  Relative to density (CV=0.144 across λ from AT-023):");
        ...
        report.AppendLine();
        report.AppendLine("  C2. Flow analysis opens a new dimension of AT investigation:");
        ...
        report.AppendLine("  Experiment AT-027 completed successfully.");
        report.AppendLine(new string('=', 100));
