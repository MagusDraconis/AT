...
/// <summary>
/// AT-009: Spatial Resonance Localization
///
...
/// </summary>
public class AT_009_SpatialResonanceLocalization : ResearchTestBase
{
    ...
    public AT_009_SpatialResonanceLocalization(ITestOutputHelper output)
        : base(output)
    {
    }

    [Fact]
    public void AT_009_RunSpatialLocalizationExperiment()
    {
    ...
    private void ExecuteExperiment()
    {
        ...
        // ── Header ──────────────────────────────────────────────
        PrintHeader("AT-009 Spatial Resonance Localization");
        report.AppendLine("AT-009: Localized Resonance Domains via Distance-Dependent Coupling");
        report.AppendLine();

        // ── 1. Objective ────────────────────────────────────────
        AppendSection(report, "1. Objective");
        report.AppendLine("  AT-008 showed only one universal resonance family in globally coupled");
        ...
        report.AppendLine();
        report.AppendLine("  C4. Spatial embedding represents a significant extension of the AT framework:");
        ...
        report.AppendLine("    • AT-010: Domain-domain boundaries and interface dynamics.");
        report.AppendLine("    • AT-011: Moving domains — spatial migration of resonance islands.");
        report.AppendLine("    • AT-012: Smaller λ (0.1, 0.5) for stronger localization effects.");

        report.AppendLine();
        report.AppendLine(new string('=', 100));
        report.AppendLine("  Experiment AT-009 completed successfully.");
        report.AppendLine(new string('=', 100));
