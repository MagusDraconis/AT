...
public class AT_057_ResonanceStateSpaceGeodesics : ResearchTestBase
{
    ...
    public AT_057_ResonanceStateSpaceGeodesics(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void AT_057_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("AT-057 Resonance State-Space Geodesics");

        report.AppendLine("AT-057: Do State Transitions Follow Preferred Geodesic Paths?");
        report.AppendLine();

        // ── Section 1: Objective ─────────────────────────────────────
        AppendSection(report, "1. Objective");
        report.AppendLine("  AT-056 revealed a single continuous attractor landscape.");
        ...
        report.AppendLine("  Experiment AT-057 completed successfully.");
        report.AppendLine(new string('=', 100));
