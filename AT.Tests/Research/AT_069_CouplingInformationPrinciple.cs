...
public class AT_069_CouplingInformationPrinciple : ResearchTestBase
{
    ...
    public AT_069_CouplingInformationPrinciple(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void AT_069_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("AT-069 Coupling Information Principle");

        sb.AppendLine("AT-069: Which Mathematical Property of a Coupling Function Predicts Attraction?");
        sb.AppendLine();

        // ── Section 1: Objective ─────────────────────────────────────
        Sec(sb, "1. Objective");
        sb.AppendLine("  AT-062: Spatial attraction exists.");
        sb.AppendLine("  AT-064: Attraction across many coupling laws.");
        sb.AppendLine("  AT-065: Symmetry alone does NOT explain attraction.");
        sb.AppendLine("  AT-066: No universal coupling regime exists.");
        sb.AppendLine("  AT-068: Curvature does not drive motion.");
        sb.AppendLine();
        ...
        if (Math.Abs(report.BestSinglePredictorR) < 0.2)
        {
            ...
            sb.AppendLine();
            sb.AppendLine("    This is consistent with AT-066 (no universal");
            sb.AppendLine("    coupling regime) and AT-068 (curvature doesn't");
        ...
        sb.AppendLine("  Experiment AT-069 completed successfully.");
        sb.AppendLine(new string('=', 100));
