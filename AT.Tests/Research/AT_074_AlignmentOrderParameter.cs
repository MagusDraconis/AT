...
public class AT_074_AlignmentOrderParameter : ResearchTestBase
{
    ...
    public AT_074_AlignmentOrderParameter(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void AT_074_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("AT-074 Alignment Order Parameter");

        sb.AppendLine("AT-074: Is Alignment the True Order Parameter for Attraction?");
        sb.AppendLine();

        // ── Section 1: Objective ─────────────────────────────────────
        Sec(sb, "1. Objective");
        sb.AppendLine("  AT-072: F_net almost perfectly predicted by alignment (r=0.986).");
        sb.AppendLine("  AT-073: F_net fit by empirical functions of R, but no universal law.");
        sb.AppendLine();
        ...
        sb.AppendLine("  Experiment AT-074 completed successfully.");
        sb.AppendLine(new string('=', 100));
