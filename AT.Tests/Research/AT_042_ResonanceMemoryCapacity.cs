...
public class AT_042_ResonanceMemoryCapacity : ResearchTestBase
{
    ...
    public AT_042_ResonanceMemoryCapacity(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void AT_042_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("AT-042 Resonance Memory Capacity");
        report.AppendLine("AT-042: How Much Can a Condensate Remember?");
        report.AppendLine();

        AppendSection(report, "1. Objective");
        report.AppendLine("  AT-041 showed condensates can learn. This experiment tests memory");
        ...
        report.AppendLine("  Experiment AT-042 completed successfully.");
        report.AppendLine(new string('=', 100));
