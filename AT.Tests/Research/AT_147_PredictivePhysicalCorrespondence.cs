...
public class AT_147_PredictivePhysicalCorrespondence : ResearchTestBase
{
    public AT_147_PredictivePhysicalCorrespondence(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void AT_147_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("AT-147 Predictive Physical Correspondence");

        Sec(sb, "0. Assumptions");
        sb.AppendLine("  1. Q → L_Q → spectrum → observables (AT-145/146).");
        ...
        sb.AppendLine($"  AT-147 complete. Classification: {report.Classification}");
        sb.AppendLine(new string('=', 100));
