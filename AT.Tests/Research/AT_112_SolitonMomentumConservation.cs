...
public class AT_112_SolitonMomentumConservation : ResearchTestBase
{
    public AT_112_SolitonMomentumConservation(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void AT_112_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("AT-112 Soliton Momentum and Conservation Laws");
        ...
        sb.AppendLine("    This is different from AT-012 discrete mergers because");
        ...
        if (report.Classification.StartsWith("D"))
            sb.AppendLine("    YES — they have mass (AT-111), momentum (AT-112),");
        else
        ...
        sb.AppendLine("  ┌─────────────────────────────────────────────────────────┐");
        sb.AppendLine("  │  PROTO-PARTICLE MECHANICS (AT-111 + AT-112)           │");
        sb.AppendLine("  ├─────────────────────────────────────────────────────────┤");
        ...
        sb.AppendLine("  Experiment AT-112 completed successfully.");
        sb.AppendLine(new string('=', 100));
