...
public class AT_138_OpenEndedInnovation : ResearchTestBase
{
    public AT_138_OpenEndedInnovation(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void AT_138_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("AT-138 Open-Ended Information Innovation");

        // ── Section 0: Assumptions ──
        Sec(sb, "0. Assumptions");
        sb.AppendLine("  1. Theta supports Darwinian evolution (AT-134/135/136/137).");
        sb.AppendLine("  2. 4 known species exist: A, B, C, D (AT-133).");
        ...
        sb.AppendLine("  AT-133: 4 stable information species discovered (A, B, C, D).");
        sb.AppendLine("  AT-134: Reproduction + inheritance + mutation.");
        sb.AppendLine("  AT-135: Selection under resource constraints.");
        sb.AppendLine("  AT-136: Fitness law w = r/c.");
        sb.AppendLine("  AT-137: Evolution is universal.");
        sb.AppendLine();
        ...
        sb.AppendLine($"  Experiment AT-138 completed.");
