...
public class AT_103_UniversalityAndScaleInvariance : ResearchTestBase
{
    private const int BaseSeed = 103_000_001;

    public AT_103_UniversalityAndScaleInvariance(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void AT_103_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("AT-103 Universality and Scale Invariance");

        sb.AppendLine("AT-103: Can scale transformations make {R, M} universal?");
        sb.AppendLine("         Searching for M* = M·N^β·K^γ·λ^δ");
        sb.AppendLine();

        // ── Section 1: Objective ─────────────────────────────────────
        Sec(sb, "1. Objective");
        sb.AppendLine("  AT-100/101/102: {R, M} theory fails at extreme N, K, λ.");
        ...
        // ── Comparison vs AT-101 ────────────────────────────────────
        sb.AppendLine("  ── Comparison: AT-101(D) vs AT-103(renormalized) ──");
        sb.AppendLine("  Attack                  │ AT-101   │ AT-103   │ Δ");
        ...
        sb.AppendLine("  Q6: Can the AT-100 failures be explained by scale effects?");
        ...
        sb.AppendLine("  Experiment AT-103 completed successfully.");
        sb.AppendLine(new string('=', 100));
