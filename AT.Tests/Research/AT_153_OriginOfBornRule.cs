...
public class AT_153_OriginOfBornRule : ResearchTestBase
{
    public AT_153_OriginOfBornRule(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void AT_153_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("AT-153 Origin of the Born Rule");

        Sec(sb, "0. Assumptions");
        sb.AppendLine("  1. AT-152: Schrödinger dynamics from Q + reversibility.");
        ...
        sb.AppendLine("  AT derives Hilbert space and Schrödinger from postulates 1-2.");
        ...
        sb.AppendLine($"  AT-153 complete. Classification: {report.Classification}");
        sb.AppendLine(new string('=', 100));
