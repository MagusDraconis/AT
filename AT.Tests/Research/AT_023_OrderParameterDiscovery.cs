...
public class AT_023_OrderParameterDiscovery : ResearchTestBase
{
    ...
    public AT_023_OrderParameterDiscovery(ITestOutputHelper output) : base(output) { }

    [Fact]
    public void AT_023_RunOrderParameterDiscovery()
    {
    ...
    private void ExecuteExperiment()
    {
        ...
        PrintHeader("AT-023 Condensation Order Parameter Discovery");
        report.AppendLine("AT-023: Identifying the Fundamental Condensation Predictor");
        report.AppendLine();

        AppendSection(report, "1. Objective");
        report.AppendLine("  AT-022 showed no single metric is λ-universal AND placement-universal.");
        ...
        report.AppendLine();
        report.AppendLine("  C3. The AT order parameter discovery process has established:");
        ...
        report.AppendLine("  Experiment AT-023 completed successfully.");
        report.AppendLine(new string('=', 100));
