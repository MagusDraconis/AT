...
public class AT_062_StateSpaceCurvatureToSpatialMotion : ResearchTestBase
{
    ...
    public AT_062_StateSpaceCurvatureToSpatialMotion(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void AT_062_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("AT-062 State-Space Curvature to Spatial Motion");

        report.AppendLine("AT-062: Can State-Space Curvature Generate Spatial Motion?");
        report.AppendLine();

        AppendSection(report, "1. Objective");
        report.AppendLine("  AT-058/059 showed memory creates state-space curvature.");
        ...
        report.AppendLine("  Experiment AT-062 completed successfully.");
        report.AppendLine(new string('=', 100));
