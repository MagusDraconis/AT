...
public class AT_126_ChargeModeInterference : ResearchTestBase
{
    public AT_126_ChargeModeInterference(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void AT_126_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("AT-126 Charge Mode Interference");

        Sec(sb, "0. Assumptions");
        sb.AppendLine("  1. Q=+1 has internal phase oscillation θ(t) (AT-124).");
        sb.AppendLine("  2. Separated charges can phase-lock (AT-125).");
        ...
        Sec(sb, "1. AT-124/125 Recap");
        sb.AppendLine("  AT-124: Internal phase mode at ω≈1 per Q=+1.");
        sb.AppendLine("  AT-125: Phase locking between charges (Adler equation).");
        ...
        sb.AppendLine($"  Experiment AT-126 completed.  Runtime: {sw.Elapsed.TotalSeconds:F0}s.");
