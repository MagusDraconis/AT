...
public class AT_107_LocalStructureSurvival : ResearchTestBase
{
    private const int BaseSeed = 107_000_001;

    public AT_107_LocalStructureSurvival(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void AT_107_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("AT-107 Local Structure Survival");

        sb.AppendLine("AT-107: Do local condensates survive despite the mean-field");
        ...
        sb.AppendLine("  AT-106 (mean-field phase portrait):");
        ...
        sb.AppendLine();
        sb.AppendLine("  Earlier AT experiments (010-012):");
        ...
        sb.AppendLine("    YES — within each condensate, local R → 1 (AT-010, AT-106).");
        ...
        sb.AppendLine("  Q7: Must AT become a spatial field theory?");
        ...
        sb.AppendLine(new string('=', 100));
        sb.AppendLine("  Experiment AT-107 completed successfully.");
        sb.AppendLine(new string('=', 100));
