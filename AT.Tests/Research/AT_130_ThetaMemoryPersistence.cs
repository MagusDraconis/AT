...
public class AT_130_ThetaMemoryPersistence : ResearchTestBase
{
    public AT_130_ThetaMemoryPersistence(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void AT_130_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("AT-130 Theta Memory and Information Persistence");

        Sec(sb, "0. Assumptions");
        sb.AppendLine("  1. Θ is autonomous at high density (AT-128).");
        sb.AppendLine("  2. Θ transports information (AT-129).");
        ...
        Sec(sb, "1. AT-129 Recap & Memory Theory");
        ...
        sb.AppendLine($"  Experiment AT-130 completed.");
