...
public class AT_043_CompetingMemoryEncoding : ResearchTestBase
{
    ...
    public AT_043_CompetingMemoryEncoding(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void AT_043_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("AT-043 Competing Memory Encoding");
        report.AppendLine("AT-043: Do Competing Memories Coexist, Interfere, or Overwrite?");
        report.AppendLine();

        AppendSection(report, "1. Objective");
        report.AppendLine("  AT-041/042 showed learning and capacity. This experiment tests how");
        ...
        report.AppendLine("  Experiment AT-043 completed successfully.");
        report.AppendLine(new string('=', 100));
