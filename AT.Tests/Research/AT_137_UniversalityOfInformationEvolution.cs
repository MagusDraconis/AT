...
public class AT_137_UniversalityOfInformationEvolution : ResearchTestBase
{
    public AT_137_UniversalityOfInformationEvolution(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void AT_137_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("AT-137 Universality of Information Evolution");

        // ── Section 0: Assumptions ──
        Sec(sb, "0. Assumptions");
        sb.AppendLine("  1. Theta is an autonomous information layer (AT-128).");
        sb.AppendLine("  2. Darwinian evolution exists under r/c fitness (AT-134/135/136).");
        ...
        // ── Section 1: AT-135/136 Recap ──
        Sec(sb, "1. AT-135/136 Recap — Darwinian Evolution in Theta");
        sb.AppendLine("  AT-135: Selection exists — 329 extinctions, 8.6× fitness differential.");
        sb.AppendLine("  AT-136: Fitness law w = r/c — Spearman ρ = 1.000, perfect prediction.");
        sb.AppendLine();
        ...
        sb.AppendLine($"  Experiment AT-137 completed.");
