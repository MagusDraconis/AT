...
public class AT_152_OriginOfNormConservation : ResearchTestBase
{
    public AT_152_OriginOfNormConservation(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void AT_152_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("AT-152 Origin of Norm Conservation");

        Sec(sb, "0. Assumptions");
        sb.AppendLine("  1. AT-151: Q + norm conservation → Schrödinger.");
        ...
        Sec(sb, "4. AT vs Standard Quantum Mechanics");
        ...
        sb.AppendLine();
        sb.AppendLine("  AT postulates:");
        sb.AppendLine("    1. Q exists (topological charge)");
        sb.AppendLine("    2. Dynamics are reversible");
        sb.AppendLine();
        sb.AppendLine("  AT DERIVES: Hilbert space (L_Q), operators (L_Q), Schrödinger (from reversibility).");
        ...
        sb.AppendLine($"  AT-152 complete. Classification: {report.Classification}");
        sb.AppendLine(new string('=', 100));
