...
public class AT_116_TopologicalChargeDynamics : ResearchTestBase
{
    public AT_116_TopologicalChargeDynamics(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void AT_116_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("AT-116 Topological Charge Dynamics");
        ...
        sb.AppendLine("    Destruction requires CATASTROPHIC perturbation (AT-011: density -50%).");
        sb.AppendLine();
        ...
        sb.AppendLine("    This has NOT been observed in any AT experiment.");
        sb.AppendLine();
        ...
        sb.AppendLine("    YES — every major AT observation has a natural charge interpretation:");
        sb.AppendLine("    • Proto-matter = Q≥1 states (AT-010)");
        sb.AppendLine("    • Stability = Q conservation (AT-011, AT-113)");
        sb.AppendLine("    • Mergers = Q→Q-1 transitions (AT-012)");
        sb.AppendLine("    • Multi-condensate = Q>1 states (AT-107)");
        sb.AppendLine("    • Identity exclusion = Q-preserving interaction (AT-050)");
        sb.AppendLine("    • Single species = all Q=+1 units (AT-114)");
        sb.AppendLine();
        ...
        sb.AppendLine("  ├─────────────────────────────────────────────────────────┤");
        sb.AppendLine("  │  UNIFIES: AT-010..115 in single charge framework       │");
        sb.AppendLine("  └─────────────────────────────────────────────────────────┘");
        sb.AppendLine();

        sb.AppendLine(new string('=', 100));
        sb.AppendLine("  Experiment AT-116 completed successfully.");
        sb.AppendLine(new string('=', 100));
