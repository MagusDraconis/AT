...
public class AT_060_MemoryCurvatureFeedbackLoop : ResearchTestBase
{
    ...
    public AT_060_MemoryCurvatureFeedbackLoop(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void AT_060_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("AT-060 Memory\u2013Curvature Feedback Loop");

        report.AppendLine("AT-060: Does Memory-Generated Curvature Feed Back Into Memory?");
        report.AppendLine();

        // ── Section 1: Objective ─────────────────────────────────────
        AppendSection(report, "1. Objective");
        report.AppendLine("  AT-059 showed memory (β) is the dominant curvature source.");
        ...
        report.AppendLine("  Experiment AT-060 completed successfully.");
        report.AppendLine(new string('=', 100));
