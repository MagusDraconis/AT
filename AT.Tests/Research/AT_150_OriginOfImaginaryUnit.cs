...
public class AT_150_OriginOfImaginaryUnit : ResearchTestBase
{
    public AT_150_OriginOfImaginaryUnit(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void AT_150_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("AT-150 Origin of the Imaginary Unit");

        Sec(sb, "0. Assumptions");
        sb.AppendLine("  1. L_Q supports Schrödinger form i∂ψ/∂t = L_Q ψ (AT-149).");
        ...
        sb.AppendLine("  AT provides Hilbert space + Hamiltonian, not the dynamical postulate.");
        sb.AppendLine();
        ...
        sb.AppendLine($"  AT-150 complete. Classification: {report.Classification}");
        sb.AppendLine(new string('=', 100));
