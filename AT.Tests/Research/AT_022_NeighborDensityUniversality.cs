...
public class AT_022_EffectiveNeighborDensityUniversality : ResearchTestBase
{
    ...
    public AT_022_EffectiveNeighborDensityUniversality(ITestOutputHelper output) : base(output) { }

    [Fact]
    public void AT_022_RunDensityUniversalityTest()
    {
    ...
    private void ExecuteExperiment()
    {
        ...
        PrintHeader("AT-022 Effective Neighbor Density Universality");
        report.AppendLine("AT-022: Is ρeff = Neff/λ² the True Universal Condensation Predictor?");
        report.AppendLine();

        AppendSection(report, "1. Objective");
        report.AppendLine("  AT-021 showed Nc_eff is λ-dependent. This experiment tests whether");
        ...
        report.AppendLine("  Cross-λ CV (the critical test from AT-021):");
        ...
        report.AppendLine("  C2. The effective neighbor density ρeff = Neff/λ² hypothesis:");
            ...
            report.AppendLine();
            report.AppendLine("  C3. The AT condensation control hierarchy (by cross-λ CV):");
        ...
        report.AppendLine("  Experiment AT-022 completed successfully.");
        report.AppendLine(new string('=', 100));
