...
public class AT_064_UniversalityOfEffectiveAttraction : ResearchTestBase
{
    ...
    public AT_064_UniversalityOfEffectiveAttraction(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void AT_064_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("AT-064 Universality of Effective Attraction");

        report.AppendLine("AT-064: Is Spatial Attraction Universal or Coupling-Specific?");
        report.AppendLine();

        AppendSection(report, "1. Objective");
        report.AppendLine("  AT-062 showed spatial convergence with cos(Δθ) coupling.");
        ...
        report.AppendLine("  Experiment AT-064 completed successfully.");
        report.AppendLine(new string('=', 100));
