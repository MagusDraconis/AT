...
public class AT_127_EmergentCollectiveChargeWaves : ResearchTestBase
{
    public AT_127_EmergentCollectiveChargeWaves(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void AT_127_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("AT-127 Emergent Collective Charge Waves");

        Sec(sb, "0. Assumptions");
        sb.AppendLine("  1. Q=+1 has internal phase mode (AT-124).");
        sb.AppendLine("  2. Charges can phase-lock (AT-125) and interfere (AT-126).");
        ...
        Sec(sb, "7. Comparison with AT-123 and AT-126");
        sb.AppendLine("  AT-123: Dilute gas (Q<10) — independent charges, R_Q≪1.");
        sb.AppendLine("  AT-126: Two-charge interference — pairwise cos(Δφ) modulation.");
        sb.AppendLine("  AT-127: Many charges — emergent medium, R_Q→1, collective waves.");
        sb.AppendLine();
        ...
        sb.AppendLine($"  Experiment AT-127 completed.  Runtime: {sw.Elapsed.TotalSeconds:F0}s.");
