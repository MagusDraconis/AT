...
public class AT_071_CriticalCoherenceThreshold : ResearchTestBase
{
    ...
    public AT_071_CriticalCoherenceThreshold(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void AT_071_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("AT-071 Critical Coherence Threshold");

        sb.AppendLine("AT-071: Is There a Universal Critical Coherence for Attraction?");
        sb.AppendLine();

        // ── Section 1: Objective ─────────────────────────────────────
        Sec(sb, "1. Objective");
        sb.AppendLine("  AT-070: Attraction appears abruptly near R ≈ 0.85–0.90.");
        ...
        sb.AppendLine("  Experiment AT-071 completed successfully.");
        sb.AppendLine(new string('=', 100));
