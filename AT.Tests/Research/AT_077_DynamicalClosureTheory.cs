...
public class AT_077_DynamicalClosureTheory : ResearchTestBase
{
    ...
    public AT_077_DynamicalClosureTheory(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void AT_077_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("AT-077 Dynamical Closure Theory");

        sb.AppendLine("AT-077: Do Dynamical Evolution Terms Close the Trajectory Theory?");
        sb.AppendLine();

        // ── Section 1: Objective ─────────────────────────────────────
        Sec(sb, "1. Objective");
        sb.AppendLine("  AT-074: F_net = Alignment × ⟨f⟩.");
        sb.AppendLine("  AT-075: Alignment ≈ R².");
        sb.AppendLine("  AT-076: Static initial conditions predict always-positive");
        ...
        // ── Research Questions ───────────────────────────────────────
        // Focus on cos — the sign-changing law that failed in AT-076.
        ...
        sb.AppendLine("  Experiment AT-077 completed successfully.");
        sb.AppendLine(new string('=', 100));
