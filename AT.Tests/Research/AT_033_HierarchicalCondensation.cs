...
public class AT_033_HierarchicalCondensation : ResearchTestBase
{
    ...
    public AT_033_HierarchicalCondensation(ITestOutputHelper output) : base(output) { }

    [Fact]
    public void AT_033_RunHierarchicalTest()
    {
    ...
    private void ExecuteExperiment()
    {
        ...
        PrintHeader("AT-033 Hierarchical Condensation");
        report.AppendLine("AT-033: Can Multiple Condensates Form Stable Assemblies?");
        report.AppendLine();

        AppendSection(report, "1. Objective");
        report.AppendLine("  AT-031/032 showed single-attractor landscapes. This experiment tests");
        ...
        report.AppendLine("  Experiment AT-033 completed successfully.");
        report.AppendLine(new string('=', 100));
