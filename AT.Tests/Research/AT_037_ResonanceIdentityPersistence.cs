...
public class AT_037_ResonanceIdentityPersistence : ResearchTestBase
{
    ...
    public AT_037_ResonanceIdentityPersistence(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void AT_037_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("AT-037 Resonance Identity Persistence");
        report.AppendLine("AT-037: Do Memory-Generated Identities Survive Perturbations?");
        report.AppendLine();

        AppendSection(report, "1. Objective");
        report.AppendLine("  AT-036 showed memory creates path dependence. This experiment tests");
        ...
        report.AppendLine("  C3. Resonance identity represents the first AT mechanism for");
        ...
        report.AppendLine("  Experiment AT-037 completed successfully.");
        report.AppendLine(new string('=', 100));
