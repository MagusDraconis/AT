...
public class AT_146_PhysicalScalingLaws : ResearchTestBase
{
    public AT_146_PhysicalScalingLaws(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void AT_146_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("AT-146 Physical Scaling Laws from Topological Charge");

        Sec(sb, "0. Assumptions");
        sb.AppendLine("  1. Q → L_Q → observables (AT-145): m_eff∝Q², E∝Q, Δ∝1/Q², ...");
        ...
        sb.AppendLine($"  AT-146 complete. Classification: {report.Classification}");
        sb.AppendLine(new string('=', 100));
