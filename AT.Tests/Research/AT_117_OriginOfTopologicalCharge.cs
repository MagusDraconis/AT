...
public class AT_117_OriginOfTopologicalCharge : ResearchTestBase
{
    public AT_117_OriginOfTopologicalCharge(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void AT_117_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("AT-117 Origin of Topological Charge");
        ...
        sb.AppendLine("  Experiment AT-117 completed successfully.");
        sb.AppendLine(new string('=', 100));
