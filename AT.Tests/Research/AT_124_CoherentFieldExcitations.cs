...
public class AT_124_CoherentFieldExcitations : ResearchTestBase
{
    public AT_124_CoherentFieldExcitations(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void AT_124_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("AT-124 Coherent Field Excitations of Topological Charge");
        ...
        sb.AppendLine("  AT-117: Q derived from field equations (topological invariant).");
        sb.AppendLine("  AT-120: Q=1 is indivisible.");
        sb.AppendLine("  AT-121: Q is fundamentally quantized.");
        sb.AppendLine("  AT-122: Q=1 is minimal stable droplet (w_c ≈ 0.05).");
        sb.AppendLine("  AT-123: Charges are mostly independent (dilute gas).");
        sb.AppendLine();
        ...
        sb.AppendLine("    — Q statistics (AT-119) — like counting statistics.");
        sb.AppendLine();
        ...
        sb.AppendLine($"  Experiment AT-124 completed successfully.  Runtime: {stopwatch.Elapsed.TotalSeconds:F0}s.");
