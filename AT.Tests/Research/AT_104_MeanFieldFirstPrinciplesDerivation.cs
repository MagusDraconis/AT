...
public class AT_104_MeanFieldFirstPrinciplesDerivation : ResearchTestBase
{
    private const int BaseSeed = 104_000_001;

    public AT_104_MeanFieldFirstPrinciplesDerivation(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void AT_104_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("AT-104 Mean-Field First-Principles Derivation");

        sb.AppendLine("AT-104: Deriving dR/dt from microscopic Kuramoto equations.");
        ...
        Sec(sb, "3. Validation Against AT-100 Attacks");
        ...
        sb.AppendLine("    AT-103 showed N is fundamental; the derivation explains WHY.");
        sb.AppendLine();
        ...
        sb.AppendLine("    This is exactly what AT-081/082 discovered empirically.");
        sb.AppendLine();

        sb.AppendLine("  Q5: Does the derived law outperform fitted laws?");
        double bestFittedSurvival = 0.50; // AT-101 Model D
        sb.AppendLine($"    Best fitted (AT-101): {bestFittedSurvival:P0} survival");
        ...
        sb.AppendLine("  Q6: Does the derivation explain AT-100 failures?");
        ...
        sb.AppendLine("  Experiment AT-104 completed successfully.");
        sb.AppendLine(new string('=', 100));
