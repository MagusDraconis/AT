...
/// <summary>
/// AT-QG Phase 45 — minimal coupling of ψ. Determines the weakest coupling between ψ and the scalar backbone
/// required to recover GW polarization. Classify: INDEPENDENT / WEAKLY COUPLED / STRONGLY COUPLED.
///
/// Tests: ATQG450 (zero coupling for polarization), ATQG451 (polarization vs sourcing), ATQG452 (classification).
/// </summary>
public class ATQG_Phase45_MinimalPsiCouplingTests : ResearchTestBase
{
    public ATQG_Phase45_MinimalPsiCouplingTests(ITestOutputHelper o) : base(o) { }

    // ── ATQG450: zero coupling for the polarization ─────────────────────────────────

    [Fact]
    public void ATQG450_ZeroCouplingForPolarization()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG450: the GW polarization needs zero coupling to the scalar backbone");
    ...
    // ── ATQG451: polarization vs sourcing ────────────────────────────────────────────

    [Fact]
    public void ATQG451_PolarizationVsSourcing()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG451: polarization is intrinsic; sourcing needs a weak coupling");
    ...
    // ── ATQG452: classification ───────────────────────────────────────────────────────

    [Fact]
    public void ATQG452_Classification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG452: INDEPENDENT / WEAKLY COUPLED / STRONGLY COUPLED?");
