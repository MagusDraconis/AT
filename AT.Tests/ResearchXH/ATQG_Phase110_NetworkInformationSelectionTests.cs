...
/// <summary>
/// AT-QG Phase 110 — Network information selection. QG109 showed stability alone does not select a unique
...
///
/// Tests: ATQG1100 (information flow + communication efficiency), ATQG1101 (causal depth + memory capacity +
/// stable computation), ATQG1102 (information selection + classification).
/// </summary>
public class ATQG_Phase110_NetworkInformationSelectionTests : ResearchTestBase
{
    public ATQG_Phase110_NetworkInformationSelectionTests(ITestOutputHelper o) : base(o) { }

    // ── ATQG1100: information flow + communication efficiency ───────────────────

    [Fact]
    public void ATQG1100_InformationFlowAndEfficiency()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG1100: information flow and communication efficiency across classes");
    ...
    // ── ATQG1101: causal depth + memory capacity + stable computation ────────────

    [Fact]
    public void ATQG1101_CausalDepthMemoryStable()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG1101: causal depth, memory capacity, stable computation");
    ...
    // ── ATQG1102: information selection + classification ─────────────────────────

    [Fact]
    public void ATQG1102_InformationSelectionAndClassification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG1102: can information capacity select a unique network class?");
