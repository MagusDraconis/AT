...
/// <summary>
/// AT-QG Phase 38 — origin of finite-density saturation. Determines why Q-events saturate at a critical density.
/// Classify: DERIVED / PREFERRED / IMPORTED.
///
/// Tests: ATQG380 (mechanism census), ATQG381 (existence vs value), ATQG382 (classification).
/// </summary>
public class ATQG_Phase38_SaturationOriginTests : ResearchTestBase
{
    public ATQG_Phase38_SaturationOriginTests(ITestOutputHelper o) : base(o) { }

    // ── ATQG380: mechanism census ─────────────────────────────────────────────────────

    [Fact]
    public void ATQG380_MechanismCensus()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG380: the five mechanisms all reduce to discreteness");
    ...
    // ── ATQG381: existence vs value ───────────────────────────────────────────────────

    [Fact]
    public void ATQG381_ExistenceVsValue()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG381: existence is derived; the value is imported");
    ...
    // ── ATQG382: classification ───────────────────────────────────────────────────────

    [Fact]
    public void ATQG382_Classification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG382: DERIVED / PREFERRED / IMPORTED?");
        ...
        sb.AppendLine("    QG14 (AT has bounds but no native cutoff value).");
