...
/// <summary>
/// AT-QG Phase 214 — Anti-Fit Reaudit 2. Review QG140–QG213, classify each by methodology, compare against
/// QG189, and verify whether RETRO-FIT = 2 and OVERFIT = 1 still hold. Methodology audit only, no physics.
/// </summary>
public class ATQG_Phase214_AntiFitReaudit2Tests : ResearchTestBase
{
    public ATQG_Phase214_AntiFitReaudit2Tests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void ATQG2140_NewPhasesClassified()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG2140: the QG190–QG213 register");
    ...
    [Fact]
    public void ATQG2141_RetroFitAndOverfitStillHold()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG2141: do RETRO-FIT = 2 and OVERFIT = 1 still hold?");
    ...
    [Fact]
    public void ATQG2142_StrongestEvidenceAndRiskTrend()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG2142: strongest anti-fit evidence and the risk trend by era");
