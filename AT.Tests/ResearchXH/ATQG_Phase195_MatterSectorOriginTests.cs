...
/// <summary>
/// AT-QG Phase 195 — Matter Sector Origin. Can an independent T_μν be recovered without defining T ≡ G/κ?
...
/// </summary>
public class ATQG_Phase195_MatterSectorOriginTests : ResearchTestBase
{
    public ATQG_Phase195_MatterSectorOriginTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void ATQG1950_NetworkStressIsDeficitDust()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG1950: the matter tensor is the deficit dust (network stress = deficit mass)");
    ...
    [Fact]
    public void ATQG1951_ConservationAndIndependence()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG1951: the deficit dust is conserved and independent of G");
    ...
    [Fact]
    public void ATQG1952_ClassificationMatterOrigin()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG1952: matter-sector origin classification");
