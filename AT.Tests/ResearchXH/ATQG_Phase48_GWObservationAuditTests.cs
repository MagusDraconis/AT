...
/// <summary>
/// AT-QG Phase 48 — GW observation audit. Separates what is directly observed from what is inferred.
/// Classify: DIRECT / MODEL-DEPENDENT / UNDECIDED.
///
/// Tests: ATQG480 (the four layers), ATQG481 (spin-2 reconstructed), ATQG482 (consequence for ψ).
/// </summary>
public class ATQG_Phase48_GWObservationAuditTests : ResearchTestBase
{
    public ATQG_Phase48_GWObservationAuditTests(ITestOutputHelper o) : base(o) { }

    // ── ATQG480: the four layers ─────────────────────────────────────────────────────

    [Fact]
    public void ATQG480_FourLayers()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG480: directly observed vs inferred");
    ...
    // ── ATQG481: spin-2 is reconstructed ─────────────────────────────────────────────

    [Fact]
    public void ATQG481_Spin2Reconstructed()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG481: is spin-2 directly measured or reconstructed?");
    ...
    // ── ATQG482: consequence for ψ ───────────────────────────────────────────────────

    [Fact]
    public void ATQG482_ConsequenceForPsi()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG482: what this means for the ψ postulate");
