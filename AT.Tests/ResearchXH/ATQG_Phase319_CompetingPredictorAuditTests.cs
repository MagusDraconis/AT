...
/// <summary>
/// AT-QG Phase 319 (reissue) — Competing Predictor Audit. QG317: lock coherence predicted the future
...
/// no target values.
/// </summary>
public class ATQG_Phase319_CompetingPredictorAuditTests : ResearchTestBase
{
    public ATQG_Phase319_CompetingPredictorAuditTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void ATQG3190_TheFivePredictors()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG3190: the five competing predictors over the 12-system cohort");
    ...
    [Fact]
    public void ATQG3191_StandardMeasuresMatchOrBeatLocks()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG3191: the standard measures predict the future HIGH class at least as well as the locks");
    ...
    public void ATQG3192_Classification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG3192: the advantage determination");
