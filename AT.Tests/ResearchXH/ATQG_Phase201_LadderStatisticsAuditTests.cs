...
/// <summary>
/// AT-QG Phase 201 — Ladder Statistics Audit. Is the 152 GeV ↔ 151.98 GeV alignment statistically
...
/// </summary>
public class ATQG_Phase201_LadderStatisticsAuditTests : ResearchTestBase
{
    public ATQG_Phase201_LadderStatisticsAuditTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void ATQG2010_DeviationAndNearestRung()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG2010: observed deviation and nearest-rung geometry");
    ...
    [Fact]
    public void ATQG2011_CoincidenceRateAndLookElsewhere()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG2011: random coincidence rate and look-elsewhere correction");
    ...
    [Fact]
    public void ATQG2012_ClassificationModerateSupport()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG2012: classification of the 152 GeV alignment");
