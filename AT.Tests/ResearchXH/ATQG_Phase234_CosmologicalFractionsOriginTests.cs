...
/// <summary>
/// AT-QG Phase 234 — Cosmological Density Fractions Origin. Derive Ω_Λ and Ω_m from the counting measure:
...
/// </summary>
public class ATQG_Phase234_CosmologicalFractionsOriginTests : ResearchTestBase
{
    public ATQG_Phase234_CosmologicalFractionsOriginTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void ATQG2340_OctaveRecordInformation()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG2340: the realized octave record [4,4,87] and its information content");
    ...
    [Fact]
    public void ATQG2341_TheFractions()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG2341: Ω_Λ = I_occ/ln K and Ω_m = 1 − Ω_Λ");
    ...
    [Fact]
    public void ATQG2342_ClassificationFractionOrigin()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG2342: classification — FRACTION ORIGIN");
