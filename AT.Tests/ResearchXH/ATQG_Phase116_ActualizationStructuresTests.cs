...
/// <summary>
/// AT-QG Phase 116 — Stable structures from actualization. QG115 showed content partially shapes structure.
...
///
/// Tests: ATQG1160 (clustered activity + persistent loops), ATQG1161 (self-reinforcing link creation +
/// topology formation), ATQG1162 (geometry classes + classification).
/// </summary>
public class ATQG_Phase116_ActualizationStructuresTests : ResearchTestBase
{
    public ATQG_Phase116_ActualizationStructuresTests(ITestOutputHelper o) : base(o) { }

    // ── ATQG1160: clustered activity + persistent activity loops ────────────────

    [Fact]
    public void ATQG1160_ClusteredActivityAndPersistentLoops()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG1160: clustered activity nucleates structures; persistent loops stabilize");
    ...
    // ── ATQG1161: self-reinforcing link creation + topology formation ────────────

    [Fact]
    public void ATQG1161_SelfReinforcingLinksAndTopologyFormation()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG1161: self-reinforcing link creation and stable topology formation");
    ...
    // ── ATQG1162: geometry classes + classification ──────────────────────────────

    [Fact]
    public void ATQG1162_GeometryClassesAndClassification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG1162: geometry classes → NO STRUCTURE / PARTIAL FORMATION / STRUCTURE ORIGIN");
