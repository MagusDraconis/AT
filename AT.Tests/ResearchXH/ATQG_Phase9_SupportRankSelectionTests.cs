...
/// <summary>
/// AT-QG Phase 9 — which support rank d is favored inside a higher-dimensional fundamental D? We score
...
///
/// Tests: ATQG90 (conformal efficiency landscape — d=3 optimal), ATQG91 (efficiency vs coverage trade-off),
///        ATQG92 (classification).
/// </summary>
public class ATQG_Phase9_SupportRankSelectionTests : ResearchTestBase
{
    public ATQG_Phase9_SupportRankSelectionTests(ITestOutputHelper o) : base(o) { }

    // ── ATQG90: conformal efficiency is maximized at d=3, independent of D ──────────

    [Fact]
    public void ATQG90_ConformalEfficiencyLandscape()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG90: conformal efficiency is maximized at d=2 (forbidden), then d=3");
    ...
    // ── ATQG91: efficiency vs coverage trade-off ────────────────────────────────────

    [Fact]
    public void ATQG91_EfficiencyVsCoverage()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG91: conformal efficiency (prefers low d) vs coverage (prefers d=D)");
    ...
    [Fact]
    public void ATQG92_Classification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG92: is a specific support rank DERIVED, PREFERRED, or NOT SELECTED?");
        ...
        sb.AppendLine("    d≥3, efficiency is maximized at d=3 (1/3) and decreases (ATQG90).");
        sb.AppendLine("  • Efficiency (prefers low d) and coverage (prefers d=D) trade off (ATQG91), so NO unique support");
