...
/// <summary>
/// AT-QG Phase 47 — why does Primitive 2 (ψ) exist? Determines the principle behind ψ's existence.
/// Classify: FORCED / PREFERRED / CONTINGENT / NEW POSTULATE.
///
/// Tests: ATQG470 (Q-event-only vs Q-event+ψ), ATQG471 (no internal forcing), ATQG472 (classification).
/// </summary>
public class ATQG_Phase47_WhyPsiExistsTests : ResearchTestBase
{
    public ATQG_Phase47_WhyPsiExistsTests(ITestOutputHelper o) : base(o) { }

    // ── ATQG470: what becomes impossible without ψ ──────────────────────────────────

    [Fact]
    public void ATQG470_WhatIsImpossibleWithoutPsi()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG470: Q-event-only vs Q-event + ψ");
    ...
    // ── ATQG471: no internal consistency principle forces ψ ─────────────────────────

    [Fact]
    public void ATQG471_NoInternalForcing()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG471: is ψ forced by internal consistency?");
    ...
    // ── ATQG472: classification ───────────────────────────────────────────────────────

    [Fact]
    public void ATQG472_Classification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG472: FORCED / PREFERRED / CONTINGENT / NEW POSTULATE?");
        ...
        sb.AppendLine();
        sb.AppendLine("WHY ψ EXISTS: not because AT forces it, but because the universe demonstrably has spin-2 gravitational waves");
