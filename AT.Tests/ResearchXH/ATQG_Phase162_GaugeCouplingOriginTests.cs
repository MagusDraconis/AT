...
/// <summary>
/// AT-QG Phase 162 — Gauge coupling origin. QG161 derived the gauge generators (U(1) + SU(2) + SU(3),
...
///
/// Tests: ATQG1620 (U(1) generator normalization → 137), ATQG1621 (SU(2)/SU(3) transition densities),
/// ATQG1622 (Weinberg angle + classification).
/// </summary>
public class ATQG_Phase162_GaugeCouplingOriginTests : ResearchTestBase
{
    public ATQG_Phase162_GaugeCouplingOriginTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void ATQG1620_U1GeneratorNormalization()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG1620: U(1) generator normalization — 1/α_em = 137");
    ...
    [Fact]
    public void ATQG1621_SU2SU3TransitionDensities()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG1621: SU(2)/SU(3) transition densities");
    ...
    [Fact]
    public void ATQG1622_WeinbergAngleAndClassification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG1622: Weinberg angle and classification");
