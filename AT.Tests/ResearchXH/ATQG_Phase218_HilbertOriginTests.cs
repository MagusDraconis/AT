...
/// <summary>
/// AT-QG Phase 218 — Hilbert Origin. Show why quantum states must be complex, from the derived amplitude
/// magnitude (QG216) and the U(1) link phase (QG63). No new primitives, deterministic.
/// </summary>
public class ATQG_Phase218_HilbertOriginTests : ResearchTestBase
{
    public ATQG_Phase218_HilbertOriginTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void ATQG2180_TwoRealDegreesOfFreedom()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG2180: a quantum state carries magnitude AND phase — two real DOFs");
    ...
    [Fact]
    public void ATQG2181_InterferenceRequiresThePhase()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG2181: interference requires the phase — impossible with real-only states");
    ...
    [Fact]
    public void ATQG2182_ClassificationHilbertOrigin()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG2182: classification — HILBERT ORIGIN");
