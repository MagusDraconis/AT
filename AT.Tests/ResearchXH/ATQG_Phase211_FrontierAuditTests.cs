...
/// <summary>
/// AT-QG Phase 211 — Frontier Audit. Recompute all remaining unresolved items after QG210, excluding
/// resolved / partial-resolved / superseded, and produce the Top-10 frontier problems. Deterministic.
/// </summary>
public class ATQG_Phase211_FrontierAuditTests : ResearchTestBase
{
    public ATQG_Phase211_FrontierAuditTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void ATQG2110_ExclusionsComplete()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG2110: resolved and superseded items excluded");
    ...
    [Fact]
    public void ATQG2111_Top10FrontierRanked()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG2111: Top-10 frontier problems ranked by importance");
    ...
    [Fact]
    public void ATQG2112_FrontierCharacter()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG2112: the character of the true final frontier");
