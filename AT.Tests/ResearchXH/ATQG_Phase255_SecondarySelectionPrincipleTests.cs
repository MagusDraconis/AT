...
/// <summary>
/// AT-QG Phase 255 — Secondary Selection Principle. Resolve the QG254 octave-preserving ties with one
/// target-free, D96-only, deterministic rule. Apply to the QG253 tie cases.
/// </summary>
public class ATQG_Phase255_SecondarySelectionPrincipleTests : ResearchTestBase
{
    public ATQG_Phase255_SecondarySelectionPrincipleTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void ATQG2550_RuleComponents()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG2550: the secondary rule components");
    ...
    [Fact]
    public void ATQG2551_ApplyToTieCases()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG2551: applying the rule to the QG254 tie cases");
    ...
    [Fact]
    public void ATQG2552_Classification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG2552: summary — UNIQUE SELECTION PRINCIPLE");
