...
/// <summary>
/// AT-QG Phase 318 (reissue) — Lock Origin Audit. QG312-317 established the D96 lock identities
...
/// </summary>
public class ATQG_Phase318_LockOriginAuditTests : ResearchTestBase
{
    public ATQG_Phase318_LockOriginAuditTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void ATQG3180_TheMomentChainIdentity()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG3180: the moment-chain identity — the common source of lock formation");
    ...
    [Fact]
    public void ATQG3181_RobustButNotInevitable()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG3181: the locks are robust to perturbation but NOT inevitable");
    ...
    public void ATQG3182_Classification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG3182: the lock-origin determination");
