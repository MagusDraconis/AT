...
/// <summary>
/// AT-QG Phase 106 — Network spectral classes. QG104–105 established discrete hierarchical spectra that are
...
///
/// Tests: ATQG1060 (graph topology classes), ATQG1061 (spectral clustering + mode-family grouping),
/// ATQG1062 (stable spectrum branches + parameter-family analogs + classification).
/// </summary>
public class ATQG_Phase106_SpectralClassesTests : ResearchTestBase
{
    public ATQG_Phase106_SpectralClassesTests(ITestOutputHelper o) : base(o) { }

    // ── ATQG1060: graph topology classes ─────────────────────────────────────────

    [Fact]
    public void ATQG1060_TopologyClasses()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG1060: distinct spectral classes across graph topology classes");
    ...
    // ── ATQG1061: spectral clustering + mode-family grouping ─────────────────────

    [Fact]
    public void ATQG1061_SpectralClusteringAndModeFamilies()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG1061: spectral clustering — octave-band mode families within the spectrum");
        ...
        sb.AppendLine("AT-native family structure: each octave = one per-octave band of the actualization");
    ...
    // ── ATQG1062: stable branches + parameter-family analogs + classification ─────

    [Fact]
    public void ATQG1062_StableBranchesAndClassification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG1062: stable spectrum branches, parameter-family analogs, classification");
