...
/// <summary>
/// AT-QG Phase 178 — Electron g-2 origin. Known: QG171 (muon g-2: a_μ = (α/2π)(1 + λ₂/Σm)). This
/// phase derives the ELECTRON anomalous magnetic moment a_e from the SAME D96 mechanism — no fitted
/// parameters, deterministic.
///
/// Tests: ATQG1780 (Schwinger base + octave-bottom correction → a_e), ATQG1781 (anomaly suppression
/// + QED consistency), ATQG1782 (muon/electron same-mechanism + classification).
/// </summary>
public class ATQG_Phase178_ElectronG2OriginTests : ResearchTestBase
{
    public ATQG_Phase178_ElectronG2OriginTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void ATQG1780_SchwingerBaseAndElectronCorrection()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG1780: Schwinger base and the electron octave-bottom correction");
    ...
    [Fact]
    public void ATQG1781_AnomalySuppressionAndQEDConsistency()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG1781: anomaly suppression and QED consistency");
    ...
    [Fact]
    public void ATQG1782_SameMechanismAndClassification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG1782: muon/electron same mechanism and classification");
