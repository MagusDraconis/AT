...
/// <summary>
/// AT-MONO005 — Hostile Referee Audit of the Final Canonical Monograph Structure. Assume submission of
...
/// </summary>
public class ATMONO005_CanonicalMonographRefereeAuditTests : ResearchTestBase
{
    public ATMONO005_CanonicalMonographRefereeAuditTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void ATMONO0050_FindingsCatalog()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATMONO0050: the hostile-referee architecture findings");
    ...
    [Fact]
    public void ATMONO0051_BlockingFinding()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATMONO0051: the blocking finding — the primitive-count conflict");
    ...
    [Fact]
    public void ATMONO0052_Verdict()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATMONO0052: the publication verdict");
