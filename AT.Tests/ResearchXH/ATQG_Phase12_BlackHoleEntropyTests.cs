...
/// <summary>
/// AT-QG Phase 12 — black-hole microstate test. Tests whether horizon entropy S ∝ Area emerges from the
/// counting measure (horizon boundary events vs bulk volume events). Classify: MATCH / PARTIAL MATCH / NO MATCH.
///
/// Tests: ATQG120 (event counting: area vs volume), ATQG121 (microstate entropy scaling), ATQG122 (classification).
/// </summary>
public class ATQG_Phase12_BlackHoleEntropyTests : ResearchTestBase
{
    public ATQG_Phase12_BlackHoleEntropyTests(ITestOutputHelper o) : base(o) { }

    // ── ATQG120: event counting — area vs volume scaling ────────────────────────────

    [Fact]
    public void ATQG120_EventCountingAreaVsVolume()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG120: the counting measure gives both area and volume counts");
    ...
    // ── ATQG121: microstate multiplicity → S ∝ Area ─────────────────────────────────

    [Fact]
    public void ATQG121_MicrostateEntropyScaling()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG121: horizon microstates give S ∝ Area, not S ∝ Volume");
    ...
    // ── ATQG122: classification ───────────────────────────────────────────────────────

    [Fact]
    public void ATQG122_Classification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG122: does S ∝ Area emerge naturally? MATCH / PARTIAL / NO MATCH?");
        ...
        sb.AppendLine("  • CAVEAT (mass scaling): AT's deficit mass (enclosed deficit) ∝ R^d, whereas Schwarzschild M ∝ R,");
