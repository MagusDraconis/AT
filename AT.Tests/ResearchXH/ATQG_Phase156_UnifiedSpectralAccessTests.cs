...
/// <summary>
/// AT-QG Phase 156 — Unified spectral access law. The known chain D96 → Z2 doublets → weak-isospin
...
///
/// Tests: ATQG1560 (spectral access primitives), ATQG1561 (unified law predictions), ATQG1562 (p_eff =
/// 2δ + classification).
/// </summary>
public class ATQG_Phase156_UnifiedSpectralAccessTests : ResearchTestBase
{
    public ATQG_Phase156_UnifiedSpectralAccessTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void ATQG1560_SpectralAccessPrimitives()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG1560: spectral access primitives");
    ...
    [Fact]
    public void ATQG1561_UnifiedLawPredictions()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG1561: unified law predictions");
    ...
    [Fact]
    public void ATQG1562_EffectiveExponentsAndClassification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG1562: effective exponents p_eff = 2δ and classification");
