...
/// <summary>
/// AT-QG Phase 93 — Global network consistency. Determines whether global consistency conditions can reduce the
/// freedom of SM parameters. Classify: NO REDUCTION / PARTIAL REDUCTION / STRONG REDUCTION.
///
/// Tests: ATQG930 (loops + metric consistency), ATQG931 (over-constrained + correlations + regions),
/// ATQG932 (classification).
/// </summary>
public class ATQG_Phase93_GlobalConsistencyTests : ResearchTestBase
{
    public ATQG_Phase93_GlobalConsistencyTests(ITestOutputHelper o) : base(o) { }

    // ── ATQG930: closed-loop constraints, global metric consistency ───────────────

    [Fact]
    public void ATQG930_LoopsAndMetric()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG930: do global loop/metric conditions over-constrain?");
    ...
    // ── ATQG931: correlations, over-constrained, allowed regions ──────────────────

    [Fact]
    public void ATQG931_ReductionOfFreedom()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG931: how much SM parameter freedom is reduced?");
    ...
    [Fact]
    public void ATQG932_Classification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG932: NO REDUCTION / PARTIAL REDUCTION / STRONG REDUCTION?");
