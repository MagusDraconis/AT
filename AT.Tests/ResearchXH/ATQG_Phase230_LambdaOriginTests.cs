...
/// <summary>
/// AT-QG Phase 230 — Lambda Origin. Derive the sign, existence, and scaling of Λ from Q-events: critical
...
/// </summary>
public class ATQG_Phase230_LambdaOriginTests : ResearchTestBase
{
    public ATQG_Phase230_LambdaOriginTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void ATQG2300_LambdaExists()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG2300: Λ exists — the critical branching vacuum has growing variance and positive information");
    ...
    [Fact]
    public void ATQG2301_LambdaSignPositive()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG2301: Λ is positive — a repulsive vacuum drives the accelerating expansion");
    ...
    [Fact]
    public void ATQG2302_ClassificationLambdaOrigin()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG2302: classification — LAMBDA ORIGIN");
