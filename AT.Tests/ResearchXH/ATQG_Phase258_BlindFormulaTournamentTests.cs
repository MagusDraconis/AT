...
/// <summary>
/// AT-QG Phase 258 — Blind Formula Tournament. Test whether the QG254/QG255 D96 selection rules have
/// predictive power when the target is revealed only after the selection is locked.
/// </summary>
public class ATQG_Phase258_BlindFormulaTournamentTests : ResearchTestBase
{
    public ATQG_Phase258_BlindFormulaTournamentTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void ATQG2580_BlindSelection()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG2580: the blind selection (locked before reveal)");
    ...
    [Fact]
    public void ATQG2581_TournamentRun()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG2581: the locked-then-revealed tournament");
    ...
    [Fact]
    public void ATQG2582_Classification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG2582: the honest verdict — WEAK");
