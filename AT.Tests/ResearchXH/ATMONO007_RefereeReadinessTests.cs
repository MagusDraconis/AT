...
/// <summary>
/// AT-MONO007 — Referee-Readiness Resolution (A02-A09). Resolve the hostile-referee findings of MONO005
...
/// </summary>
public class ATMONO007_RefereeReadinessTests : ResearchTestBase
{
    public ATMONO007_RefereeReadinessTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void ATMONO0070_ActualizationDerivedDifferencePrimitive()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATMONO0070: Actualization is derived; Difference remains primitive [A01/A02]");
    ...
    [Fact]
    public void ATMONO0071_BoundarySeparationAndScope()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATMONO0071: boundaries are separated from emergent content [A04/A07/VALID001]");
    ...
    [Fact]
    public void ATMONO0072_CompletenessRefereeSafe()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATMONO0072: completeness claims are referee-safe [A03/A05/A08/A09]");
