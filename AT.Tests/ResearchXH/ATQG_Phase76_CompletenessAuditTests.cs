...
/// <summary>
/// AT-QG Phase 76 — completeness audit. Audits six domains against the network description.
/// Classify: DERIVED / COMPATIBLE / UNKNOWN / MISSING.
///
/// Tests: ATQG760 (classification), ATQG761 (derived vs compatible), ATQG762 (remaining gaps).
/// </summary>
public class ATQG_Phase76_CompletenessAuditTests : ResearchTestBase
{
    public ATQG_Phase76_CompletenessAuditTests(ITestOutputHelper o) : base(o) { }

    // ── ATQG760: classification ────────────────────────────────────────────────────

    [Fact]
    public void ATQG760_Classification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG760: audit six domains against the network");
    ...
    // ── ATQG761: derived vs compatible ─────────────────────────────────────────────

    [Fact]
    public void ATQG761_DerivedVsCompatible()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG761: GR is derived; QM/gauge/fermions/SM are compatible");
    ...
    // ── ATQG762: remaining gaps ─────────────────────────────────────────────────────

    [Fact]
    public void ATQG762_RemainingGaps()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG762: what is still outside the network?");
