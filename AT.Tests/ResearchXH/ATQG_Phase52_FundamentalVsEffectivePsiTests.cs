...
/// <summary>
/// AT-QG Phase 52 — is ψ fundamental or effective? Determines whether ψ must exist microscopically or can emerge
/// in the continuum limit. Classify: FUNDAMENTAL / EFFECTIVE / UNDECIDED.
///
/// Tests: ATQG520 (coarse-graining preserves spin), ATQG521 (no collective tensor mode), ATQG522 (classification).
/// </summary>
public class ATQG_Phase52_FundamentalVsEffectivePsiTests : ResearchTestBase
{
    public ATQG_Phase52_FundamentalVsEffectivePsiTests(ITestOutputHelper o) : base(o) { }

    // ── ATQG520: coarse-graining preserves spin ─────────────────────────────────────

    [Fact]
    public void ATQG520_CoarseGrainingPreservesSpin()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG520: averaging scalars gives a scalar, never a tensor");
    ...
    // ── ATQG521: no collective tensor mode from scalar constituents ─────────────────

    [Fact]
    public void ATQG521_NoCollectiveTensorMode()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG521: scalar constituents have no transverse-traceless collective mode");
    ...
    // ── ATQG522: classification ───────────────────────────────────────────────────────

    [Fact]
    public void ATQG522_Classification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG522: FUNDAMENTAL / EFFECTIVE / UNDECIDED?");
