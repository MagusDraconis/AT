...
/// <summary>
/// AT-MONO110A — Physics-Focused Monograph Re-audit. Create a physics-focused publication: keep
...
/// physics.
/// </summary>
public class ATMONO110A_PhysicsFocusedMonographTests : ResearchTestBase
{
    public ATMONO110A_PhysicsFocusedMonographTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void ATMONO110A0_RevisedStructure()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATMONO110A0: the revised physics-focused chapter structure");
    ...
    [Fact]
    public void ATMONO110A1_UniversalityAsFutureWork()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATMONO110A1: Universality as future work, boundary/validation retained");
    ...
    [Fact]
    public void ATMONO110A2_PageEstimateAndDetermination()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATMONO110A2: the page estimate and the determination");
