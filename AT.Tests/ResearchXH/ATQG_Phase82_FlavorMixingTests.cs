...
/// <summary>
/// AT-QG Phase 82 — Origin of flavor mixing. Determines whether CKM/PMNS mixing can emerge from network family
/// indices. Classify: DERIVED / COMPATIBLE / NEW SECTOR.
///
/// Tests: ATQG820 (family-index dynamics + link-state mixing), ATQG821 (oscillations + rotations + CKM/PMNS),
/// ATQG822 (classification).
/// </summary>
public class ATQG_Phase82_FlavorMixingTests : ResearchTestBase
{
    public ATQG_Phase82_FlavorMixingTests(ITestOutputHelper o) : base(o) { }

    // ── ATQG820: family-index dynamics, link-state mixing ─────────────────────────

    [Fact]
    public void ATQG820_FamilyIndexDynamics()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG820: can family indices mix via off-diagonal couplings?");
    ...
    // ── ATQG821: oscillations, rotations, CKM/PMNS interpretation ─────────────────

    [Fact]
    public void ATQG821_OscillationsAndRotations()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG821: flavor oscillations, mass rotations, CKM/PMNS parameters");
    ...
    [Fact]
    public void ATQG822_Classification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG822: DERIVED / COMPATIBLE / NEW SECTOR?");
