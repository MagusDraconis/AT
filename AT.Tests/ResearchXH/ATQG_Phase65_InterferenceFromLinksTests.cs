...
/// <summary>
/// AT-QG Phase 65 — can quantum interference emerge from link phases?
/// Classify: MATCH / PARTIAL MATCH / NO MATCH.
///
/// Tests: ATQG650 (path amplitude + accumulation), ATQG651 (double-slit), ATQG652 (Born rule + classification).
/// </summary>
public class ATQG_Phase65_InterferenceFromLinksTests : ResearchTestBase
{
    public ATQG_Phase65_InterferenceFromLinksTests(ITestOutputHelper o) : base(o) { }

    // ── ATQG650: path amplitudes and phase accumulation ────────────────────────────

    [Fact]
    public void ATQG650_PathAmplitudeAndAccumulation()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG650: a path accumulates phase and carries the amplitude e^(iθ)");
    ...
    // ── ATQG651: double-slit interference ──────────────────────────────────────────

    [Fact]
    public void ATQG651_DoubleSlit()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG651: the double-slit pattern 2 + 2cos(Δθ) emerges");
    ...
    // ── ATQG652: Born rule + classification ─────────────────────────────────────────

    [Fact]
    public void ATQG652_BornRuleAndClassification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG652: Born rule consistency and classification");
