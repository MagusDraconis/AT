...
/// <summary>
/// AT-QG Phase 194 — Matter Deficit Origin. Can "matter = ρ̄ − ρ" be DERIVED from TRM (not postulated)?
...
/// </summary>
public class ATQG_Phase194_MatterDeficitOriginTests : ResearchTestBase
{
    public ATQG_Phase194_MatterDeficitOriginTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void ATQG1940_DeficitIsEnergyAndMass()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG1940: the deficit is the actualization (energy) deficit carrying rest mass");
    ...
    [Fact]
    public void ATQG1941_DeficitIsExactlyConserved()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG1941: deficit conservation (∫m dV = the conserved count deviation)");
    ...
    [Fact]
    public void ATQG1942_ClassificationDeficitOrigin()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG1942: matter-deficit origin classification");
