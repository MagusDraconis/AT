...
/// <summary>
/// AT-QG Phase 66 — origin of spin-1/2. Determines whether fermions emerge from the network.
/// Classify: DERIVED / COMPATIBLE / REQUIRES NEW PRIMITIVE.
///
/// Tests: ATQG660 (integer vs half-integer), ATQG661 (double cover), ATQG662 (classification).
/// </summary>
public class ATQG_Phase66_OriginOfSpinHalfTests : ResearchTestBase
{
    public ATQG_Phase66_OriginOfSpinHalfTests(ITestOutputHelper o) : base(o) { }

    // ── ATQG660: integer vs half-integer spin ──────────────────────────────────────

    [Fact]
    public void ATQG660_IntegerVsHalfInteger()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG660: the network hosts integer spins; fermions are half-integer");
    ...
    // ── ATQG661: double cover required ─────────────────────────────────────────────

    [Fact]
    public void ATQG661_DoubleCoverRequired()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG661: spinors require a double cover (spin structure)");
    ...
    // ── ATQG662: classification ───────────────────────────────────────────────────────

    [Fact]
    public void ATQG662_Classification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG662: DERIVED / COMPATIBLE / REQUIRES NEW PRIMITIVE?");
