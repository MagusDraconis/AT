...
/// <summary>
/// AT-QG Phase 56 — origin of Weyl-capable links. Determines why links carry a non-conformal (traceless) DOF.
/// Classify: FORCED / PREFERRED / CONTINGENT.
///
/// Tests: ATQG560 (rank-2 decomposition), ATQG561 (link completeness), ATQG562 (classification).
/// </summary>
public class ATQG_Phase56_OriginOfWeylLinksTests : ResearchTestBase
{
    public ATQG_Phase56_OriginOfWeylLinksTests(ITestOutputHelper o) : base(o) { }

    // ── ATQG560: rank-2 link tensor always has a traceless part ────────────────────

    [Fact]
    public void ATQG560_Rank2Decomposition()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG560: a link tensor decomposes into trace + traceless (Weyl)");
    ...
    // ── ATQG561: link completeness forces the Weyl capacity ────────────────────────

    [Fact]
    public void ATQG561_LinkCompleteness()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG561: a complete link carries the full rank-2 relation");
    ...
    // ── ATQG562: classification ───────────────────────────────────────────────────────

    [Fact]
    public void ATQG562_Classification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG562: FORCED / PREFERRED / CONTINGENT?");
