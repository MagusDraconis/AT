...
/// <summary>
/// AT-QG Phase 280 — Final Frontier Inventory. Review QG223-QG279, classify every remaining issue, and
/// produce the definitive post-QG279 frontier list ranked by importance. Inventory only, no derivations.
/// </summary>
public class ATQG_Phase280_FinalFrontierInventoryTests : ResearchTestBase
{
    public ATQG_Phase280_FinalFrontierInventoryTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void ATQG2800_Inventory()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG2800: the definitive post-QG279 frontier list");
    ...
    [Fact]
    public void ATQG2801_Classification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG2801: the classification of each remaining issue");
    ...
    [Fact]
    public void ATQG2802_Summary()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG2802: the definitive frontier summary");
