...
/// <summary>
/// AT-QG Phase 175 — Precision electroweak origin. Known: QG162 (couplings, sin²θ_W), QG168 (MW, MZ,
...
/// deterministic.
///
/// Tests: ATQG1750 (effective mixing angle + Z width), ATQG1751 (W and Higgs widths + R_b),
/// ATQG1752 (forward-backward asymmetries + classification).
/// </summary>
public class ATQG_Phase175_PrecisionElectroweakOriginTests : ResearchTestBase
{
    public ATQG_Phase175_PrecisionElectroweakOriginTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void ATQG1750_EffectiveMixingAngleAndZWidth()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG1750: effective mixing angle and the Z width");
    ...
    [Fact]
    public void ATQG1751_WAndHiggsWidthsAndRb()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG1751: W and Higgs widths, and R_b");
    ...
    [Fact]
    public void ATQG1752_AsymmetriesAndClassification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG1752: forward-backward asymmetries and classification");
