...
/// <summary>
/// AT-QG Phase 227 — Initial Conditions Origin. Derive why the universe starts in its specific initial
...
/// </summary>
public class ATQG_Phase227_InitialConditionsOriginTests : ResearchTestBase
{
    public ATQG_Phase227_InitialConditionsOriginTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void ATQG2270_StationarityAndScaleFreeness()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG2270: the initial state must be a stationary, scale-free fixed point");
    ...
    [Fact]
    public void ATQG2271_MinimumInformationAndAttractor()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG2271: minimum-information selection and the attractor's erasure of initial data");
    ...
    [Fact]
    public void ATQG2272_ClassificationInitialConditionOrigin()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG2272: classification — INITIAL-CONDITION ORIGIN");
