...
/// <summary>
/// AT-QG Phase 312 — Adversarial Spectrum Audit. Try to break the operator basis: craft fake spectra
...
/// </summary>
public class ATQG_Phase312_AdversarialSpectrumAuditTests : ResearchTestBase
{
    public ATQG_Phase312_AdversarialSpectrumAuditTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void ATQG3120_FakeSpectra()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG3120: the three adversarial fakes");
    ...
    [Fact]
    public void ATQG3121_OperatorTriggering()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG3121: can the fakes trigger the operators?");
    ...
    public void ATQG3122_Classification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG3122: the adversarial robustness determination");
