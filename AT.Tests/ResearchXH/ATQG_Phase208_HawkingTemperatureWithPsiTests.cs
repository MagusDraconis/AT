...
/// <summary>
/// AT-QG Phase 208 — Hawking Temperature With Psi. Determine whether the ψ sector changes the Hawking
...
/// </summary>
public class ATQG_Phase208_HawkingTemperatureWithPsiTests : ResearchTestBase
{
    public ATQG_Phase208_HawkingTemperatureWithPsiTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void ATQG2080_SurfaceGravityAndTemperatureScaling()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG2080: surface gravity and temperature scaling in the ψ sector");
    ...
    [Fact]
    public void ATQG2081_PsiCorrectionIsPrefactorial()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG2081: the ψ correction is a prefactor — the T ∝ 1/R law is invariant");
    ...
    [Fact]
    public void ATQG2082_ClassificationHawkingOrigin()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG2082: classification — HAWKING ORIGIN");
