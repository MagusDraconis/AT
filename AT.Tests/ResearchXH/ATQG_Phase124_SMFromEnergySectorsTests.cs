...
/// <summary>
/// AT-QG Phase 124 — Standard Model sectors from energy hierarchy. QG123 found an
...
///
/// Tests: ATQG1240 (sector ordering), ATQG1241 (family emergence + hierarchy formation),
/// ATQG1242 (sector transitions + observable-sector selection + classification).
/// </summary>
public class ATQG_Phase124_SMFromEnergySectorsTests : ResearchTestBase
{
    public ATQG_Phase124_SMFromEnergySectorsTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void ATQG1240_SectorOrderingAndEmergence()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG1240: sector ordering along the energy hierarchy");
    ...
    [Fact]
    public void ATQG1241_FamilyEmergenceAndHierarchyFormation()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG1241: family emergence and hierarchy formation");
    ...
    [Fact]
    public void ATQG1242_SectorTransitionsSelectionAndClassification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG1242: sector transitions, observable selection, classification");
