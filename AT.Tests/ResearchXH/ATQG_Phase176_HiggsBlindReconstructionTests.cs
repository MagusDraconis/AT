...
///
/// Tests: ATQG1760 (Path A: pure allowed-list reconstruction), ATQG1761 (Path B occupancy cross-check
/// + derived ratios), ATQG1762 (dependency graph + blindness proof + classification).
/// </summary>
public class ATQG_Phase176_HiggsBlindReconstructionTests : ResearchTestBase
{
    public ATQG_Phase176_HiggsBlindReconstructionTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void ATQG1760_BlindPathAAllowedListOnly()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG1760: Path A — pure allowed-list reconstruction");
    ...
    [Fact]
    public void ATQG1761_OccupancyCrossCheckAndRatios()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG1761: occupancy-geometry cross-check and derived ratios");
    ...
    [Fact]
    public void ATQG1762_DependencyGraphBlindnessAndClassification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG1762: dependency graph, blindness proof, and classification");
