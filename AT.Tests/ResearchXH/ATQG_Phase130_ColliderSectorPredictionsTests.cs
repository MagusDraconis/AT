...
/// <summary>
/// AT-QG Phase 130 — Collider-accessible sector prediction. QG124-129 established that higher-energy
...
/// collider energies.
///
/// Tests: ATQG1300 (sector thresholds + ladder accessibility), ATQG1301 (decay spectra + observable
/// signatures), ATQG1302 (LHC/FCC reach + classification).
/// </summary>
public class ATQG_Phase130_ColliderSectorPredictionsTests : ResearchTestBase
{
    public ATQG_Phase130_ColliderSectorPredictionsTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void ATQG1300_SectorThresholdsAndLadderAccessibility()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG1300: sector thresholds and ladder accessibility");
    ...
    [Fact]
    public void ATQG1301_DecaySpectraAndObservableSignatures()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG1301: decay spectra and observable signatures");
    ...
    [Fact]
    public void ATQG1302_LhcFccReachAndClassification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG1302: LHC/FCC reach and classification");
