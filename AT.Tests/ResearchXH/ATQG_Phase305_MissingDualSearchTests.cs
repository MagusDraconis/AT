...
/// <summary>
/// AT-QG Phase 305 — Missing Dual Search. Find physics quantities lacking explicit tensor/scalar
/// duals; predict the missing dual observables. No observables, no target values, D96 only,
/// deterministic.
/// </summary>
public class ATQG_Phase305_MissingDualSearchTests : ResearchTestBase
{
    public ATQG_Phase305_MissingDualSearchTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void ATQG3050_MatrixTensorDuals()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG3050: matrix/tensor quantities → scalar angle/mass sets");
    ...
    [Fact]
    public void ATQG3051_ScalarToTensorDuals()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG3051: scalar quantities → tensor rotation/stress/polarization");
    ...
    [Fact]
    public void ATQG3052_Classification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG3052: the missing-dual determination");
