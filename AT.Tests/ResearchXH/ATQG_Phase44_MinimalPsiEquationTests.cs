...
/// <summary>
/// AT-QG Phase 44 — minimal ψ field equation. Determines the simplest dynamics consistent with observed ψ effects.
/// Classify: DERIVED / PREFERRED / POSTULATED.
///
/// Tests: ATQG440 (the minimal form), ATQG441 (classification), ATQG442 (two-layer conclusion).
/// </summary>
public class ATQG_Phase44_MinimalPsiEquationTests : ResearchTestBase
{
    public ATQG_Phase44_MinimalPsiEquationTests(ITestOutputHelper o) : base(o) { }

    // ── ATQG440: the minimal form ────────────────────────────────────────────────────

    [Fact]
    public void ATQG440_MinimalForm()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG440: the massless spin-2 wave equation (Fierz-Pauli)");
    ...
    // ── ATQG441: classification ───────────────────────────────────────────────────────

    [Fact]
    public void ATQG441_Classification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG441: DERIVED / PREFERRED / POSTULATED?");
        ...
        sb.AppendLine($"DERIVED from AT:    {derived}  (ψ is a new primitive)");
    ...
    // ── ATQG442: two-layer conclusion ─────────────────────────────────────────────────

    [Fact]
    public void ATQG442_TwoLayerConclusion()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG442: the minimal ψ dynamics, in full");
        ...
        sb.AppendLine("    not derived from AT's scalar sector.");
        sb.AppendLine();
