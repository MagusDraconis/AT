...
/// <summary>
/// AT-QG Phase 270 — Distinction Origin Audit. What is being distinguished, and does distinction arise
/// from structure, actualization, or a deeper principle? D96 only, no observables.
/// </summary>
public class ATQG_Phase270_DistinctionOriginAuditTests : ResearchTestBase
{
    public ATQG_Phase270_DistinctionOriginAuditTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void ATQG2700_PositionCandidates()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG2700: causal vs network position");
    ...
    [Fact]
    public void ATQG2701_DifferenceStructure()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG2701: the difference structure — what is distinguished");
    ...
    [Fact]
    public void ATQG2702_Classification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG2702: the distinction-origin determination");
