...
/// each as KNOWN GR-LIKE / AT-SPECIFIC / UNDECIDED.
///
/// Tests: G4-O00 (curvature-density + Poisson, AT-specific), G4-O01 (acceleration + redshift,
...
public class G4O_Phase0_PhysicalObservablesTests : ResearchTestBase
{
    ...
    // ── G4-O00: curvature-density relation + native Poisson (AT-SPECIFIC) ─────────────
    ...
    public void G4_O00_CurvatureDensityAndPoisson()
    {
        ...
        sb.AppendLine();
        sb.AppendLine("CLASSIFICATION: AT-SPECIFIC (algebraic curvature-density relation; curvature-sourced Poisson).");
    ...
    public void G4_O01_AccelerationAndRedshift()
    {
        ...
        sb.AppendLine("with the AT-specific potential Φ = (1/d)ln ρ).");
        Output.WriteLine(sb.ToString());
    ...
    public void G4_O02_LensingExpansionAndDimension()
    {
        ...
        sb.AppendLine($"dimension dependence: Φ and a scale as 1/d — AT-specific conformal-weight dependence");
        sb.AppendLine();
        sb.AppendLine("CLASSIFICATION: lensing + expansion KNOWN GR-LIKE; the 1/d conformal-weight scaling is AT-SPECIFIC.");
        Output.WriteLine(sb.ToString());
