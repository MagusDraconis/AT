...
/// <summary>
/// AT-QG Phase 290 — Framework Inventory Audit. Are the QG289 framework items {η, 3+1, π} equally
...
/// </summary>
public class ATQG_Phase290_FrameworkInventoryAuditTests : ResearchTestBase
{
    public ATQG_Phase290_FrameworkInventoryAuditTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void ATQG2900_DimensionDerived()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG2900: the dimensionality 3+1 is DERIVED, not fundamental");
    ...
    [Fact]
    public void ATQG2901_EtaAndPiFramework()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG2901: η and π are irreducible FRAMEWORK references");
    ...
    [Fact]
    public void ATQG2902_MinimumIrreducibleFramework()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG2902: the minimum irreducible framework {η, π}");
