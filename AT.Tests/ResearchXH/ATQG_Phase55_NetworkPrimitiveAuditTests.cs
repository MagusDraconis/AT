...
/// <summary>
/// AT-QG Phase 55 — are Q-events and ψ truly independent? Determines whether (nodes, links) can be one primitive.
/// Classify: INDEPENDENT / DUAL / UNIFIED.
///
/// Tests: ATQG550 (node/link completeness), ATQG551 (one network primitive), ATQG552 (classification).
/// </summary>
public class ATQG_Phase55_NetworkPrimitiveAuditTests : ResearchTestBase
{
    public ATQG_Phase55_NetworkPrimitiveAuditTests(ITestOutputHelper o) : base(o) { }

    // ── ATQG550: node-only / link-only / node+link ─────────────────────────────────

    [Fact]
    public void ATQG550_Completeness()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG550: nodes alone and links alone are both incomplete");
    ...
    // ── ATQG551: one network primitive ──────────────────────────────────────────────

    [Fact]
    public void ATQG551_OneNetworkPrimitive()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG551: (nodes, links) = one primitive");
    ...
    // ── ATQG552: classification ───────────────────────────────────────────────────────

    [Fact]
    public void ATQG552_Classification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG552: INDEPENDENT / DUAL / UNIFIED?");
