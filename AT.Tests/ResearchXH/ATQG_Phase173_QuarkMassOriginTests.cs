...
///
/// Tests: ATQG1730 (up/down anchors + s/d ratio), ATQG1731 (strange/charm/bottom + b/d ratio),
/// ATQG1732 (top + t/u ratio + all-quark consistency + classification).
/// </summary>
public class ATQG_Phase173_QuarkMassOriginTests : ResearchTestBase
{
    public ATQG_Phase173_QuarkMassOriginTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void ATQG1730_UpDownAnchorsAndStrangeRatio()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG1730: up/down anchors and the strange ratio");
    ...
    [Fact]
    public void ATQG1731_StrangeCharmBottomAndBottomRatio()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG1731: strange, charm, bottom and the b/d ratio");
    ...
    [Fact]
    public void ATQG1732_TopAllQuarksAndClassification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG1732: top, all-quark consistency, and classification");
