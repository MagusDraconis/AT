...
/// <summary>
/// AT-QG Phase 0 — unify actualization dynamics and gravity. Tests whether the microscopic actualization
...
///
/// Tests: ATQG00 (the α=0 attractor = the log-deficit density), ATQG01 (this ρ reproduces all four gravity
///        requirements), ATQG02 (classification FULL/PARTIAL/NO MATCH).
/// </summary>
public class ATQG_Phase0_ActualizationToGravityTests : ResearchTestBase
{
    public ATQG_Phase0_ActualizationToGravityTests(ITestOutputHelper o) : base(o) { }

    private const int D = 3;

    // ── ATQG00: the α=0 actualization attractor IS the log-deficit density ──────────

    [Fact]
    public void ATQG00_EntropyAttractorIsLogDeficit()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG00: the α=0 actualization attractor is exactly the log-deficit density");
    ...
    // ── ATQG01: the actualization density reproduces all four gravity requirements ───

    [Fact]
    public void ATQG01_ReproducesGravityRequirements()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG01: the actualization-generated ρ reproduces all four gravity requirements");
    ...
    // ── ATQG02: classification ───────────────────────────────────────────────────────

    [Fact]
    public void ATQG02_Classification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG02: does the actualization program generate the gravity-required ρ?");
        ...
        sb.AppendLine("    structure (G from ρ derivatives), and the flat rotation curve — all four verified (ATQG01).");
