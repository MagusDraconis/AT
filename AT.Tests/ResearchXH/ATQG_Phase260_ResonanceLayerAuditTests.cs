...
/// <summary>
/// AT-QG Phase 260 — Resonance Layer Audit. Determine whether a hidden resonance layer exists between
/// D96 and the observables, or whether it was collapsed into the D96 moment set.
/// </summary>
public class ATQG_Phase260_ResonanceLayerAuditTests : ResearchTestBase
{
    public ATQG_Phase260_ResonanceLayerAuditTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void ATQG2600_SpectralStructure()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG2600: the D96 spectral structure (the raw material)");
    ...
    [Fact]
    public void ATQG2601_BeatIdentities()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG2601: the collapsed beat identities among the D96 moments");
    ...
    [Fact]
    public void ATQG2602_Classification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG2602: the layer determination");
