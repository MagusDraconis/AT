...
/// <summary>
/// AT-QG Phase 240 — Cosmology Blind Reproduction. Hide the observed n_s and peak values; recompute from
...
/// </summary>
public class ATQG_Phase240_CosmologyBlindReproductionTests : ResearchTestBase
{
    public ATQG_Phase240_CosmologyBlindReproductionTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void ATQG2400_PredictionsLockedFromD96Only()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG2400: the predictions are locked from D96 primitives only");
    ...
    [Fact]
    public void ATQG2401_ComparisonOnlyAfterLock()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG2401: compare only after the predictions are locked");
    ...
    [Fact]
    public void ATQG2402_ClassificationBlindSuccess()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG2402: classification — BLIND SUCCESS");
