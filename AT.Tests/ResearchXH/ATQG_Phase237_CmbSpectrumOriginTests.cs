...
/// <summary>
/// AT-QG Phase 237 — CMB Spectrum Origin. Derive the observed CMB spectrum from Q-events: seed power
...
/// </summary>
public class ATQG_Phase237_CmbSpectrumOriginTests : ResearchTestBase
{
    public ATQG_Phase237_CmbSpectrumOriginTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void ATQG2370_OctaveHierarchyTilt()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG2370: the octave-hierarchy tilt 1 − n_s = ln(span)/(Σm − #d)");
    ...
    [Fact]
    public void ATQG2371_SpectralIndexAndRunning()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG2371: n_s = 0.96497 (0.007%) and running = 0");
    ...
    [Fact]
    public void ATQG2372_ClassificationPartialOrigin()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG2372: classification — PARTIAL ORIGIN (n_s derived, acoustic structure partial)");
