...
/// <summary>
/// AT-QG Phase 78 — origin of SU(3) color. Determines whether color charge emerges from link structure.
/// Classify: DERIVED / COMPATIBLE / NEW SECTOR.
///
/// Tests: ATQG780 (different Lie algebra), ATQG781 (link carries SU(3)), ATQG782 (classification).
/// </summary>
public class ATQG_Phase78_ColorOriginTests : ResearchTestBase
{
    public ATQG_Phase78_ColorOriginTests(ITestOutputHelper o) : base(o) { }

    // ── ATQG780: SU(3) is a different Lie algebra ─────────────────────────────────

    [Fact]
    public void ATQG780_DifferentLieAlgebra()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG780: SU(3) does not emerge from U(1) or SU(2)");
    ...
    // ── ATQG781: the link can carry SU(3) ─────────────────────────────────────────

    [Fact]
    public void ATQG781_LinkCarriesSu3()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG781: the link carries an SU(3) connection, like it carries U(1)");
    ...
    // ── ATQG782: classification ───────────────────────────────────────────────────────

    [Fact]
    public void ATQG782_Classification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG782: DERIVED / COMPATIBLE / NEW SECTOR?");
