...
/// <summary>
/// AT-QG Phase 267 — Conservation Principle Audit. Are all conservation laws manifestations of one
/// deeper principle? D96 only, no observables.
/// </summary>
public class ATQG_Phase267_ConservationPrincipleAuditTests : ResearchTestBase
{
    public ATQG_Phase267_ConservationPrincipleAuditTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void ATQG2670_ConservationLaws()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG2670: the six conservation laws");
    ...
    [Fact]
    public void ATQG2671_CommonProjection()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG2671: the common projection — conservation of the actualization count N");
    ...
    [Fact]
    public void ATQG2672_Classification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG2672: the unification determination");
