...
/// <summary>
/// AT-QG Phase 281 — Boundary Condition Audit. Is observable structure determined by boundary conditions
/// or energy content? Does resonance emerge from conservation plus boundary conditions?
/// </summary>
public class ATQG_Phase281_BoundaryConditionAuditTests : ResearchTestBase
{
    public ATQG_Phase281_BoundaryConditionAuditTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void ATQG2810_SpectrumIsBoundaryDetermined()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG2810: the D96 spectrum is boundary-determined");
    ...
    [Fact]
    public void ATQG2811_ConservationTimesBoundary()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG2811: conservation × boundary = the total");
    ...
    [Fact]
    public void ATQG2812_Classification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG2812: the boundary-condition determination");
