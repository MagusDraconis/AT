...
/// <summary>
/// AT-QG Phase 98 — Physical meaning of network angles. Determines whether network angles correspond to physical
/// mixing angles and internal symmetry rotations. Classify: NO RELATION / PARTIAL RELATION / ANGLE ORIGIN.
///
/// Tests: ATQG980 (triangle + orientation angles), ATQG981 (CKM/PMNS + gauge rotations), ATQG982 (classification).
/// </summary>
public class ATQG_Phase98_NetworkAnglesTests : ResearchTestBase
{
    public ATQG_Phase98_NetworkAnglesTests(ITestOutputHelper o) : base(o) { }

    // ── ATQG980: triangle angles, link orientation ────────────────────────────────

    [Fact]
    public void ATQG980_TriangleAndOrientation()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG980: do real geometric network angles exist?");
    ...
    // ── ATQG981: CKM/PMNS analogs, gauge rotations ────────────────────────────────

    [Fact]
    public void ATQG981_InternalVsGeometric()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG981: are mixing/gauge angles geometric or internal?");
    ...
    // ── ATQG982: classification ───────────────────────────────────────────────────

    [Fact]
    public void ATQG982_Classification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG982: NO RELATION / PARTIAL RELATION / ANGLE ORIGIN?");
