...
/// <summary>
/// AT-QG Phase 249 — Final TOE Audit. Re-evaluate the TOE status after QG223-248 using the external
...
/// </summary>
public class ATQG_Phase249_FinalToeAuditTests : ResearchTestBase
{
    public ATQG_Phase249_FinalToeAuditTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void ATQG2490_TenCriteriaFinal()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG2490: the ten TOE criteria (final)");
    ...
    [Fact]
    public void ATQG2491_FourDeterminations()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG2491: the four determination questions");
    ...
    [Fact]
    public void ATQG2492_ClassificationAndCriticisms()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG2492: classification and the top-10 criticisms");
