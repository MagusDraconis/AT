...
/// <summary>
/// AT-QG Phase 282 — Boundary Origin Audit. What is the origin of the boundary (N=96 closure)? Is it
/// derived or primitive? D96 only, no formulas.
/// </summary>
public class ATQG_Phase282_BoundaryOriginAuditTests : ResearchTestBase
{
    public ATQG_Phase282_BoundaryOriginAuditTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void ATQG2820_AttractorClosure()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG2820: the N=96 attractor as the closure");
    ...
    [Fact]
    public void ATQG2821_NotAMenuChoice()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG2821: the D96 selection is the attractor, not a menu");
    ...
    [Fact]
    public void ATQG2822_Classification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG2822: the boundary-origin determination");
