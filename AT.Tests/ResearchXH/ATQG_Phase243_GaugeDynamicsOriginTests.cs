...
/// <summary>
/// AT-QG Phase 243 — Gauge Dynamics Origin. Derive interaction dynamics from the same D96 structure
/// that gives the symmetry groups. No new primitives, deterministic. Closes QG242's hosted/OPEN
/// dynamics items.
/// </summary>
public class ATQG_Phase243_GaugeDynamicsOriginTests : ResearchTestBase
{
    public ATQG_Phase243_GaugeDynamicsOriginTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void ATQG2430_GeneratorActionAndCouplings()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG2430: the interaction IS the generator action; the couplings are D96-derived");
    ...
    [Fact]
    public void ATQG2431_InteractionEquations()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG2431: the three interaction equations — QED, weak, strong");
    ...
    [Fact]
    public void ATQG2432_ClassificationPartialOrigin()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG2432: classification — PARTIAL ORIGIN");
