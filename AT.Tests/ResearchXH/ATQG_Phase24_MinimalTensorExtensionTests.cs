...
/// <summary>
/// AT-QG Phase 24 — minimal tensor extension audit. Ranks the four candidate new primitives by the additional
...
///
/// Tests: ATQG240 (d.o.f. census & minimality), ATQG241 (observable requirements), ATQG242 (classification).
/// </summary>
public class ATQG_Phase24_MinimalTensorExtensionTests : ResearchTestBase
{
    public ATQG_Phase24_MinimalTensorExtensionTests(ITestOutputHelper o) : base(o) { }

    // ── ATQG240: candidate census — which primitive is smallest AND spin-2-capable? ───

    [Fact]
    public void ATQG240_CandidateCensus()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG240: candidate new primitives ranked by d.o.f. and spin");
    ...
    // ── ATQG241: observable requirements — what do lensing/GW/Hawking each need? ─────

    [Fact]
    public void ATQG241_ObservableRequirements()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG241: minimal additional d.o.f. to restore all three observables");
    ...
    // ── ATQG242: classification ───────────────────────────────────────────────────────

    [Fact]
    public void ATQG242_Classification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG242: classification of the minimal tensor extension");
