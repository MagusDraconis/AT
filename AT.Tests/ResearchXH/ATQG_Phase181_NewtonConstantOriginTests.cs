...
/// <summary>
/// AT-QG Phase 181 — Newton constant origin. Known: QG161-163 (gauge sector), QG168 (MW, MZ),
...
///
/// Tests: ATQG1810 (Planck mass from the cube of the occupation-weighted spectral content),
/// ATQG1811 (Newton constant from M_Pl in natural and SI units), ATQG1812 (consistency + classification).
/// </summary>
public class ATQG_Phase181_NewtonConstantOriginTests : ResearchTestBase
{
    public ATQG_Phase181_NewtonConstantOriginTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void ATQG1810_PlanckMassFromSpectralContentCube()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG1810: the Planck mass from the cube of the spectral content");
    ...
    [Fact]
    public void ATQG1811_NewtonConstantFromPlanckMass()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG1811: Newton's constant from the derived Planck mass");
    ...
    [Fact]
    public void ATQG1812_ConsistencyAndClassification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG1812: consistency, dependency structure, and classification");
