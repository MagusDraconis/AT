...
/// <summary>
/// AT-QG Phase 298 — First Peak Origin Audit. Why does only ℓ₁ require an extra factor (5/4) while
/// the peak ratios need none? Is 5/4 a missing structural projection? No observables, no target
/// values, D96 only, deterministic.
/// </summary>
public class ATQG_Phase298_FirstPeakOriginAuditTests : ResearchTestBase
{
    public ATQG_Phase298_FirstPeakOriginAuditTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void ATQG2980_BoundaryProjection()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG2980: 5/4 is the boundary projection of the fundamental");
    ...
    [Fact]
    public void ATQG2981_OnlyL1Absolute()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG2981: only ℓ₁ is absolute — the ratios are relative");
    ...
    [Fact]
    public void ATQG2982_Classification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG2982: the first-peak origin determination");
