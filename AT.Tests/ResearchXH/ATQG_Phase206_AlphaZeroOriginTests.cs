...
/// <summary>
/// AT-QG Phase 206 — Alpha Zero Origin. Derive α = 0 (the flat-rotation-curve deficit exponent) from
/// TRM/D96 instead of assuming it. No new primitives, deterministic.
/// </summary>
public class ATQG_Phase206_AlphaZeroOriginTests : ResearchTestBase
{
    public ATQG_Phase206_AlphaZeroOriginTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void ATQG2060_FlatRotationRequiresAlphaZero()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG2060: flat rotation requires α = 0 exactly");
    ...
    [Fact]
    public void ATQG2061_LogDeficitSelfSimilarAndStable()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG2061: the log deficit is self-similar and α = 0 is the unique stable point");
    ...
    [Fact]
    public void ATQG2062_ClassificationAlphaZeroOrigin()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG2062: classification — ALPHA-ZERO ORIGIN");
