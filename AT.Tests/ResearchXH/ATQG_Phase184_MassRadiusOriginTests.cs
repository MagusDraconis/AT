...
/// <summary>
/// AT-QG Phase 184 — Mass-radius origin. Known: QG12 (S ∝ Area from boundary counting), QG13
...
///
/// Tests: ATQG1840 (the per-octave deficit gives M ∝ R), ATQG1841 (QG13's volume assignment was the
/// compact-void assumption; the counting-measure deficit is per-octave), ATQG1842 (Hawking restored via
/// first law + classification).
/// </summary>
public class ATQG_Phase184_MassRadiusOriginTests : ResearchTestBase
{
    public ATQG_Phase184_MassRadiusOriginTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void ATQG1840_PerOctaveDeficitGivesMassProportionalToRadius()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG1840: the per-octave deficit gives M ∝ R (radius-proportional mass)");
    ...
    [Fact]
    public void ATQG1841_CompactVoidWasTheVolumeAssumption()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG1841: QG13's volume assignment was the compact-void assumption");
    ...
    [Fact]
    public void ATQG1842_HawkingRestoredAndClassification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG1842: Hawking restored via first law, and classification");

        sb.AppendLine("ASSUMPTIONS: with the mass-radius relation M ∝ R (ATQG1840) and the horizon entropy");
