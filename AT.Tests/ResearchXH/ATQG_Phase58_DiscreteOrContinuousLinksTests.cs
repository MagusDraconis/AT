...
/// <summary>
/// AT-QG Phase 58 — discrete or continuous links? Determines whether links are discrete objects or continuous
/// fields. Classify: DISCRETE / CONTINUOUS / BOTH.
///
/// Tests: ATQG580 (microscopic discreteness), ATQG581 (continuum limit), ATQG582 (classification).
/// </summary>
public class ATQG_Phase58_DiscreteOrContinuousLinksTests : ResearchTestBase
{
    public ATQG_Phase58_DiscreteOrContinuousLinksTests(ITestOutputHelper o) : base(o) { }

    // ── ATQG580: microscopic discreteness ───────────────────────────────────────────

    [Fact]
    public void ATQG580_MicroscopicDiscreteness()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG580: links are quantized and countable at the microscopic level");
    ...
    // ── ATQG581: continuum limit ─────────────────────────────────────────────────────

    [Fact]
    public void ATQG581_ContinuumLimit()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG581: the continuum limit yields a smooth ψ field");
    ...
    // ── ATQG582: classification ───────────────────────────────────────────────────────

    [Fact]
    public void ATQG582_Classification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG582: DISCRETE / CONTINUOUS / BOTH?");
