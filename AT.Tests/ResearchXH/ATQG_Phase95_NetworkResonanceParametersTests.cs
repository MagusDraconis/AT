...
/// <summary>
/// AT-QG Phase 95 — Global resonance origin of parameters. Determines whether masses/couplings/mixing angles can be
/// interpreted as stable global resonance modes. Classify: NO RELATION / PARTIAL RELATION / RESONANCE ORIGIN.
///
/// Tests: ATQG950 (normal modes + link resonances), ATQG951 (actualization frequency + spectra + quantization),
/// ATQG952 (classification).
/// </summary>
public class ATQG_Phase95_NetworkResonanceParametersTests : ResearchTestBase
{
    public ATQG_Phase95_NetworkResonanceParametersTests(ITestOutputHelper o) : base(o) { }

    // ── ATQG950: network normal modes, link-state resonances ──────────────────────

    [Fact]
    public void ATQG950_NormalModesAndResonances()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG950: do normal modes / link resonances exist?");
    ...
    // ── ATQG951: actualization frequencies, discrete spectra, quantization ────────

    [Fact]
    public void ATQG951_FrequencySpectraQuantization()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG951: actualization frequency, discrete spectra, quantization");
    ...
    [Fact]
    public void ATQG952_Classification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG952: NO RELATION / PARTIAL RELATION / RESONANCE ORIGIN?");
