...
/// </summary>
public class ATQG_Phase193_PredictionRegistryTests : ResearchTestBase
{
    public ATQG_Phase193_PredictionRegistryTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void ATQG1930_ImmutableRegistryContents()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG1930: immutable prediction registry (P1, P2, P3)");
    ...
    [Fact]
    public void ATQG1931_FormulasAndInputsComplete()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG1931: formulas, inputs, uncertainty recorded for every prediction");
    ...
    [Fact]
    public void ATQG1932_ImmutabilityLockHolds()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG1932: immutability lock — only outcomes may be added, never values edited");
