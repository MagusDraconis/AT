...
/// <summary>
/// AT-QG Phase 310 — Anti-Organization Prediction. Maximally-unorganized systems (white noise, Poisson
...
/// </summary>
public class ATQG_Phase310_AntiOrganizationPredictionTests : ResearchTestBase
{
    public ATQG_Phase310_AntiOrganizationPredictionTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void ATQG3100_FiveUnorganizedSystems()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG3100: the five maximally-unorganized systems");
    ...
    [Fact]
    public void ATQG3101_OperatorSignatures()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG3101: the four operators on each unorganized system");
    ...
    public void ATQG3102_Classification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG3102: the organization-signature determination");
