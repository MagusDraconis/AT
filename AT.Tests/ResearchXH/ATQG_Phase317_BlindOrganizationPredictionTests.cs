...
/// </summary>
public class ATQG_Phase317_BlindOrganizationPredictionTests : ResearchTestBase
{
    public ATQG_Phase317_BlindOrganizationPredictionTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void ATQG3170_BlindProtocol()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG3170: the blind protocol — predict from stage 2, reveal at stage 8");
    ...
    [Fact]
    public void ATQG3171_EarlyLocksPredictFutureClass()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG3171: the early lock structure predicts the future maturity class");
    ...
    [Fact]
    public void ATQG3172_Classification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG3172: the blind-prediction determination");
