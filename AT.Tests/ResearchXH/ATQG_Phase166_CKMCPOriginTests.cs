...
/// <summary>
/// AT-QG Phase 166 — CKM CP origin. QG165 derived the CKM magnitudes. This phase derives the CKM
...
///
/// Tests: ATQG1660 (chiral automorphisms — reflection reverses rotation), ATQG1661 (spectral
/// circulation → δ_CP), ATQG1662 (Jarlskog invariant + classification).
/// </summary>
public class ATQG_Phase166_CKMCPOriginTests : ResearchTestBase
{
    public ATQG_Phase166_CKMCPOriginTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void ATQG1660_ChiralAutomorphisms()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG1660: chiral automorphisms — the parity-breaking structure");
    ...
    [Fact]
    public void ATQG1661_SpectralCirculationPhase()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG1661: spectral circulation → δ_CP");
    ...
    [Fact]
    public void ATQG1662_JarlskogInvariantAndClassification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG1662: Jarlskog invariant and classification");
