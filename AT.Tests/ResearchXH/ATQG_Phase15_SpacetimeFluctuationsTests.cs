...
/// <summary>
/// AT-QG Phase 15 — spacetime fluctuations. Tests whether Poisson event-count fluctuations δρ/ρ = 1/√N
/// propagate to metric and curvature fluctuations, and whether they are graviton-like (tensor) or scalar
/// (conformal).
///
/// Tests: ATQG150 (Poisson variance/scaling), ATQG151 (metric/curvature propagation + correlation length),
///        ATQG152 (classification: scalar, not graviton).
/// </summary>
public class ATQG_Phase15_SpacetimeFluctuationsTests : ResearchTestBase
{
    public ATQG_Phase15_SpacetimeFluctuationsTests(ITestOutputHelper o) : base(o) { }

    // ── ATQG150: Poisson variance — δρ/ρ = 1/√N ─────────────────────────────────────

    [Fact]
    public void ATQG150_PoissonVariance()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG150: Poisson event-count fluctuations — δρ/ρ = 1/√N");
    ...
    // ── ATQG151: metric and curvature inherit the fluctuation ──────────────────────

    [Fact]
    public void ATQG151_MetricCurvaturePropagation()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG151: δρ propagates to δg and δR");
    ...
    [Fact]
    public void ATQG152_Classification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG152: are the fluctuations graviton-like (tensor) or scalar (conformal)?");
        ...
        sb.AppendLine("  • The fluctuations EMERGE statistically: Poisson δρ/ρ = 1/√N propagates to δg and δR (ATQG150/151),");
        ...
        sb.AppendLine("    dynamical Weyl/ψ-field), which AT does not provide.");
        Output.WriteLine(sb.ToString());
