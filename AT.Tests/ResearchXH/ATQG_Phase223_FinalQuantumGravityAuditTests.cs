...
/// <summary>
/// AT-QG Phase 223 — Final Quantum Gravity Audit. Re-evaluate the QG status after QG222 (native metric
/// dynamics) and adjudicate the ψ origin status. Audit only — no new derivations, no new physics.
/// </summary>
public class ATQG_Phase223_FinalQuantumGravityAuditTests : ResearchTestBase
{
    public ATQG_Phase223_FinalQuantumGravityAuditTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void ATQG2230_SixCriteriaComplete()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG2230: the six criteria — all hold after QG222");
    ...
    [Fact]
    public void ATQG2231_PsiStatusAdjudication()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG2231: the ψ origin status — boundary and tensor-sector question, NOT a blocker");
    ...
    [Fact]
    public void ATQG2232_ClassificationCompleteQg()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG2232: classification — COMPLETE QG");
