...
/// <summary>
/// AT-QG Phase 171 — Muon g-2 origin. The established chain is D96 → couplings → CKM → PMNS →
...
///
/// Tests: ATQG1710 (Schwinger base + spectral-gap correction + full a_μ), ATQG1711 (the g-2
/// anomaly), ATQG1712 (comparison vs experiment/SM + classification).
/// </summary>
public class ATQG_Phase171_MuonG2OriginTests : ResearchTestBase
{
    public ATQG_Phase171_MuonG2OriginTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void ATQG1710_SchwingerBaseAndFullAMu()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG1710: Schwinger base and full a_mu");
    ...
    [Fact]
    public void ATQG1711_TheG2Anomaly()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG1711: the muon g-2 anomaly");
    ...
    [Fact]
    public void ATQG1712_ComparisonAndClassification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG1712: comparison vs experiment/SM and classification");
