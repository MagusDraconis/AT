...
/// <summary>
/// AT-QG Phase 304 — Real Network Universality. Test REAL network structure only: connectome, protein,
...
/// </summary>
public class ATQG_Phase304_RealNetworkUniversalityAuditTests : ResearchTestBase
{
    public ATQG_Phase304_RealNetworkUniversalityAuditTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void ATQG3040_RealStructuralSignatures()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG3040: the five real-structure domains");
    ...
    [Fact]
    public void ATQG3041_OperatorSignatures()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG3041: the four operators in each real-structure domain");
    ...
    [Fact]
    public void ATQG3042_Classification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG3042: the real-network universality determination");
