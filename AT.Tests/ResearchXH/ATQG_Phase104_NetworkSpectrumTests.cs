...
/// <summary>
/// AT-QG Phase 104 — Compute network spectrum. For a concrete causal network (deterministic 1+1D causal-set
...
///
/// Tests: ATQG1040 (adjacency + Laplacian spectra), ATQG1041 (actualization operator + stable modes +
/// spectral ratios), ATQG1042 (SM comparison + classification).
/// </summary>
public class ATQG_Phase104_NetworkSpectrumTests : ResearchTestBase
{
    public ATQG_Phase104_NetworkSpectrumTests(ITestOutputHelper o) : base(o) { }

    private static CausalSetData Cs() => NetworkSpectrum.BuildConcreteCausalNetwork(6, 6);

    // ── ATQG1040: adjacency spectrum + graph Laplacian spectrum ──────────────────

    [Fact]
    public void ATQG1040_AdjacencyAndLaplacianSpectra()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG1040: adjacency spectrum + graph Laplacian spectrum of the concrete causal network");
    ...
    // ── ATQG1041: actualization operator + stable modes + spectral ratios ─────────

    [Fact]
    public void ATQG1041_ActualizationOperatorModesAndRatios()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG1041: actualization operator spectrum, stable-mode frequencies, spectral ratios");
    ...
    // ── ATQG1042: SM hierarchies vs network spectra — classification ──────────────

    [Fact]
    public void ATQG1042_SMHierarchyComparisonAndClassification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG1042: SM mass hierarchies vs network spectra → NO MATCH / PARTIAL MATCH / NUMERICAL CORRESPONDENCE");
