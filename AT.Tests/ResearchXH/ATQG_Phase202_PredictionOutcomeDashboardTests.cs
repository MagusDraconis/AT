...
/// <summary>
/// AT-QG Phase 202 — Prediction Outcome Dashboard. Single source of truth for the external validation of
...
/// </summary>
public class ATQG_Phase202_PredictionOutcomeDashboardTests : ResearchTestBase
{
    public ATQG_Phase202_PredictionOutcomeDashboardTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void ATQG2020_DashboardCompleteForAllPredictions()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG2020: the complete prediction outcome dashboard");

        sb.AppendLine("ASSUMPTIONS:");
        sb.AppendLine("  - Inputs: Docs/ATQG_Predictions.json (immutable registry) and the evidence audits");
    ...
    [Fact]
    public void ATQG2021_StatesAndEvidenceConsistent()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG2021: states consistent with the evidence audits");
    ...
    [Fact]
    public void ATQG2022_RegistryCompliance()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG2022: registry compliance and forward-only transitions");
