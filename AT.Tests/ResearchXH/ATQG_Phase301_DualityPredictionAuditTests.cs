...
/// <summary>
/// AT-QG Phase 301 — Duality Prediction Audit. For every scalar result search the tensor dual; for
...
/// </summary>
public class ATQG_Phase301_DualityPredictionAuditTests : ResearchTestBase
{
    public ATQG_Phase301_DualityPredictionAuditTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void ATQG3010_ScalarToTensorDuals()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG3010: every scalar result has a tensor dual");
    ...
    [Fact]
    public void ATQG3011_TensorToScalarDuals()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG3011: every tensor result has a scalar dual");
    ...
    [Fact]
    public void ATQG3012_Classification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG3012: the duality determination");
