...
/// </summary>
public class ATQG_Phase232_ParameterCompletenessAuditTests : ResearchTestBase
{
    public ATQG_Phase232_ParameterCompletenessAuditTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void ATQG2320_ParameterCatalog()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG2320: the fundamental-parameter catalog across six categories");
    ...
    [Fact]
    public void ATQG2321_DerivedFraction()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG2321: the derived fraction and remaining gaps");
    ...
    [Fact]
    public void ATQG2322_ClassificationPartialComplete()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG2322: classification — PARTIAL COMPLETE");
