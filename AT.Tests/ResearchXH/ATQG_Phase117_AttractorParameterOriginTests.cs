...
/// <summary>
/// AT-QG Phase 117 — Do physical parameters control the attractor geometry? QG116b showed the universal
...
///
/// Tests: ATQG1170 (attractor radius + parameter response), ATQG1171 (geometry classes), ATQG1172
/// (parameter sensitivity + classification).
/// </summary>
public class ATQG_Phase117_AttractorParameterOriginTests : ResearchTestBase
{
    public ATQG_Phase117_AttractorParameterOriginTests(ITestOutputHelper o) : base(o) { }

    // ── ATQG1170: attractor radius + parameter response ───────────────────────────

    [Fact]
    public void ATQG1170_AttractorRadiusAndParameterResponse()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG1170: attractor radius; feedback and damping response");
    ...
    // ── ATQG1171: geometry classes ────────────────────────────────────────────────

    [Fact]
    public void ATQG1171_GeometryClasses()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG1171: do parameter plateaus map to distinct stable geometry classes?");
    ...
    // ── ATQG1172: parameter sensitivity + classification ─────────────────────────

    [Fact]
    public void ATQG1172_ParameterSensitivityAndClassification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG1172: parameter sensitivity → NO RELATION / PARTIAL RELATION / ATTRACTOR ORIGIN");
