...
/// </summary>
public class ATQG_Phase185_BekensteinQuarterOriginTests : ResearchTestBase
{
    public ATQG_Phase185_BekensteinQuarterOriginTests(ITestOutputHelper output)
        : base(output)
    {
    }

    [Fact]
    public void ATQG1850_StructureIsDerived()
    {
        var sb = new StringBuilder();

        PrintHeader("ATQG1850 — Bekenstein quarter origin: structure derivation audit");
        ...
        sb.AppendLine($"  - The remaining question is the COEFFICIENT (1/4) — the subject of ATQG1851/1852.");
    ...
    [Fact]
    public void ATQG1851_TwoPiGapPreventsExactQuarter()
    {
        var sb = new StringBuilder();

        PrintHeader("ATQG1851 — The 2π gap: why the deficit first law gives 1/2, not 1/4");
        sb.AppendLine("ASSUMPTIONS:");
    ...
    [Fact]
    public void ATQG1852_ClassificationPartialOrigin()
    {
        var sb = new StringBuilder();

        PrintHeader("ATQG1852 — Quarter-origin classification");
        sb.AppendLine("ASSUMPTIONS:");
