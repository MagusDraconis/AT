...
/// <summary>
/// AT-QG Phase 132 — First falsifiable collider prediction. QG131 established that existing collider data
...
///
/// Tests: ATQG1320 (missing ladder rungs + predicted resonances), ATQG1321 (decay-cascade endpoints +
/// threshold regions), ATQG1322 (collider reach + classification).
/// </summary>
public class ATQG_Phase132_FirstFalsifiablePredictionTests : ResearchTestBase
{
    public ATQG_Phase132_FirstFalsifiablePredictionTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void ATQG1320_MissingLadderRungsAndPredictedResonances()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG1320: missing ladder rungs and predicted resonances");
    ...
    [Fact]
    public void ATQG1321_DecayCascadeEndpointsAndThresholdRegions()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG1321: decay-cascade endpoints and threshold regions");
    ...
    [Fact]
    public void ATQG1322_ColliderReachAndClassification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG1322: collider reach and classification");
