...
/// <summary>
/// AT-QG Phase 196 — Quarter Coefficient Origin. Can the exact 1/4 in S = A/4 be derived — no fitting,
...
/// </summary>
public class ATQG_Phase196_QuarterCoefficientOriginTests : ResearchTestBase
{
    public ATQG_Phase196_QuarterCoefficientOriginTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void ATQG1960_StructureDerivedCoefficientsDefinite()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG1960: structure derived; QG12 and deficit first-law give definite coefficients");
    ...
    [Fact]
    public void ATQG1961_QuarterRequiresImportedPi()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG1961: the bit-per-cell constraint — 1/4 requires imported π");
    ...
    [Fact]
    public void ATQG1962_ClassificationPartialOrigin()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG1962: quarter-coefficient classification");
