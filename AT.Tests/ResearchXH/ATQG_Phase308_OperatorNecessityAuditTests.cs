...
/// <summary>
/// AT-QG Phase 308 — Operator Necessity Audit. Why exactly these four operators? Can any be derived
...
/// </summary>
public class ATQG_Phase308_OperatorNecessityAuditTests : ResearchTestBase
{
    public ATQG_Phase308_OperatorNecessityAuditTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void ATQG3080_GroupingsDiffer()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG3080: CROWDING and COMPRESSION are different groupings of the same 95 modes");
    ...
    [Fact]
    public void ATQG3081_NoOperatorDerivable()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG3081: no operator's outputs are derivable from the others");
    ...
    [Fact]
    public void ATQG3082_Classification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG3082: the operator-necessity determination");
