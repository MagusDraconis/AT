...
///
/// Tests: ATQG1590 (Z2 automorphism + family-count constraints), ATQG1591 (octave-rung selection),
/// ATQG1592 (candidate discrimination + classification).
/// </summary>
public class ATQG_Phase159_D96SelectionOriginTests : ResearchTestBase
{
    public ATQG_Phase159_D96SelectionOriginTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void ATQG1590_Z2AndFamilyCountConstraints()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG1590: Z2 automorphism and family-count constraints");
    ...
    [Fact]
    public void ATQG1591_OctaveRungSelection()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG1591: octave-rung selection — D96 is the unique 3-family rung");
    ...
    [Fact]
    public void ATQG1592_CandidateDiscriminationAndClassification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG1592: candidate discrimination and classification");
