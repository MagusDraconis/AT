...
/// <summary>
/// AT-QG Phase 228 — Information Content Origin. Derive why non-zero information appears from the
...
/// </summary>
public class ATQG_Phase228_InformationContentOriginTests : ResearchTestBase
{
    public ATQG_Phase228_InformationContentOriginTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void ATQG2280_EntropyDeficitDefinition()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG2280: information = entropy deficit — zero at uniform, positive for any departure");
    ...
    [Fact]
    public void ATQG2281_FluctuationsBreakUniformity()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG2281: mandatory counting fluctuations break the symmetry and differentiate branches");
    ...
    [Fact]
    public void ATQG2282_ClassificationInformationOrigin()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG2282: classification — INFORMATION ORIGIN");
