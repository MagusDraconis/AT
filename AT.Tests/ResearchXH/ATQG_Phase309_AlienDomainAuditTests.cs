...
/// <summary>
/// AT-QG Phase 309 — Alien Domain Audit. Attack universality: do the operators {CROWDING, COMPRESSION,
...
/// </summary>
public class ATQG_Phase309_AlienDomainAuditTests : ResearchTestBase
{
    public ATQG_Phase309_AlienDomainAuditTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void ATQG3090_AlienDomainsNoPhysics()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG3090: the five alien domains — no physics concepts");
    ...
    [Fact]
    public void ATQG3091_OperatorSignatures()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG3091: the four operators in each alien domain");
    ...
    public void ATQG3092_Classification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG3092: the universality-attack outcome");
