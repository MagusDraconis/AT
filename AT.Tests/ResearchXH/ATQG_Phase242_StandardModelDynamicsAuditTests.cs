...
/// <summary>
/// AT-QG Phase 242 — Standard Model Dynamics Audit. Determine whether SM dynamics are derived or only
/// hosted. Audit only — no new physics.
/// </summary>
public class ATQG_Phase242_StandardModelDynamicsAuditTests : ResearchTestBase
{
    public ATQG_Phase242_StandardModelDynamicsAuditTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void ATQG2420_SixDynamicsChecks()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG2420: the six SM dynamics checks");
    ...
    [Fact]
    public void ATQG2421_SymmetryDerivedDynamicsHosted()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG2421: the gauge SYMMETRY is derived; the DYNAMICS is hosted");
    ...
    [Fact]
    public void ATQG2422_Summary()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG2422: summary — symmetry derived, dynamics hosted");
