...
///
/// Tests: ATQG1290 (mass-spectrum matching + resonance spacing), ATQG1291 (threshold energies + collider
/// accessibility), ATQG1292 (scaling laws + classification).
/// </summary>
public class ATQG_Phase129_PhysicalCalibrationTests : ResearchTestBase
{
    public ATQG_Phase129_PhysicalCalibrationTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void ATQG1290_MassSpectrumMatchingAndResonanceSpacing()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG1290: mass-spectrum matching and resonance spacing");
    ...
    [Fact]
    public void ATQG1291_ThresholdEnergiesAndColliderAccessibility()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG1291: threshold energies and collider accessibility");
    ...
    [Fact]
    public void ATQG1292_ScalingLawsAndClassification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG1292: scaling laws and classification");
