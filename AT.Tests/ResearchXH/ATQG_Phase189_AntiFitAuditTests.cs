...
/// <summary>
/// AT-QG Phase 189 — Anti-Fit Audit. Reviews QG140–QG188 derivation methodology: inputs, hidden targets,
...
/// OVERFIT RISK.
/// </summary>
public class ATQG_Phase189_AntiFitAuditTests : ResearchTestBase
{
    public ATQG_Phase189_AntiFitAuditTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void ATQG1890_CompleteRegister()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG1890: complete anti-fit register (QG140–QG188)");
    ...
    [Fact]
    public void ATQG1891_EraSplitAndDistribution()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG1891: fitting era vs structural era, risk distribution");
    ...
    [Fact]
    public void ATQG1892_ConclusionsAndGoldStandard()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG1892: audit conclusions and gold-standard blind tests");
