...
/// <summary>
/// AT-QG Phase 271 — Post-Resonance Integrity Audit. Re-evaluate all remaining issues through the
/// QG260-270 resonance hierarchy. Deterministic, structure only.
/// </summary>
public class ATQG_Phase271_PostResonanceIntegrityAuditTests : ResearchTestBase
{
    public ATQG_Phase271_PostResonanceIntegrityAuditTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void ATQG2710_Reevaluation()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG2710: re-evaluating the remaining critiques through the resonance hierarchy");
    ...
    [Fact]
    public void ATQG2711_FocusCritiques()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG2711: the special-focus critiques (QG250/252/253/256/257/258)");
    ...
    [Fact]
    public void ATQG2712_TrueFrontier()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG2712: the true remaining frontier after QG270");
