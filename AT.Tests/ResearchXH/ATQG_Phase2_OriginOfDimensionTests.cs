...
/// <summary>
/// AT-QG Phase 2 — origin of spacetime dimension. The gravity chain is derived once d is supplied; here we
...
///
/// Tests: ATQG20 (Einstein degeneracy: d&lt;3 trivial, d≥3 non-trivial), ATQG21 (conformal-flatness cost:
///        automatic d≤3, restrictive d≥4), ATQG22 (classification).
/// </summary>
public class ATQG_Phase2_OriginOfDimensionTests : ResearchTestBase
{
    public ATQG_Phase2_OriginOfDimensionTests(ITestOutputHelper o) : base(o) { }

    // ── ATQG20: Einstein non-triviality requires d ≥ 3 ──────────────────────────────

    [Fact]
    public void ATQG20_EinsteinRequiresDAtLeast3()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG20: Einstein non-triviality requires d ≥ 3");
    ...
    // ── ATQG21: conformal-flatness cost — automatic for d≤3, restrictive for d≥4 ────

    [Fact]
    public void ATQG21_ConformalFlatnessCost()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG21: conformal flatness is automatic for d≤2, restrictive for d≥3");
    ...
    // ── ATQG22: classification ───────────────────────────────────────────────────────

    [Fact]
    public void ATQG22_Classification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG22: is any dimension DERIVED, PREFERRED, or SUPPLIED?");
        ...
        sb.AppendLine("    d ≥ 3 (ATQG20).");
        sb.AppendLine("  • d=3 is the dimension where the AT conformally-flat gravity is COMPLETE — the Weyl tensor");
        sb.AppendLine("    vanishes identically, so conformal flatness freezes out NOTHING (ATQG21). d≥4 requires the");
