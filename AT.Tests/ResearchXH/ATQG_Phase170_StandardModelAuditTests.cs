...
/// <summary>
/// AT-QG Phase 170 — Standard Model audit. QG138-169 reproduce many SM structures and parameters.
/// This phase audits all major measured SM quantities against the AT-QG derivation record,
...
///
/// Tests: ATQG1700 (fermion masses + CKM + PMNS + CP), ATQG1701 (couplings, running, boson masses,
/// g-2, neutrinos, EW), ATQG1702 (coverage percentage + ranked remaining tests).
/// </summary>
public class ATQG_Phase170_StandardModelAuditTests : ResearchTestBase
{
    public ATQG_Phase170_StandardModelAuditTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void ATQG1700_FermionCKMAndPMNS()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG1700: fermion masses, CKM, PMNS, CP audit");

        sb.AppendLine("ASSUMPTIONS: the AT-QG derivation record through QG169 is the authoritative");
    ...
    [Fact]
    public void ATQG1701_CouplingsBosonsAndUntested()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG1701: couplings, running, boson masses, g-2, neutrinos, EW audit");
    ...
    [Fact]
    public void ATQG1702_CoverageAndRankedRemainingTests()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG1702: coverage percentage and ranked remaining tests");
        ...
        sb.AppendLine("directional only; UNTESTED = no AT-QG derivation. Coverage is computed both");
