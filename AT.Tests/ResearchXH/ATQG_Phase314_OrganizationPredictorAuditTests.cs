...
/// <summary>
/// AT-QG Phase 314 — Organization Predictor Audit. QG313: the lock LAW is universal, the lock VALUES are
...
/// </summary>
public class ATQG_Phase314_OrganizationPredictorAuditTests : ResearchTestBase
{
    public ATQG_Phase314_OrganizationPredictorAuditTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void ATQG3140_LockCoherenceScores()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG3140: the lock-coherence organization score across the eight domains");
    ...
    [Fact]
    public void ATQG3141_ClassSeparationNotStrengthRanking()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG3141: the score separates the CLASS but not the STRENGTH");
    ...
    [Fact]
    public void ATQG3142_Classification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG3142: the lock-prediction determination");
