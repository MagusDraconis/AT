...
/// <summary>
/// AT-QG Phase 268 — Count Conservation Origin. Why is the actualization count conserved? D96 only,
/// no observables.
/// </summary>
public class ATQG_Phase268_CountConservationOriginTests : ResearchTestBase
{
    public ATQG_Phase268_CountConservationOriginTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void ATQG2680_ActualizationAndIndividuation()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG2680: actualization and individuation — the primitive is a countable unit");
    ...
    [Fact]
    public void ATQG2681_NetworkClosure()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG2681: network closure — the attractor fixes the event count");
    ...
    [Fact]
    public void ATQG2682_Classification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG2682: the origin determination — why count is conserved");
