...
/// <summary>
/// AT-QG Phase 31 — derive the TRM propagator from Q-event network dynamics. Tests whether TRM's kernel is a
/// propagation law or a correlation function. Classify: NO RELATION / PARTIAL MATCH / SAME OBJECT.
///
/// Tests: ATQG310 (native vs TRM effective profile), ATQG311 (derivability), ATQG312 (classification).
/// </summary>
public class ATQG_Phase31_TRMPropagatorOriginTests : ResearchTestBase
{
    public ATQG_Phase31_TRMPropagatorOriginTests(ITestOutputHelper o) : base(o) { }

    // ── ATQG310: native tick propagation vs TRM kernel ───────────────────────────────

    [Fact]
    public void ATQG310_NativeVsTrm()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG310: native tick propagator (M_eff=0) vs TRM kernel (M_eff=e^Φ−1)");
    ...
    // ── ATQG311: derivability ─────────────────────────────────────────────────────────

    [Fact]
    public void ATQG311_Derivability()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG311: is TRM's kernel derivable as a propagation law (not a correlation)?");
    ...
    // ── ATQG312: classification ───────────────────────────────────────────────────────

    [Fact]
    public void ATQG312_Classification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG312: NO RELATION / PARTIAL MATCH / SAME OBJECT?");
