...
///
/// Tests: ATQG1770 (coupling/angle observables LOO), ATQG1771 (mass/width observables LOO),
/// ATQG1772 (mixing/mass-splitting observables LOO + dependency graphs + classification).
/// </summary>
public class ATQG_Phase177_LeaveOneOutValidationTests : ResearchTestBase
{
    public ATQG_Phase177_LeaveOneOutValidationTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void ATQG1770_CouplingAndAngleLeaveOneOut()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG1770: leave-one-out — couplings and angles");
    ...
    [Fact]
    public void ATQG1771_MassAndSplittingLeaveOneOut()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG1771: leave-one-out — masses and splittings");
    ...
    [Fact]
    public void ATQG1772_MixingDependencyGraphsAndClassification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG1772: mixing LOO, dependency graphs, and classification");
