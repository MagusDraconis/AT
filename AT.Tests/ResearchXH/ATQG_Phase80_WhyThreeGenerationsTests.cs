...
/// <summary>
/// AT-QG Phase 80 — Why three generations? Determines whether the 3-generation count is related to the network
/// structure that hosts color. Classify: DERIVED / PREFERRED / NEW POSTULATE.
///
/// Tests: ATQG800 (spin replication + topological families), ATQG801 (link sectors + color connection),
/// ATQG802 (classification).
/// </summary>
public class ATQG_Phase80_WhyThreeGenerationsTests : ResearchTestBase
{
    public ATQG_Phase80_WhyThreeGenerationsTests(ITestOutputHelper o) : base(o) { }

    // ── ATQG800: replication of spin structures, topological families ─────────────

    [Fact]
    public void ATQG800_ReplicationAndTopology()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG800: do spin structures replicate / do topological families give 3?");
    ...
    // ── ATQG801: link sectors and color-generation connection ─────────────────────

    [Fact]
    public void ATQG801_SectorsAndColorConnection()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG801: link-sector multiplicity and the color-generation connection");
    ...
    [Fact]
    public void ATQG802_Classification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("ATQG802: DERIVED / PREFERRED / NEW POSTULATE?");
