...
public class AT_XB004_OriginOfUniversalVolatility : ResearchTestBase
{
    public AT_XB004_OriginOfUniversalVolatility(ITestOutputHelper o) : base(o) { }
    ...
    private void RunTest()
    {
        ...
        // 5. Final synthesis
        Sec(sb, "Final Synthesis — Unified AT");
        ...
        sb.AppendLine($"  RESEARCHX + RESEARCHXB = UNIFIED AT.");
        sb.AppendLine(new string('=', 100));
