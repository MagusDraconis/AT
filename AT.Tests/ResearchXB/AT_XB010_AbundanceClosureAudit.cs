...
public class AT_XB010_AbundanceClosureAudit : ResearchTestBase
{
    public AT_XB010_AbundanceClosureAudit(ITestOutputHelper o) : base(o) { }
    ...
    private void RunTest()
    {
        ...
        // 6. Complete AT
        Sec(sb, "COMPLETE AT — Final Architecture");
        sb.AppendLine("  ┌─────────────────────────────────────────────────────┐");
        sb.AppendLine("  │                  AT — COMPLETE                      │");
        sb.AppendLine("  ├─────────────────────────────────────────────────────┤");
        ...
        sb.AppendLine("  │  SM ~19 numbers → AT ~1 number + 2 primitives.     │");
        sb.AppendLine("  └─────────────────────────────────────────────────────┘");
        sb.AppendLine();
