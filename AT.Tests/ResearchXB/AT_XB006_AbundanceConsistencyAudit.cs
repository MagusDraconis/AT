...
public class AT_XB006_AbundanceConsistencyAudit : ResearchTestBase
{
    public AT_XB006_AbundanceConsistencyAudit(ITestOutputHelper o) : base(o) { }
    ...
    private void RunTest()
    {
        ...
        sb.AppendLine($"  NO hidden parameters beyond AT core.");
