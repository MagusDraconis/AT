...
public class AT_XF001_ComplexityEmergencePrinciple : ResearchTestBase
{
    public AT_XF001_ComplexityEmergencePrinciple(ITestOutputHelper o) : base(o) { }
    ...
    private void RunTest()
    {
        ...
        sb.AppendLine();
        sb.AppendLine("  AT does not 'select' this point.");
