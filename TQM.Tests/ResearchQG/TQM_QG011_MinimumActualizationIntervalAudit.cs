...
public class TQM_QG011_MinimumActualizationIntervalAudit:ResearchTestBase{
    public TQM_QG011_MinimumActualizationIntervalAudit(ITestOutputHelper o):base(o){}
