...
public class TQM_QG007_GravityConstantEmergenceAudit:ResearchTestBase{
    public TQM_QG007_GravityConstantEmergenceAudit(ITestOutputHelper o):base(o){}
    [Fact]public void QG007_Run(){
        ...
        S(sb,"Section A — The Role of G in TQM");sb.AppendLine(r.SA);
