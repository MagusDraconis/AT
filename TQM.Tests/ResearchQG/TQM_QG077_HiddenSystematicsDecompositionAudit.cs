...
public class TQM_QG077_HiddenSystematicsDecompositionAudit : ResearchTestBase
{
    public TQM_QG077_HiddenSystematicsDecompositionAudit(ITestOutputHelper o) : base(o) { }
    ...
    public void QG077_HiddenSystematics()
    {
        ...
        S(sb, "Section E — Remaining scatter vs TQM signal"); sb.AppendLine(r.SE);
