...
public class TQM_QG052_GenerationStructureMinimalityAudit:ResearchTestBase{
    public TQM_QG052_GenerationStructureMinimalityAudit(ITestOutputHelper o):base(o){}
