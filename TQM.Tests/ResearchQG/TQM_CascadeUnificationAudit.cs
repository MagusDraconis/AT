...
public class TQM_CascadeUnificationAudit : ResearchTestBase
{
    public TQM_CascadeUnificationAudit(ITestOutputHelper o) : base(o) { }
    ...
    private static string SectionE()
    {
        return
            ...
            "  shared-cascade hypothesis is irreducible-UNRESOLVABLE within TQM: it cannot be tested and\n" +
