...
public class TQM_QG079_DetectabilityLimitAudit : ResearchTestBase
{
    public TQM_QG079_DetectabilityLimitAudit(ITestOutputHelper o) : base(o) { }
    ...
    public void QG079_DetectabilityLimit()
    {
        ...
        S(sb, "Section A — TQM signal amplitude"); sb.AppendLine(r.SA);
