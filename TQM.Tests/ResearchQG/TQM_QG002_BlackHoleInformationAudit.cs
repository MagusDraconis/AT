...
public class TQM_QG002_BlackHoleInformationAudit:ResearchTestBase{
    public TQM_QG002_BlackHoleInformationAudit(ITestOutputHelper o):base(o){}
    [Fact]public void QG002_Run(){
        ...
        S(sb,"Section A — Black Hole in TQM");sb.AppendLine(r.SA);
