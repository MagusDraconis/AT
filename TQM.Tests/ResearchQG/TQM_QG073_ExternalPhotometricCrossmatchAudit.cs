...
public class TQM_QG073_ExternalPhotometricCrossmatchAudit : ResearchTestBase
{
    public TQM_QG073_ExternalPhotometricCrossmatchAudit(ITestOutputHelper o) : base(o) { }
