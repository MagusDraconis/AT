...
public class TQM_QG068_PredictionInventoryAudit:ResearchTestBase{
    public TQM_QG068_PredictionInventoryAudit(ITestOutputHelper o):base(o){}
    [Fact]public void QG068_Run(){
        Thread.CurrentThread.CurrentCulture=CultureInfo.InvariantCulture;
        var sb=new StringBuilder();PrintHeader("ResearchQG-068 TQM Prediction Inventory Audit");
