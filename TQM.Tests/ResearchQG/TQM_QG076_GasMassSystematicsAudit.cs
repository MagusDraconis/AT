...
public class TQM_QG076_GasMassSystematicsAudit : ResearchTestBase
{
    public TQM_QG076_GasMassSystematicsAudit(ITestOutputHelper o) : base(o) { }
    ...
    public void QG076_GasMassSystematics()
    {
        ...
        S(sb, "Section F — TQM vs MOND discrimination"); sb.AppendLine(r.SF);
