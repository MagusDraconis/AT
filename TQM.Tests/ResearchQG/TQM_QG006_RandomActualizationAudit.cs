...
public class TQM_QG006_RandomActualizationAudit:ResearchTestBase{
    public TQM_QG006_RandomActualizationAudit(ITestOutputHelper o):base(o){}
    [Fact]public void QG006_Run(){
        ...
        sb.AppendLine("  Random Actualization is IRREDUCIBLE. TQM bedrock: Q + Randomness.");
        sb.AppendLine("  QG program (6 experiments) COMPLETE. TQM fully compressed.");
