...
public class TQM_QG075_LargeSampleRARAudit : ResearchTestBase
{
    public TQM_QG075_LargeSampleRARAudit(ITestOutputHelper o) : base(o) { }
    ...
    public void QG075_LargeSampleRAR()
    {
        ...
        Assert.True(File.Exists(Path.Combine(outDir, "TQM_vs_MOND_Statistics.csv")));
    }
