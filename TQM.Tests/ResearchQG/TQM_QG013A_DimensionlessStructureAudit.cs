...
public class TQM_QG013A_DimensionlessStructureAudit:ResearchTestBase{
    public TQM_QG013A_DimensionlessStructureAudit(ITestOutputHelper o):base(o){}
    [Fact]public void QG013A_Run(){
        ...
        sb.AppendLine("  NO hidden invariants. TQM provides STRUCTURE, not SCALE.");
