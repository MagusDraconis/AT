...
/// <summary>
/// TQM-QG Phase 257 — Principle Competition Audit. Compare the seven formula-selection principles on
/// selection quality only (power, survivors, consistency, ad-hoc exceptions). No target values.
/// </summary>
public class TQMQG_Phase257_PrincipleCompetitionAuditTests : ResearchTestBase
{
    public TQMQG_Phase257_PrincipleCompetitionAuditTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQMQG2570_SevenPrinciples()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2570: the seven candidate principles");
    ...
    [Fact]
    public void TQMQG2571_Ranking()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2571: the principle ranking");
    ...
    [Fact]
    public void TQMQG2572_Classification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2572: the determination — NO UNIVERSAL PRINCIPLE");
