...
/// <summary>
/// TQM-QG Phase 263 — Operator Reduction Audit. Test whether the four operators (CROWDING, COMPRESSION,
/// BEAT, LOCKING) are projections of a deeper resonance dynamics. Structure only, no observables.
/// </summary>
public class TQMQG_Phase263_OperatorReductionAuditTests : ResearchTestBase
{
    public TQMQG_Phase263_OperatorReductionAuditTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQMQG2630_CrowdingCompressionReduction()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2630: CROWDING vs COMPRESSION — mode-density concentration?");
    ...
    [Fact]
    public void TQMQG2631_BeatLockingReduction()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2631: BEAT vs LOCKING — frequency synchronization?");
    ...
    [Fact]
    public void TQMQG2632_Classification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2632: the operator reduction — minimum basis and classification");
