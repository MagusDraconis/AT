...
/// <summary>
/// TQM-QG Phase 28 — derive the light-propagation law. Tests which rule (null geodesics vs TRM effective medium)
/// follows from actualization dynamics. Classify: DERIVED / PREFERRED / IMPORTED.
///
/// Tests: TQMQG280 (index & conformal invariance), TQMQG281 (mechanism census), TQMQG282 (classification).
/// </summary>
public class TQMQG_Phase28_PropagationLawTests : ResearchTestBase
{
    public TQMQG_Phase28_PropagationLawTests(ITestOutputHelper o) : base(o) { }

    // ── TQMQG280: effective index & conformal invariance ──────────────────────────────

    [Fact]
    public void TQMQG280_IndexAndConformalInvariance()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG280: effective index — null geodesic (n=1) vs TRM (n=ρ^(1/d))");
    ...
    // ── TQMQG281: mechanism census — which mechanisms are native? ─────────────────────

    [Fact]
    public void TQMQG281_MechanismCensus()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG281: do the five mechanisms yield n=1 (native) or n=e^Φ (imported)?");
    ...
    // ── TQMQG282: classification ───────────────────────────────────────────────────────

    [Fact]
    public void TQMQG282_Classification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG282: null geodesics vs TRM propagation — DERIVED, PREFERRED, or IMPORTED?");
        ...
        sb.AppendLine("    spatial g_ii. This is not in TQM's primitives — it is the ψ ≠ 0 (non-conformal) sector in disguise");
