...
/// <summary>
/// TQM-QG Phase 199 — P1 Evidence Update. Re-audits the published experimental record for the P1
...
/// </summary>
public class TQMQG_Phase199_P1EvidenceUpdateTests : ResearchTestBase
{
    public TQMQG_Phase199_P1EvidenceUpdateTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQMQG1990_SupportiveAndNullEvidenceCatalogued()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1990: supportive evidence and null searches (cited)");
    ...
    [Fact]
    public void TQMQG1991_ExclusionStatusAndHlLhcProspect()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1991: exclusion status and HL-LHC discovery potential");
    ...
    [Fact]
    public void TQMQG1992_ClassificationStaysPending()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1992: P1 classification — PENDING");
