...
/// <summary>
/// TQM-QG Phase 244 — Lagrangian Origin. Derive explicit field equations and Lagrangian structure from
/// D96. No new primitives, deterministic. Closes QG243's remaining Lagrangian-form partial.
/// </summary>
public class TQMQG_Phase244_LagrangianOriginTests : ResearchTestBase
{
    public TQMQG_Phase244_LagrangianOriginTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQMQG2440_NoetherCurrentsAndGeneratorAlgebra()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2440: the Noether currents and the generator algebra (the Lagrangian inputs)");
    ...
    [Fact]
    public void TQMQG2441_TheLagrangianDensity()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2441: the derived Lagrangian density L = −(1/4)F^aF^a + iψ̄γ^μD_μψ − mψ̄ψ");
    ...
    [Fact]
    public void TQMQG2442_ClassificationLagrangianOrigin()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2442: classification — LAGRANGIAN ORIGIN");
