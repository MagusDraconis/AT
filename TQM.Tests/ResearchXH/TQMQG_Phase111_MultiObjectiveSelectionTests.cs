...
/// <summary>
/// TQM-QG Phase 111 — Multi-objective network selection. QG109 (stability) and QG110 (information) each gave
...
///
/// Tests: TQMQG1110 (objectives + Pareto front), TQMQG1111 (trade-offs + dominance), TQMQG1112 (multi-objective
/// selection + classification).
/// </summary>
public class TQMQG_Phase111_MultiObjectiveSelectionTests : ResearchTestBase
{
    public TQMQG_Phase111_MultiObjectiveSelectionTests(ITestOutputHelper o) : base(o) { }

    // ── TQMQG1110: objectives + Pareto front ──────────────────────────────────────

    [Fact]
    public void TQMQG1110_ObjectivesAndParetoFront()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1110: five objectives over the ensemble + the Pareto-optimal front");
    ...
    // ── TQMQG1111: trade-offs + dominance ─────────────────────────────────────────

    [Fact]
    public void TQMQG1111_TradeoffsAndDominance()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1111: do the objectives trade off against each other?");
    ...
    // ── TQMQG1112: multi-objective selection + classification ─────────────────────

    [Fact]
    public void TQMQG1112_MultiObjectiveSelectionAndClassification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1112: does simultaneous optimization select a unique network class?");
