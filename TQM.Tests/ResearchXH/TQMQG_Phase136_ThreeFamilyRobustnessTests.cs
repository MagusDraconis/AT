...
/// <summary>
/// TQM-QG Phase 136 — Robustness of the 3-family sector. QG135 found 3 families emerge from octave structure
...
///
/// Tests: TQMQG1360 (feedback + damping sweeps), TQMQG1361 (size scaling + stability basin), TQMQG1362
/// (universality + classification).
/// </summary>
public class TQMQG_Phase136_ThreeFamilyRobustnessTests : ResearchTestBase
{
    public TQMQG_Phase136_ThreeFamilyRobustnessTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQMQG1360_FeedbackAndDampingSweeps()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1360: feedback and damping sweeps");
    ...
    [Fact]
    public void TQMQG1361_SizeScalingAndStabilityBasin()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1361: size scaling and family stability basin");
    ...
    [Fact]
    public void TQMQG1362_UniversalityAndClassification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1362: universality and classification");
