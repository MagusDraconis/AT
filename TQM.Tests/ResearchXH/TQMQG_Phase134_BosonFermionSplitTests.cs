...
/// <summary>
/// TQM-QG Phase 134 — Boson-fermion calibration split. QG133 showed boson anchors agree while fermion
/// anchors shift. This phase asks why the ladder calibrates consistently to bosons but not fermions.
///
/// Tests: TQMQG1340 (boson vs fermion sector mapping), TQMQG1341 (family-index effects + generation gap),
/// TQMQG1342 (calibration universality + classification).
/// </summary>
public class TQMQG_Phase134_BosonFermionSplitTests : ResearchTestBase
{
    public TQMQG_Phase134_BosonFermionSplitTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQMQG1340_BosonAndFermionSectorMapping()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1340: boson vs fermion sector mapping");
    ...
    [Fact]
    public void TQMQG1341_FamilyIndexEffectsAndGenerationGap()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1341: family-index effects and generation hierarchy gap");
    ...
    [Fact]
    public void TQMQG1342_CalibrationUniversalityAndClassification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1342: calibration universality and classification");
