...
/// <summary>
/// TQM-QG Phase 300 — Operator Universality Prediction. Search observables NOT used during QG0-QG299
...
/// </summary>
public class TQMQG_Phase300_OperatorUniversalityPredictionTests : ResearchTestBase
{
    public TQMQG_Phase300_OperatorUniversalityPredictionTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQMQG3000_PrecisionEwReduces()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG3000: the precision-EW observables reduce to the operator basis");
    ...
    [Fact]
    public void TQMQG3001_RunningPredictionsNewtonReduce()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG3001: running couplings, predictions, and Newton constant reduce");
    ...
    [Fact]
    public void TQMQG3002_Classification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG3002: the operator universality determination");
