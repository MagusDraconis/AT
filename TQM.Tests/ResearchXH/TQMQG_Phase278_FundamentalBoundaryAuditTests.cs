...
/// <summary>
/// TQM-QG Phase 278 — Fundamental Boundary Audit. Have we reached a true primitive layer? Identify the
/// first concept that cannot be reduced without reintroducing itself.
/// </summary>
public class TQMQG_Phase278_FundamentalBoundaryAuditTests : ResearchTestBase
{
    public TQMQG_Phase278_FundamentalBoundaryAuditTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQMQG2780_ConceptReduction()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2780: the four candidate concepts and their reduction");
    ...
    [Fact]
    public void TQMQG2781_SelfReferentialTest()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2781: the self-referential reduction test");
    ...
    [Fact]
    public void TQMQG2782_Classification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2782: the fundamental-boundary determination");
