...
/// <summary>
/// TQM-QG Phase 253 — Formula Uniqueness Audit. Replace empirical formula choice with a derivation-choice
...
/// </summary>
public class TQMQG_Phase253_FormulaUniquenessAuditTests : ResearchTestBase
{
    public TQMQG_Phase253_FormulaUniquenessAuditTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQMQG2530_GenerateAndMatch()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2530: the candidate pool and the search");
    ...
    [Fact]
    public void TQMQG2531_PerObservableAnalyses()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2531: per-observable uniqueness analysis");
    ...
    [Fact]
    public void TQMQG2532_Classification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2532: the honest verdict");
