...
/// <summary>
/// TQM-QG Phase 140 — Mass hierarchy amplification. QG139 found the octave ladder (1:2:4) does not match the
...
///
/// Tests: TQMQG1400 (mode occupation + coupling strength), TQMQG1401 (damping effects + exponential
/// scaling), TQMQG1402 (hierarchy amplification + classification).
/// </summary>
public class TQMQG_Phase140_HierarchyAmplificationTests : ResearchTestBase
{
    public TQMQG_Phase140_HierarchyAmplificationTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQMQG1400_ModeOccupationAndCouplingStrength()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1400: mode occupation and coupling strength");
    ...
    [Fact]
    public void TQMQG1401_DampingEffectsAndExponentialScaling()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1401: damping effects and exponential scaling");
    ...
    [Fact]
    public void TQMQG1402_HierarchyAmplificationAndClassification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1402: hierarchy amplification and classification");
