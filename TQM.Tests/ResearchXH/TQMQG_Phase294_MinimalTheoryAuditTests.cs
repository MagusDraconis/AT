...
/// <summary>
/// TQM-QG Phase 294 — Minimal Theory Audit. Verify that every compressed layer (Closure, Conservation,
...
/// </summary>
public class TQMQG_Phase294_MinimalTheoryAuditTests : ResearchTestBase
{
    public TQMQG_Phase294_MinimalTheoryAuditTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQMQG2940_ClosureConservationResonanceDerivable()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2940: Closure, Conservation, Resonance are DERIVABLE");
    ...
    [Fact]
    public void TQMQG2941_QuestionMeasurementDerivable()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2941: Question and Measurement are DERIVABLE");
    ...
    [Fact]
    public void TQMQG2942_Classification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2942: the minimal theory determination");
