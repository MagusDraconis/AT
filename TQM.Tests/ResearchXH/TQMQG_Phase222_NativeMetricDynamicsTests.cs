...
/// <summary>
/// TQM-QG Phase 222 — Native Metric Dynamics. Derive gravitational dynamics from Q-event evolution — no new
/// primitives, ρ only, deterministic. Rejects imported BDG/Einstein dynamics.
/// </summary>
public class TQMQG_Phase222_NativeMetricDynamicsTests : ResearchTestBase
{
    public TQMQG_Phase222_NativeMetricDynamicsTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQMQG2220_ActualizationFlowAndCountConservation()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2220: the actualization flow — branching densities and count conservation");
    ...
    [Fact]
    public void TQMQG2221_BranchingContinuityAndDensityEvolution()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2221: branching continuity — the density evolution equation from Q-events");
    ...
    [Fact]
    public void TQMQG2222_ClassificationDynamicsOrigin()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2222: classification — DYNAMICS ORIGIN");
