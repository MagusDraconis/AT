...
/// <summary>
/// TQM-QG Phase 285 — Psi Reinterpretation Audit. What role does ψ play in the reduced hierarchy
/// (Difference → Actualization → Resonance → Measurement → Physics)? D96 only, no observables.
/// </summary>
public class TQMQG_Phase285_PsiReinterpretationAuditTests : ResearchTestBase
{
    public TQMQG_Phase285_PsiReinterpretationAuditTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQMQG2850_PsiFacts()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2850: the established ψ facts");
    ...
    [Fact]
    public void TQMQG2851_ReinterpretationLinks()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2851: the reinterpretation links in the reduced hierarchy");
    ...
    [Fact]
    public void TQMQG2852_Classification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2852: the ψ determination");
