...
/// <summary>
/// TQM-QG Phase 273 — Assignment Principle Audit. Why does a projection become mass, coupling, mixing,
/// gravity, or cosmology instead of another sector? Is there a D96-native assignment rule?
/// </summary>
public class TQMQG_Phase273_AssignmentPrincipleAuditTests : ResearchTestBase
{
    public TQMQG_Phase273_AssignmentPrincipleAuditTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQMQG2730_AssignmentFeatures()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2730: the structural assignment features");
    ...
    [Fact]
    public void TQMQG2731_DecisiveDuplication()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2731: the decisive evidence — identical form in two sectors");
    ...
    [Fact]
    public void TQMQG2732_Classification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2732: the assignment-rule determination");
