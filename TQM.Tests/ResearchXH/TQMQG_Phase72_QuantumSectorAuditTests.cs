...
/// <summary>
/// TQM-QG Phase 72 — complete quantum sector audit. Audits six quantum features with θ + S + J.
/// Classify: COMPLETE / PARTIAL / MISSING.
///
/// Tests: TQMQG720 (feature census), TQMQG721 (the missing collapse), TQMQG722 (overall classification).
/// </summary>
public class TQMQG_Phase72_QuantumSectorAuditTests : ResearchTestBase
{
    public TQMQG_Phase72_QuantumSectorAuditTests(ITestOutputHelper o) : base(o) { }

    // ── TQMQG720: feature census ────────────────────────────────────────────────────

    [Fact]
    public void TQMQG720_FeatureCensus()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG720: audit six quantum features with θ + S + J");
    ...
    // ── TQMQG721: the missing collapse ──────────────────────────────────────────────

    [Fact]
    public void TQMQG721_MissingCollapse()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG721: the one missing piece is the measurement collapse");
    ...
    // ── TQMQG722: overall classification ─────────────────────────────────────────────

    [Fact]
    public void TQMQG722_Overall()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG722: is the full quantum structure present?");
