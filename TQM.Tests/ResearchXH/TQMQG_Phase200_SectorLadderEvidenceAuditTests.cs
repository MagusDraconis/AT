...
/// <summary>
/// TQM-QG Phase 200 — Sector Ladder Evidence Audit. Reviews the frozen 12-rung sector ladder (QG192) against
...
/// </summary>
public class TQMQG_Phase200_SectorLadderEvidenceAuditTests : ResearchTestBase
{
    public TQMQG_Phase200_SectorLadderEvidenceAuditTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQMQG2000_FullLadderEvidenceTable()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2000: the frozen ladder vs published evidence (all 12 rungs)");
    ...
    [Fact]
    public void TQMQG2001_ClassificationDistribution()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2001: classification distribution across the ladder");
    ...
    [Fact]
    public void TQMQG2002_ConsistencyWithQg192AndLep2()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2002: consistency with the frozen ladder and the LEP2 caveat");
