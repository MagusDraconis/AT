...
/// <summary>
/// TQM-QG Phase 165 — CKM origin. The established chain is D96 → fermion hierarchies. This phase derives
...
///
/// Tests: TQMQG1650 (doublet coupling → Vus), TQMQG1651 (octave transition + occupancy ratio → Vcb/Vub),
/// TQMQG1652 (full matrix + classification).
/// </summary>
public class TQMQG_Phase165_CKMOriginTests : ResearchTestBase
{
    public TQMQG_Phase165_CKMOriginTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQMQG1650_DoubletCouplingCabibbo()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1650: doublet coupling → the Cabibbo angle (Vus)");
    ...
    [Fact]
    public void TQMQG1651_OctaveTransitionAndOccupancyRatio()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1651: octave transition (Vcb) and occupancy ratio (Vub)");
    ...
    [Fact]
    public void TQMQG1652_FullMatrixAndClassification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1652: full CKM matrix and classification");
