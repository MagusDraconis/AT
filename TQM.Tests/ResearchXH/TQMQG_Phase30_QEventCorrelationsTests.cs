...
/// <summary>
/// TQM-QG Phase 30 — Q-event correlation dynamics. Tests whether correlations between Q-events can generate the
/// systematic observation-level effects (lensing, delay, magnification) without introducing ψ.
///
/// Tests: TQMQG300 (zero-mean vs nonzero variance), TQMQG301 (systematic vs stochastic), TQMQG302 (determination).
/// </summary>
public class TQMQG_Phase30_QEventCorrelationsTests : ResearchTestBase
{
    public TQMQG_Phase30_QEventCorrelationsTests(ITestOutputHelper o) : base(o) { }

    // ── TQMQG300: zero-mean fluctuations vs nonzero variance ──────────────────────────

    [Fact]
    public void TQMQG300_ZeroMeanVsVariance()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG300: correlations are zero-mean, but have nonzero variance");
    ...
    // ── TQMQG301: systematic vs stochastic ────────────────────────────────────────────

    [Fact]
    public void TQMQG301_SystematicVsStochastic()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG301: do correlations produce lensing, or only jitter?");
    ...
    // ── TQMQG302: determination ────────────────────────────────────────────────────────

    [Fact]
    public void TQMQG302_Determination()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG302: can correlations replace ψ?");
