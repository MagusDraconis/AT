...
/// <summary>
/// TQM-QG Phase 279 — Boundary Legitimacy Audit. Is the Difference boundary genuine or an artifact of
/// language? Attempt independent reductions. Structure only.
/// </summary>
public class TQMQG_Phase279_BoundaryLegitimacyAuditTests : ResearchTestBase
{
    public TQMQG_Phase279_BoundaryLegitimacyAuditTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQMQG2790_ReductionAttempts()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2790: the independent reduction attempts");
    ...
    [Fact]
    public void TQMQG2791_RealReferent()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2791: the reality check — difference has a concrete D96 referent");
    ...
    [Fact]
    public void TQMQG2792_Classification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2792: the boundary-legitimacy determination");
