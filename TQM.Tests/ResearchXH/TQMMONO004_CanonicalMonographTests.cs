...
/// from the CANONICAL END-STATE of TQM [post-QG319]: six parts, 17 chapters, every chapter classified
...
/// </summary>
public class TQMMONO004_CanonicalMonographTests : ResearchTestBase
{
    public TQMMONO004_CanonicalMonographTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQMMONO0040_ChapterStructure()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMMONO0040: the six-part, 17-chapter canonical structure");
    ...
    [Fact]
    public void TQMMONO0041_CanonicalCoreAndOperators()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMMONO0041: the canonical core, the primitives, and the universal operators");
    ...
    [Fact]
    public void TQMMONO0042_BoundaryLayerAndDetermination()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMMONO0042: the boundary layer, the frontier, and the monograph determination");
