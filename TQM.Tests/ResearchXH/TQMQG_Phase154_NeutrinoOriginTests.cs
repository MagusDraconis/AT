...
/// <summary>
/// TQM-QG Phase 154 — Origin of the neutrino sector. QG138-QG153 derive families, hierarchies, mode access
...
///
/// Tests: TQMQG1540 (neutral-charge limit + T3-only access), TQMQG1541 (doublet occupancy + spectral
/// accessibility), TQMQG1542 (neutrino hierarchy + classification).
/// </summary>
public class TQMQG_Phase154_NeutrinoOriginTests : ResearchTestBase
{
    public TQMQG_Phase154_NeutrinoOriginTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQMQG1540_NeutralChargeLimitAndT3OnlyAccess()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1540: neutral-charge limit and T3-only access");
    ...
    [Fact]
    public void TQMQG1541_DoubletOccupancyAndSpectralAccessibility()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1541: doublet occupancy and spectral accessibility");
    ...
    [Fact]
    public void TQMQG1542_NeutrinoHierarchyAndClassification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1542: neutrino hierarchy and classification");
