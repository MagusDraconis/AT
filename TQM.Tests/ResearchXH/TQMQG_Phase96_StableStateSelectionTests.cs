...
/// <summary>
/// TQM-QG Phase 96 — Stable State Selection. Determines whether the network possesses preferred stable states whose
/// spectra could select physical parameters. Classify: NO SELECTION / PARTIAL SELECTION / STATE SELECTION.
///
/// Tests: TQMQG960 (energy minima + resonance modes), TQMQG961 (attractors + spectrum selection + metastable),
/// TQMQG962 (classification).
/// </summary>
public class TQMQG_Phase96_StableStateSelectionTests : ResearchTestBase
{
    public TQMQG_Phase96_StableStateSelectionTests(ITestOutputHelper o) : base(o) { }

    // ── TQMQG960: network energy minima, stable resonance modes ────────────────────

    [Fact]
    public void TQMQG960_EnergyMinimaAndModes()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG960: native energy minima? stable modes?");
    ...
    // ── TQMQG961: attractor states, discrete spectrum selection, metastable ────────

    [Fact]
    public void TQMQG961_AttractorsSpectrumMetastable()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG961: attractors, spectrum selection, metastable states");
    ...
    [Fact]
    public void TQMQG962_Classification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG962: NO SELECTION / PARTIAL SELECTION / STATE SELECTION?");
