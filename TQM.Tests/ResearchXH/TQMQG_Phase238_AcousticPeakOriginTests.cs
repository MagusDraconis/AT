...
/// <summary>
/// TQM-QG Phase 238 — Acoustic Peak Origin. Derive the acoustic peak structure from the D96 octave
/// hierarchy: first peak, peak ratios, peak spacing. No new primitives, deterministic. Closes QG237's
/// remaining acoustic item.
/// </summary>
public class TQMQG_Phase238_AcousticPeakOriginTests : ResearchTestBase
{
    public TQMQG_Phase238_AcousticPeakOriginTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQMQG2380_FirstPeak()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2380: the first acoustic peak ℓ₁ = Σm·ln(span)·(5/4)");
    ...
    [Fact]
    public void TQMQG2381_PeakRatios()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2381: the peak ratios — the D96 octave hierarchy");
    ...
    [Fact]
    public void TQMQG2382_ClassificationPartialOrigin()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2382: classification — PARTIAL ORIGIN (peaks derived, recombination mechanism partial)");
