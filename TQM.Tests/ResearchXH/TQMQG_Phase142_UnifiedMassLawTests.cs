...
/// <summary>
/// TQM-QG Phase 142 — Unified fermion mass law. QG138 derived the family count and QG141 the hierarchy
...
///
/// Tests: TQMQG1420 (leptons), TQMQG1421 (up/down quarks), TQMQG1422 (neutrinos + universal scaling +
/// classification).
/// </summary>
public class TQMQG_Phase142_UnifiedMassLawTests : ResearchTestBase
{
    public TQMQG_Phase142_UnifiedMassLawTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQMQG1420_LeptonsAndOctaveLaw()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1420: lepton sector vs the octave law");
    ...
    [Fact]
    public void TQMQG1421_UpAndDownQuarkSectors()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1421: up and down quark sectors");
    ...
    [Fact]
    public void TQMQG1422_NeutrinosUniversalScalingAndClassification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1422: neutrinos, universal scaling, classification");
