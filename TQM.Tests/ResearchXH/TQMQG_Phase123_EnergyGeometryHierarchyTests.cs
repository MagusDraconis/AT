...
/// <summary>
/// TQM-QG Phase 123 — Structure hierarchy from energy. QG122 showed energy (actualization rate) acts as an
...
///
/// Tests: TQMQG1230 (attractor ladders + geometry transitions), TQMQG1231 (family emergence + sector
/// emergence), TQMQG1232 (energy-class hierarchy + classification).
/// </summary>
public class TQMQG_Phase123_EnergyGeometryHierarchyTests : ResearchTestBase
{
    public TQMQG_Phase123_EnergyGeometryHierarchyTests(ITestOutputHelper o) : base(o) { }

    // ── TQMQG1230: attractor ladders + geometry transitions ───────────────────────

    [Fact]
    public void TQMQG1230_AttractorLaddersAndGeometryTransitions()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1230: energy-ordered attractor ladders and geometry transitions");
    ...
    // ── TQMQG1231: family emergence + sector emergence ────────────────────────────

    [Fact]
    public void TQMQG1231_FamilyAndSectorEmergence()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1231: family emergence and sector emergence across the energy axis");
    ...
    // ── TQMQG1232: energy-class hierarchy + classification ────────────────────────

    [Fact]
    public void TQMQG1232_EnergyClassHierarchyAndClassification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1232: energy-class hierarchy → NO HIERARCHY / PARTIAL HIERARCHY / SECTOR HIERARCHY");
