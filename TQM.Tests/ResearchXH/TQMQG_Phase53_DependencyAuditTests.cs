...
/// <summary>
/// TQM-QG Phase 53 — dependency audit. Maps which conclusions depend on which assumptions.
/// Classify: ASSUMPTION-FREE / DERIVED / OBSERVATION-DEPENDENT / MODEL-DEPENDENT.
///
/// Tests: TQMQG530 (dependency graph), TQMQG531 (the derived chain), TQMQG532 (weakest links).
/// </summary>
public class TQMQG_Phase53_DependencyAuditTests : ResearchTestBase
{
    public TQMQG_Phase53_DependencyAuditTests(ITestOutputHelper o) : base(o) { }

    // ── TQMQG530: dependency graph classification ────────────────────────────────────

    [Fact]
    public void TQMQG530_DependencyGraph()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG530: classify every node of the dependency graph");
    ...
    // ── TQMQG531: the derived chain ───────────────────────────────────────────────────

    [Fact]
    public void TQMQG531_DerivedChain()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG531: the scalar backbone is fully derived");
    ...
    // ── TQMQG532: weakest links ───────────────────────────────────────────────────────

    [Fact]
    public void TQMQG532_WeakestLinks()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG532: the weakest remaining links");
