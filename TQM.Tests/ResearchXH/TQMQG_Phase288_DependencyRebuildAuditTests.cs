...
/// <summary>
/// TQM-QG Phase 288 — Dependency Rebuild Audit. Rebuilds dependencies using only the reduced chain
...
/// </summary>
public class TQMQG_Phase288_DependencyRebuildAuditTests : ResearchTestBase
{
    public TQMQG_Phase288_DependencyRebuildAuditTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQMQG2880_ReducedChainPrimitives()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2880: the reduced-chain primitives rebuild the structural layer");
    ...
    [Fact]
    public void TQMQG2881_StructuralResultsRebuilt()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2881: structural physics is rebuilt from the resonance primitives alone");
    ...
    [Fact]
    public void TQMQG2882_DependencyMapAndClassification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2882: the post-reduction dependency map");
