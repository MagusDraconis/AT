...
/// <summary>
/// TQM-QG Phase 35 — does ψ alone reproduce the regular-core structure M_eff(r)=M(1−e^(−r³/r_c³))? Classify:
/// FULL MATCH / PARTIAL MATCH / NO MATCH.
///
/// Tests: TQMQG350 (target profile properties), TQMQG351 (ψ qualitative vs exact), TQMQG352 (classification).
/// </summary>
public class TQMQG_Phase35_PsiVsRegularCoreTests : ResearchTestBase
{
    public TQMQG_Phase35_PsiVsRegularCoreTests(ITestOutputHelper o) : base(o) { }

    // ── TQMQG350: target regular-mass profile properties ──────────────────────────────

    [Fact]
    public void TQMQG350_RegularMassProfile()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG350: the target regular mass M(1-e^(-r^3/rc^3))");
    ...
    // ── TQMQG351: ψ qualitative match vs exact form ───────────────────────────────────

    [Fact]
    public void TQMQG351_PsiQualitativeVsExact()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG351: can ψ generate the specific form without additional assumptions?");
    ...
    // ── TQMQG352: classification ───────────────────────────────────────────────────────

    [Fact]
    public void TQMQG352_Classification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG352: FULL MATCH / PARTIAL MATCH / NO MATCH");
