...
/// <summary>
/// TQM-QG Phase 145 — Origin of up-sector enhancement. QG143-144 established the quark anomaly is
...
///
/// Tests: TQMQG1450 (spectral × charge + spectral × isospin coupling), TQMQG1451 (charge-isospin cross
/// terms + up-peak), TQMQG1452 (sector occupancy + hierarchy reconstruction + classification).
/// </summary>
public class TQMQG_Phase145_UpSectorEnhancementTests : ResearchTestBase
{
    public TQMQG_Phase145_UpSectorEnhancementTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQMQG1450_SpectralChargeAndIsospinCoupling()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1450: spectral × charge and spectral × isospin coupling");
    ...
    [Fact]
    public void TQMQG1451_ChargeIsospinCrossTermsAndUpPeak()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1451: charge-isospin cross terms and the up-peak");
    ...
    [Fact]
    public void TQMQG1452_SectorOccupancyHierarchyReconstructionAndClassification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1452: sector occupancy, hierarchy reconstruction, classification");
