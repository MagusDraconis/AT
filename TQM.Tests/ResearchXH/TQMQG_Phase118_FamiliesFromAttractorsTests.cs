...
/// <summary>
/// TQM-QG Phase 118 — Families from attractor geometries. QG117 showed dynamic parameters produce discrete
...
/// FAMILY ORIGIN.
///
/// Tests: TQMQG1180 (geometry-class count + family analogs), TQMQG1181 (class transitions + hierarchy
/// generation), TQMQG1182 (stability of classes + classification).
/// </summary>
public class TQMQG_Phase118_FamiliesFromAttractorsTests : ResearchTestBase
{
    public TQMQG_Phase118_FamiliesFromAttractorsTests(ITestOutputHelper o) : base(o) { }

    // ── TQMQG1180: geometry-class count + family analogs ───────────────────────────

    [Fact]
    public void TQMQG1180_GeometryClassCountAndFamilyAnalogs()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1180: geometry-class count and family analogs within each class");
    ...
    // ── TQMQG1181: class transitions + hierarchy generation ───────────────────────

    [Fact]
    public void TQMQG1181_ClassTransitionsAndHierarchyGeneration()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1181: class transitions and internal hierarchy generation");
    ...
    // ── TQMQG1182: stability of classes + classification ──────────────────────────

    [Fact]
    public void TQMQG1182_ClassStabilityAndClassification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1182: class stability → NO RELATION / PARTIAL RELATION / FAMILY ORIGIN");
