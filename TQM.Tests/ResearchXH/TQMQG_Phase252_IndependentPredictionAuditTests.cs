...
/// <summary>
/// TQM-QG Phase 252 — Independent Prediction Audit. Measure how much of TQM's validation comes from
/// genuine prediction vs reconstruction.
/// </summary>
public class TQMQG_Phase252_IndependentPredictionAuditTests : ResearchTestBase
{
    public TQMQG_Phase252_IndependentPredictionAuditTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQMQG2520_Inventory()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2520: the validation inventory (QG176/177/190-193/199-202/240)");
    ...
    [Fact]
    public void TQMQG2521_EvidenceFractions()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2521: the independent-evidence fractions");
    ...
    [Fact]
    public void TQMQG2522_Classification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2522: the independent-evidence strength");
