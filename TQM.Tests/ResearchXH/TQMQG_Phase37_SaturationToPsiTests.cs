...
/// <summary>
/// TQM-QG Phase 37 — can saturation generate ψ? Tests whether nonlinear saturation of the Q-event network can
/// generate an effective anisotropic/tensor sector. Classify: NEW PRIMITIVE / EMERGENT / PARTIAL MATCH.
///
/// Tests: TQMQG370 (spin census), TQMQG371 (no independent d.o.f.), TQMQG372 (classification).
/// </summary>
public class TQMQG_Phase37_SaturationToPsiTests : ResearchTestBase
{
    public TQMQG_Phase37_SaturationToPsiTests(ITestOutputHelper o) : base(o) { }

    // ── TQMQG370: spin census of saturation ───────────────────────────────────────────

    [Fact]
    public void TQMQG370_SpinCensus()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG370: what spin can each saturation mechanism reach?");
    ...
    // ── TQMQG371: no independent degree of freedom ─────────────────────────────────────

    [Fact]
    public void TQMQG371_NoIndependentDof()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG371: does saturation add an independent degree of freedom?");
    ...
    // ── TQMQG372: classification ───────────────────────────────────────────────────────

    [Fact]
    public void TQMQG372_Classification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG372: NEW PRIMITIVE / EMERGENT / PARTIAL MATCH?");
