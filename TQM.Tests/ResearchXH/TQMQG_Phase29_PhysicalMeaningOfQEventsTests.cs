...
/// <summary>
/// TQM-QG Phase 29 — physical interpretation of Q-events. Determines the minimal physical meaning of a Q-event:
/// primitive point vs state transition in a temporal network. Classify: REAL-UNDERIVED / EMERGENT / NETWORK
/// TRANSITION.
///
/// Tests: TQMQG290 (criteria scoring), TQMQG291 (determination), TQMQG292 (minimal meaning synthesis).
/// </summary>
public class TQMQG_Phase29_PhysicalMeaningOfQEventsTests : ResearchTestBase
{
    public TQMQG_Phase29_PhysicalMeaningOfQEventsTests(ITestOutputHelper o) : base(o) { }

    // ── TQMQG290: criteria scoring ────────────────────────────────────────────────────

    [Fact]
    public void TQMQG290_CriteriaScoring()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG290: which pictures satisfy the four criteria?");
    ...
    // ── TQMQG291: determination ────────────────────────────────────────────────────────

    [Fact]
    public void TQMQG291_Determination()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG291: primitive point vs network transition vs emergent");
    ...
    // ── TQMQG292: minimal meaning synthesis ────────────────────────────────────────────

    [Fact]
    public void TQMQG292_MinimalMeaning()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG292: the minimal physical meaning of a Q-event");
