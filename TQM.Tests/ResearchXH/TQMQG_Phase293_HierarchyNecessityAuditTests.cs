...
/// <summary>
/// TQM-QG Phase 293 — Hierarchy Necessity Audit. Remove each intermediate layer of the hierarchy
...
/// </summary>
public class TQMQG_Phase293_HierarchyNecessityAuditTests : ResearchTestBase
{
    public TQMQG_Phase293_HierarchyNecessityAuditTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQMQG2930_ActualizationAndSpectrumIndispensable()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2930: Actualization and Spectrum are INDISPENSABLE");
    ...
    [Fact]
    public void TQMQG2931_ClosureConservationResonanceCompressible()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2931: Closure, Conservation, Resonance are COMPRESSIBLE");
    ...
    [Fact]
    public void TQMQG2932_MinimalHierarchy()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2932: the minimal hierarchy");
