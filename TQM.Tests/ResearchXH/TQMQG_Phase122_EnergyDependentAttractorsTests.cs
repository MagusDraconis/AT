...
/// NEW CLASSES.
///
/// Tests: TQMQG1220 (energy scaling + actualization-rate regimes), TQMQG1221 (phase transitions +
/// family-count evolution), TQMQG1222 (high-energy classes + classification).
/// </summary>
public class TQMQG_Phase122_EnergyDependentAttractorsTests : ResearchTestBase
{
    public TQMQG_Phase122_EnergyDependentAttractorsTests(ITestOutputHelper o) : base(o) { }

    // ── TQMQG1220: energy scaling + actualization-rate regimes ─────────────────────

    [Fact]
    public void TQMQG1220_EnergyScalingAndRateRegimes()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1220: seed energy scaling and activity-ceiling (rate) regimes");
    ...
    // ── TQMQG1221: phase transitions + family-count evolution ─────────────────────

    [Fact]
    public void TQMQG1221_PhaseTransitionsAndFamilyEvolution()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1221: attractor phase transitions and family-count evolution with energy");
    ...
    // ── TQMQG1222: high-energy classes + classification ───────────────────────────

    [Fact]
    public void TQMQG1222_HighEnergyClassesAndClassification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1222: high-energy classes → NO EFFECT / PARTIAL EFFECT / NEW CLASSES");
