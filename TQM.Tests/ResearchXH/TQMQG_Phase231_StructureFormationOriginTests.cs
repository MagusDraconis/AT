...
/// <summary>
/// TQM-QG Phase 231 — Structure Formation Origin. Derive the density-contrast growth law from Q-event
...
/// cosmology feature.
/// </summary>
public class TQMQG_Phase231_StructureFormationOriginTests : ResearchTestBase
{
    public TQMQG_Phase231_StructureFormationOriginTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQMQG2310_PoissonSeed()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2310: the Poisson counting variance seeds the density contrast");
    ...
    [Fact]
    public void TQMQG2311_ContrastGrowthLaw()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2311: the growth law δ(a) = δ_i·a/a_i — linear, pressureless dust");
    ...
    [Fact]
    public void TQMQG2312_ClassificationStructureOrigin()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2312: classification — STRUCTURE ORIGIN");
