...
///
/// Tests: TQMQG1150 (feedback + activity-driven connectivity), TQMQG1151 (self-organized geometry +
/// structure-from-content), TQMQG1152 (fixed vs adaptive + classification).
/// </summary>
public class TQMQG_Phase115_StructureFromContentTests : ResearchTestBase
{
    public TQMQG_Phase115_StructureFromContentTests(ITestOutputHelper o) : base(o) { }

    // ── TQMQG1150: feedback + activity-driven connectivity ────────────────────────

    [Fact]
    public void TQMQG1150_FeedbackAndActivityDrivenConnectivity()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1150: feedback between Q-events (activity) and links (structure)");
    ...
    // ── TQMQG1151: self-organized geometry + structure-from-content ───────────────

    [Fact]
    public void TQMQG1151_SelfOrganizationAndStructureFromContent()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1151: self-organized geometry and structure-from-content");
    ...
    // ── TQMQG1152: fixed vs adaptive + classification ─────────────────────────────

    [Fact]
    public void TQMQG1152_FixedVsAdaptiveAndClassification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1152: fixed vs adaptive networks → FIXED / PARTIAL FEEDBACK / FULL SELF-ORGANIZATION");
