...
/// <summary>
/// TQM-QG Phase 212 — Conformal Optics Resolution. Resolve the conformal-optics frontier: is conformal
/// no-lensing physical, an artifact, or a restricted sector? No new primitives, deterministic.
/// </summary>
public class TQMQG_Phase212_ConformalOpticsResolutionTests : ResearchTestBase
{
    public TQMQG_Phase212_ConformalOpticsResolutionTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQMQG2120_PsiZeroSectorNoLensing()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2120: the ψ = 0 sector — PPN γ = −1, all lensing observables vanish");
    ...
    [Fact]
    public void TQMQG2121_PsiNonZeroRestoresLensing()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2121: the ψ ≠ 0 sector — PPN γ = +1, full GR optics restored");
    ...
    [Fact]
    public void TQMQG2122_ClassificationOpticsResolved()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2122: classification — OPTICS RESOLVED (restricted sector)");
