...
/// <summary>
/// TQM-QG Phase 67 — network spin structure. Determines whether the causal network naturally carries a spin structure.
/// Classify: DERIVED / COMPATIBLE / REQUIRES NEW PRIMITIVE.
///
/// Tests: TQMQG670 (orientation ≠ spin structure), TQMQG671 (compatible but not present), TQMQG672 (classification).
/// </summary>
public class TQMQG_Phase67_NetworkSpinStructureTests : ResearchTestBase
{
    public TQMQG_Phase67_NetworkSpinStructureTests(ITestOutputHelper o) : base(o) { }

    // ── TQMQG670: orientation is not a spin structure ───────────────────────────────

    [Fact]
    public void TQMQG670_OrientationVsSpinStructure()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG670: graph orientation (Z2) is not a spin structure (double cover)");
    ...
    // ── TQMQG671: compatible but not naturally present ──────────────────────────────

    [Fact]
    public void TQMQG671_CompatibleButNotPresent()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG671: the network CAN carry a spin structure, but it is new data");
    ...
    // ── TQMQG672: classification ───────────────────────────────────────────────────────

    [Fact]
    public void TQMQG672_Classification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG672: DERIVED / COMPATIBLE / REQUIRES NEW PRIMITIVE?");
