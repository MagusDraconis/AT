...
/// <summary>
/// TQM-QG Phase 126 — Particle interpretation of attractor sectors. QG123-125 established a hierarchy of
...
///
/// Tests: TQMQG1260 (sector inventory: low/high energy sectors + family correspondence), TQMQG1261 (decay
/// chains + observable remnants), TQMQG1262 (mapping score + classification).
/// </summary>
public class TQMQG_Phase126_ParticleSectorMappingTests : ResearchTestBase
{
    public TQMQG_Phase126_ParticleSectorMappingTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQMQG1260_SectorInventoryAndFamilyCorrespondence()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1260: sector inventory and family correspondence");
    ...
    [Fact]
    public void TQMQG1261_DecayChainsAndObservableRemnants()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1261: sector decay chains and observable remnants");
    ...
    [Fact]
    public void TQMQG1262_MappingScoreAndClassification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1262: sector→particle mapping score and classification");
