...
/// <summary>
/// TQM-QG Phase 81 — Origin of family replication. Determines whether the EXISTENCE of multiple fermion families
/// can emerge from network structure at all. Classify: DERIVED / COMPATIBLE / FUNDAMENTALLY POSTULATED.
///
/// Tests: TQMQG810 (spin replication + topology), TQMQG811 (link degeneracies + family symmetry + count),
/// TQMQG812 (classification).
/// </summary>
public class TQMQG_Phase81_FamilyReplicationTests : ResearchTestBase
{
    public TQMQG_Phase81_FamilyReplicationTests(ITestOutputHelper o) : base(o) { }

    // ── TQMQG810: replicated spin structures, topological sectors ──────────────────

    [Fact]
    public void TQMQG810_SpinAndTopology()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG810: does replication emerge from spin structure or topology?");
    ...
    // ── TQMQG811: link degeneracies, family symmetry, generation count ─────────────

    [Fact]
    public void TQMQG811_DegeneraciesAndSymmetry()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG811: can the link host replication (degenerate family index)?");
    ...
    [Fact]
    public void TQMQG812_Classification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG812: DERIVED / COMPATIBLE / FUNDAMENTALLY POSTULATED?");
