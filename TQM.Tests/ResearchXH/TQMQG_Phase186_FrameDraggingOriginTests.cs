...
/// <summary>
/// TQM-QG Phase 186 — Frame Dragging Origin (Lense–Thirring).
...
/// </summary>
public class TQMQG_Phase186_FrameDraggingOriginTests : ResearchTestBase
{
    public TQMQG_Phase186_FrameDraggingOriginTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQMQG1860_PsiRestoresTheGravitomagneticSector()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1860: frame dragging is a ψ-sector (h_0i) observable");
    ...
    [Fact]
    public void TQMQG1861_FrameDraggingRateMatchesTargets()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1861: Lense-Thirring rate vs Gravity Probe B and LAGEOS");
    ...
    [Fact]
    public void TQMQG1862_ClassificationFrameDraggingOrigin()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1862: frame-dragging origin classification");
