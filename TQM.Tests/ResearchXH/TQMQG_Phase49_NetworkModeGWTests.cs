...
/// <summary>
/// TQM-QG Phase 49 — network-mode explanation of GW strain. Tests whether collective Q-event network modes can
/// reproduce the observed differential strain without ψ. Classify: IMPOSSIBLE / PARTIAL MATCH / FULL MATCH.
///
/// Tests: TQMQG490 (breathing vs tensor), TQMQG491 (collective modes are scalar), TQMQG492 (classification).
/// </summary>
public class TQMQG_Phase49_NetworkModeGWTests : ResearchTestBase
{
    public TQMQG_Phase49_NetworkModeGWTests(ITestOutputHelper o) : base(o) { }

    // ── TQMQG490: breathing (common-mode) vs tensor (differential) ───────────────────

    [Fact]
    public void TQMQG490_BreathingVsTensor()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG490: scalar breathing is common-mode; tensor is differential");
    ...
    // ── TQMQG491: collective network modes are scalar ────────────────────────────────

    [Fact]
    public void TQMQG491_CollectiveModesAreScalar()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG491: collective modes of a scalar network stay scalar");
    ...
    // ── TQMQG492: classification ───────────────────────────────────────────────────────

    [Fact]
    public void TQMQG492_Classification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG492: IMPOSSIBLE / PARTIAL MATCH / FULL MATCH?");
