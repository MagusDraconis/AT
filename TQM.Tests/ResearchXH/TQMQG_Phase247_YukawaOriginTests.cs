...
/// <summary>
/// TQM-QG Phase 247 — Yukawa Origin. Derive the Yukawa interaction y_f ψ̄ψ φ from native D96
/// structure — no new primitives, deterministic, rejects the imported SM mechanism.
/// </summary>
public class TQMQG_Phase247_YukawaOriginTests : ResearchTestBase
{
    public TQMQG_Phase247_YukawaOriginTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQMQG2470_FormAndCouplings()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2470: the Yukawa form and the derived couplings");
    ...
    [Fact]
    public void TQMQG2471_HierarchyAndMechanism()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2471: the Yukawa hierarchy and the mass-generation mechanism");
    ...
    [Fact]
    public void TQMQG2472_Classification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2472: summary — YUKAWA ORIGIN");
