...
/// <summary>
/// TQM-QG Phase 10 — information-theoretic dimension selection. Measures how much information an actualization
...
///
/// Tests: TQMQG100 (capacity/entropy/connectivity monotonic), TQMQG101 (propagation efficiency d-independent +
///        efficiency landscape), TQMQG102 (classification).
/// </summary>
public class TQMQG_Phase10_InformationDimensionTests : ResearchTestBase
{
    public TQMQG_Phase10_InformationDimensionTests(ITestOutputHelper o) : base(o) { }

    // ── TQMQG100: capacity, entropy density, causal connectivity are monotonic ────────

    [Fact]
    public void TQMQG100_MonotonicInformationQuantities()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG100: information capacity, entropy density, and causal connectivity are monotonic");
    ...
    // ── TQMQG101: propagation efficiency is dimension-independent; efficiency landscape ─

    [Fact]
    public void TQMQG101_PropagationEfficiencyDimIndependent()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG101: propagation efficiency is dimension-independent; efficiency peaks at smallest allowed d");
    ...
    // ── TQMQG102: classification ───────────────────────────────────────────────────────

    [Fact]
    public void TQMQG102_Classification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG102: does any dimension maximize information efficiency?");
        ...
        sb.AppendLine("    with d; entropy density (ln d + ln K)/d DECREASES — all MONOTONIC (TQMQG100), so no dimension");
        ...
        sb.AppendLine("    nothing (TQMQG101).");
