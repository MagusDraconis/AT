...
/// <summary>
/// TQM-QG Phase 138 — Origin of the effective-size law. QG137 established that family count follows N/K.
/// This phase asks WHY N/K controls the family count: artifact, dynamical, or fundamental?
///
/// Tests: TQMQG1380 (mode density + octave spacing), TQMQG1381 (spectral crowding + effective horizon),
/// TQMQG1382 (family-band identity + classification).
/// </summary>
public class TQMQG_Phase138_EffectiveSizeLawTests : ResearchTestBase
{
    public TQMQG_Phase138_EffectiveSizeLawTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQMQG1380_ModeDensityAndOctaveSpacing()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1380: mode density and octave spacing");
    ...
    [Fact]
    public void TQMQG1381_SpectralCrowdingAndEffectiveHorizon()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1381: spectral crowding and effective horizon");
    ...
    [Fact]
    public void TQMQG1382_FamilyBandIdentityAndClassification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1382: family-band identity and classification");
