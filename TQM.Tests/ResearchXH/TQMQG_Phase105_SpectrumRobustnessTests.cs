...
/// <summary>
/// TQM-QG Phase 105 — Spectrum robustness audit. QG104 found a hierarchical discrete spectrum on the
...
///
/// Tests: TQMQG1050 (size scaling 91/200/500), TQMQG1051 (topology perturbations), TQMQG1052 (spectral
/// universality + classification).
/// </summary>
public class TQMQG_Phase105_SpectrumRobustnessTests : ResearchTestBase
{
    public TQMQG_Phase105_SpectrumRobustnessTests(ITestOutputHelper o) : base(o) { }

    // ── TQMQG1050: spectral ratios under size growth (91 → 200 → 500) ─────────────

    [Fact]
    public void TQMQG1050_SizeScaling()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1050: spectral ratios under network-size growth (91 → 200 → 500 events)");
    ...
    // ── TQMQG1051: topology perturbations (aspect ratio + link removal) ───────────

    [Fact]
    public void TQMQG1051_TopologyPerturbations()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1051: spectral ratios under topology perturbations (fixed N = 91)");
    ...
    // ── TQMQG1052: spectral universality + classification ─────────────────────────

    [Fact]
    public void TQMQG1052_UniversalityAndClassification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1052: RANDOM / ROBUST / UNIVERSAL?");
