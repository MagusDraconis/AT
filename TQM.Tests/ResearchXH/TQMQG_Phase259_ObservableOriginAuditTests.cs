...
/// <summary>
/// TQM-QG Phase 259 — Observable Origin Audit. Determine whether observables were selected because they
/// matched a D96 formula (post-hoc) or because D96 naturally points to them.
/// </summary>
public class TQMQG_Phase259_ObservableOriginAuditTests : ResearchTestBase
{
    public TQMQG_Phase259_ObservableOriginAuditTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQMQG2590_ObservableRegister()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2590: the observable register (QG140-258)");
    ...
    [Fact]
    public void TQMQG2591_OriginEvidence()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2591: the origin evidence for every observable");
    ...
    [Fact]
    public void TQMQG2592_SelectionRisk()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2592: the observable-selection risk");
