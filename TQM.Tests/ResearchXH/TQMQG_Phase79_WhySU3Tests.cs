...
/// <summary>
/// TQM-QG Phase 79 — Why SU(3)? Determines whether SU(3) is the MINIMAL non-Abelian extension of the link.
/// Classify: DERIVED / PREFERRED / NEW POSTULATE.
///
/// Tests: TQMQG790 (SU(2) vs SU(3)), TQMQG791 (color triplets + generator counting + confinement), TQMQG792 (classification).
/// </summary>
public class TQMQG_Phase79_WhySU3Tests : ResearchTestBase
{
    public TQMQG_Phase79_WhySU3Tests(ITestOutputHelper o) : base(o) { }

    // ── TQMQG790: SU(2) vs SU(3) — minimality ──────────────────────────────────────

    [Fact]
    public void TQMQG790_Su2VsSu3()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG790: is SU(3) the MINIMAL non-Abelian extension?");
    ...
    // ── TQMQG791: color triplets, generator counting, confinement ──────────────────

    [Fact]
    public void TQMQG791_TripletsAndGenerators()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG791: given 3 colors, SU(3) is the unique gauge group");
    ...
    // ── TQMQG792: classification ───────────────────────────────────────────────────

    [Fact]
    public void TQMQG792_Classification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG792: DERIVED / PREFERRED / NEW POSTULATE?");
