...
/// <summary>
/// TQM-QG Phase 246 — Higgs Potential Origin. Derive the Higgs potential V(φ) and its vacuum
/// minimum from D96 — no new primitives, deterministic, rejects the imported Higgs potential.
/// </summary>
public class TQMQG_Phase246_HiggsPotentialOriginTests : ResearchTestBase
{
    public TQMQG_Phase246_HiggsPotentialOriginTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQMQG2460_PotentialFormAndCoefficients()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2460: the potential form and its D96 coefficients");
    ...
    [Fact]
    public void TQMQG2461_VacuumMinimumAndSymmetryBreaking()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2461: the vacuum minimum and spontaneous symmetry breaking");
    ...
    [Fact]
    public void TQMQG2462_RadialModeAndClassification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2462: the radial mode and the classification");
