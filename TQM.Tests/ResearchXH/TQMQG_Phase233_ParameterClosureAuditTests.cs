...
/// <summary>
/// TQM-QG Phase 233 — Remaining Parameter Closure Audit. Re-adjudicate the 8 PARTIAL parameters from QG232
/// as DERIVED / BOUNDARY / ACTUALLY OPEN, separating true missing physics from documented boundaries.
/// Audit only — no new physics.
/// </summary>
public class TQMQG_Phase233_ParameterClosureAuditTests : ResearchTestBase
{
    public TQMQG_Phase233_ParameterClosureAuditTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQMQG2330_EightParametersReAdjudicated()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2330: the 8 partial parameters re-adjudicated");
    ...
    [Fact]
    public void TQMQG2331_TrueMissingPhysicsSeparated()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2331: true missing physics vs documented boundaries");
    ...
    [Fact]
    public void TQMQG2332_Verdict()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2332: verdict — remaining exact gaps are Ω_Λ and Ω_m");
