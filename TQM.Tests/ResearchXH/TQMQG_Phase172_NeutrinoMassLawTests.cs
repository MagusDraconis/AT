...
/// <summary>
/// TQM-QG Phase 172 — Neutrino mass law. Known: QG154 (neutrino origin: Q=0, T3-only access) and
...
///
/// Tests: TQMQG1720 (neutral-sector scale + solar splitting), TQMQG1721 (atmospheric splitting +
/// masses), TQMQG1722 (sum + ratio + classification).
/// </summary>
public class TQMQG_Phase172_NeutrinoMassLawTests : ResearchTestBase
{
    public TQMQG_Phase172_NeutrinoMassLawTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQMQG1720_NeutralScaleAndSolarSplitting()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1720: neutral-sector scale and solar splitting");
    ...
    [Fact]
    public void TQMQG1721_AtmosphericSplittingAndMasses()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1721: atmospheric splitting and masses");
    ...
    [Fact]
    public void TQMQG1722_SumRatioAndClassification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1722: sum, ratio, and classification");
