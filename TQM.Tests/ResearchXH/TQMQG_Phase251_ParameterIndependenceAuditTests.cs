...
/// <summary>
/// TQM-QG Phase 251 — Parameter Independence Audit. Determine the effective number of independent D96
/// parameters and whether over-parameterization can reasonably be claimed.
/// </summary>
public class TQMQG_Phase251_ParameterIndependenceAuditTests : ResearchTestBase
{
    public TQMQG_Phase251_ParameterIndependenceAuditTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQMQG2510_ParameterClassifications()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2510: the nine D96 parameters");
    ...
    [Fact]
    public void TQMQG2511_EffectiveCountAndRatio()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2511: the effective independent parameter count");
    ...
    [Fact]
    public void TQMQG2512_Classification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2512: the parameter-leakage risk");
