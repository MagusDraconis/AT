...
/// <summary>
/// TQM-QG Phase 225 — Dependency Graph Audit. Verify the phase derivation DAG over QG0-QG224: cycles,
/// hidden loops, target reuse, future-to-past dependencies, circular derivations. Audit only.
/// </summary>
public class TQMQG_Phase225_DependencyGraphAuditTests : ResearchTestBase
{
    public TQMQG_Phase225_DependencyGraphAuditTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQMQG2250_AcyclicGraph()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2250: the phase derivation graph is ACYCLIC");
    ...
    [Fact]
    public void TQMQG2251_RootsLongestChainCriticalNodes()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2251: longest dependency chain, root primitives, and critical nodes");
    ...
    [Fact]
    public void TQMQG2252_FutureToPastAnnotationsAndVerdict()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2252: future-to-past references are correction annotations, not dependencies");
