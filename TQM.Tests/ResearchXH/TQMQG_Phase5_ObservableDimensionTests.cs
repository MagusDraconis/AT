...
/// <summary>
/// TQM-QG Phase 5 — derive the observable dimension. The observable dimension d is the support rank of ρ (how
...
/// NOT SELECTED.
///
/// Tests: TQMQG50 (entropy per active dimension monotonic), TQMQG51 (dilution + branching monotonic),
///        TQMQG52 (classification: support rank conserved, not selected).
/// </summary>
public class TQMQG_Phase5_ObservableDimensionTests : ResearchTestBase
{
    public TQMQG_Phase5_ObservableDimensionTests(ITestOutputHelper o) : base(o) { }

    private const int K = 8;
    private const double LAMBDA = 1.5;

    // ── TQMQG50: entropy per active dimension is monotonic (no d=4 extremum) ─────────

    [Fact]
    public void TQMQG50_EntropyPerDimensionMonotonic()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG50: configurational entropy per active dimension is monotonic");
    ...
    // ── TQMQG51: dilution and branching efficiency are monotonic (no special d) ──────

    [Fact]
    public void TQMQG51_DilutionBranchingMonotonic()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG51: density dilution and branching efficiency are monotonic in d");
    ...
    // ── TQMQG52: classification ───────────────────────────────────────────────────────

    [Fact]
    public void TQMQG52_Classification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG52: is the observable dimension DERIVED, PREFERRED, or NOT SELECTED?");
        ...
        sb.AppendLine("    none selects a preferred observable dimension (TQMQG50/51).");
