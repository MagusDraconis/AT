...
/// <summary>
/// TQM-QG Phase 43 — observational uniqueness of ψ. Which observations require the tensor ψ vs a scalar ψ?
/// Classify: SCALAR / PSI / AMBIGUOUS.
///
/// Tests: TQMQG430 (classification table), TQMQG431 (the PSI case), TQMQG432 (uniqueness summary).
/// </summary>
public class TQMQG_Phase43_ObservationalUniquenessTests : ResearchTestBase
{
    public TQMQG_Phase43_ObservationalUniquenessTests(ITestOutputHelper o) : base(o) { }

    // ── TQMQG430: classification table ────────────────────────────────────────────────

    [Fact]
    public void TQMQG430_ClassificationTable()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG430: SCALAR / PSI / AMBIGUOUS for five observables");
    ...
    // ── TQMQG431: the PSI case ─────────────────────────────────────────────────────────

    [Fact]
    public void TQMQG431_PsiCase()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG431: only the GW polarization genuinely requires the tensor ψ");
    ...
    // ── TQMQG432: uniqueness summary ───────────────────────────────────────────────────

    [Fact]
    public void TQMQG432_UniquenessSummary()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG432: the observational uniqueness of ψ");
