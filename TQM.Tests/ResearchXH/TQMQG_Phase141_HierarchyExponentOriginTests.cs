...
/// <summary>
/// TQM-QG Phase 141 — Origin of hierarchy exponents. QG140 reproduced the lepton hierarchy via a fitted
...
///
/// Tests: TQMQG1410 (spectral scaling laws + octave occupancy), TQMQG1411 (mode-density effects +
/// actualization statistics), TQMQG1412 (exponent derivation + classification).
/// </summary>
public class TQMQG_Phase141_HierarchyExponentOriginTests : ResearchTestBase
{
    public TQMQG_Phase141_HierarchyExponentOriginTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQMQG1410_SpectralScalingLawsAndOctaveOccupancy()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1410: spectral scaling laws and octave occupancy");
    ...
    [Fact]
    public void TQMQG1411_ModeDensityEffectsAndActualizationStatistics()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1411: mode-density effects and actualization statistics");
    ...
    [Fact]
    public void TQMQG1412_ExponentDerivationAndClassification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1412: exponent derivation and classification");
