...
/// <summary>
/// TQM-QG Phase 88 — Origin of parameter values. Determines whether dynamical selection principles within the
/// network can determine preferred parameter values. Classify: NO CONSTRAINT / PARTIAL CONSTRAINT / VALUE SELECTION.
///
/// Tests: TQMQG880 (entropy extremization + stability), TQMQG881 (information minimization + criticality + attractors),
/// TQMQG882 (classification).
/// </summary>
public class TQMQG_Phase88_ParameterValueSelectionTests : ResearchTestBase
{
    public TQMQG_Phase88_ParameterValueSelectionTests(ITestOutputHelper o) : base(o) { }

    // ── TQMQG880: entropy extremization, stability criteria ────────────────────────

    [Fact]
    public void TQMQG880_EntropyAndStability()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG880: entropy extremization vs stability criteria");
    ...
    // ── TQMQG881: information minimization, criticality, attractors ────────────────

    [Fact]
    public void TQMQG881_MinimizationCriticalityAttractors()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG881: information minimization, criticality, RG attractors");
    ...
    [Fact]
    public void TQMQG882_Classification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG882: NO CONSTRAINT / PARTIAL CONSTRAINT / VALUE SELECTION?");
