...
/// C3 information density, C4 hybrid) against the TQM metric-origin chain, the
...
public class G4F_PhysicalMeaningOfRhoTests : ResearchTestBase
{
    ...
    // Compatibility matrix (documented TQM facts, grounded in code where possible):
    ...
    public void G4_F01_NoNewPrimitiveRequired()
    {
        ...
        sb.AppendLine("TQM primitives: Q (becoming), Random Actualization, (ℓ, τ, ħ).");
