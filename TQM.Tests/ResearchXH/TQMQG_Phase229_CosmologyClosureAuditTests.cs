...
/// <summary>
/// TQM-QG Phase 229 — Cosmology Closure Audit. Determine the exact cosmology gap; classify the six
/// features; identify the highest-impact blocker. Audit only — no new physics.
/// </summary>
public class TQMQG_Phase229_CosmologyClosureAuditTests : ResearchTestBase
{
    public TQMQG_Phase229_CosmologyClosureAuditTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQMQG2290_SixCosmologyFeatures()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2290: the six cosmology features and their status");
    ...
    [Fact]
    public void TQMQG2291_HighestImpactBlocker()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2291: the single highest-impact remaining cosmology blocker");
    ...
    [Fact]
    public void TQMQG2292_ClassificationPartialCosmology()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2292: classification — PARTIAL COSMOLOGY");
