...
/// <summary>
/// TQM-QG Phase 192 — Pre-Registered Sector-Ladder Spectrum. The full 12-rung ladder spectrum is LOCKED from
...
/// </summary>
public class TQMQG_Phase192_PreRegisteredLadderSpectrumTests : ResearchTestBase
{
    public TQMQG_Phase192_PreRegisteredLadderSpectrumTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQMQG1920_FrozenLadderSpectrum()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1920: frozen 12-rung ladder spectrum (D96/QG121-132 only)");
    ...
    [Fact]
    public void TQMQG1921_MultiplicitiesWidthsProduction()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1921: multiplicities, widths, production ordering");
    ...
    [Fact]
    public void TQMQG1922_OutputTableAndAcceptance()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1922: required output table and acceptance criteria");
