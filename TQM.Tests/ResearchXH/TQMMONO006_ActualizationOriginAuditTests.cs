...
/// <summary>
/// TQM-MONO006 — A01 Critical Consistency Check: the actualization origin. Resolve the hostile-referee
...
/// </summary>
public class TQMMONO006_ActualizationOriginAuditTests : ResearchTestBase
{
    public TQMMONO006_ActualizationOriginAuditTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQMMONO0060_DependencyEvidence()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMMONO0060: the dependency evidence from accepted phases");
    ...
    [Fact]
    public void TQMMONO0061_TheDependencyProof()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMMONO0061: the dependency proof — Actualization is derived from Difference");
    ...
    [Fact]
    public void TQMMONO0062_ContradictionAndConfidence()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMMONO0062: the contradiction, the canonical architecture, and the confidence");
