...
/// <summary>
/// TQM-QG Phase 21 — derive light propagation from TQM. Tests whether light follows null geodesics of the
...
///
/// Tests: TQMQG210 (light speed + redshift vs no lensing), TQMQG211 (photon emergence / temporal field), TQMQG212 (classification).
/// </summary>
public class TQMQG_Phase21_LightPropagationTests : ResearchTestBase
{
    public TQMQG_Phase21_LightPropagationTests(ITestOutputHelper o) : base(o) { }

    // ── TQMQG210: light speed c, redshift present, bending absent ────────────────────

    [Fact]
    public void TQMQG210_SpeedRedshiftNoBending()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG210: light speed = c, redshift present, bending absent");
        ...
        sb.AppendLine("But g_00 = −ρ^(2/d) varies, so light IS redshifted (frequency changes). TQM predicts redshift");
    ...
    // ── TQMQG211: photon emergence — the temporal field does not modify null geodesics ─

    [Fact]
    public void TQMQG211_PhotonEmergenceTemporalField()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG211: the temporal field does not modify the effective light speed");
    ...
    // ── TQMQG212: classification ───────────────────────────────────────────────────────

    [Fact]
    public void TQMQG212_Classification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG212: is light propagation NULL-GEODESIC, MODIFIED, or EMERGENT?");
        ...
        sb.AppendLine("    and is NOT bent (no gravitational lensing) (TQMQG210/211).");
        ...
        sb.AppendLine("  • This is a specific, falsifiable TQM prediction that DIFFERS from GR (GR predicts both redshift and");
        sb.AppendLine("    lensing, via the non-conformal Weyl/Ricci structure). TQM's conformal gravity gives redshift only.");
