...
/// <summary>
/// TQM-QG Phase 205 — Post-200 Coverage Audit. Recompute tested/partial/open after removing the resolved
...
/// </summary>
public class TQMQG_Phase205_Post200CoverageAuditTests : ResearchTestBase
{
    public TQMQG_Phase205_Post200CoverageAuditTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQMQG2050_RecomputedStatusAfterRemovals()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2050: recomputed coverage after the resolved-item removals");
    ...
    [Fact]
    public void TQMQG2051_Top10RemainingOpenProblems()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2051: Top-10 remaining open problems ranked by importance");
    ...
    [Fact]
    public void TQMQG2052_ResolutionsRemovedNotListed()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2052: the resolved items are absent from the remaining open set");
