...
/// <summary>
/// TQM-QG Phase 274 — Measurement Class Audit. Do measurement classes exist between projections and
/// sectors? Do sector labels emerge from measurement classes? D96 only, no observables.
/// </summary>
public class TQMQG_Phase274_MeasurementClassAuditTests : ResearchTestBase
{
    public TQMQG_Phase274_MeasurementClassAuditTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQMQG2740_MeasurementClasses()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2740: the five measurement classes");
    ...
    [Fact]
    public void TQMQG2741_ClassSectorMapping()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2741: the class → sector mapping");
    ...
    [Fact]
    public void TQMQG2742_Classification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2742: the class-layer determination");
