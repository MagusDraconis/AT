...
///
/// Tests: TQMQG1670 (θ12 solar), TQMQG1671 (θ23 atmospheric + θ13 reactor), TQMQG1672 (neutrino CP
/// phase + classification).
/// </summary>
public class TQMQG_Phase167_PMNSOriginTests : ResearchTestBase
{
    public TQMQG_Phase167_PMNSOriginTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQMQG1670_Theta12Solar()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1670: θ12 (solar) — doublet-coupling density");
    ...
    [Fact]
    public void TQMQG1671_Theta23AndTheta13()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1671: θ23 (atmospheric) and θ13 (reactor)");
    ...
    [Fact]
    public void TQMQG1672_NeutrinoCPPhaseAndClassification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1672: neutrino CP phase and classification");
