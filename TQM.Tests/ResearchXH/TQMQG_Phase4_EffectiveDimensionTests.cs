...
/// <summary>
/// TQM-QG Phase 4 — distinguish fundamental dimension from observed dimension. Tests whether TQM can be
...
///
/// Tests: TQMQG40 (dimensional reduction: observable support), TQMQG41 (metric-origin consistency selects the
///        observable dimension), TQMQG42 (classification: d=4 emergent, not fundamental).
/// </summary>
public class TQMQG_Phase4_EffectiveDimensionTests : ResearchTestBase
{
    public TQMQG_Phase4_EffectiveDimensionTests(ITestOutputHelper o) : base(o) { }

    // ── TQMQG40: dimensional reduction — ρ's support is the observable dimension ─────

    [Fact]
    public void TQMQG40_DimensionalReduction()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG40: ρ's support (where it varies) is the observable dimension");
    ...
    // ── TQMQG41: metric-origin consistency selects the observable dimension ──────────

    [Fact]
    public void TQMQG41_MetricOriginConsistency()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG41: √(−g)=ρ holds only in the observable dimension — it is dimension-specific");
    ...
    // ── TQMQG42: classification ───────────────────────────────────────────────────────

    [Fact]
    public void TQMQG42_Classification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG42: is d=4 fundamental or emergent?");
        ...
        sb.AppendLine("    higher-dimensional fundamental geometry is NOT excluded (TQMQG40).");
