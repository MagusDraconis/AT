...
/// <summary>
/// TQM-QG Phase 6 — origin of the coupling G. The gravity structure is derived; only the overall scale remains
...
///
/// Tests: TQMQG60 (the conformal gravity has NO free coupling; GM_eff is native), TQMQG61 (G–M non-separability),
///        TQMQG62 (classification).
/// </summary>
public class TQMQG_Phase6_OriginOfGTests : ResearchTestBase
{
    public TQMQG_Phase6_OriginOfGTests(ITestOutputHelper o) : base(o) { }

    private const int D = 3;

    // ── TQMQG60: the conformal gravity has no free coupling — GM_eff is native ────────

    [Fact]
    public void TQMQG60_NoFreeCoupling()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG60: the conformal gravity has no free coupling — GM_eff is native");
        ...
        double r = 12.0;
        double a = DeficitCollective.TqmAcceleration3D(u => DeficitCollective.PowerLawDeficit(u, rhoBar, m0, r0), r, D);
    ...
    // ── TQMQG61: G and M are not separable (degeneracy) ───────────────────────────────

    [Fact]
    public void TQMQG61_GMDegeneracy()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG61: G and M are not separable — only GM_eff is physical");
    ...
    [Fact]
    public void TQMQG62_Classification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG62: is G DERIVED, PREFERRED, or IMPORTED?");
        ...
        sb.AppendLine("    abundance of the actualization, with NO independent coupling G (TQMQG60). The conformal");
        sb.AppendLine("    gravity a = −(1/d)∇lnρ has no free coupling constant.");
        sb.AppendLine("  • G and M are NOT separable — only GM_eff is physical (TQMQG61), so the question 'what is G' is");
