...
/// <summary>
/// TQM-QG Phase 125 — Stability of high-energy sectors. QG124 found an energy-ordered sector hierarchy.
/// This phase asks whether the higher sectors remain stable or decay into the observable 3-family sector.
///
/// Tests: TQMQG1250 (sector lifetime + attractor stability), TQMQG1251 (downward transitions + metastability),
/// TQMQG1252 (observable remnants + classification).
/// </summary>
public class TQMQG_Phase125_HighEnergySectorStabilityTests : ResearchTestBase
{
    public TQMQG_Phase125_HighEnergySectorStabilityTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQMQG1250_SectorLifetimeAndAttractorStability()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1250: sector lifetime and attractor stability");
    ...
    [Fact]
    public void TQMQG1251_DownwardTransitionsAndMetastability()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1251: downward transitions and metastability");
    ...
    [Fact]
    public void TQMQG1252_ObservableRemnantsAndClassification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1252: observable remnants and classification");
