...
/// <summary>
/// TQM-QG Phase 42 — final TRM decomposition. Classifies every TRM component and computes the percentage derived
/// from TQM. Categories: DERIVED / PARTIAL / IMPORTED / NEW PRIMITIVE.
///
/// Tests: TQMQG420 (classification table), TQMQG421 (percentage), TQMQG422 (decomposition summary).
/// </summary>
public class TQMQG_Phase42_FinalTRMAuditTests : ResearchTestBase
{
    public TQMQG_Phase42_FinalTRMAuditTests(ITestOutputHelper o) : base(o) { }

    // ── TQMQG420: classification table ────────────────────────────────────────────────

    [Fact]
    public void TQMQG420_ClassificationTable()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG420: classify every TRM component");
    ...
    // ── TQMQG421: percentage derived ───────────────────────────────────────────────────

    [Fact]
    public void TQMQG421_PercentageDerived()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG421: what percentage of TRM is derived from TQM?");
    ...
    // ── TQMQG422: decomposition summary ────────────────────────────────────────────────

    [Fact]
    public void TQMQG422_DecompositionSummary()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG422: the final TRM decomposition");

        sb.AppendLine("WHAT IS DERIVED FROM TQM:");
        ...
        sb.AppendLine("new ψ primitive. The scalar (saturation + redshift) core is TQM-derived; the lensing/GW/rotation-curve");
