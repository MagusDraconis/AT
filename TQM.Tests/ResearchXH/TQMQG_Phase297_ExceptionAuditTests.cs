...
/// <summary>
/// TQM-QG Phase 297 — Exception Audit. Focus: the 5/4 constant. Determine whether 5/4 is derived,
...
/// </summary>
public class TQMQG_Phase297_ExceptionAuditTests : ResearchTestBase
{
    public TQMQG_Phase297_ExceptionAuditTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQMQG2970_NotDerivedNotStructural()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2970: 5/4 is not derived and not structural");
    ...
    [Fact]
    public void TQMQG2971_FitNotBoundary()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2971: 5/4 is a FIT, not a boundary");
    ...
    [Fact]
    public void TQMQG2972_Classification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2972: the exception determination");
