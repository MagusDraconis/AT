...
/// <summary>
/// TQM-QG Phase 303 — Hidden Dual Prediction. Review QG286/301; find scalar results lacking tensor
...
/// </summary>
public class TQMQG_Phase303_HiddenDualPredictionTests : ResearchTestBase
{
    public TQMQG_Phase303_HiddenDualPredictionTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQMQG3030_ScalarHiddenDuals()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG3030: scalar results lacking tensor partners → predicted tensor duals");
    ...
    [Fact]
    public void TQMQG3031_TensorHiddenDuals()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG3031: tensor results lacking scalar partners → predicted scalar duals");
    ...
    [Fact]
    public void TQMQG3032_Classification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG3032: the hidden-dual determination");
