...
/// <summary>
/// TQM-QG Phase 245 — Higgs Yukawa Origin Audit. Determine the exact status of the four Higgs-sector
/// components. Audit only — no new physics.
/// </summary>
public class TQMQG_Phase245_HiggsYukawaOriginAuditTests : ResearchTestBase
{
    public TQMQG_Phase245_HiggsYukawaOriginAuditTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQMQG2450_FourComponents()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2450: the four Higgs/Yukawa components");
    ...
    [Fact]
    public void TQMQG2451_MissingComponents()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2451: the exact missing SM dynamics components");
    ...
    [Fact]
    public void TQMQG2452_Summary()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2452: summary — SM DYNAMICS NOT COMPLETE");
