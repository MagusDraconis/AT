...
/// <summary>
/// TQM-QG Phase 311 — Operator Specificity Audit. Do the four operators measure organization or merely
...
/// </summary>
public class TQMQG_Phase311_OperatorSpecificityAuditTests : ResearchTestBase
{
    public TQMQG_Phase311_OperatorSpecificityAuditTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQMQG3110_PairA_ShuffleIndistinguishable()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG3110: Pair (a) — same inequality, different arrangement (frequency read)");
    ...
    [Fact]
    public void TQMQG3111_PairB_ModularDiffers()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG3111: Pair (b) — same degree sequence, different arrangement (graph read)");
    ...
    [Fact]
    public void TQMQG3112_Classification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG3112: the operator-specificity determination");
