...
/// <summary>
/// TQM-QG Phase 254 — Formula Selection Principle. Derive a D96-only, target-free, deterministic rule
/// that selects a formula BEFORE any comparison.
/// </summary>
public class TQMQG_Phase254_FormulaSelectionPrincipleTests : ResearchTestBase
{
    public TQMQG_Phase254_FormulaSelectionPrincipleTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQMQG2540_OctavePreservationPredicate()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2540: the octave-preservation predicate");
    ...
    [Fact]
    public void TQMQG2541_PoolFiltering()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2541: applying the rule to the QG253 candidate pool");
    ...
    [Fact]
    public void TQMQG2542_Classification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2542: summary — SELECTION PRINCIPLE");
