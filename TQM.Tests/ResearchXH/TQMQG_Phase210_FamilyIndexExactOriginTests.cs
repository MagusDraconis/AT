...
/// <summary>
/// TQM-QG Phase 210 — Family Index Exact Origin. Derive the family index exactly — why family = 1, 2, 3
...
/// </summary>
public class TQMQG_Phase210_FamilyIndexExactOriginTests : ResearchTestBase
{
    public TQMQG_Phase210_FamilyIndexExactOriginTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQMQG2100_FamilyCountIsOctaveBandCount()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2100: the family count is the octave-band count");
    ...
    [Fact]
    public void TQMQG2101_WhyNoFourthFamily()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2101: why there is no fourth family");
    ...
    [Fact]
    public void TQMQG2102_ClassificationExactOrigin()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2102: classification — EXACT ORIGIN");
