...
/// <summary>
/// TQM-QG Phase 148 — Independent validation of the exponent law. QG147 constructed p = 6.760 − 1.473·Q +
...
///
/// Tests: TQMQG1480 (neutrino sector prediction), TQMQG1481 (leave-one-out validation), TQMQG1482
/// (overfitting check + classification).
/// </summary>
public class TQMQG_Phase148_ExponentLawValidationTests : ResearchTestBase
{
    public TQMQG_Phase148_ExponentLawValidationTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQMQG1480_NeutrinoSectorPrediction()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1480: neutrino sector (unseen) prediction");
    ...
    [Fact]
    public void TQMQG1481_LeaveOneOutValidation()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1481: leave-one-out validation");
    ...
    [Fact]
    public void TQMQG1482_OverfittingCheckAndClassification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1482: overfitting check and classification");
