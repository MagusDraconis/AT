...
/// <summary>
/// TQM-QG Phase 114 — 3D connectivity classes. QG87 showed higher cells are derived. This phase asks whether
...
///
/// Tests: TQMQG1140 (valence classes + tetrahedral structures), TQMQG1141 (local volume geometry + connectivity
/// degeneracies), TQMQG1142 (family/color analogs + classification).
/// </summary>
public class TQMQG_Phase114_ConnectivityClasses3DTests : ResearchTestBase
{
    public TQMQG_Phase114_ConnectivityClasses3DTests(ITestOutputHelper o) : base(o) { }

    // ── TQMQG1140: valence classes + tetrahedral structures ───────────────────────

    [Fact]
    public void TQMQG1140_ValenceClassesAndTetrahedra()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1140: do valence 3,4,5,6 generate discrete spectral classes + tetrahedral structure?");
    ...
    // ── TQMQG1141: local volume geometry + connectivity degeneracies ──────────────

    [Fact]
    public void TQMQG1141_VolumeGeometryAndDegeneracies()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1141: local volume geometry and connectivity degeneracies");
    ...
    // ── TQMQG1142: family/color analogs + classification ──────────────────────────

    [Fact]
    public void TQMQG1142_FamilyColorAnalogsAndClassification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1142: family/color analogs → NO RELATION / PARTIAL / CONNECTIVITY CLASS ORIGIN");
