...
/// <summary>
/// TQM-QG Phase 289 — Anchor Inventory Audit. Inventories the anchors identified by QG288 (me, MZ,
...
/// </summary>
public class TQMQG_Phase289_AnchorInventoryAuditTests : ResearchTestBase
{
    public TQMQG_Phase289_AnchorInventoryAuditTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQMQG2890_AnchorValuesVerified()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2890: the eight anchors and their verified values");
    ...
    [Fact]
    public void TQMQG2891_Classifications()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2891: STRUCTURAL / EMPIRICAL / BOUNDARY / REMOVABLE");
    ...
    [Fact]
    public void TQMQG2892_MinimalInventoryAndClassification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2892: the minimal anchor inventory");
