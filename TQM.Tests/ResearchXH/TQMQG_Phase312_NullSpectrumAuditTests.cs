...
/// <summary>
/// TQM-QG Phase 312 — Null Spectrum Audit. Generate 10k deterministic random spectra, measure the four
/// operators, and compare with D96 / Language / DNA / Internet / Finance. Output: TRIVIAL / NONTRIVIAL.
/// </summary>
public class TQMQG_Phase312_NullSpectrumAuditTests : ResearchTestBase
{
    public TQMQG_Phase312_NullSpectrumAuditTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQMQG3120_NullGeneration()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG3120: the 10,000-spectrum null generation");
    ...
    [Fact]
    public void TQMQG3121_Comparison()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG3121: the operator presence — random vs organized");
    ...
    public void TQMQG3122_Classification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG3122: the null-spectrum determination");
