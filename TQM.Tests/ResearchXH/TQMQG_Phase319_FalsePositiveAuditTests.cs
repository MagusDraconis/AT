...
/// <summary>
/// TQM-QG Phase 319 — False Positive Audit. QG317: the early lock structure predicted the future
...
/// </summary>
public class TQMQG_Phase319_FalsePositiveAuditTests : ResearchTestBase
{
    public TQMQG_Phase319_FalsePositiveAuditTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQMQG3190_TheContingencyTable()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG3190: the 1000-system contingency table");
    ...
    [Fact]
    public void TQMQG3191_BothFailureModesSucceed()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG3191: both failure modes are real");
    ...
    public void TQMQG3192_Classification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG3192: the robustness determination");
