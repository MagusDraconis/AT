...
/// <summary>
/// TQM-MONO001 — Quantum Gravity Monograph Assembly. Assemble the complete monograph structure from
/// QG0-QG225: 18 chapters, each mapped to its source QG phases. Assembly only — no new physics.
/// </summary>
public class TQMMONO001_MonographAssemblyTests : ResearchTestBase
{
    public TQMMONO001_MonographAssemblyTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQMMONO0010_FullChapterOutline()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMMONO0010: the complete 18-chapter monograph outline with source QG phases");
    ...
    [Fact]
    public void TQMMONO0011_SourceCoverage()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMMONO0011: source-phase coverage across the 18 chapters");
    ...
    [Fact]
    public void TQMMONO0012_ClosureChapters()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMMONO0012: the closure/validation chapters carry the QG completion phases");
