...
/// <summary>
/// TQM-QG Phase 39 — separate TRM into derived and non-derived sectors. Audits six observables into SATURATION /
/// PSI / BOTH.
///
/// Tests: TQMQG390 (sector census), TQMQG391 (the BOTH case), TQMQG392 (summary).
/// </summary>
public class TQMQG_Phase39_TRMSectorAuditTests : ResearchTestBase
{
    public TQMQG_Phase39_TRMSectorAuditTests(ITestOutputHelper o) : base(o) { }

    // ── TQMQG390: sector census ────────────────────────────────────────────────────────

    [Fact]
    public void TQMQG390_SectorCensus()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG390: SATURATION / PSI / BOTH for six TRM observables");
    ...
    // ── TQMQG391: the BOTH case ────────────────────────────────────────────────────────

    [Fact]
    public void TQMQG391_BothCase()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG391: regular black hole = scalar core (saturation) + tensor horizon (ψ)");
    ...
    [Fact]
    public void TQMQG392_Summary()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG392: what TRM contributes from each sector");
        ...
        sb.AppendLine("regular core are derived scalar physics. This is the final sector separation: TQM derives the scalar backbone");
