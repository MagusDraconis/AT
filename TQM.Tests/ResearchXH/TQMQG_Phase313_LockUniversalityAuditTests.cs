...
/// <summary>
/// TQM-QG Phase 313 — Lock Universality Audit. QG312: operators can be faked, locks cannot. Are the
...
/// </summary>
public class TQMQG_Phase313_LockUniversalityAuditTests : ResearchTestBase
{
    public TQMQG_Phase313_LockUniversalityAuditTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQMQG3130_LockIdentities()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG3130: the normalized lock identities across the seven domains");
    ...
    [Fact]
    public void TQMQG3131_StructureUniversalValuesSpecific()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG3131: the lock LAW is universal, the VALUES are domain-specific");
    ...
    [Fact]
    public void TQMQG3132_Classification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG3132: the lock-law determination");
