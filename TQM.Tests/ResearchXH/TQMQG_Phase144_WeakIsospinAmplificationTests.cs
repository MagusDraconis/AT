...
/// <summary>
/// TQM-QG Phase 144 — Weak-isospin amplification origin. QG143 established the quark deviations are
/// isospin-signed. This phase asks whether weak-isospin coupling can explain the quark hierarchy
/// amplification.
///
/// Tests: TQMQG1440 (T3 dependence + up/down amplification), TQMQG1441 (charge-isospin combinations +
/// sector splitting), TQMQG1442 (hierarchy reconstruction + classification).
/// </summary>
public class TQMQG_Phase144_WeakIsospinAmplificationTests : ResearchTestBase
{
    public TQMQG_Phase144_WeakIsospinAmplificationTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQMQG1440_T3DependenceAndUpDownAmplification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1440: T3 dependence and up/down amplification");
    ...
    [Fact]
    public void TQMQG1441_ChargeIsospinCombinationsAndSectorSplitting()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1441: charge-isospin combinations and sector splitting");
    ...
    [Fact]
    public void TQMQG1442_HierarchyReconstructionAndClassification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1442: hierarchy reconstruction and classification");
