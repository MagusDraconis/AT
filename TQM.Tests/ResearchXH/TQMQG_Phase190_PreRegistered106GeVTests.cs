...
/// <summary>
/// TQM-QG Phase 190 — Pre-Registered 106 GeV Resonance. The prediction is LOCKED before any future data:
...
/// </summary>
public class TQMQG_Phase190_PreRegistered106GeVTests : ResearchTestBase
{
    public TQMQG_Phase190_PreRegistered106GeVTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQMQG1900_CentralMassAndWindowFrozenFromD96()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1900: pre-registered central mass and uncertainty window (D96/QG128-132 only)");
    ...
    [Fact]
    public void TQMQG1901_ProductionAndDecayHierarchyFrozen()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1901: pre-registered production and decay hierarchy");
    ...
    [Fact]
    public void TQMQG1902_AcceptanceCriteria()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1902: acceptance criteria (CONFIRMED / DISFAVORED)");
