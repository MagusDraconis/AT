...
/// <summary>
/// TQM-QG Phase 163 — Running coupling origin. QG162 established the couplings at the observable scale
...
///
/// Tests: TQMQG1630 (spectral scale and occupation flow), TQMQG1631 (running couplings), TQMQG1632
/// (hierarchy preservation + classification).
/// </summary>
public class TQMQG_Phase163_RunningCouplingOriginTests : ResearchTestBase
{
    public TQMQG_Phase163_RunningCouplingOriginTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQMQG1630_SpectralScaleAndOccupationFlow()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1630: spectral scale (octave ladder) and occupation flow");
    ...
    [Fact]
    public void TQMQG1631_RunningCouplings()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1631: running couplings α(E) = g_i / D_i(N(E))");
    ...
    [Fact]
    public void TQMQG1632_HierarchyPreservationAndClassification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1632: hierarchy preservation and classification");
