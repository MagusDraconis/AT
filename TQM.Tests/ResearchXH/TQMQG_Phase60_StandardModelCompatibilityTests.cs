...
/// <summary>
/// TQM-QG Phase 60 — Standard Model compatibility. Audits whether the network hosts the Standard Model.
/// Classify: NATURAL / COMPATIBLE / UNKNOWN.
///
/// Tests: TQMQG600 (classification), TQMQG601 (native spin content), TQMQG602 (conclusion).
/// </summary>
public class TQMQG_Phase60_StandardModelCompatibilityTests : ResearchTestBase
{
    public TQMQG_Phase60_StandardModelCompatibilityTests(ITestOutputHelper o) : base(o) { }

    // ── TQMQG600: classification ─────────────────────────────────────────────────────

    [Fact]
    public void TQMQG600_Classification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG600: NATURAL / COMPATIBLE / UNKNOWN for Standard Model ingredients");
    ...
    // ── TQMQG601: native spin content ────────────────────────────────────────────────

    [Fact]
    public void TQMQG601_NativeSpinContent()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG601: the network natively produces spin-0 and spin-2 only");
    ...
    [Fact]
    public void TQMQG602_Conclusion()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG602: what the network can and cannot host");
        ...
        sb.AppendLine();
        sb.AppendLine("CONCLUSION: TQM's causal network is a theory of GRAVITY (spin-0 + spin-2). It accommodates charge and gauge");
        ...
        sb.AppendLine("(spin-1/2) — consistent with TQM being a gravitational/completion framework, not a full matter theory.");
        Output.WriteLine(sb.ToString());
