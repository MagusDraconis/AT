...
/// <summary>
/// TQM-QG Phase 131 — Existing collider anomaly audit. QG127-130 predict metastable sector cascades and a
...
///
/// Tests: TQMQG1310 (excess-event searches + cascade-like signatures), TQMQG1311 (resonance clustering +
/// threshold structures), TQMQG1312 (null-result consistency + classification).
/// </summary>
public class TQMQG_Phase131_ColliderDataAuditTests : ResearchTestBase
{
    public TQMQG_Phase131_ColliderDataAuditTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQMQG1310_ExcessEventSearchesAndCascadeSignatures()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1310: excess-event searches and cascade-like signatures");
    ...
    [Fact]
    public void TQMQG1311_ResonanceClusteringAndThresholdStructures()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1311: resonance clustering and threshold structures");
    ...
    [Fact]
    public void TQMQG1312_NullResultConsistencyAndClassification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1312: null-result consistency and classification");
