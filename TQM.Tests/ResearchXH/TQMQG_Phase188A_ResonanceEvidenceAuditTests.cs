...
/// <summary>
/// TQM-QG Phase 188A — 106 GeV Resonance Evidence Audit.
/// Audits all existing published experimental evidence (ATLAS, CMS, LEP) against the QG132 prediction of a
/// primary resonance at 106.39 GeV in the 99–114 GeV window. Uses only completed TQM results; no new theory,
/// no fitting. Deterministic — all values are published constants.
/// </summary>
public class TQMQG_Phase188A_ResonanceEvidenceAuditTests : ResearchTestBase
{
    public TQMQG_Phase188A_ResonanceEvidenceAuditTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQMQG188A0_SupportingExcessesAndNullSearches()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG188A0: supporting excesses vs null searches in the 99–114 GeV window");
    ...
    [Fact]
    public void TQMQG188A1_ExclusionStatusAndDiscoveryPotential()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG188A1: exclusion status of 106 GeV and Run-3 discovery potential");
    ...
    [Fact]
    public void TQMQG188A2_ClassificationInconclusive()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG188A2: evidence classification");
