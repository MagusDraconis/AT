...
/// <summary>
/// TQM-QG Phase 315 — Early Lock Prediction. QG312: operators can be faked, locks are robust. Do the
...
/// target values.
/// </summary>
public class TQMQG_Phase315_EarlyLockPredictionTests : ResearchTestBase
{
    public TQMQG_Phase315_EarlyLockPredictionTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQMQG3150_EvolutionTrajectories()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG3150: the lock and maturity trajectories of the four evolving systems");
    ...
    [Fact]
    public void TQMQG3151_LocksReachHalfBeforeMaturity()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG3151: the lock identity reaches half-strength before the maturity does");
    ...
    [Fact]
    public void TQMQG3152_Classification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG3152: the temporal determination");
