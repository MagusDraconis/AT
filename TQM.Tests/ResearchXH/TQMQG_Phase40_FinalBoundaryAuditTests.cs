...
/// <summary>
/// TQM-QG Phase 40 — final quantum-gravity boundary audit. Settles what is DERIVED, NEW PRIMITIVE, IMPORTED, and
/// whether anything is EMERGENT across the full QG arc.
///
/// Tests: TQMQG400 (boundary census), TQMQG401 (the two primitives + derived chain), TQMQG402 (final boundary).
/// </summary>
public class TQMQG_Phase40_FinalBoundaryAuditTests : ResearchTestBase
{
    public TQMQG_Phase40_FinalBoundaryAuditTests(ITestOutputHelper o) : base(o) { }

    // ── TQMQG400: boundary census ──────────────────────────────────────────────────────

    [Fact]
    public void TQMQG400_BoundaryCensus()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG400: DERIVED / EMERGENT / NEW PRIMITIVE / IMPORTED across 11 items");
    ...
    // ── TQMQG401: the two primitives + the derived chain ──────────────────────────────

    [Fact]
    public void TQMQG401_TwoPrimitivesAndDerivedChain()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG401: two primitives, seven derived, two imported");
    ...
    // ── TQMQG402: final boundary ───────────────────────────────────────────────────────

    [Fact]
    public void TQMQG402_FinalBoundary()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG402: the final quantum-gravity boundary");
        ...
        sb.AppendLine();
        sb.AppendLine("CONCLUSION: TQM's quantum-gravity boundary is TWO primitives (Q-events + ψ) and NOTHING else. The entire");
