...
/// <summary>
/// TQM-QG Phase 151 — Origin of isospin-guided spectral access. QG150 established that mode access is
/// strongly isospin-constrained. This phase asks WHY weak isospin selects different spectral regions.
///
/// Tests: TQMQG1510 (spectral-band selection + T3-dependent occupation), TQMQG1511 (octave accessibility +
/// mode competition), TQMQG1512 (sector-selection mechanism + classification).
/// </summary>
public class TQMQG_Phase151_IsospinModeAccessTests : ResearchTestBase
{
    public TQMQG_Phase151_IsospinModeAccessTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQMQG1510_SpectralBandSelectionAndT3Occupation()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1510: spectral-band selection and T3-dependent occupation");
    ...
    [Fact]
    public void TQMQG1511_OctaveAccessibilityAndModeCompetition()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1511: octave accessibility and mode competition");
    ...
    [Fact]
    public void TQMQG1512_SectorSelectionMechanismAndClassification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1512: sector-selection mechanism and classification");
