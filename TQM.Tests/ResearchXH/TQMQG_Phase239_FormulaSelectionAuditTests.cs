...
/// <summary>
/// TQM-QG Phase 239 — Formula Selection Audit. Audit the uniqueness of the closed-form derivations in
/// QG203-QG238. Audit only — no new physics.
/// </summary>
public class TQMQG_Phase239_FormulaSelectionAuditTests : ResearchTestBase
{
    public TQMQG_Phase239_FormulaSelectionAuditTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQMQG2390_SixRelationsAudited()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2390: the six closed-form relations audited");
    ...
    [Fact]
    public void TQMQG2391_SelectionIntegrity()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2391: selection integrity — target influence and preregistration");
    ...
    [Fact]
    public void TQMQG2392_Summary()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2392: summary — the formula-risk table");
