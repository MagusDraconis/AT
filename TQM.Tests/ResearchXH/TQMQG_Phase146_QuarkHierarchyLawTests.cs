...
/// <summary>
/// TQM-QG Phase 146 — Quark mass hierarchy law. QG145 established quark amplification arises from spectral ×
...
///
/// Tests: TQMQG1460 (up/down sectors + spectral density), TQMQG1461 (charge×isospin amplification),
/// TQMQG1462 (hierarchy reconstruction + classification).
/// </summary>
public class TQMQG_Phase146_QuarkHierarchyLawTests : ResearchTestBase
{
    public TQMQG_Phase146_QuarkHierarchyLawTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQMQG1460_UpAndDownSectorsAndSpectralDensity()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1460: up/down quark sectors and spectral density");
    ...
    [Fact]
    public void TQMQG1461_ChargeIsospinAmplification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1461: charge×isospin amplification");
    ...
    [Fact]
    public void TQMQG1462_HierarchyReconstructionAndClassification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1462: hierarchy reconstruction and classification");
