...
/// <summary>
/// TQM-QG Phase 261 — Resonance Operator Audit. Determine whether the five named D96 quantities
/// (Σm, span, λ₂, occMom, Σ√m) are projections of deeper resonance operators.
/// </summary>
public class TQMQG_Phase261_ResonanceOperatorAuditTests : ResearchTestBase
{
    public TQMQG_Phase261_ResonanceOperatorAuditTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQMQG2610_OperatorSet()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2610: the candidate operator set");
    ...
    [Fact]
    public void TQMQG2611_DerivationClustering()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2611: clustering the successful derivations by operator");
    ...
    [Fact]
    public void TQMQG2612_Classification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2612: the minimum operator basis and the layer determination");
