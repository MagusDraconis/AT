...
/// <summary>
/// TQM-QG Phase 169 — Higgs mass origin. The established chain is D96 → Higgs = collective scalar
...
///
/// Tests: TQMQG1690 (scalar-mode amplitude + primary MH), TQMQG1691 (SM-quartic cross-check),
/// TQMQG1692 (ratios + classification).
/// </summary>
public class TQMQG_Phase169_HiggsMassOriginTests : ResearchTestBase
{
    public TQMQG_Phase169_HiggsMassOriginTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQMQG1690_ScalarModeAmplitudeAndPrimaryMass()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1690: scalar-mode amplitude and primary Higgs mass");
    ...
    [Fact]
    public void TQMQG1691_QuarticCrossCheck()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1691: SM-quartic cross-check via spectral gap");
    ...
    [Fact]
    public void TQMQG1692_RatiosAndClassification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1692: MH/v, MH/MW, MH/MZ ratios and classification");
