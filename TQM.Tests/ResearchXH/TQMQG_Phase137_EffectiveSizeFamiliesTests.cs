...
/// <summary>
/// TQM-QG Phase 137 — Effective-size invariance. QG136 found 3 families only for a specific size range.
/// This phase asks whether the family count depends on absolute size N or on an effective size determined
/// by actualization.
///
/// Tests: TQMQG1370 (active-node fraction + occupied size), TQMQG1371 (family scaling with N and K),
/// TQMQG1372 (size normalization + classification).
/// </summary>
public class TQMQG_Phase137_EffectiveSizeFamiliesTests : ResearchTestBase
{
    public TQMQG_Phase137_EffectiveSizeFamiliesTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQMQG1370_ActiveNodeFractionAndOccupiedSize()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1370: active-node fraction and occupied-network size");
    ...
    [Fact]
    public void TQMQG1371_FamilyScalingWithSizeAndLinkRadius()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1371: family scaling with absolute size and link radius");
    ...
    [Fact]
    public void TQMQG1372_SizeNormalizationAndClassification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1372: size normalization and classification");
