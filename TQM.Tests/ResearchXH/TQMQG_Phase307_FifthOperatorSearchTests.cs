...
/// <summary>
/// TQM-QG Phase 307 — Fifth Operator Search. Attempt to discover a new operator beyond {CROWDING,
/// COMPRESSION, BEAT, LOCKING} by searching all unexplored domains. No observables, no target values,
/// D96 only, deterministic.
/// </summary>
public class TQMQG_Phase307_FifthOperatorSearchTests : ResearchTestBase
{
    public TQMQG_Phase307_FifthOperatorSearchTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQMQG3070_CandidatesReducible()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG3070: the candidate fifth operators reduce to the existing basis");
    ...
    [Fact]
    public void TQMQG3071_ZeroModeAndSynchronization()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG3071: the zero-mode is the boundary; synchronization is the source");
    ...
    [Fact]
    public void TQMQG3072_Classification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG3072: the fifth-operator determination");
