...
/// <summary>
/// TQM-QG Phase 191 — Pre-Registered Neutrinoless Double Beta Decay. The effective Majorana mass prediction
...
/// </summary>
public class TQMQG_Phase191_PreRegisteredMbbTests : ResearchTestBase
{
    public TQMQG_Phase191_PreRegisteredMbbTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQMQG1910_MbbFrozenFromD96Inputs()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1910: pre-registered m_ββ from QG167/172/179 only");
    ...
    [Fact]
    public void TQMQG1911_OutputsAreCompleteAndConsistent()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1911: pre-registered outputs complete and internally consistent");
    ...
    [Fact]
    public void TQMQG1912_AcceptanceCriteria()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1912: acceptance criteria (CONFIRMED / FALSIFIED)");
