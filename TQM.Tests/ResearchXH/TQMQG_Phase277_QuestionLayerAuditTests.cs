...
/// <summary>
/// TQM-QG Phase 277 — Question Layer Audit. Do measurement classes emerge from more fundamental question
/// classes? D96 only, no observables.
/// </summary>
public class TQMQG_Phase277_QuestionLayerAuditTests : ResearchTestBase
{
    public TQMQG_Phase277_QuestionLayerAuditTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQMQG2770_QuestionClasses()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2770: the five question classes");
    ...
    [Fact]
    public void TQMQG2771_GenerativeLayer()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2771: the generative layer — question selects the class");
    ...
    [Fact]
    public void TQMQG2772_Classification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2772: the question-layer determination");
