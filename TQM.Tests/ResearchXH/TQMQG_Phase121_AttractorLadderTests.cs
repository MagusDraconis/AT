...
///
/// Tests: TQMQG1210 (threshold effects), TQMQG1211 (rounding structure), TQMQG1212 (fixed-point
/// bifurcations + universality + classification).
/// </summary>
public class TQMQG_Phase121_AttractorLadderTests : ResearchTestBase
{
    public TQMQG_Phase121_AttractorLadderTests(ITestOutputHelper o) : base(o) { }

    // ── TQMQG1210: threshold effects ───────────────────────────────────────────────

    [Fact]
    public void TQMQG1210_ThresholdEffects()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1210: does the ladder persist under different activity thresholds?");
    ...
    // ── TQMQG1211: rounding structure ──────────────────────────────────────────────

    [Fact]
    public void TQMQG1211_RoundingStructure()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1211: is the ladder a rounding artifact? (round / floor / ceil / continuous)");
    ...
    // ── TQMQG1212: fixed-point bifurcations + universality + classification ───────

    [Fact]
    public void TQMQG1212_FixedPointBifurcationsAndClassification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1212: fixed-point bifurcations, transitions, universality → classification");
