...
/// <summary>
/// TQM-QG Phase 143 — Origin of quark amplification. QG141/142 derived the lepton hierarchy from the
...
///
/// Tests: TQMQG1430 (deviation factors + color-sector effects), TQMQG1431 (charge + isospin effects),
/// TQMQG1432 (sector occupation + multi-sector coupling + classification).
/// </summary>
public class TQMQG_Phase143_QuarkAmplificationTests : ResearchTestBase
{
    public TQMQG_Phase143_QuarkAmplificationTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQMQG1430_DeviationFactorsAndColorSectorEffects()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1430: deviation factors and color-sector effects");
    ...
    [Fact]
    public void TQMQG1431_ChargeAndIsospinEffects()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1431: charge-sector and isospin effects");
    ...
    [Fact]
    public void TQMQG1432_OccupationDensityAndMultiSectorCoupling()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1432: sector occupation density, multi-sector coupling, classification");
