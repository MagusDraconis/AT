...
/// <summary>
/// TQM-QG Phase 284 — Post-Assignment Frontier Audit. Which frontier items remain after the assignment
/// closure (QG283)? Re-classify as OPEN / PARTIAL / BOUNDARY / METHODOLOGY. Audit only.
/// </summary>
public class TQMQG_Phase284_PostAssignmentFrontierAuditTests : ResearchTestBase
{
    public TQMQG_Phase284_PostAssignmentFrontierAuditTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQMQG2840_RemainingFrontier()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2840: the frontier after assignment closure");
    ...
    [Fact]
    public void TQMQG2841_Reclassification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2841: the reclassification after QG283");
    ...
    [Fact]
    public void TQMQG2842_Summary()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2842: the final remaining frontier");
