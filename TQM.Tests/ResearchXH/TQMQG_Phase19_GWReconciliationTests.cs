...
/// <summary>
/// TQM-QG Phase 19 — reconcile gravitational-wave observations. Tests whether observed GW signals can arise from
/// an emergent tensor channel or require a new primitive. Classify: EMERGENT / NEW PRIMITIVE / IMPOSSIBLE.
///
/// Tests: TQMQG190 (spin mismatch → emergent tensor impossible), TQMQG191 (all channels fail), TQMQG192 (classification).
/// </summary>
public class TQMQG_Phase19_GWReconciliationTests : ResearchTestBase
{
    public TQMQG_Phase19_GWReconciliationTests(ITestOutputHelper o) : base(o) { }

    // ── TQMQG190: spin mismatch — scalar (spin-0) cannot produce graviton (spin-2) ────

    [Fact]
    public void TQMQG190_SpinMismatchEmergentImpossible()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG190: spin-0 (scalar) cannot produce spin-2 (graviton) — emergent tensor impossible");
    ...
    // ── TQMQG191: all emergent channels fail ─────────────────────────────────────────

    [Fact]
    public void TQMQG191_AllChannelsFail()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG191: branching anisotropy, higher-D support, and effective ψ all fail");
    ...
    // ── TQMQG192: classification ───────────────────────────────────────────────────────

    [Fact]
    public void TQMQG192_Classification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG192: do GW observations require EMERGENT, NEW PRIMITIVE, or are they IMPOSSIBLE?");
        ...
        sb.AppendLine("    (however collective or anisotropic) can source tensor modes; spin-0 cannot produce spin-2 (TQMQG190).");
        sb.AppendLine("  • Collective branching anisotropy, higher-D support, and effective ψ all fail (TQMQG191): each yields");
        ...
        sb.AppendLine("  • This is the definitive structural conclusion of the tensor/GW arc (QG15–QG19): TQM's two primitives");
