...
/// <summary>
/// TQM-QG Phase 179 — Majorana origin. Known: QG154 (neutrino origin: unique Q=0, T3-only access),
...
///
/// Tests: TQMQG1790 (self-conjugate access + unique neutral sector), TQMQG1791 (Z2 doublets + real mass
/// matrix), TQMQG1792 (0νββ expectation + classification).
/// </summary>
public class TQMQG_Phase179_MajoranaOriginTests : ResearchTestBase
{
    public TQMQG_Phase179_MajoranaOriginTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQMQG1790_SelfConjugateAccessAndNeutralSector()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1790: self-conjugate access and the unique neutral sector");
    ...
    [Fact]
    public void TQMQG1791_Z2DoubletsAndRealMassMatrix()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1791: Z2 doublets and the real mass matrix");
    ...
    [Fact]
    public void TQMQG1792_ZeroNuBBAndClassification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1792: 0νββ expectation and classification");
