...
public class G4O_Phase4_RhoInterpretationAuditTests : ResearchTestBase
{
    ...
    public void G4_O40_PeaksMinimaVacuum()
    {
        ...
        double aPeak = PhysicalObservables.TqmAcceleration(u => PhysicalObservables.Gaussian(u), 0.4, D);
        ...
        double aVac = PhysicalObservables.TqmAcceleration(u => PhysicalObservables.Uniform(u), 0.4, D);
    ...
    public void G4_O41_RawRhoVsLnRhoVsGradRho()
    {
        ...
        double aConformal = PhysicalObservables.TqmAcceleration(u => PhysicalObservables.Gaussian(u), x, D);
