...
///
/// Tests: TQMQG1270 (decay signatures + cascade spectra), TQMQG1271 (transient occupation + energy
/// thresholds), TQMQG1272 (observable low-energy remnant + classification).
/// </summary>
public class TQMQG_Phase127_HighEnergySectorSignaturesTests : ResearchTestBase
{
    public TQMQG_Phase127_HighEnergySectorSignaturesTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQMQG1270_DecaySignaturesAndCascadeSpectra()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1270: decay signatures and cascade spectra");
    ...
    [Fact]
    public void TQMQG1271_TransientOccupationAndEnergyThresholds()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1271: transient sector occupation and energy thresholds");
    ...
    [Fact]
    public void TQMQG1272_ObservableRemnantAndClassification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1272: observable low-energy remnant and classification");
