...
/// <summary>
/// TQM-QG Phase 120 — Horizon suppression of families. QG119 showed local observers see fewer octave
...
///
/// Tests: TQMQG1200 (horizon size + family visibility), TQMQG1201 (mode localization + spectral
/// suppression), TQMQG1202 (observable family count + classification).
/// </summary>
public class TQMQG_Phase120_HorizonFamiliesTests : ResearchTestBase
{
    public TQMQG_Phase120_HorizonFamiliesTests(ITestOutputHelper o) : base(o) { }

    // ── TQMQG1200: horizon size + family visibility ────────────────────────────────

    [Fact]
    public void TQMQG1200_HorizonSizeAndFamilyVisibility()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1200: horizon size → observable family count; family visibility");
    ...
    // ── TQMQG1201: mode localization + spectral suppression ───────────────────────

    [Fact]
    public void TQMQG1201_ModeLocalizationAndSpectralSuppression()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1201: mode localization by family; spectral suppression profile");
    ...
    // ── TQMQG1202: observable family count + classification ───────────────────────

    [Fact]
    public void TQMQG1202_ObservableCountAndClassification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1202: observable family count → NO SUPPRESSION / PARTIAL SUPPRESSION / HORIZON ORIGIN");
