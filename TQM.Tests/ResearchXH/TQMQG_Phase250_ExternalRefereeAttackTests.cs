...
/// <summary>
/// TQM-QG Phase 250 — External Referee Audit. A hostile referee attacks QG0-QG249: the strongest
/// remaining reasons TQM could still fail. Attack only — no defense.
/// </summary>
public class TQMQG_Phase250_ExternalRefereeAttackTests : ResearchTestBase
{
    public TQMQG_Phase250_ExternalRefereeAttackTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQMQG2500_Top25Attacks()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2500: the top-25 strongest remaining attacks");
    ...
    [Fact]
    public void TQMQG2501_FatalAttacks()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2501: the two FATAL attacks");
    ...
    [Fact]
    public void TQMQG2502_Verdict()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2502: the hostile referee's verdict");
