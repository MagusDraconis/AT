...
/// <summary>
/// TQM-QG Phase 180 — Oblique parameters origin. Known: QG162 (couplings), QG168 (MW, MZ, ρ = 1),
...
///
/// Tests: TQMQG1800 (S parameter from the lightest-octave fraction), TQMQG1801 (T parameter + T=2S
/// relation), TQMQG1802 (U parameter + global-fit consistency + classification).
/// </summary>
public class TQMQG_Phase180_ObliqueParametersOriginTests : ResearchTestBase
{
    public TQMQG_Phase180_ObliqueParametersOriginTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQMQG1800_SParameterFromLightestOctave()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1800: the S parameter from the lightest-octave fraction");
    ...
    [Fact]
    public void TQMQG1801_TParameterAndTEqualsTwoS()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1801: the T parameter and the T = 2S relation");
    ...
    [Fact]
    public void TQMQG1802_UParameterAndClassification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1802: the U parameter, global-fit consistency, and classification");
