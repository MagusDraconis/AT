...
/// <summary>
/// TQM-QG Phase 203 — Absolute Neutrino Mass Origin. Derive m1, m2, m3 as closed-form D96 expressions
...
/// </summary>
public class TQMQG_Phase203_AbsoluteNeutrinoMassOriginTests : ResearchTestBase
{
    public TQMQG_Phase203_AbsoluteNeutrinoMassOriginTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQMQG2030_ClosedFormAbsoluteMasses()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2030: the three absolute masses as closed-form D96 expressions");
    ...
    [Fact]
    public void TQMQG2031_ExactMassRatioAndPmnsCrossCheck()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2031: the exact mass ratio and the PMNS cross-check");
    ...
    [Fact]
    public void TQMQG2032_ClassificationAbsoluteMassOrigin()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2032: classification — ABSOLUTE MASS ORIGIN");
