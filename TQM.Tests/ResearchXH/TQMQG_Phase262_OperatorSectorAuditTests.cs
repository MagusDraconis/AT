...
/// <summary>
/// TQM-QG Phase 262 — Operator Sector Audit. Classify every successful derivation by primary/secondary
...
/// </summary>
public class TQMQG_Phase262_OperatorSectorAuditTests : ResearchTestBase
{
    public TQMQG_Phase262_OperatorSectorAuditTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQMQG2620_OperatorMap()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2620: the operator map (every successful derivation)");
    ...
    [Fact]
    public void TQMQG2621_SectorProjections()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2621: the sector operator signatures");
    ...
    [Fact]
    public void TQMQG2622_Classification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2622: the sector-unification determination");
