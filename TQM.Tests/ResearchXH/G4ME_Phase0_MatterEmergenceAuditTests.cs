...
public class G4ME_Phase0_MatterEmergenceAuditTests : ResearchTestBase
{
    ...
    public void G4_ME00_MaximaRepulsiveMinimaAttractive()
    {
        ...
        double aPeak = PhysicalObservables.TqmAcceleration(u => PhysicalObservables.Gaussian(u), x, D);
        ...
        double aVoid = PhysicalObservables.TqmAcceleration(u => PhysicalObservables.Void(u), x, D);
    ...
    public void G4_ME02_RealUnderivedVsDerived()
    {
        ...
        double aMatter = PhysicalObservables.TqmAcceleration(u => PhysicalObservables.Void(u), x, D);
