...
/// <summary>
/// TQM-QG Phase 318 — Reorganization Prediction. QG315: locks precede organization; QG316: critical
...
/// </summary>
public class TQMQG_Phase318_ReorganizationPredictionTests : ResearchTestBase
{
    public TQMQG_Phase318_ReorganizationPredictionTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQMQG3180_TheReorganizationCohort()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG3180: the reorganization cohort — four systems, law switch at stage 4");
    ...
    [Fact]
    public void TQMQG3181_LockedSystemsReorganizeLess()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG3181: locked systems are plasticity-lost — they reorganize less");
    ...
    public void TQMQG3182_Classification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG3182: the reorganization-prediction determination");
