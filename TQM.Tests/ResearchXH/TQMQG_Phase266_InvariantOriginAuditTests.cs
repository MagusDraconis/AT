...
/// <summary>
/// TQM-QG Phase 266 — Invariant Origin Audit. Is the invariant Σλ = 12×96 fundamental or the projection
/// of a deeper conservation law? D96 only, no observables.
/// </summary>
public class TQMQG_Phase266_InvariantOriginAuditTests : ResearchTestBase
{
    public TQMQG_Phase266_InvariantOriginAuditTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQMQG2660_TraceIdentity()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2660: the trace of the Laplacian — a universal graph identity");
    ...
    [Fact]
    public void TQMQG2661_RegularNetwork()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2661: the network is regular — why the value is 12×96");
    ...
    [Fact]
    public void TQMQG2662_Classification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2662: the origin determination — why Σλ is conserved");
