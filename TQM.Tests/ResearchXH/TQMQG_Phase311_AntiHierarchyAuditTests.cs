...
/// <summary>
/// TQM-QG Phase 311 — Anti-Hierarchy Audit. Try to kill the operator basis using systems with no
...
/// </summary>
public class TQMQG_Phase311_AntiHierarchyAuditTests : ResearchTestBase
{
    public TQMQG_Phase311_AntiHierarchyAuditTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQMQG3110_FiveAntiHierarchySystems()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG3110: the five anti-hierarchy systems");
    ...
    [Fact]
    public void TQMQG3111_OperatorSignatures()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG3111: the four operators on each anti-hierarchy system");
    ...
    public void TQMQG3112_Classification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG3112: the anti-hierarchy outcome");
