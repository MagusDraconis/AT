...
///
/// Tests: TQMQG1680 (weak scale + g₂), TQMQG1681 (MW and MZ), TQMQG1682 (ratio, ρ, classification).
/// </summary>
public class TQMQG_Phase168_WeakBosonMassOriginTests : ResearchTestBase
{
    public TQMQG_Phase168_WeakBosonMassOriginTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQMQG1680_WeakScaleAndCoupling()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1680: weak scale and SU(2) coupling");
    ...
    [Fact]
    public void TQMQG1681_MWAndMZ()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1681: W and Z boson masses");
    ...
    [Fact]
    public void TQMQG1682_RatioRhoAndClassification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1682: MW/MZ, ρ parameter, and classification");
