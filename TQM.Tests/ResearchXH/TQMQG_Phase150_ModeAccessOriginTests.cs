...
/// <summary>
/// TQM-QG Phase 150 — Origin of mode access. QG149 established sector exponents emerge from
/// occupation-weighted mode access. This phase asks WHY different sectors access different parts of the same
/// spectrum.
///
/// Tests: TQMQG1500 (mode-selection rules + charge/isospin constraints), TQMQG1501 (spectral accessibility),
/// TQMQG1502 (occupation mechanisms + classification).
/// </summary>
public class TQMQG_Phase150_ModeAccessOriginTests : ResearchTestBase
{
    public TQMQG_Phase150_ModeAccessOriginTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQMQG1500_ModeSelectionRulesAndQuantumConstraints()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1500: mode-selection rules and quantum-number constraints");
    ...
    [Fact]
    public void TQMQG1501_SpectralAccessibility()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1501: spectral accessibility");
    ...
    [Fact]
    public void TQMQG1502_OccupationMechanismsAndClassification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1502: occupation mechanisms and classification");
