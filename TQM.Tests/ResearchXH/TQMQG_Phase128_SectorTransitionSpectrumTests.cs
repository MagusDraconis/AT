...
///
/// Tests: TQMQG1280 (transition ladder spacing + emitted-energy analog), TQMQG1281 (cascade spectrum +
/// threshold structure), TQMQG1282 (observable signatures + classification).
/// </summary>
public class TQMQG_Phase128_SectorTransitionSpectrumTests : ResearchTestBase
{
    public TQMQG_Phase128_SectorTransitionSpectrumTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQMQG1280_TransitionLadderSpacingAndEmittedEnergy()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1280: transition ladder spacing and emitted-energy analog");
    ...
    [Fact]
    public void TQMQG1281_CascadeSpectrumAndThresholdStructure()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1281: cascade spectrum and threshold structure");
    ...
    [Fact]
    public void TQMQG1282_ObservableSignaturesAndClassification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1282: observable signatures and classification");
