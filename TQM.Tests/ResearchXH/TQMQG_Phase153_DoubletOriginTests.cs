...
/// <summary>
/// TQM-QG Phase 153 — Origin of the Z2 doublet structure. QG151 found 95/95 modes in 44 spectral Z2 pairs
...
///
/// Tests: TQMQG1530 (pair formation + symmetry origin), TQMQG1531 (octave-band pairing + size scaling),
/// TQMQG1532 (sector robustness + classification).
/// </summary>
public class TQMQG_Phase153_DoubletOriginTests : ResearchTestBase
{
    public TQMQG_Phase153_DoubletOriginTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQMQG1530_PairFormationAndSymmetryOrigin()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1530: pair formation and symmetry origin");
    ...
    [Fact]
    public void TQMQG1531_OctaveBandPairingAndSizeScaling()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1531: octave-band pairing and size scaling");
    ...
    [Fact]
    public void TQMQG1532_SectorRobustnessAndClassification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1532: sector robustness and classification");
