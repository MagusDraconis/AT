...
/// <summary>
/// TQM-QG Phase 160 — Period-3 seed origin. The established chain is period-3 seed → D96 selection →
...
///
/// Tests: TQMQG1600 (stability + octave-family natural size), TQMQG1601 (Z2 completeness + automorphism),
/// TQMQG1602 (candidate discrimination + classification).
/// </summary>
public class TQMQG_Phase160_Period3SeedOriginTests : ResearchTestBase
{
    public TQMQG_Phase160_Period3SeedOriginTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQMQG1600_StabilityAndNaturalSize()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1600: stability and octave-rung natural size");
    ...
    [Fact]
    public void TQMQG1601_Z2CompletenessAndAutomorphism()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1601: Z2 completeness and automorphism constraint");
    ...
    [Fact]
    public void TQMQG1602_CandidateDiscriminationAndClassification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1602: candidate discrimination and classification");
