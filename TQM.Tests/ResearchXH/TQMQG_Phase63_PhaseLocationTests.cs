...
/// <summary>
/// TQM-QG Phase 63 — physical location of the quantum phase. Determines where the U(1) phase lives.
/// Classify: NODES / LINKS / LOOPS / new object.
///
/// Tests: TQMQG630 (the three homes), TQMQG631 (links canonical, loops derived), TQMQG632 (classification).
/// </summary>
public class TQMQG_Phase63_PhaseLocationTests : ResearchTestBase
{
    public TQMQG_Phase63_PhaseLocationTests(ITestOutputHelper o) : base(o) { }

    // ── TQMQG630: the three natural homes ────────────────────────────────────────────

    [Fact]
    public void TQMQG630_ThreeHomes()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG630: nodes (matter), links (gauge), loops (derived)");
    ...
    // ── TQMQG631: links are canonical, loops derived ─────────────────────────────────

    [Fact]
    public void TQMQG631_LinksCanonicalLoopsDerived()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG631: the gauge connection is canonically a link variable");
    ...
    // ── TQMQG632: classification ───────────────────────────────────────────────────────

    [Fact]
    public void TQMQG632_Classification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG632: NODES / LINKS / LOOPS / new object?");
