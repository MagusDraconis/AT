...
/// <summary>
/// TQM-QG Phase 149 — Physical origin of sector exponents. QG148 showed the linear exponent law overfits.
/// This phase tests whether sector exponents can emerge from a physical spectral mechanism rather than
/// parameter fitting.
///
/// Tests: TQMQG1490 (spectral density shifts + occupation weighting), TQMQG1491 (charge/isospin mode
/// access + effective dimension), TQMQG1492 (mechanism + classification).
/// </summary>
public class TQMQG_Phase149_PhysicalSectorExponentOriginTests : ResearchTestBase
{
    public TQMQG_Phase149_PhysicalSectorExponentOriginTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQMQG1490_SpectralDensityShiftsAndOccupationWeighting()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1490: spectral density shifts and occupation weighting");
    ...
    [Fact]
    public void TQMQG1491_ChargeIsospinModeAccessAndEffectiveDimension()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1491: charge/isospin mode access and effective dimension");
    ...
    [Fact]
    public void TQMQG1492_MechanismAndClassification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1492: physical mechanism and classification");
