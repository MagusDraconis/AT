...
/// <summary>
/// TQM-QG Phase 187 — GPS Correction Origin.
...
/// </summary>
public class TQMQG_Phase187_GpsCorrectionOriginTests : ResearchTestBase
{
    public TQMQG_Phase187_GpsCorrectionOriginTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQMQG1870_ClockRateIsTheRedshiftLaw()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1870: gravitational time dilation IS the QG21 redshift law");
    ...
    [Fact]
    public void TQMQG1871_FullCorrectionMatchesObserved()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1871: GPS correction = gravitational (redshift) + kinematic (SR)");
    ...
    [Fact]
    public void TQMQG1872_ClassificationGpsOrigin()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1872: GPS-correction origin classification");
