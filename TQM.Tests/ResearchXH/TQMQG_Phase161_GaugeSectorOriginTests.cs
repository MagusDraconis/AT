...
/// <summary>
/// TQM-QG Phase 161 — Gauge sector origin. The established chain is period-3 seed → D96 selection →
...
///
/// Tests: TQMQG1610 (automorphism generators + weak su(2)), TQMQG1611 (strong su(3) + total 1+3+8),
/// TQMQG1612 (Higgs collective mode + classification).
/// </summary>
public class TQMQG_Phase161_GaugeSectorOriginTests : ResearchTestBase
{
    public TQMQG_Phase161_GaugeSectorOriginTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQMQG1610_AutomorphismGeneratorsAndWeakSU2()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1610: D96 automorphism generators and the weak su(2)");
    ...
    [Fact]
    public void TQMQG1611_StrongSU3AndTotalStructure()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1611: strong su(3) from the 3 families and the total 1+3+8");
    ...
    [Fact]
    public void TQMQG1612_HiggsCollectiveModeAndClassification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1612: Higgs as collective scalar and classification");
