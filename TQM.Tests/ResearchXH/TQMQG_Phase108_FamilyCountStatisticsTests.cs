...
/// <summary>
/// TQM-QG Phase 108 — Family count statistics. QG107 found robust octave-band spectral mode families. This
...
///
/// Tests: TQMQG1080 (ensemble + family-count distribution), TQMQG1081 (hierarchy span + size scaling),
/// TQMQG1082 (N=3 preference + classification).
/// </summary>
public class TQMQG_Phase108_FamilyCountStatisticsTests : ResearchTestBase
{
    public TQMQG_Phase108_FamilyCountStatisticsTests(ITestOutputHelper o) : base(o) { }

    // ── TQMQG1080: ensemble + family-count distribution ───────────────────────────

    [Fact]
    public void TQMQG1080_EnsembleAndDistribution()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1080: family-count distribution over the large causal-graph ensemble");
    ...
    // ── TQMQG1081: hierarchy span + scaling with network size ─────────────────────

    [Fact]
    public void TQMQG1081_HierarchySpanAndSizeScaling()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1081: hierarchy span and family-count scaling with network size");
    ...
    [Fact]
    public void TQMQG1082_ThreePreferenceAndClassification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1082: preference for N=3 families → NO / WEAK / STRONG");
