...
///
/// Tests: TQMQG1830 (physical exponent pinned at 3), TQMQG1831 (only the cube reproduces M_Pl among
/// A¹..A⁴ and nearby exponents), TQMQG1832 (uniqueness among alternative A definitions + classification).
/// </summary>
public class TQMQG_Phase183_PlanckScaleRobustnessTests : ResearchTestBase
{
    public TQMQG_Phase183_PlanckScaleRobustnessTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQMQG1830_PhysicalExponentIsCubic()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1830: the physical Planck mass pins the exponent at 3");
    ...
    [Fact]
    public void TQMQG1831_OnlyTheCubeReproducesPlanckMass()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1831: only the cube reproduces M_Pl among A¹..A⁴ and nearby exponents");
    ...
    [Fact]
    public void TQMQG1832_UniquenessAmongAlternativesAndClassification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1832: uniqueness among alternative A definitions and classification");
