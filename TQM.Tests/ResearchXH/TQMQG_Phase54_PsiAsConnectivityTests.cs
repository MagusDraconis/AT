...
/// <summary>
/// TQM-QG Phase 54 — is ψ a connectivity primitive? Tests whether the spin-2 sector can originate from links.
/// Classify: FIELD / CONNECTIVITY / BOTH / IMPOSSIBLE.
///
/// Tests: TQMQG540 (adjacency tensor decomposition), TQMQG541 (Weyl content), TQMQG542 (classification).
/// </summary>
public class TQMQG_Phase54_PsiAsConnectivityTests : ResearchTestBase
{
    public TQMQG_Phase54_PsiAsConnectivityTests(ITestOutputHelper o) : base(o) { }

    // ── TQMQG540: adjacency tensor carries 2 spin-2 polarizations ────────────────────

    [Fact]
    public void TQMQG540_AdjacencyCarriesSpin2()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG540: a symmetric rank-2 adjacency tensor carries 2 spin-2 polarizations");
    ...
    // ── TQMQG541: ψ = Weyl content of the causal connectivity ────────────────────────

    [Fact]
    public void TQMQG541_WeylContent()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG541: ψ is the non-conformal (Weyl) content of the causal links");
    ...
    // ── TQMQG542: classification ───────────────────────────────────────────────────────

    [Fact]
    public void TQMQG542_Classification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG542: FIELD / CONNECTIVITY / BOTH / IMPOSSIBLE?");
