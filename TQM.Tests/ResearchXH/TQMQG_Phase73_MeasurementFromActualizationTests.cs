...
/// <summary>
/// TQM-QG Phase 73 — measurement from actualization. Determines whether measurement = Q-event actualization.
/// Classify: MATCH / PARTIAL MATCH / NO MATCH.
///
/// Tests: TQMQG730 (Born-weighted projection), TQMQG731 (binary limitation), TQMQG732 (classification).
/// </summary>
public class TQMQG_Phase73_MeasurementFromActualizationTests : ResearchTestBase
{
    public TQMQG_Phase73_MeasurementFromActualizationTests(ITestOutputHelper o) : base(o) { }

    // ── TQMQG730: actualization is a Born-weighted projection ───────────────────────

    [Fact]
    public void TQMQG730_BornWeightedProjection()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG730: a Q-event is a discrete, Born-weighted projection");
    ...
    // ── TQMQG731: the binary limitation ─────────────────────────────────────────────

    [Fact]
    public void TQMQG731_BinaryLimitation()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG731: the projection is binary (tick/no-tick), not general");
    ...
    // ── TQMQG732: classification ───────────────────────────────────────────────────────

    [Fact]
    public void TQMQG732_Classification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG732: MATCH / PARTIAL MATCH / NO MATCH?");
