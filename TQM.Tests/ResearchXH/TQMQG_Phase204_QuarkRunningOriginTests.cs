...
/// <summary>
/// TQM-QG Phase 204 — Quark Running Origin. Derive the scale dependence connecting the D96 masses (QG173)
/// to the MS̄ scheme. D96 only, deterministic, no fitted QCD factors. Targets: mc(mc), mb(mb), mt(mt) and
/// running to 2 GeV and MZ.
/// </summary>
public class TQMQG_Phase204_QuarkRunningOriginTests : ResearchTestBase
{
    public TQMQG_Phase204_QuarkRunningOriginTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQMQG2040_NativeMsBarScaleMatch()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2040: the D96 mass law is natively at the MS̄ natural scale");
    ...
    [Fact]
    public void TQMQG2041_SpectralAlphaSAndRunningExponent()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2041: spectral α_s and the D96 running exponent");
    ...
    [Fact]
    public void TQMQG2042_ClassificationRunningOrigin()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2042: classification — RUNNING ORIGIN");
