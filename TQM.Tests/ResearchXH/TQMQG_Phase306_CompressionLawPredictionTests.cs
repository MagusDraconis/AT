...
/// <summary>
/// TQM-QG Phase 306 — Compression Law Prediction. Do non-network systems (language, music, DNA,
/// software, finance) also produce CROWDING / COMPRESSION / BEAT / LOCKING? No observables, no
/// fitting, deterministic.
/// </summary>
public class TQMQG_Phase306_CompressionLawPredictionTests : ResearchTestBase
{
    public TQMQG_Phase306_CompressionLawPredictionTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQMQG3060_FiveNonNetworkDomains()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG3060: the five non-network domains");
    ...
    [Fact]
    public void TQMQG3061_OperatorSignatures()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG3061: the four operators in each non-network domain");
    ...
    [Fact]
    public void TQMQG3062_Classification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG3062: the compression-law determination");
