...
/// <summary>
/// TQM-QG Phase 25 — observable reconstruction audit. Separates the OBSERVED EFFECT (its spin) from the GR
/// EXPLANATION (spin-2). Classify each observable: TENSOR REQUIRED / OBSERVABLE AMBIGUITY / UNDECIDED.
///
/// Tests: TQMQG250 (spin census), TQMQG251 (classification counts), TQMQG252 (minimal d.o.f. refinement).
/// </summary>
public class TQMQG_Phase25_ObservableReconstructionAuditTests : ResearchTestBase
{
    public TQMQG_Phase25_ObservableReconstructionAuditTests(ITestOutputHelper o) : base(o) { }
    ...
    // ── TQMQG250: separate observed effect from GR explanation ────────────────────────

    [Fact]
    public void TQMQG250_SeparateEffectFromExplanation()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG250: observed effect (spin) vs GR explanation (tensor)");
    ...
    // ── TQMQG251: classification counts ────────────────────────────────────────────────

    [Fact]
    public void TQMQG251_ClassificationCounts()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG251: which failures are truly tensor requirements?");
    ...
    // ── TQMQG252: minimal d.o.f. refinement ─────────────────────────────────────────────

    [Fact]
    public void TQMQG252_MinimalDofRefinement()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG252: refined minimal extension after separating effect from explanation");
