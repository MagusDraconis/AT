...
/// <summary>
/// TQM-QG Phase 283 — Assignment Frontier Closure. Can the Question → Physics Role mapping be closed by
/// a D96-native role assignment law? D96 only, no observables.
/// </summary>
public class TQMQG_Phase283_AssignmentFrontierClosureTests : ResearchTestBase
{
    public TQMQG_Phase283_AssignmentFrontierClosureTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQMQG2830_UniqueAxisPositions()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2830: the full axis positions are unique");
    ...
    [Fact]
    public void TQMQG2831_RelationalSubclassResolved()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2831: the relational subclass resolution");
    ...
    [Fact]
    public void TQMQG2832_Classification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2832: the assignment closure determination");
