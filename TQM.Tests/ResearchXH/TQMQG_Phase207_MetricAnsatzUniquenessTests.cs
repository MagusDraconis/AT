...
/// <summary>
/// TQM-QG Phase 207 — Metric Ansatz Uniqueness. Test all admissible conformal powers ρ^a·η and alternative
...
/// </summary>
public class TQMQG_Phase207_MetricAnsatzUniquenessTests : ResearchTestBase
{
    public TQMQG_Phase207_MetricAnsatzUniquenessTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQMQG2070_MeasurePreservationUniquelySelectsMetricPower()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2070: measure preservation uniquely selects k = 2/d");
    ...
    [Fact]
    public void TQMQG2071_AccelerationAndEinsteinRecovery()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2071: geodesic acceleration and Einstein recovery select k = 2/d");
    ...
    [Fact]
    public void TQMQG2072_ClassificationPartialUnique()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2072: classification — PARTIAL UNIQUE");
