...
/// that definition emerges UNIQUELY from TQM principles (abundance conservation, normalization, positivity,
...
public class G4ME_Phase5_DeriveDeficitMatterTests : ResearchTestBase
{
    ...
    public void G4_ME52_AlternativeDefinitionsClassification()
    {
        ...
        double a = PhysicalObservables.TqmAcceleration(u => PhysicalObservables.Void(u), x, D);
