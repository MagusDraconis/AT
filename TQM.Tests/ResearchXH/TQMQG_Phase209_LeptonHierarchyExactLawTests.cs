...
/// <summary>
/// TQM-QG Phase 209 — Lepton Hierarchy Exact Law. Derive the exact me/m_μ/m_τ hierarchy law from D96
/// quantities only (Σm, occMom, λ₂, electron anchor), without empirical exponents. Deterministic.
/// </summary>
public class TQMQG_Phase209_LeptonHierarchyExactLawTests : ResearchTestBase
{
    public TQMQG_Phase209_LeptonHierarchyExactLawTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQMQG2090_ExactHierarchyRatios()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2090: the exact lepton hierarchy ratios");
    ...
    [Fact]
    public void TQMQG2091_ExactAbsoluteMasses()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2091: the exact muon and tau masses from the electron anchor");
    ...
    [Fact]
    public void TQMQG2092_ClassificationExactLaw()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2092: classification — EXACT LAW");
