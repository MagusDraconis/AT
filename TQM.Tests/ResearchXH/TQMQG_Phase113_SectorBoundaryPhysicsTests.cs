...
/// <summary>
/// TQM-QG Phase 113 — Sector boundary physics. QG112 found interacting network sectors. This phase asks whether
...
///
/// Tests: TQMQG1130 (boundary links + inter-sector coupling), TQMQG1131 (family transitions + mixing-angle
/// generation), TQMQG1132 (parameter localization + classification).
/// </summary>
public class TQMQG_Phase113_SectorBoundaryPhysicsTests : ResearchTestBase
{
    public TQMQG_Phase113_SectorBoundaryPhysicsTests(ITestOutputHelper o) : base(o) { }

    private static readonly int NA = CausalSet.BuildGrid(6, 6).Count;   // sector A = causal grid, N=91

    // ── TQMQG1130: boundary links + inter-sector coupling ─────────────────────────

    [Fact]
    public void TQMQG1130_BoundaryLinksAndCoupling()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1130: boundary links and inter-sector coupling of a two-sector network");
    ...
    // ── TQMQG1131: family transitions + mixing-angle generation ──────────────────

    [Fact]
    public void TQMQG1131_FamilyTransitionsAndMixingAngles()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1131: family-transition modes and boundary-generated mixing angles");
    ...
    // ── TQMQG1132: parameter localization + classification ────────────────────────

    [Fact]
    public void TQMQG1132_ParameterLocalizationAndClassification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1132: parameter localization → NO RELATION / PARTIAL / BOUNDARY ORIGIN");
