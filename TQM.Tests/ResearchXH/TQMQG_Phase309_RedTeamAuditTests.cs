...
/// <summary>
/// TQM-QG Phase 309 — Red Team Audit. Assume QG260-QG308 are WRONG; destroy the minimal theory. Search
...
/// </summary>
public class TQMQG_Phase309_RedTeamAuditTests : ResearchTestBase
{
    public TQMQG_Phase309_RedTeamAuditTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQMQG3090_CounterexampleDomains()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG3090: red-team attack (a) — degenerate counterexample domains");
    ...
    [Fact]
    public void TQMQG3091_FifthOperatorAndChainFailure()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG3091: red-team attacks (b) and (c)");
    ...
    public void TQMQG3092_Classification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG3092: the red-team outcome");
