...
/// <summary>
/// TQM-QG Phase 139 — Mass hierarchy from octave structure. QG138 established the family count follows the
...
///
/// Tests: TQMQG1390 (band positions + spectral gaps), TQMQG1391 (octave scaling + mass-ratio analogs),
/// TQMQG1392 (family hierarchy + classification).
/// </summary>
public class TQMQG_Phase139_MassHierarchyFromOctavesTests : ResearchTestBase
{
    public TQMQG_Phase139_MassHierarchyFromOctavesTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQMQG1390_BandPositionsAndSpectralGaps()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1390: octave band positions and spectral gaps");
    ...
    [Fact]
    public void TQMQG1391_OctaveScalingAndMassRatioAnalogs()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1391: octave scaling and mass-ratio analogs");
    ...
    [Fact]
    public void TQMQG1392_FamilyHierarchyAndClassification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1392: family hierarchy and classification");
