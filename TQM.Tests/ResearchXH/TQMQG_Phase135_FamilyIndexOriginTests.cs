...
/// <summary>
/// TQM-QG Phase 135 — Origin of the family index. QG134 established fermions carry a family index inside an
...
///
/// Tests: TQMQG1350 (intra-sector modes + family splitting), TQMQG1351 (family stability + hierarchy
/// formation), TQMQG1352 (generation count + classification).
/// </summary>
public class TQMQG_Phase135_FamilyIndexOriginTests : ResearchTestBase
{
    public TQMQG_Phase135_FamilyIndexOriginTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQMQG1350_IntraSectorModesAndFamilySplitting()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1350: intra-sector modes and family splitting");
    ...
    [Fact]
    public void TQMQG1351_FamilyStabilityAndHierarchyFormation()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1351: family stability and hierarchy formation");
    ...
    [Fact]
    public void TQMQG1352_GenerationCountAndClassification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1352: generation count and classification");
