...
/// <summary>
/// TQM-QG Phase 188 — Prediction Audit. Lists all remaining falsifiable predictions (from the physics-coverage
...
/// </summary>
public class TQMQG_Phase188_PredictionAuditTests : ResearchTestBase
{
    public TQMQG_Phase188_PredictionAuditTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQMQG1880_FullPredictionCatalog()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1880: complete remaining-prediction catalog");

        sb.AppendLine("ASSUMPTIONS:");
        sb.AppendLine("  - Source of truth: Docs/TQMQG_PhysicsCoverage.json (predictions, observables, open questions).");
    ...
    [Fact]
    public void TQMQG1881_HorizonClassificationAndRanking()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1881: horizon classification (now / soon / inaccessible) and composite ranking");
    ...
    [Fact]
    public void TQMQG1882_Top10AndRecommendedTarget()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1882: Top-10 predictions and recommended next target");
