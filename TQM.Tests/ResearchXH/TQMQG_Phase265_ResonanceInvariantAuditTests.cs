...
/// <summary>
/// TQM-QG Phase 265 — Resonance Invariant Audit. What is the actual conserved quantity behind the four
/// operators? D96 only, no observables.
/// </summary>
public class TQMQG_Phase265_ResonanceInvariantAuditTests : ResearchTestBase
{
    public TQMQG_Phase265_ResonanceInvariantAuditTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQMQG2650_ConservedQuantity()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2650: the conserved quantity — the total spectral weight");
    ...
    [Fact]
    public void TQMQG2651_OperatorsReadSameInvariant()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2651: all operators are measurements of the one invariant");
    ...
    [Fact]
    public void TQMQG2652_Classification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2652: the invariant determination");
