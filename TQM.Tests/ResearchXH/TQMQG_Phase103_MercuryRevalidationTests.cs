...
/// <summary>
/// TQM-QG Phase 103 — Mercury perihelion revalidation. Computes the observed 42.98 "/century from first principles
/// and compares the scalar-only conformal sector (γ=−1) against the unified (ρ+ψ, spin-2) sector.
/// Classify: MATCH / PARTIAL / FAIL.
///
/// Tests: TQMQG1030 (GR baseline + PPN factor machinery), TQMQG1031 (conformal FAIL vs unified MATCH),
/// TQMQG1032 (classification).
/// </summary>
public class TQMQG_Phase103_MercuryRevalidationTests : ResearchTestBase
{
    public TQMQG_Phase103_MercuryRevalidationTests(ITestOutputHelper o) : base(o) { }

    // ── TQMQG1030: weak-field metric → GR baseline & PPN factor ────────────────────

    [Fact]
    public void TQMQG1030_GrBaseline()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1030: GR baseline perihelion (42.98 \"/century)");
    ...
    // ── TQMQG1031: conformal (ρ-only) FAIL vs unified (ρ+ψ) MATCH ──────────────────

    [Fact]
    public void TQMQG1031_ConformalVsUnified()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1031: scalar-only conformal vs unified (ρ+ψ) network");
    ...
    [Fact]
    public void TQMQG1032_Classification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1032: MATCH / PARTIAL / FAIL?");
