...
/// <summary>
/// TQM-QG Phase 174 — Strong CP origin. Known: QG161 (gauge sector 1+3+8), QG166 (CKM CP from chiral
...
///
/// Tests: TQMQG1740 (D96 reflection automorphism + real spectrum), TQMQG1741 (real mass determinant →
/// arg det = 0 → θ_QCD = 0), TQMQG1742 (weak-vs-strong contrast + bound + classification).
/// </summary>
public class TQMQG_Phase174_StrongCPOriginTests : ResearchTestBase
{
    public TQMQG_Phase174_StrongCPOriginTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQMQG1740_D96ReflectionAndRealSpectrum()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1740: D96 reflection automorphism and the real spectrum");
    ...
    [Fact]
    public void TQMQG1741_RealDeterminantAndThetaQCD()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1741: real mass determinant → arg det = 0 → θ_QCD = 0");
        ...
        sb.AppendLine($"  θ_vac = 0   (reflection-even vacuum, TQMQG1740)");
    ...
    [Fact]
    public void TQMQG1742_WeakVsStrongAndClassification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1742: weak vs strong CP contrast and classification");
