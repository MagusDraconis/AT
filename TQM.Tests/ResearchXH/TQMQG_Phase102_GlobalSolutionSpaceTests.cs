...
/// <summary>
/// TQM-QG Phase 102 — Global Network Solution Space. Determines whether SM parameters are properties of globally
/// consistent network solutions. Classify: NO RELATION / PARTIAL RELATION / SOLUTION-SPACE ORIGIN.
///
/// Tests: TQMQG1020 (allowed classes + manifolds), TQMQG1021 (topology + correlations + uniqueness), TQMQG1022 (classification).
/// </summary>
public class TQMQG_Phase102_GlobalSolutionSpaceTests : ResearchTestBase
{
    public TQMQG_Phase102_GlobalSolutionSpaceTests(ITestOutputHelper o) : base(o) { }

    // ── TQMQG1020: allowed network classes, global consistency manifolds ───────────

    [Fact]
    public void TQMQG1020_ClassesAndManifolds()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1020: does a global solution space exist?");
    ...
    // ── TQMQG1021: topology, correlations, uniqueness ──────────────────────────────

    [Fact]
    public void TQMQG1021_TopologyCorrelationsUniqueness()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1021: solution-space topology, correlations, uniqueness");
    ...
    // ── TQMQG1022: classification ──────────────────────────────────────────────────

    [Fact]
    public void TQMQG1022_Classification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1022: NO RELATION / PARTIAL RELATION / SOLUTION-SPACE ORIGIN?");
