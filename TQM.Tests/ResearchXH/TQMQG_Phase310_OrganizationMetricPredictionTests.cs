...
/// <summary>
/// TQM-QG Phase 310 — Organization Metric Prediction. Hypothesis: operator strength (the degree of
...
/// </summary>
public class TQMQG_Phase310_OrganizationMetricPredictionTests : ResearchTestBase
{
    public TQMQG_Phase310_OrganizationMetricPredictionTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQMQG3100_OrganizationScores()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG3100: the organization scores from the four operators");
    ...
    [Fact]
    public void TQMQG3101_ClassSeparation()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG3101: the operator structure separates unorganized from organized");
    ...
    public void TQMQG3102_Classification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG3102: the organization-metric determination");
