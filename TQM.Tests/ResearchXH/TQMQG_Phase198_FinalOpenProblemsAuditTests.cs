...
/// <summary>
/// TQM-QG Phase 198 — Final Open Problems Audit. Enumerate ALL unresolved physics questions from the
...
/// </summary>
public class TQMQG_Phase198_FinalOpenProblemsAuditTests : ResearchTestBase
{
    public TQMQG_Phase198_FinalOpenProblemsAuditTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQMQG1980_CatalogIsCompleteAndExclusionsRespected()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1980: the complete unresolved-problem catalog (exclusions respected)");

        sb.AppendLine("ASSUMPTIONS:");
        sb.AppendLine("  - Sources: Docs/TQMQG_PhysicsCoverage.json (open_questions, observables, gr_topics)");
        sb.AppendLine("    and Docs/TQMQG_Predictions.json (registered predictions, outcome = null ⇒ PENDING).");
    ...
    [Fact]
    public void TQMQG1981_Top20RankedByImportance()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1981: Top-20 open problems ranked by importance");
    ...
    [Fact]
    public void TQMQG1982_EveryProblemHasReasonBlockingAndPriority()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1982: why-open, blocking impact, and priority for every problem");
