...
/// <summary>
/// TQM-QG Phase 182 — G bridge origin. Known: QG6 (deficit GM_eff = m₀·r₀/(d·ρ̄), magnitude free),
...
///
/// Tests: TQMQG1820 (deficit parameters from D96 occupancy), TQMQG1821 (GM_eff = 1/ln(M_Pl/v) bridge
/// equation), TQMQG1822 (equivalence + classification).
/// </summary>
public class TQMQG_Phase182_GravityBridgeOriginTests : ResearchTestBase
{
    public TQMQG_Phase182_GravityBridgeOriginTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQMQG1820_DeficitParametersFromD96()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1820: deficit parameters m₀, r₀, ρ̄ from D96 occupancy");
    ...
    [Fact]
    public void TQMQG1821_BridgeEquation()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1821: the bridge equation GM_eff = 1/ln(M_Pl/v)");
        ...
        sb.AppendLine("With the D96 deficit parameters (TQMQG1820), the deficit scale must equal the inverse");
    ...
    [Fact]
    public void TQMQG1822_EquivalenceAndClassification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1822: equivalence of the two G constructions and classification");
