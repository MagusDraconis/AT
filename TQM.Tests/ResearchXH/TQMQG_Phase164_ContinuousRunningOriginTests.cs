...
/// <summary>
/// TQM-QG Phase 164 — Continuous running origin. QG163 established discrete running on the octave
...
///
/// Tests: TQMQG1640 (partial mode activation), TQMQG1641 (linear-in-doublet beta flow + interpolation),
/// TQMQG1642 (log-like running + continuum limit + classification).
/// </summary>
public class TQMQG_Phase164_ContinuousRunningOriginTests : ResearchTestBase
{
    public TQMQG_Phase164_ContinuousRunningOriginTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQMQG1640_PartialModeActivation()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1640: partial mode activation — continuous denominators");
    ...
    [Fact]
    public void TQMQG1641_LinearBetaFlowAndInterpolation()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1641: linear-in-doublet beta flow and fractional interpolation");
    ...
    [Fact]
    public void TQMQG1642_LogLikeRunningAndClassification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1642: log-like running and classification");
