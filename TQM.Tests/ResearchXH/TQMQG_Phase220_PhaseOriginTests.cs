...
/// <summary>
/// TQM-QG Phase 220 — Phase Origin. Derive θ (the U(1) angle) from network structure — no new primitives,
...
/// </summary>
public class TQMQG_Phase220_PhaseOriginTests : ResearchTestBase
{
    public TQMQG_Phase220_PhaseOriginTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQMQG2200_CausalCirculationPhase()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2200: the U(1) angle from causal circulation — cycle closure fixes the phase quantum");
    ...
    [Fact]
    public void TQMQG2201_LinkOrientationCyclesConnectivity()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2201: link orientation, network cycles, and the connectivity phase");
    ...
    [Fact]
    public void TQMQG2202_ClassificationPhaseOrigin()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2202: classification — PHASE ORIGIN");
