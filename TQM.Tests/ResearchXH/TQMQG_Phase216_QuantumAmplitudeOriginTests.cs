...
/// <summary>
/// TQM-QG Phase 216 — Quantum Amplitude Origin. Derive |ψ|² from Q-events only (no new primitives,
/// deterministic) via actualization frequency, path multiplicity, counting measure, and network branching.
/// </summary>
public class TQMQG_Phase216_QuantumAmplitudeOriginTests : ResearchTestBase
{
    public TQMQG_Phase216_QuantumAmplitudeOriginTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQMQG2160_AmplitudeMagnitudeIsCountingMeasureShare()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2160: |ψ|² = ρ = the normalized actualization share");
    ...
    [Fact]
    public void TQMQG2161_BornRuleHoldsExactly()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2161: the Born rule Σ|ψ|² = 1 is exact for any branching ratio");
    ...
    [Fact]
    public void TQMQG2162_ClassificationAmplitudeOrigin()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2162: classification — AMPLITUDE ORIGIN");
