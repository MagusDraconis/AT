...
/// <summary>
/// TQM-QG Phase 74 — general measurement basis. Determines whether actualization reproduces arbitrary bases.
/// Classify: MATCH / PARTIAL / NO MATCH.
///
/// Tests: TQMQG740 (multi-state), TQMQG741 (basis rotation + POVM), TQMQG742 (classification).
/// </summary>
public class TQMQG_Phase74_GeneralMeasurementTests : ResearchTestBase
{
    public TQMQG_Phase74_GeneralMeasurementTests(ITestOutputHelper o) : base(o) { }

    // ── TQMQG740: multi-state actualization ────────────────────────────────────────

    [Fact]
    public void TQMQG740_MultiStateActualization()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG740: the node is multi-state, not merely binary");
    ...
    // ── TQMQG741: basis rotation + POVM ────────────────────────────────────────────

    [Fact]
    public void TQMQG741_BasisRotationAndPovm()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG741: arbitrary bases via unitaries; POVMs via ancillas");
    ...
    // ── TQMQG742: classification ───────────────────────────────────────────────────────

    [Fact]
    public void TQMQG742_Classification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG742: MATCH / PARTIAL / NO MATCH?");
