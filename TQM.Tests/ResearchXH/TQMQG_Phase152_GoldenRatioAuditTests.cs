...
/// <summary>
/// TQM-QG Phase 152 — Golden-ratio robustness audit. QG151 found δ(up) − δ(down) ≈ φ (golden ratio) and
...
/// perturbations.
///
/// Tests: TQMQG1520 (size + K scaling), TQMQG1521 (damping + feedback + perturbations), TQMQG1522 (audit
/// aggregates + classification).
/// </summary>
public class TQMQG_Phase152_GoldenRatioAuditTests : ResearchTestBase
{
    public TQMQG_Phase152_GoldenRatioAuditTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQMQG1520_SizeAndKScaling()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1520: size and K scaling of the golden-ratio relation");
    ...
    [Fact]
    public void TQMQG1521_DampingFeedbackAndPerturbations()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1521: damping, feedback, and spectral-perturbation robustness");
    ...
    [Fact]
    public void TQMQG1522_AuditAggregatesAndClassification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1522: audit aggregates and classification");
