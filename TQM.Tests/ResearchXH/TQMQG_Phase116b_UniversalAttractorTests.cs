...
/// <summary>
/// TQM-QG Phase 116b — Origin of the universal attractor. QG116 showed the sustained self-reinforcing
...
///
/// Tests: TQMQG1163 (attractor stability), TQMQG1164 (basin size + universality), TQMQG1165 (fixed-point
/// structure + geometry emergence + classification).
/// </summary>
public class TQMQG_Phase116b_UniversalAttractorTests : ResearchTestBase
{
    public TQMQG_Phase116b_UniversalAttractorTests(ITestOutputHelper o) : base(o) { }

    // ── TQMQG1163: attractor stability ─────────────────────────────────────────────

    [Fact]
    public void TQMQG1163_AttractorStability()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1163: is the universal attractor a STABLE fixed point of the dynamics?");
    ...
    // ── TQMQG1164: basin size + universality ───────────────────────────────────────

    [Fact]
    public void TQMQG1164_BasinSizeAndUniversality()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1164: how large is the attractor basin; is the geometry universal in network size?");
    ...
    // ── TQMQG1165: fixed-point structure + geometry emergence + classification ─────

    [Fact]
    public void TQMQG1165_FixedPointStructureAndClassification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1165: geometry emergence, parameter dependence, and classification");
