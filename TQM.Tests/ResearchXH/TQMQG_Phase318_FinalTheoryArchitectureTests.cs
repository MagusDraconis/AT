...
/// <summary>
/// TQM-QG Phase 318 (reissue 2) — Final Theory Architecture. Review QG223-QG317 and produce the CANONICAL
/// MINIMAL ARCHITECTURE of TQM: 4 layers [primitive, dynamic, spectrum, physics], every concept
...
/// </summary>
public class TQMQG_Phase318_FinalTheoryArchitectureTests : ResearchTestBase
{
    public TQMQG_Phase318_FinalTheoryArchitectureTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQMQG3180_TheFourLayers()
    {
    ...
    [Fact]
    public void TQMQG3181_TheDependencyGraphIsAcyclic()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG3181: the dependency graph is acyclic and topological");
    ...
    public void TQMQG3182_Classification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG3182: the final architecture determination");

        sb.AppendLine("HYPOTHESES:");
        sb.AppendLine("  - FINAL TQM ARCHITECTURE: the canonical minimal architecture is complete and");
        ...
        Assert.Equal("FINAL TQM ARCHITECTURE", FinalTheoryArchitecture.Classify());
        Assert.Equal(6, FinalTheoryArchitecture.ArchitectureScore());
        Assert.Contains("FINAL TQM ARCHITECTURE", FinalTheoryArchitecture.Summary());
    }
}
