...
///
/// Tests: TQMQG1070 (random topologies vs causal grids), TQMQG1071 (perturbed + sparse/dense graphs),
/// TQMQG1072 (family-count statistics + classification).
/// </summary>
public class TQMQG_Phase107_FamilyStructureRobustnessTests : ResearchTestBase
{
    public TQMQG_Phase107_FamilyStructureRobustnessTests(ITestOutputHelper o) : base(o) { }

    // ── TQMQG1070: random topologies vs causal grids ──────────────────────────────

    [Fact]
    public void TQMQG1070_RandomVsCausalGrids()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1070: octave families in random topologies vs causal grids");
    ...
    // ── TQMQG1071: perturbed networks + sparse vs dense graphs ────────────────────

    [Fact]
    public void TQMQG1071_PerturbedAndSparseDense()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1071: octave families under perturbations and across density");
    ...
    [Fact]
    public void TQMQG1072_FamilyCountStatisticsAndClassification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1072: family-count statistics across all network classes → ACCIDENTAL / ROBUST / UNIVERSAL");
