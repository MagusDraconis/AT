...
/// <summary>
/// TQM-QG Phase 296 — Reconstruction Audit. Reconstruct all major QG results (QG223-295) from only
...
/// </summary>
public class TQMQG_Phase296_ReconstructionAuditTests : ResearchTestBase
{
    public TQMQG_Phase296_ReconstructionAuditTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQMQG2960_DirectResults()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2960: the DIRECT results use only the minimal hierarchy");
    ...
    [Fact]
    public void TQMQG2961_IndirectResults()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2961: the INDIRECT results need only the ONE scale + derived intermediates");
    ...
    [Fact]
    public void TQMQG2962_Classification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2962: the reconstruction determination");
