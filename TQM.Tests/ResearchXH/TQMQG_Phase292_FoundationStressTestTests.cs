...
/// <summary>
/// TQM-QG Phase 292 — Foundation Stress Test. Remove one foundation item at a time
...
/// </summary>
public class TQMQG_Phase292_FoundationStressTestTests : ResearchTestBase
{
    public TQMQG_Phase292_FoundationStressTestTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQMQG2920_CaseADifferenceRemoved()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2920: Case A — Difference removed: NOTHING survives");
    ...
    [Fact]
    public void TQMQG2921_CaseBEtaRemoved()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2921: Case B — η removed: the counting/scalar chain survives");
    ...
    [Fact]
    public void TQMQG2922_Classification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2922: the foundation determination");
