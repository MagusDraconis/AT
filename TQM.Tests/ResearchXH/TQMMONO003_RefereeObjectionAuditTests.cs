...
/// </summary>
public class TQMMONO003_RefereeObjectionAuditTests : ResearchTestBase
{
    public TQMMONO003_RefereeObjectionAuditTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQMMONO0030_FiftyObjectionsCatalogued()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMMONO0030: the Top-50 referee objections are catalogued and classified");
    ...
    [Fact]
    public void TQMMONO0031_StrongestObjections()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMMONO0031: the strongest objections (FATAL and MAJOR) and their resolutions");
    ...
    [Fact]
    public void TQMMONO0032_Verdict()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMMONO0032: the hostile-referee verdict");
