...
/// <summary>
/// TQM-QG Phase 213 — Ultra Frontier Audit. Recompute the frontier after QG212, excluding resolved /
...
/// </summary>
public class TQMQG_Phase213_UltraFrontierAuditTests : ResearchTestBase
{
    public TQMQG_Phase213_UltraFrontierAuditTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQMQG2130_TheoryCompletionPercentage()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2130: percentage of theory completed");
    ...
    [Fact]
    public void TQMQG2131_ExclusionsAndTop10()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2131: exclusions and the Top-10 frontier");
    ...
    [Fact]
    public void TQMQG2132_FrontierPrimarilyExperimental()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2132: the remaining frontier is primarily experimental");
