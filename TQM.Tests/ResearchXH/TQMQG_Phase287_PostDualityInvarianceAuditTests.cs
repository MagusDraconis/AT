...
/// <summary>
/// TQM-QG Phase 287 — Post-Duality Invariance Audit. The QG286 reinterpretation
...
/// </summary>
public class TQMQG_Phase287_PostDualityInvarianceAuditTests : ResearchTestBase
{
    public TQMQG_Phase287_PostDualityInvarianceAuditTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQMQG2870_PredictionRegistryInvariant()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2870: the frozen registry (P1/P2/P3) is reproduced exactly");
    ...
    [Fact]
    public void TQMQG2871_MassesCouplingsMixingsInvariant()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2871: masses, couplings, and mixings are numerically invariant");
    ...
    [Fact]
    public void TQMQG2872_CosmologyAndClassification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2872: cosmology invariance and the final determination");
