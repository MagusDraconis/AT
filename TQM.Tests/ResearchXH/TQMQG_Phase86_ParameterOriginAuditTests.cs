...
/// <summary>
/// TQM-QG Phase 86 — Parameter Origin Audit. Determines whether any network mechanism can constrain the free SM
/// parameters. Classify: CONSTRAINED / PARTIAL / FULLY FREE.
///
/// Tests: TQMQG860 (capacity + symmetry), TQMQG861 (entropy + counting + minimal description), TQMQG862 (classification).
/// </summary>
public class TQMQG_Phase86_ParameterOriginAuditTests : ResearchTestBase
{
    public TQMQG_Phase86_ParameterOriginAuditTests(ITestOutputHelper o) : base(o) { }

    // ── TQMQG860: information capacity, symmetry constraints ───────────────────────

    [Fact]
    public void TQMQG860_CapacityAndSymmetry()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG860: do capacity and symmetry constrain the values?");
    ...
    // ── TQMQG861: entropy, parameter counting, minimal description ─────────────────

    [Fact]
    public void TQMQG861_EntropyCountingDescription()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG861: is the count/form constrained? entropy / minimal description native?");
    ...
    // ── TQMQG862: classification ───────────────────────────────────────────────────

    [Fact]
    public void TQMQG862_Classification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG862: CONSTRAINED / PARTIAL / FULLY FREE?");
