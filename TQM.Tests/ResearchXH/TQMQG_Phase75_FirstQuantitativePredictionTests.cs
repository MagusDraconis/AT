...
/// <summary>
/// TQM-QG Phase 75 — first quantitative prediction of the unified network theory.
/// Classify: UNIQUE / TESTABLE / FALSIFIABLE.
///
/// Tests: TQMQG750 (the profile), TQMQG751 (uniqueness), TQMQG752 (classification).
/// </summary>
public class TQMQG_Phase75_FirstQuantitativePredictionTests : ResearchTestBase
{
    public TQMQG_Phase75_FirstQuantitativePredictionTests(ITestOutputHelper o) : base(o) { }

    // ── TQMQG750: the predicted profile ────────────────────────────────────────────

    [Fact]
    public void TQMQG750_PredictedProfile()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG750: M_eff(r) = M(1 - e^(-r^3/rc^3))");
    ...
    [Fact]
    public void TQMQG751_Uniqueness()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG751: the specific form differs from GR and from Hayward/Bardeen");
    ...
    // ── TQMQG752: classification ───────────────────────────────────────────────────────

    [Fact]
    public void TQMQG752_Classification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG752: UNIQUE / TESTABLE / FALSIFIABLE?");
