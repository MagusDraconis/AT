...
/// <summary>
/// TQM-QG Phase 286 — Difference Duality Audit. Are ρ and ψ independent primitives, or dual projections
/// of Difference? D96 only, no observables.
/// </summary>
public class TQMQG_Phase286_DifferenceDualityAuditTests : ResearchTestBase
{
    public TQMQG_Phase286_DifferenceDualityAuditTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQMQG2860_TwoSectors()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2860: the two sectors — scalar and tensor difference");
    ...
    [Fact]
    public void TQMQG2861_TraceTracelessDecomposition()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2861: the trace/traceless decomposition — ρ and ψ are not independent");
    ...
    [Fact]
    public void TQMQG2862_Classification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2862: the final duality determination");
        ...
        sb.AppendLine("    'primitives' of TQM are the two faces of the single Difference: the scalar");
