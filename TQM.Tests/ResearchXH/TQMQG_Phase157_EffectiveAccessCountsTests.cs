...
/// <summary>
/// TQM-QG Phase 157 — Origin of effective access counts. QG156 established δ = log(N_eff)/log(span) and
...
///
/// Tests: TQMQG1570 (D96 moment structure), TQMQG1571 (derived counts predict sectors), TQMQG1572
/// (no-parameter law + classification).
/// </summary>
public class TQMQG_Phase157_EffectiveAccessCountsTests : ResearchTestBase
{
    public TQMQG_Phase157_EffectiveAccessCountsTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQMQG1570_D96MomentStructure()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1570: D96 moment structure");
    ...
    [Fact]
    public void TQMQG1571_DerivedCountsPredictSectors()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1571: derived counts predict the sector dimensions");
    ...
    [Fact]
    public void TQMQG1572_NoParameterLawAndClassification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1572: no-parameter law and classification");
