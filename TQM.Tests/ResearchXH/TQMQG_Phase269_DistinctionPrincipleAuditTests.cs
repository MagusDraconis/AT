...
/// <summary>
/// TQM-QG Phase 269 — Distinction Principle Audit. What makes a Q-event a distinguishable unit? Is count
/// more fundamental than distinction, or vice versa? D96 only, no observables.
/// </summary>
public class TQMQG_Phase269_DistinctionPrincipleAuditTests : ResearchTestBase
{
    public TQMQG_Phase269_DistinctionPrincipleAuditTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQMQG2690_CountabilityAndStructure()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2690: countability and the regular network");
    ...
    [Fact]
    public void TQMQG2691_DegeneracyEvidence()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2691: the degeneracy evidence — count works without spectral distinction");
    ...
    [Fact]
    public void TQMQG2692_Classification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2692: the individuation determination");
