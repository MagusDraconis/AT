...
/// <summary>
/// TQM-QG Phase 90 — Origin of gauge sector splitting. Determines why the link decomposes into three gauge sectors
/// instead of one unified gauge structure. Classify: DERIVED / PARTIAL / POSTULATED.
///
/// Tests: TQMQG900 (representation hierarchy + minimal link info), TQMQG901 (symmetry breaking + relations +
/// unification), TQMQG902 (classification).
/// </summary>
public class TQMQG_Phase90_GaugeSectorSplittingTests : ResearchTestBase
{
    public TQMQG_Phase90_GaugeSectorSplittingTests(ITestOutputHelper o) : base(o) { }

    // ── TQMQG900: representation hierarchy, minimal link information ───────────────

    [Fact]
    public void TQMQG900_HierarchyAndMinimalLink()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG900: three sectors on one link — product structure");
    ...
    // ── TQMQG901: symmetry breaking, relations, unified candidates ─────────────────

    [Fact]
    public void TQMQG901_SymmetryAndUnification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG901: is unification native?");
    ...
    // ── TQMQG902: classification ───────────────────────────────────────────────────

    [Fact]
    public void TQMQG902_Classification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG902: DERIVED / PARTIAL / POSTULATED?");
