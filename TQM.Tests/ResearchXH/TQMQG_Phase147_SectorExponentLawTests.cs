...
/// <summary>
/// TQM-QG Phase 147 — Sector-dependent exponent law. QG146 established up/down require different effective
/// exponents. This phase asks whether charge and isospin can determine the hierarchy exponent itself.
///
/// Tests: TQMQG1470 (exponent vs charge/T3/cross), TQMQG1471 (effective spectral dimension + law fit),
/// TQMQG1472 (hierarchy reconstruction + classification).
/// </summary>
public class TQMQG_Phase147_SectorExponentLawTests : ResearchTestBase
{
    public TQMQG_Phase147_SectorExponentLawTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQMQG1470_ExponentVsChargeIsospinCross()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1470: hierarchy exponent vs charge, isospin, and cross term");
    ...
    [Fact]
    public void TQMQG1471_EffectiveSpectralDimensionAndLawFit()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1471: effective spectral dimension and exponent-law fit");
    ...
    [Fact]
    public void TQMQG1472_HierarchyReconstructionAndClassification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1472: hierarchy reconstruction and classification");
