...
/// <summary>
/// TQM-QG Phase 109 — Selection of the physical network. QG102 found many globally-consistent network classes;
...
///
/// Tests: TQMQG1090 (stability + attractor basins), TQMQG1091 (actualization statistics + growth history),
/// TQMQG1092 (anthropic-free selection + classification).
/// </summary>
public class TQMQG_Phase109_PhysicalNetworkSelectionTests : ResearchTestBase
{
    public TQMQG_Phase109_PhysicalNetworkSelectionTests(ITestOutputHelper o) : base(o) { }

    // ── TQMQG1090: stability selection + attractor basins ─────────────────────────

    [Fact]
    public void TQMQG1090_StabilityAndAttractorBasins()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1090: does stability + attractor structure narrow the network class?");
    ...
    // ── TQMQG1091: actualization statistics + growth history ─────────────────────

    [Fact]
    public void TQMQG1091_ActualizationStatisticsAndGrowth()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1091: actualization statistics and network growth history");
    ...
    [Fact]
    public void TQMQG1092_AnthropicFreeSelectionAndClassification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1092: anthropic-free selection → NO / PARTIAL / PHYSICAL");
