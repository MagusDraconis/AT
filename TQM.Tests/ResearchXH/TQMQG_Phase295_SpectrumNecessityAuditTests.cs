...
/// <summary>
/// TQM-QG Phase 295 — Spectrum Necessity Audit. Is the spectrum fundamental (primitive input), derived
...
/// </summary>
public class TQMQG_Phase295_SpectrumNecessityAuditTests : ResearchTestBase
{
    public TQMQG_Phase295_SpectrumNecessityAuditTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQMQG2950_ActualizationDynamicsConverge()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2950: the actualization dynamics converge to a unique fixed point");
    ...
    [Fact]
    public void TQMQG2951_BoundaryAndSpectrum()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2951: the boundary is the closure; the spectrum is its eigenspectrum");
    ...
    [Fact]
    public void TQMQG2952_Classification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2952: the spectrum origin determination");
