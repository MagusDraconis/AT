...
/// <summary>
/// TQM-QG Phase 264 — Projection Family Audit. Are the density and frequency projections fundamental,
/// or manifestations of a single resonance invariant? No observables, no formulas, D96 only.
/// </summary>
public class TQMQG_Phase264_ProjectionFamilyAuditTests : ResearchTestBase
{
    public TQMQG_Phase264_ProjectionFamilyAuditTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQMQG2640_SharedOriginAndDuality()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2640: shared origin and the frequency → density duality");
    ...
    [Fact]
    public void TQMQG2641_UnifiedExponentLaw()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2641: the density ↔ frequency duality (unified exponent law)");
    ...
    [Fact]
    public void TQMQG2642_Classification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2642: the projection-family determination");
