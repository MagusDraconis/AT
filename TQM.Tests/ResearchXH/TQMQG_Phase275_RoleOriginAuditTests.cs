...
/// <summary>
/// TQM-QG Phase 275 — Role Origin Audit. Why does a measurement class receive a sector role? What
/// determines the role assignment? D96 only, no observables.
/// </summary>
public class TQMQG_Phase275_RoleOriginAuditTests : ResearchTestBase
{
    public TQMQG_Phase275_RoleOriginAuditTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQMQG2750_OntologicalPositions()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2750: the class positions on the ontological axes");
    ...
    [Fact]
    public void TQMQG2751_ForcedAssignments()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2751: the forced class→role assignments");
    ...
    [Fact]
    public void TQMQG2752_Classification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2752: the role-origin determination");
