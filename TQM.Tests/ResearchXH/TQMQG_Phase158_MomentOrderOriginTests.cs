...
/// <summary>
/// TQM-QG Phase 158 — Moment order origin. QG157 established N_eff = moment(D96 multiplicity structure)
...
///
/// Tests: TQMQG1580 (Z2 base-2 inevitability), TQMQG1581 (mode-selection rule and half-moment),
/// TQMQG1582 (Z2-power law and classification).
/// </summary>
public class TQMQG_Phase158_MomentOrderOriginTests : ResearchTestBase
{
    public TQMQG_Phase158_MomentOrderOriginTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQMQG1580_Z2Base2Inevitability()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1580: Z2 base-2 inevitability of the moment orders");
    ...
    [Fact]
    public void TQMQG1581_ModeSelectionRuleAndHalfMoment()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1581: mode-selection rule and half-moment origin");
    ...
    [Fact]
    public void TQMQG1582_Z2PowerLawAndClassification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1582: Z2-power law and classification");
