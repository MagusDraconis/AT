...
/// <summary>
/// TQM-QG Phase 221 — Quantum Gravity Reclosure Audit (after QG220). Re-evaluate the QG status using QG215
/// (baseline), QG216 (amplitude magnitude), QG218 (complex structure), and QG220 (phase origin). Audit only.
/// </summary>
public class TQMQG_Phase221_QuantumGravityReclosureAuditTests : ResearchTestBase
{
    public TQMQG_Phase221_QuantumGravityReclosureAuditTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQMQG2210_ReclosureDeltas()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2210: the reclosure deltas since QG215 — the phase origin is now closed");
    ...
    [Fact]
    public void TQMQG2211_GapStatuses()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2211: which QG219 gaps remain after the phase origin");
    ...
    [Fact]
    public void TQMQG2212_ClassificationNearCompleteQg()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2212: classification — NEAR-COMPLETE QG");
