...
/// <summary>
/// TQM-QG Phase 276 — Equation Class Audit. Why do different equation types exist? Is there a layer
/// between Role and Observable? D96 only, no observables.
/// </summary>
public class TQMQG_Phase276_EquationClassAuditTests : ResearchTestBase
{
    public TQMQG_Phase276_EquationClassAuditTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQMQG2760_EquationForms()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2760: the equation forms per sector");
    ...
    [Fact]
    public void TQMQG2761_FormSharing()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2761: the form sharing — equation classes are projection classes");
    ...
    [Fact]
    public void TQMQG2762_Classification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2762: the equation-layer determination");
