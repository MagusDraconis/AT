...
/// <summary>
/// TQM-QG Phase 256 — Selection Principle Audit. Determine whether the QG254/QG255 selection rules are
/// forced by D96 or were selected post-hoc. Methodology only.
/// </summary>
public class TQMQG_Phase256_SelectionPrincipleAuditTests : ResearchTestBase
{
    public TQMQG_Phase256_SelectionPrincipleAuditTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQMQG2560_TwoRulesAudited()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2560: the two selection rules audited");
    ...
    [Fact]
    public void TQMQG2561_NoetherInconsistency()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2561: the decisive 5/4 inconsistency");

        sb.AppendLine("ASSUMPTIONS:");
        sb.AppendLine("  - QG255 rejected '5/4·Σ√m/λ₂' because 5/4 is a 'free constant';");
        sb.AppendLine("  - If 5/4 appears in a PUBLISHED TQM formula, the exclusion is post-hoc.");
        sb.AppendLine();
    ...
    [Fact]
    public void TQMQG2562_Risk()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2562: the selection-principle risk");
