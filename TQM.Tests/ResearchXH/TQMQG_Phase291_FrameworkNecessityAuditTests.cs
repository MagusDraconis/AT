...
/// <summary>
/// TQM-QG Phase 291 — Framework Necessity Audit. Are the QG290 framework items {η, π} equally
...
/// </summary>
public class TQMQG_Phase291_FrameworkNecessityAuditTests : ResearchTestBase
{
    public TQMQG_Phase291_FrameworkNecessityAuditTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQMQG2910_EtaNecessary()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2910: η is NECESSARY — the reference structure presupposed by the duality");
    ...
    [Fact]
    public void TQMQG2911_PiRedundant()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2911: π is REDUNDANT — no derived prediction uses it");
    ...
    [Fact]
    public void TQMQG2912_MinimumFramework()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG2912: the minimum framework beyond Difference");
