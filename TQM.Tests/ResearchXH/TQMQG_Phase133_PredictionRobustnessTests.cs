...
///
/// Tests: TQMQG1330 (Z/H/W/t anchor calibrations), TQMQG1331 (parameter uncertainty), TQMQG1332 (score +
/// classification).
/// </summary>
public class TQMQG_Phase133_PredictionRobustnessTests : ResearchTestBase
{
    public TQMQG_Phase133_PredictionRobustnessTests(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQMQG1330_AnchorCalibrations()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1330: primary prediction across calibration anchors");
    ...
    [Fact]
    public void TQMQG1331_ParameterUncertainty()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1331: parameter uncertainty sensitivity");
    ...
    [Fact]
    public void TQMQG1332_RobustnessScoreAndClassification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1332: robustness score and classification");
