...
/// HIDDEN CLASSES.
///
/// Tests: TQMQG1190 (local accessibility + global spectrum), TQMQG1191 (hidden classes + suppression),
/// TQMQG1192 (observable vs total families + classification).
/// </summary>
public class TQMQG_Phase119_LocalVsGlobalAttractorsTests : ResearchTestBase
{
    public TQMQG_Phase119_LocalVsGlobalAttractorsTests(ITestOutputHelper o) : base(o) { }

    // ── TQMQG1190: local accessibility + global spectrum ───────────────────────────

    [Fact]
    public void TQMQG1190_LocalAccessibilityAndGlobalSpectrum()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1190: local attractor accessibility vs the global attractor spectrum");
    ...
    // ── TQMQG1191: hidden classes + suppression ────────────────────────────────────

    [Fact]
    public void TQMQG1191_HiddenClassesAndSuppression()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1191: are any global classes hidden, and are higher families suppressed?");
    ...
    [Fact]
    public void TQMQG1192_ObservableVsTotalAndClassification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG1192: observable vs total families → EXACT MATCH / LOCAL SUBSET / HIDDEN CLASSES");
