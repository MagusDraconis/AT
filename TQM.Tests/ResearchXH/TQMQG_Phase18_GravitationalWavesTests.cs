...
/// <summary>
/// TQM-QG Phase 18 — compatibility with observed gravitational waves. Tests whether observed GW phenomena can
/// arise in the scalar (conformal) sector, comparing polarization and trace structure. Classify: MATCH /
/// PARTIAL MATCH / NO MATCH.
///
/// Tests: TQMQG180 (polarization count), TQMQG181 (trace/transverse structure), TQMQG182 (classification).
/// </summary>
public class TQMQG_Phase18_GravitationalWavesTests : ResearchTestBase
{
    public TQMQG_Phase18_GravitationalWavesTests(ITestOutputHelper o) : base(o) { }

    // ── TQMQG180: polarization count — scalar 1 vs tensor 2 ──────────────────────────

    [Fact]
    public void TQMQG180_PolarizationCount()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG180: scalar sector has 1 breathing mode; GWs have 2 (+ and ×) modes");
    ...
    // ── TQMQG181: trace / transverse structure — breathing vs traceless ──────────────

    [Fact]
    public void TQMQG181_TraceTransverseStructure()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG181: scalar mode is breathing (non-zero trace); GWs are traceless");
    ...
    // ── TQMQG182: classification ───────────────────────────────────────────────────────

    [Fact]
    public void TQMQG182_Classification()
    {
        Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        var sb = new StringBuilder();
        PrintHeader("TQMQG182: can observed GWs arise in the scalar sector? MATCH / PARTIAL / NO MATCH?");
        ...
        sb.AppendLine("    observed GWs have TWO transverse-traceless modes (+, ×) (TQMQG180/181).");
        ...
        sb.AppendLine("  • Therefore TQM's scalar sector does NOT reproduce the observed gravitational waves: it is a PARTIAL");
