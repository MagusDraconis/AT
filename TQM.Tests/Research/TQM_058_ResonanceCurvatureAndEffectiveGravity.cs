...
public class TQM_058_ResonanceCurvatureAndEffectiveGravity : ResearchTestBase
{
    ...
    public TQM_058_ResonanceCurvatureAndEffectiveGravity(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQM_058_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("TQM-058 Resonance Curvature and Effective Gravity");

        report.AppendLine("TQM-058: Does State-Space Curvature Create Effective Directed Motion?");
        report.AppendLine();

        // ── Section 1: Objective ─────────────────────────────────────
        AppendSection(report, "1. Objective");
        report.AppendLine("  TQM-057 demonstrated deterministic near-geodesic trajectories.");
        ...
        report.AppendLine("  Experiment TQM-058 completed successfully.");
        report.AppendLine(new string('=', 100));
