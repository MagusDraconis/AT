...
public class TQM_076_PredictiveTrajectoryTheory : ResearchTestBase
{
    ...
    public TQM_076_PredictiveTrajectoryTheory(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQM_076_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("TQM-076 Predictive Trajectory Theory");

        sb.AppendLine("TQM-076: Can Future Trajectories Be Predicted from Initial Conditions?");
        sb.AppendLine();

        // ── Section 1: Objective ─────────────────────────────────────
        Sec(sb, "1. Objective");
        sb.AppendLine("  TQM-074: F_net = Alignment × ⟨f⟩ (R²=0.9895).");
        sb.AppendLine("  TQM-075: Alignment ≈ R² (R²=0.942).");
        sb.AppendLine();
        ...
        sb.AppendLine("    (a ≈ 2524 from TQM-074 calibration)");
        sb.AppendLine();
        ...
        sb.AppendLine("  Experiment TQM-076 completed successfully.");
        sb.AppendLine(new string('=', 100));
