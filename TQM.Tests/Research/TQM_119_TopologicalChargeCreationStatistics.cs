...
public class TQM_119_TopologicalChargeCreationStatistics : ResearchTestBase
{
    public TQM_119_TopologicalChargeCreationStatistics(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQM_119_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("TQM-119 Topological Charge Creation Statistics");

        // ══════════════════════════════════════════════════════════════
        // ASSUMPTIONS
        // ══════════════════════════════════════════════════════════════
        Sec(sb, "0. Assumptions");
        sb.AppendLine("  1. Q = #{connected domains where R(x)>0.5} (TQM-113, TQM-117).");
        sb.AppendLine("  2. Q=0 is the PDE vacuum; finite-N fluctuations make it metastable (TQM-118).");
        sb.AppendLine("  3. Charge creation = kink-antikink pair nucleation (TQM-118).");
        sb.AppendLine("  4. The creation condition is c₀·M₀ > D_R/w² (TQM-118).");
        sb.AppendLine("  5. Q is integer and additive (TQM-116).");
        ...
        sb.Clear();
        System.Diagnostics.Debug.WriteLine("Starting TQM-119 ensemble scan...");
        ...
        // ══════════════════════════════════════════════════════════════
        // SECTION 5: TQM-006 REINTERPRETATION
        // ══════════════════════════════════════════════════════════════
        Sec(sb, "5. TQM-006 Reinterpretation");

        sb.AppendLine("  TQM-006 identified a critical resonance density ρc ≈ 0.09");
        ...
        sb.AppendLine();
        sb.AppendLine("  The phase transition observed in TQM-006 is:");
        ...
        sb.AppendLine("    → Counter: TQM-118 already proved Q=0 is a stable PDE equilibrium.");
        sb.AppendLine("      TQM-119 only asks what STATISTICS govern transitions from Q=0.");
        sb.AppendLine();
        ...
        // ══════════════════════════════════════════════════════════════
        sb.AppendLine(new string('=', 100));
        sb.AppendLine("  Experiment TQM-119 completed successfully.");
