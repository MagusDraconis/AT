...
public class TQM_110_PDEvsDiscreteInteractionRegimes : ResearchTestBase
{
    public TQM_110_PDEvsDiscreteInteractionRegimes(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQM_110_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("TQM-110 PDE vs Discrete Interaction Regimes");

        // ── Section 1 ───────────────────────────────────────────────
        Sec(sb, "1. The Two Interaction Mechanisms");

        sb.AppendLine("  TQM has TWO distinct interaction mechanisms:");
        sb.AppendLine();
        ...
        sb.AppendLine("    • Drives rapid mergers (TQM-012)");
        sb.AppendLine();
        ...
        sb.AppendLine("    • Negligible at N=100 (TQM-109)");
        sb.AppendLine();
        ...
        sb.AppendLine($"  │           │ (TQM-012 mergers)│ K·exp(−d/λ) dominates     │");
        sb.AppendLine("  ├─────────────────────────────────────────────────────────┤");
        ...
        sb.AppendLine($"  │           │ (TQM-107 survival)│ D_R·∇²R, negligible at N=100│");
        sb.AppendLine("  └─────────────────────────────────────────────────────────┘");
        sb.AppendLine();
        ...
        sb.AppendLine("  Q4: Can TQM-012 mergers be reproduced?");
        sb.AppendLine($"    YES — TQM-012 separations (d ≤ 0.25) are near the coupling");
        ...
        sb.AppendLine($"  C6.  TQM-012 mergers: DISCRETE regime (d < coupling range)");
        sb.AppendLine($"  C7.  TQM-107 survival: PDE regime (d ≫ coupling range, negligible force)");
        sb.AppendLine($"  C8.  All TQM condensate interactions are DISCRETE, not field-theoretic");
        sb.AppendLine();

        sb.AppendLine(new string('=', 100));
        sb.AppendLine("  Experiment TQM-110 completed successfully.");
        sb.AppendLine(new string('=', 100));
