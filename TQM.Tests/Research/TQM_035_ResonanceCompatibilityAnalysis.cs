...
public class TQM_035_ResonanceCompatibilityAnalysis : ResearchTestBase
{
    ...
    public TQM_035_ResonanceCompatibilityAnalysis(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQM_035_Run()
    {
    ...
    private void Run()
    {
        ...
        PrintHeader("TQM-035 Resonance Compatibility Analysis");
        report.AppendLine("TQM-035: Do Condensates Need Compatibility to Form Assemblies?");
        report.AppendLine();

        AppendSection(report, "1. Objective");
        report.AppendLine("  TQM-034 showed proximity alone is insufficient. This experiment tests");
        ...
        report.AppendLine("  Experiment TQM-035 completed successfully.");
        report.AppendLine(new string('=', 100));
