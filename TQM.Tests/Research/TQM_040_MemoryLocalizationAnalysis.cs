...
public class TQM_040_MemoryLocalizationAnalysis : ResearchTestBase
{
    ...
    public TQM_040_MemoryLocalizationAnalysis(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQM_040_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("TQM-040 Memory Localization Analysis");
        report.AppendLine("TQM-040: Where Is Resonance Memory Stored?");
        report.AppendLine();

        AppendSection(report, "1. Objective");
        report.AppendLine("  TQM-036/037 showed memory creates persistent identity. This experiment");
        ...
        report.AppendLine("  Experiment TQM-040 completed successfully.");
        report.AppendLine(new string('=', 100));
