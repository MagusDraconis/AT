...
public class TQM_120_MinimalChargeQuantum : ResearchTestBase
{
    public TQM_120_MinimalChargeQuantum(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQM_120_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("TQM-120 Minimal Charge Quantum");

        // ══════════════════════════════════════════════════════════════
        // ASSUMPTIONS
        // ══════════════════════════════════════════════════════════════
        Sec(sb, "0. Assumptions");
        sb.AppendLine("  1. Q = #{connected components where R(x)>0.5} (TQM-113, TQM-117).");
        sb.AppendLine("  2. Q ∈ ℕ and is conserved under PDE evolution (TQM-116).");
        sb.AppendLine("  3. Q is created in kink-antikink pairs (TQM-118).");
        sb.AppendLine("  4. Q statistics are parameter-dependent (TQM-119).");
        ...
        sb.AppendLine("      Only the 0.5 threshold has the one-way barrier (TQM-117).");
        ...
        sb.AppendLine("    → TQM-011 showed condensates survive perturbations up to 50%.");
        ...
        sb.AppendLine("    → NO — merger is a DISCRETE event (TQM-012, TQM-116).");
        ...
        sb.AppendLine($"  Experiment TQM-120 completed successfully.  Runtime: {stopwatch.Elapsed.TotalSeconds:F0}s.");
