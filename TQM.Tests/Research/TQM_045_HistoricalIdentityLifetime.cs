...
public class TQM_045_HistoricalIdentityLifetime : ResearchTestBase
{
    ...
    public TQM_045_HistoricalIdentityLifetime(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQM_045_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("TQM-045 Historical Identity Lifetime");
        report.AppendLine("TQM-045: How Long Do Path-Dependent Identities Survive?");
        report.AppendLine();

        AppendSection(report, "1. Objective");
        report.AppendLine("  TQM-044 showed AB ≠ BA. This experiment tests whether the difference");
        ...
        report.AppendLine("  Experiment TQM-045 completed successfully.");
        report.AppendLine(new string('=', 100));
