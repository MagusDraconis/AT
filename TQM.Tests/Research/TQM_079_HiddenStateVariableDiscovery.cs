...
public class TQM_079_HiddenStateVariableDiscovery : ResearchTestBase
{
    ...
    public TQM_079_HiddenStateVariableDiscovery(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQM_079_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("TQM-079 Hidden State Variable Discovery");

        sb.AppendLine("TQM-079: What Hidden Variable Determines Coherence Evolution?");
        sb.AppendLine();

        // ── Section 1: Objective ─────────────────────────────────────
        Sec(sb, "1. Objective");
        sb.AppendLine("  TQM-078: dR/dt not predictable from R and K alone.");
        ...
        sb.AppendLine("  Experiment TQM-079 completed successfully.");
        sb.AppendLine(new string('=', 100));
