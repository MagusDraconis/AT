...
public class TQM_145_PhysicalObservables : ResearchTestBase
{
    public TQM_145_PhysicalObservables(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQM_145_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("TQM-145 Physical Observables from Topological Charge");

        Sec(sb, "0. Assumptions");
        sb.AppendLine("  1. Q is the fundamental topological charge (TQM-117-122).");
        sb.AppendLine("  2. Theta hierarchy = graph Laplacian physics (TQM-142/144).");
        ...
        sb.AppendLine($"  Experiment TQM-145 completed.");
