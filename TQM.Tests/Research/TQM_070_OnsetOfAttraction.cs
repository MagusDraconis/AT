...
public class TQM_070_OnsetOfAttraction : ResearchTestBase
{
    ...
    public TQM_070_OnsetOfAttraction(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQM_070_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("TQM-070 Onset of Attraction");

        sb.AppendLine("TQM-070: When Does Attraction First Emerge During Synchronization?");
        sb.AppendLine();

        // ── Section 1: Objective ─────────────────────────────────────
        Sec(sb, "1. Objective");
        sb.AppendLine("  TQM-062-069 established:");
        sb.AppendLine("    - Attraction exists (TQM-062).");
        sb.AppendLine("    - Not driven by error minimization (TQM-063).");
        sb.AppendLine("    - Not explained by curvature (TQM-068).");
        sb.AppendLine("    - Not fully explained by static function");
        sb.AppendLine("      properties (TQM-069).");
        sb.AppendLine();
        ...
        sb.AppendLine("  Experiment TQM-070 completed successfully.");
        sb.AppendLine(new string('=', 100));
