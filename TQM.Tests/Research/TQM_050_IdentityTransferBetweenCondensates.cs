...
public class TQM_050_IdentityTransferBetweenCondensates : ResearchTestBase
{
    ...
    public TQM_050_IdentityTransferBetweenCondensates(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQM_050_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("TQM-050 Identity Transfer Between Condensates");

        report.AppendLine("TQM-050: Can Resonance Identity Propagate Between Condensates?");
        report.AppendLine();

        // ── Section 1: Objective ─────────────────────────────────────
        AppendSection(report, "1. Objective");
        report.AppendLine("  TQM-049 demonstrated identity is latent and recoverable.");
        ...
        report.AppendLine("  Experiment TQM-050 completed successfully.");
        report.AppendLine(new string('=', 100));
