...
public class TQM_123_ProtoMatterCollectiveDynamics : ResearchTestBase
{
    public TQM_123_ProtoMatterCollectiveDynamics(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQM_123_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("TQM-123 Proto-Matter Collective Dynamics");
        ...
        sb.AppendLine("  3. Multiple Q=+1 droplets can coexist (TQM-010, TQM-107).");
        sb.AppendLine("  4. Condensates interact via coupling gradient (TQM-012, TQM-062).");
        ...
        sb.AppendLine("  TQM-117: Q derived from field equations.");
        sb.AppendLine("  TQM-118: Q created through topological nucleation.");
        sb.AppendLine("  TQM-119: Q follows statistical creation laws.");
        sb.AppendLine("  TQM-120: Q=1 is indivisible.");
        sb.AppendLine("  TQM-121: Q is fundamentally quantized (combined mechanism).");
        sb.AppendLine("  TQM-122: Q=1 is the minimal stable topological droplet (w_c > 0).");
        sb.AppendLine();
        ...
        sb.AppendLine("    → TQM-012 demonstrated that condensates MERGE within coupling range.");
        ...
        sb.AppendLine("      nucleation (ν term, from TQM-118), and binary mergers (γ term, from TQM-012).");
        ...
        sb.AppendLine("  ATTEMPT 5: Is the charge phase diagram just the TQM-006 phase diagram re-labeled?");
        sb.AppendLine("    → RELATED but DISTINCT. TQM-006 studied coherence order parameter R.");
        sb.AppendLine("    → TQM-123 studies CHARGE DENSITY ρ_Q, which includes the spatial organization");
        ...
        sb.AppendLine($"  Experiment TQM-123 completed successfully.  Runtime: {stopwatch.Elapsed.TotalSeconds:F0}s.");
