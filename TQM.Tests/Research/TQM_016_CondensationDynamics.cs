...
public class TQM_016_CondensationDynamics : ResearchTestBase
{
    ...
    public TQM_016_CondensationDynamics(ITestOutputHelper output) : base(output) { }

    [Fact]
    public void TQM_016_RunCondensationDynamics()
    {
    ...
    private void ExecuteExperiment()
    {
        ...
        PrintHeader("TQM-016 Condensation Dynamics");
        report.AppendLine("TQM-016: Birth Process of Resonance Condensates");
        report.AppendLine();

        AppendSection(report, "1. Objective");
        report.AppendLine("  TQM-015 identified ρc ≈ 0.035. This experiment investigates HOW");
        ...
        report.AppendLine("  Experiment TQM-016 completed successfully.");
        report.AppendLine(new string('=', 100));
        Output.WriteLine(report.ToString());
    }
