...
public class TQM_108_SpatialFieldTheoryDerivation : ResearchTestBase
{
    public TQM_108_SpatialFieldTheoryDerivation(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQM_108_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("TQM-108 Spatial Field Theory Derivation");

        // ── Section 1: Motivation ────────────────────────────────────
        Sec(sb, "1. From ODE to PDE");

        sb.AppendLine("  TQM-104/105: Derived ODE mean-field theory.");
        sb.AppendLine("  TQM-106:     (R,M)→(1,K) global attractor.");
        sb.AppendLine("  TQM-107:     Mean-field BREAKS for multi-condensate systems.");
        sb.AppendLine();
        ...
        sb.AppendLine("  In TQM-107, two condensates at separation 0.6 survived —");
        ...
        sb.AppendLine("    → ∂R/∂t = c₀·M·R·(1−R²)  [TQM-104]");
        sb.AppendLine("    → ∂M/∂t = a·R²            [TQM-105]");
        sb.AppendLine();
        ...
        sb.AppendLine("  Q5: Is TQM-010 proto-matter a field-theoretic soliton?");
        ...
        sb.AppendLine("  Q7: Does a true TQM field theory exist?");
        ...
        Sec(sb, "9. Conclusion");
        sb.AppendLine("  ┌─────────────────────────────────────────────────────────┐");
        sb.AppendLine("  │  TQM SPATIAL FIELD THEORY                               │");
        sb.AppendLine("  ├─────────────────────────────────────────────────────────┤");
        ...
        sb.AppendLine("       • TQM-104/105: ODE as homogeneous limit");
        sb.AppendLine("       • TQM-106:     Single-condensate attractor dynamics");
        sb.AppendLine("       • TQM-107:     Multi-condensate survival via diffusion");
        sb.AppendLine("       • TQM-010-012: Proto-matter as field-theoretic solitons");
        sb.AppendLine();

        sb.AppendLine(new string('=', 100));
        sb.AppendLine("  Experiment TQM-108 completed successfully.");
        sb.AppendLine(new string('=', 100));
