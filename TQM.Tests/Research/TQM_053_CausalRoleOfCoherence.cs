...
public class TQM_053_CausalRoleOfCoherence : ResearchTestBase
{
    ...
    public TQM_053_CausalRoleOfCoherence(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQM_053_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("TQM-053 Causal Role of Coherence");

        report.AppendLine("TQM-053: Is Coherence the CAUSE or a Correlate of Condensate Identity?");
        report.AppendLine();

        // ── Section 1: Objective ─────────────────────────────────────
        AppendSection(report, "1. Objective");
        report.AppendLine("  TQM-052 discovered Local Coherence is perfectly conserved across");
        ...
        report.AppendLine();
        report.AppendLine("  Correlation ≠ Causation. TQM-053 performs a causal intervention:");
        ...
        if (agg.CausalClassification.StartsWith("A:"))
        {
            ...
            report.AppendLine("      TQM-052's finding: coherence is the conserved foundation");
        ...
        report.AppendLine("  Experiment TQM-053 completed successfully.");
        report.AppendLine(new string('=', 100));
