...
public class TQM_113_TopologicalChargeOfProtoMatter : ResearchTestBase
{
    public TQM_113_TopologicalChargeOfProtoMatter(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQM_113_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("TQM-113 Topological Charge of Proto-Matter");
        ...
        sb.AppendLine("    Only mergers (discrete coupling, TQM-012) change it.");
        sb.AppendLine();
        ...
        sb.AppendLine("  Q5: Does topological charge explain TQM-011 stability?");
        sb.AppendLine("    YES — TQM-011 demonstrated 96% condensate survival under");
        ...
        sb.AppendLine("  │  • TQM-011: 96% survival under perturbations ✓          │");
        sb.AppendLine("  │  • TQM-012: Mergers when discrete coupling overlaps ✓   │");
        sb.AppendLine("  │  • TQM-107: Multi-condensate survival ✓                 │");
        sb.AppendLine("  │  • TQM-050: Identity exclusion (separate domains) ✓     │");
        sb.AppendLine("  ├─────────────────────────────────────────────────────────┤");
        ...
        sb.AppendLine("  Experiment TQM-113 completed successfully.");
        sb.AppendLine(new string('=', 100));
