...
public class TQM_114_TopologicalSpeciesSpectrum : ResearchTestBase
{
    public TQM_114_TopologicalSpeciesSpectrum(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQM_114_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("TQM-114 Topological Species Spectrum");
        ...
        sb.AppendLine("  Q7: Is TQM-008's single family result an N=100 artifact?");
        sb.AppendLine("    PARTIALLY. TQM-008 found only F4 is universal at N=100.");
        ...
        sb.AppendLine("  Experiment TQM-114 completed successfully.");
        sb.AppendLine(new string('=', 100));
