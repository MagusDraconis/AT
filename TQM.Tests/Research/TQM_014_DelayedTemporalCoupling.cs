...
/// <summary>
/// TQM-014: Delayed Temporal Coupling
///
...
/// </summary>
public class TQM_014_DelayedTemporalCoupling : ResearchTestBase
{
    ...
    public TQM_014_DelayedTemporalCoupling(ITestOutputHelper output) : base(output) { }

    [Fact]
    public void TQM_014_RunDelayedCouplingExperiment()
    {
    ...
    private void ExecuteExperiment()
    {
        ...
        PrintHeader("TQM-014 Delayed Temporal Coupling");
        report.AppendLine("TQM-014: Finite Propagation Speed in Oscillator Coupling");
        report.AppendLine();

        AppendSection(report, "1. Objective");
        report.AppendLine("  TQM-013 showed all internal states collapse to uniformity under");
        ...
        report.AppendLine("  Experiment TQM-014 completed successfully.");
        report.AppendLine(new string('=', 100));
