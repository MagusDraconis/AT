...
public class TQM_028_ConservedQuantitiesSearch : ResearchTestBase
{
    ...
    public TQM_028_ConservedQuantitiesSearch(ITestOutputHelper output) : base(output) { }

    [Fact]
    public void TQM_028_RunConservedQuantitySearch()
    {
    ...
    private void ExecuteExperiment()
    {
        ...
        PrintHeader("TQM-028 Conserved Quantities Search");
        report.AppendLine("TQM-028: Hidden Conservation Laws in Condensate Dynamics");
        report.AppendLine();

        AppendSection(report, "1. Objective");
        report.AppendLine("  TQM-015→027 found no single universal birth parameter. This experiment");
        ...
        report.AppendLine();
        report.AppendLine("  C2. The search for conservation laws in TQM condensates reveals:");
        ...
        report.AppendLine("      conservation laws in the TQM framework — precursors to the");
        report.AppendLine("      energy, momentum, and charge conservation of physical particles.");

        report.AppendLine();
        report.AppendLine(new string('=', 100));
        report.AppendLine("  Experiment TQM-028 completed successfully.");
        report.AppendLine(new string('=', 100));
