...
public class TQM_018_NucleationThreshold : ResearchTestBase
{
    ...
    public TQM_018_NucleationThreshold(ITestOutputHelper output) : base(output) { }

    [Fact]
    public void TQM_018_RunNucleationExperiment()
    {
    ...
    private void ExecuteExperiment()
    {
        ...
        PrintHeader("TQM-018 Resonance Nucleation Threshold");
        report.AppendLine("TQM-018: Minimum Viable Resonance Nucleus");
        report.AppendLine();

        AppendSection(report, "1. Objective");
        report.AppendLine("  TQM-017 showed condensate birth is cluster growth of pre-coherent nuclei.");
        ...
        report.AppendLine("  Experiment TQM-018 completed successfully.");
        report.AppendLine(new string('=', 100));
