...
public class TQM_065_CouplingSymmetryPrinciple : ResearchTestBase
{
    ...
    public TQM_065_CouplingSymmetryPrinciple(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQM_065_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("TQM-065 Coupling Symmetry Principle");

        report.AppendLine("TQM-065: Is Coupling Symmetry the Cause of Attraction?");
        report.AppendLine();

        AppendSection(report, "1. Objective");
        report.AppendLine("  TQM-064 showed 7/8 coupling laws attract. Only sin(Δθ) fails.");
        ...
        report.AppendLine("  Experiment TQM-065 completed successfully.");
        report.AppendLine(new string('=', 100));
