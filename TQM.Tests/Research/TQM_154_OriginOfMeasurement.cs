...
public class TQM_154_OriginOfMeasurement : ResearchTestBase
{
    public TQM_154_OriginOfMeasurement(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQM_154_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("TQM-154 Origin of Quantum Measurement");

        Sec(sb, "0. Assumptions");
        sb.AppendLine("  1. TQM-153: Schrödinger + Born rule established.");
        ...
        sb.AppendLine("  WHAT TQM (AND ALL PHYSICS) CAN EXPLAIN:");
        ...
        sb.AppendLine();
        sb.AppendLine("  This is NOT a TQM limitation. It is the measurement problem —");
        ...
        sb.AppendLine(new string('=', 100));
        sb.AppendLine($"  TQM-154 complete. Classification: {report.Classification}");
