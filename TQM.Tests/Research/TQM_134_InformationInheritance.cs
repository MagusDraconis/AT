...
public class TQM_134_InformationInheritance : ResearchTestBase
{
    public TQM_134_InformationInheritance(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQM_134_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("TQM-134 Information Species Reproduction and Inheritance");

        // ── Section 0: Assumptions ──
        Sec(sb, "0. Assumptions");
        sb.AppendLine("  1. Theta is an autonomous information layer (TQM-128).");
        sb.AppendLine("  2. 4 stable information species exist (TQM-133): A, B, C, D.");
        ...
        // ── Section 1: TQM-133 Recap ──
        Sec(sb, "1. TQM-133 Recap — Stable Information Species");
        sb.AppendLine("  TQM-133 discovered 4 stable information species in Theta:");
        ...
        sb.AppendLine("  (ρ_Q > 0.3, autonomy threshold from TQM-128), a species can generate");
        ...
        sb.AppendLine("  This would bridge proto-matter to proto-life within the TQM framework.");
        sb.AppendLine();
        ...
        sb.AppendLine($"  Experiment TQM-134 completed.");
