...
public class TQM_046_MemoryVsAttractorCompetition : ResearchTestBase
{
    ...
    public TQM_046_MemoryVsAttractorCompetition(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQM_046_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("TQM-046 Memory vs Attractor Competition");
        report.AppendLine("TQM-046: Does Memory Strength β Resist Attractor Convergence?");
        report.AppendLine();

        AppendSection(report, "1. Objective");
        report.AppendLine("  TQM-044/045 showed path dependence decays. This experiment maps");
        ...
        report.AppendLine("  Experiment TQM-046 completed successfully.");
        report.AppendLine(new string('=', 100));
