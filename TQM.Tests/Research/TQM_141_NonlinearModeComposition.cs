...
public class TQM_141_NonlinearModeComposition : ResearchTestBase
{
    public TQM_141_NonlinearModeComposition(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQM_141_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("TQM-141 Nonlinear Mode Composition and Species Emergence");

        Sec(sb, "0. Assumptions");
        sb.AppendLine("  1. 10 eigenmodes from TQM-140 form the spectral basis.");
        sb.AppendLine("  2. 13-19 species observed in TQM-138/139.");
        ...
        Sec(sb, "1. TQM-140 Recap — Spectral Origin");
        sb.AppendLine("  TQM-140: 10 eigenmodes, 7/7 species mapped, overlap 0.808.");
        ...
        sb.AppendLine($"  TQM-139 species mapped: {report.TotalSpeciesMapped}");
        ...
        sb.AppendLine($"  Eigenmodes (TQM-140):  10");
        sb.AppendLine($"  Composite species:     {report.SpeciesCountFromComposites}");
        sb.AppendLine($"  Observed (TQM-138/139): ~13-19");
        ...
        sb.AppendLine($"  Experiment TQM-141 completed.");
