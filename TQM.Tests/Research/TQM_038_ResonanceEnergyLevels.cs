...
public class TQM_038_ResonanceEnergyLevels : ResearchTestBase
{
    ...
    public TQM_038_ResonanceEnergyLevels(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQM_038_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("TQM-038 Resonance Energy Levels");
        report.AppendLine("TQM-038: Do Multiple Stable Energy States Exist?");
        report.AppendLine();

        AppendSection(report, "1. Objective");
        report.AppendLine("  TQM-036/037 showed memory creates identity. This experiment tests");
        ...
        report.AppendLine("  C3. Energy discretization in TQM is an emergent property of");
        report.AppendLine("      the resonance dynamics — potential precursor to quantum-like levels.");

        report.AppendLine();
        report.AppendLine(new string('=', 100));
        report.AppendLine("  Experiment TQM-038 completed successfully.");
        report.AppendLine(new string('=', 100));
