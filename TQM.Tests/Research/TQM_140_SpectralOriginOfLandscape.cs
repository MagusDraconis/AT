...
public class TQM_140_SpectralOriginOfLandscape : ResearchTestBase
{
    public TQM_140_SpectralOriginOfLandscape(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQM_140_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("TQM-140 Spectral Origin of the Information Landscape");
        ...
        sb.AppendLine("  3. ~13 species from TQM-139 are the test targets.");
        sb.AppendLine("  4. Assume NO spectral origin until eigenmode mapping is demonstrated.");
        sb.AppendLine();

        Sec(sb, "1. TQM-139 Recap — Finite Attractor Landscape");
        sb.AppendLine("  TQM-139: 13 attractors, 5 components, 2 hubs, 13 bottlenecks.");
        ...
        sb.AppendLine($"  TQM-139 species mapped: {report.MappedSpecies}/{report.TotalEigenmodes}");
        ...
        Sec(sb, "6. Spectral Predictions vs TQM-139 Observations");
        sb.AppendLine($"  Predicted species count:  {report.PredictedAttractorCount}");
        sb.AppendLine($"  TQM-139 observed count:   ~13 (from gradient descent)");
        sb.AppendLine($"  TQM-138 observed count:   ~19 (from evolution)");
        sb.AppendLine();
        ...
        sb.AppendLine($"  Experiment TQM-140 completed.");
