...
public class TQM_015_LocalDensityThresholdMapping : ResearchTestBase
{
    ...
    public TQM_015_LocalDensityThresholdMapping(ITestOutputHelper output) : base(output) { }

    [Fact]
    public void TQM_015_RunThresholdMapping()
    {
    ...
    private void ExecuteExperiment()
    {
        ...
        PrintHeader("TQM-015 Local Density Threshold Mapping");
        report.AppendLine("TQM-015: Critical Local Density for Resonance Condensation");
        report.AppendLine();
        ...
        report.AppendLine("      confirming the resonance condensation hypothesis from TQM-010.");

        report.AppendLine();
        report.AppendLine(new string('=', 100));
        report.AppendLine("  Experiment TQM-015 completed successfully.");
        report.AppendLine(new string('=', 100));
        Output.WriteLine(report.ToString());
    }
