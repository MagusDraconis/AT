...
public class TQM_128_AutonomousCollectiveWaveField : ResearchTestBase
{
    public TQM_128_AutonomousCollectiveWaveField(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQM_128_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("TQM-128 Autonomous Collective Wave Field");

        Sec(sb, "0. Assumptions");
        sb.AppendLine("  1. Θ(x,t) = Σ A_c·exp(iθ_c) is the collective field (TQM-126/127).");
        ...
        Sec(sb, "1. TQM-127 Recap & Field Autonomy Theory");
        ...
        sb.AppendLine($"  Experiment TQM-128 completed.  Runtime: {sw.Elapsed.TotalSeconds:F0}s.");
