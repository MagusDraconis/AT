...
public class TQM_139_InformationLandscapeTopology : ResearchTestBase
{
    public TQM_139_InformationLandscapeTopology(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQM_139_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("TQM-139 Information Attractor Landscape Topology");

        // ── Section 0: Assumptions ──
        Sec(sb, "0. Assumptions");
        sb.AppendLine("  1. Theta has an attractor landscape with ~19 species (TQM-138).");
        ...
        // ── Section 1: TQM-138 Recap ──
        Sec(sb, "1. TQM-138 Recap — Bounded Innovation");
        sb.AppendLine("  TQM-138: 66 novel species, 15 unique, saturation index 0.82.");
        ...
        sb.AppendLine();
        sb.AppendLine("  TQM-139 asks: WHY ~19 species? What is the landscape topology?");
        sb.AppendLine();
        ...
        // ── Section 7: TQM-138 Consistency ──
        Sec(sb, "7. Consistency with TQM-138");
        int expectedSpecies = 19;
        int observedSpecies = g.TotalAttractors;
        sb.AppendLine($"  TQM-138 species count:  ~{expectedSpecies}");
        sb.AppendLine($"  TQM-139 attractor count: {observedSpecies}");
        ...
        sb.AppendLine($"  Experiment TQM-139 completed.");
