...
public class TQM_125_InterChargeCoherence : ResearchTestBase
{
    public TQM_125_InterChargeCoherence(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQM_125_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("TQM-125 Inter-Charge Coherence and Phase Locking");

        // ══════════════════════════════════════════════════════════════
        Sec(sb, "0. Assumptions");
        sb.AppendLine("  1. Q=+1 supports internal phase oscillation θ(t)≈ωt (TQM-124).");
        sb.AppendLine("  2. Multiple Q=+1 charges can coexist (TQM-010, TQM-123).");
        ...
        sb.AppendLine("  TQM-124: Each Q=+1 has internal phase oscillation θ(t) at ω≈1.");
        sb.AppendLine("  TQM-124: All spatial modes are damped; only phase mode survives.");
        ...
        sb.AppendLine($"  Experiment TQM-125 completed.  Runtime: {stopwatch.Elapsed.TotalSeconds:F0}s.");
