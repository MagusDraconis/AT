...
public class TQM_078_CoherenceEvolutionLaw : ResearchTestBase
{
    ...
    public TQM_078_CoherenceEvolutionLaw(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQM_078_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("TQM-078 Coherence Evolution Law");

        sb.AppendLine("TQM-078: Does dR/dt Follow a Closed Analytic Equation?");
        sb.AppendLine();

        // ── Section 1: Objective ─────────────────────────────────────
        Sec(sb, "1. Objective");
        sb.AppendLine("  TQM-077: dR/dt is the dominant dynamical term (2.2× gain).");
        sb.AppendLine();
        ...
        sb.AppendLine("  Experiment TQM-078 completed successfully.");
        sb.AppendLine(new string('=', 100));
