...
public class TQM_041_ResonanceLearning : ResearchTestBase
{
    ...
    public TQM_041_ResonanceLearning(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQM_041_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("TQM-041 Resonance Learning");
        report.AppendLine("TQM-041: Can Condensates Learn from Repeated Experience?");
        report.AppendLine();

        AppendSection(report, "1. Objective");
        report.AppendLine("  TQM-036-040 established memory, identity, and distributed storage.");
        ...
        report.AppendLine("  C2. Repeated stimulation represents the first TQM mechanism for");
        report.AppendLine("      information encoding through temporal dynamics.");

        report.AppendLine();
        report.AppendLine(new string('=', 100));
        report.AppendLine("  Experiment TQM-041 completed successfully.");
        report.AppendLine(new string('=', 100));
