...
public class TQM_115_TopologicalChargeRobustness : ResearchTestBase
{
    public TQM_115_TopologicalChargeRobustness(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQM_115_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("TQM-115 Topological Charge Robustness");

        sb.AppendLine("TQM-115: HOSTILE REVIEW of TQM-113 topological charge.");
        ...
        if (report.Classification.StartsWith("D"))
        {
            ...
            sb.AppendLine();
            sb.AppendLine("  TQM-113's conclusion is CONFIRMED and STRENGTHENED:");
        ...
        sb.AppendLine("  Experiment TQM-115 completed successfully.");
        sb.AppendLine(new string('=', 100));
