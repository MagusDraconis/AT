...
/// <summary>
/// TQM-004: Temporal Field-Mediated Synchronization Experiment
///
...
/// </summary>
public class TQM_004_TemporalFieldMediatedSynchronization : ResearchTestBase
{
    ...
    public TQM_004_TemporalFieldMediatedSynchronization(ITestOutputHelper output)
        : base(output)
    {
    }

    [Fact]
    public void TQM_004_RunFieldMediatedSynchronization()
    {
    ...
    private void ExecuteExperiment()
    {
        ...
        // ── Header ──────────────────────────────────────────────
        PrintHeader("TQM-004 Temporal Field-Mediated Synchronization");
        report.AppendLine("TQM-004: Field-Mediated Oscillator Synchronization");
        report.AppendLine();
        ...
        report.AppendLine("  Previous TQM experiments used direct Kuramoto coupling:");
        ...
        report.AppendLine("    • TQM-005: N-oscillator field-mediated synchronization.");
        report.AppendLine("    • TQM-006: 2D temporal field with spatial mode patterns.");
        report.AppendLine("    • TQM-007: Field eigenmodes and temporal quantization.");

        report.AppendLine();
        report.AppendLine(new string('=', 100));
        report.AppendLine("  Experiment TQM-004 completed successfully.");
        report.AppendLine(new string('=', 100));
