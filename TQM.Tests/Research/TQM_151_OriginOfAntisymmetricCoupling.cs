...
public class TQM_151_OriginOfAntisymmetricCoupling : ResearchTestBase
{
    public TQM_151_OriginOfAntisymmetricCoupling(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQM_151_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("TQM-151 Origin of the Antisymmetric Coupling");

        Sec(sb, "0. Assumptions");
        sb.AppendLine("  1. J = [[0,1],[-1,0]] was assumed in TQM-150.");
        ...
        sb.AppendLine($"  TQM-151 complete. Classification: {report.Classification}");
        sb.AppendLine(new string('=', 100));
