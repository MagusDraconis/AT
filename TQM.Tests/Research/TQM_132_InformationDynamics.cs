...
public class TQM_132_InformationDynamics : ResearchTestBase
{
    public TQM_132_InformationDynamics(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQM_132_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("TQM-132 Information Dynamics in the Theta Field");

        Sec(sb, "0. Assumptions");
        sb.AppendLine("  1. Θ transports (TQM-129) and stores (TQM-130) information.");
        sb.AppendLine("  2. Θ and Q are decoupled (TQM-131).");
        ...
        sb.AppendLine($"  Experiment TQM-132 completed.");
