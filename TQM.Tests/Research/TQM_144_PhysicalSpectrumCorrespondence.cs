...
public class TQM_144_PhysicalSpectrumCorrespondence : ResearchTestBase
{
    public TQM_144_PhysicalSpectrumCorrespondence(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQM_144_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("TQM-144 Physical Spectrum Correspondence");

        Sec(sb, "0. Assumptions");
        sb.AppendLine("  1. L = graph Laplacian of Q interactions (TQM-142).");
        sb.AppendLine("  2. Theta hierarchy is universal graph-based physics (TQM-143).");
        ...
        Sec(sb, "1. TQM-142/143 Recap");
        sb.AppendLine("  TQM-142: L = graph Laplacian → Theta spectra.");
        sb.AppendLine("  TQM-143: Hierarchy universal across locally connected graphs.");
        ...
        sb.AppendLine($"  Novel TQM prediction:      {(report.NovelPredictionMade ? "YES" : "NO")}");
        sb.AppendLine();
        ...
        sb.AppendLine($"  Experiment TQM-144 completed.");
