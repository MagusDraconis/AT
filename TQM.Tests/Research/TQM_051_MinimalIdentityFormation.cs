...
public class TQM_051_MinimalIdentityFormation : ResearchTestBase
{
    ...
    public TQM_051_MinimalIdentityFormation(ITestOutputHelper o) : base(o) { }
    ...
    private void RunTest()
    {
        ...
        PrintHeader("TQM-051 Minimal Identity Formation");

        report.AppendLine("TQM-051: What Is the Minimum History That Creates Identity?");
        report.AppendLine();

        // ── Section 1: Objective ─────────────────────────────────────
        AppendSection(report, "1. Objective");
        report.AppendLine("  TQM-044 showed AB ≠ BA. TQM-050 showed identities repel.");
        ...
        report.AppendLine("  Experiment TQM-051 completed successfully.");
        report.AppendLine(new string('=', 100));
