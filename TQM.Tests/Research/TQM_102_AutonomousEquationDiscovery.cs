...
public class TQM_102_AutonomousEquationDiscovery : ResearchTestBase
{
    private const int BaseSeed = 102_000_001;

    public TQM_102_AutonomousEquationDiscovery(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQM_102_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("TQM-102 Autonomous Equation Discovery");

        sb.AppendLine("TQM-102: Discovering governing equations directly from data.");
        sb.AppendLine("         No assumptions about functional form.");
        sb.AppendLine();

        // ── Section 1: Objective ─────────────────────────────────────
        Sec(sb, "1. Objective");
        sb.AppendLine("  TQM-083: Identified state variables {R, M}.");
        sb.AppendLine("  TQM-100: Rejected linear equation dR/dt = α₀+α₁·R+α₂·M.");
        sb.AppendLine("  TQM-101: Partial repair, 4/8 attacks still fail.");
        sb.AppendLine();
        ...
        Sec(sb, "5. Hostile Validation (TQM-100 Attack Vectors)");
        ...
        // Compare with TQM-101 best.
        sb.AppendLine("  ── Comparison: TQM-101 vs TQM-102 ──");
        sb.AppendLine("  Attack                  │ TQM-101(D) │ TQM-102   │ Δ");
        sb.AppendLine("  " + new string('─', 65));
        // TQM-101 Model D scores from earlier run.
        var tqm101 = new Dictionary<string, double>
        {
        ...
        {
            double t101 = tqm101.GetValueOrDefault(name, 0);
        ...
        sb.AppendLine("    TQM-082 best fit: dM/dt = f(M,R,M²,R²,MR) with Adj R²=0.299");
        sb.AppendLine();
        ...
        sb.AppendLine("  Experiment TQM-102 completed successfully.");
        sb.AppendLine(new string('=', 100));
