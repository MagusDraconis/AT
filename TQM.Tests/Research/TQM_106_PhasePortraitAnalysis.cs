...
public class TQM_106_PhasePortraitAnalysis : ResearchTestBase
{
    public TQM_106_PhasePortraitAnalysis(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQM_106_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("TQM-106 Phase Portrait and Fixed Point Analysis");

        sb.AppendLine("TQM-106: What dynamical behavior emerges from the closed theory?");
        sb.AppendLine();

        // ── Section 1: The Closed System ─────────────────────────────
        Sec(sb, "1. The Closed TQM Field Theory");
        sb.AppendLine("  dR/dt = c₀ · M · R · (1 − R²)    [TQM-104, mean-field derivation]");
        sb.AppendLine("  dM/dt = a · R²                     [TQM-105, position-dynamic derivation]");
        sb.AppendLine();
        ...
        sb.AppendLine("    This explains WHY synchronization is so robust (TQM-052/053).");
        sb.AppendLine();
        ...
        sb.AppendLine("      R↑ → M↑ (TQM-105: dM/dt ∝ R²)");
        sb.AppendLine("      M↑ → R↑ (TQM-104: dR/dt ∝ M)");
        ...
        sb.AppendLine("    synchronization observed throughout TQM experiments.");
        sb.AppendLine();
        ...
        sb.AppendLine("       to complete order — consistent with TQM-052/053.");
        sb.AppendLine();

        sb.AppendLine(new string('=', 100));
        sb.AppendLine("  Experiment TQM-106 completed successfully.");
        sb.AppendLine(new string('=', 100));
