...
public class TQM_020_EffectiveConnectivityThreshold : ResearchTestBase
{
    ...
    public TQM_020_EffectiveConnectivityThreshold(ITestOutputHelper output) : base(output) { }

    [Fact]
    public void TQM_020_RunConnectivityExperiment()
    {
    ...
    private void ExecuteExperiment()
    {
        ...
        PrintHeader("TQM-020 Effective Connectivity Threshold");
        report.AppendLine("TQM-020: Is Effective Connectivity the True Universal Predictor?");
        report.AppendLine();

        AppendSection(report, "1. Objective");
        report.AppendLine("  TQM-019 showed ρc depends strongly on placement. This experiment tests");
        ...
        // Compare against TQM-019 density CV.
        report.AppendLine($"  TQM-019 density CV (cross-placement): 0.683");
        ...
        report.AppendLine("  Experiment TQM-020 completed successfully.");
        report.AppendLine(new string('=', 100));
