...
/// <summary>
/// TQM-012: Condensate Interaction Experiment
///
...
/// </summary>
public class TQM_012_CondensateInteractionExperiment : ResearchTestBase
{
    ...
    public TQM_012_CondensateInteractionExperiment(ITestOutputHelper output)
        : base(output)
    {
    }

    [Fact]
    public void TQM_012_RunInteractionExperiment()
    {
    ...
    private void ExecuteExperiment()
    {
        ...
        PrintHeader("TQM-012 Condensate Interaction Experiment");
        report.AppendLine("TQM-012: Dynamics of Interacting Proto-Matter Condensates");
        report.AppendLine();

        AppendSection(report, "1. Objective");
        report.AppendLine("  TQM-010/011 established that condensates are stable dynamical attractors.");
        ...
        report.AppendLine();
        report.AppendLine("  C3. These interaction dynamics are the first TQM evidence of");
        ...
        report.AppendLine("    • TQM-013: Multi-condensate systems (3+ interacting condensates).");
        report.AppendLine("    • TQM-014: Condensate scattering cross-sections.");

        report.AppendLine();
        report.AppendLine(new string('=', 100));
        report.AppendLine("  Experiment TQM-012 completed successfully.");
        report.AppendLine(new string('=', 100));
