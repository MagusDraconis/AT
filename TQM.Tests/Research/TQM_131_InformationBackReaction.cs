...
public class TQM_131_InformationBackReaction : ResearchTestBase
{
    public TQM_131_InformationBackReaction(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQM_131_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("TQM-131 Information Back-Reaction on Proto-Matter Genesis");

        Sec(sb, "0. Assumptions");
        sb.AppendLine("  1. Θ stores information (TQM-130).");
        sb.AppendLine("  2. Q is created when c₀·M > D_R/w² (TQM-118).");
        ...
        Sec(sb, "1. TQM-130 Recap & Back-Reaction Theory");
        ...
        sb.AppendLine($"  Experiment TQM-131 completed.");
