...
public class TQM_029_CondensateLifecycleAnalysis : ResearchTestBase
{
    ...
    public TQM_029_CondensateLifecycleAnalysis(ITestOutputHelper output) : base(output) { }

    [Fact]
    public void TQM_029_RunLifecycleAnalysis()
    {
    ...
    private void ExecuteExperiment()
    {
        ...
        PrintHeader("TQM-029 Condensate Lifecycle Analysis");
        report.AppendLine("TQM-029: Birth, Growth, Mergers, and Death of Condensates");
        report.AppendLine();

        AppendSection(report, "1. Objective");
        report.AppendLine("  TQM-028 found local quantities are conserved. This experiment tracks");
        ...
        report.AppendLine("  Experiment TQM-029 completed successfully.");
        report.AppendLine(new string('=', 100));
