...
public class TQM_111_SolitonEffectiveMass : ResearchTestBase
{
    public TQM_111_SolitonEffectiveMass(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQM_111_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("TQM-111 Soliton Effective Mass and Inertia");
        ...
        // ── Section 3 ───────────────────────────────────────────────
        Sec(sb, "3. Resolution of TQM-109 Paradox");

        sb.AppendLine("  TQM-109: PDE soliton interaction force is O(10⁻⁵).");
        sb.AppendLine("  TQM-109: Solitons show no measurable motion.");
        sb.AppendLine();
        ...
        sb.AppendLine("  ├─────────────────────────────────────────────────────────┤");
        sb.AppendLine("  │  RESOLVES TQM-109 PARADOX:                              │");
        sb.AppendLine("  │  Weak soliton motion = small force + large inertia      │");
        sb.AppendLine("  └─────────────────────────────────────────────────────────┘");
        sb.AppendLine();

        sb.AppendLine(new string('=', 100));
        sb.AppendLine("  Experiment TQM-111 completed successfully.");
        sb.AppendLine(new string('=', 100));
