...
public class TQM_031_MultiAttractorSearch : ResearchTestBase
{
    ...
    public TQM_031_MultiAttractorSearch(ITestOutputHelper output) : base(output) { }

    [Fact]
    public void TQM_031_RunMultiAttractorSearch()
    {
    ...
    private void ExecuteExperiment()
    {
        ...
        PrintHeader("TQM-031 Multi-Attractor Search");
        report.AppendLine("TQM-031: How Many Stable Attractor Basins Exist?");
        report.AppendLine();

        AppendSection(report, "1. Objective");
        report.AppendLine("  TQM-030 showed condensates are deep attractors. This experiment searches");
        ...
        report.AppendLine($"  C1. The TQM resonance landscape is: {classification}");
        ...
        report.AppendLine("      available to TQM condensates — analogous to the vacuum structure");
        report.AppendLine("      of quantum field theories.");

        report.AppendLine();
        report.AppendLine(new string('=', 100));
        report.AppendLine("  Experiment TQM-031 completed successfully.");
        report.AppendLine(new string('=', 100));
