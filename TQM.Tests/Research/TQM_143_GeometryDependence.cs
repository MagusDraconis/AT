...
public class TQM_143_GeometryDependence : ResearchTestBase
{
    public TQM_143_GeometryDependence(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQM_143_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("TQM-143 Geometry Dependence of the Theta Hierarchy");

        Sec(sb, "0. Assumptions");
        sb.AppendLine("  1. L = graph Laplacian of Q interaction network (TQM-142).");
        sb.AppendLine("  2. TQM-142 used a 1D chain topology.");
        ...
        sb.AppendLine($"  Experiment TQM-143 completed.");
