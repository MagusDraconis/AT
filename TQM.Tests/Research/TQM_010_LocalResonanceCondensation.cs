...
/// <summary>
/// TQM-010: Local Resonance Condensation
///
...
/// </summary>
public class TQM_010_LocalResonanceCondensation : ResearchTestBase
{
    ...
    public TQM_010_LocalResonanceCondensation(ITestOutputHelper output)
        : base(output)
    {
    }

    [Fact]
    public void TQM_010_RunLocalCondensationExperiment()
    {
    ...
    private void ExecuteExperiment()
    {
        ...
        PrintHeader("TQM-010 Local Resonance Condensation");
        report.AppendLine("TQM-010: Emergence of Localized Resonance Condensates");
        report.AppendLine();

        AppendSection(report, "1. Objective");
        report.AppendLine("  TQM-009 showed that distance-dependent coupling weakens synchronization.");
        ...
        if (hasProtoMatter)
        {
            ...
            report.AppendLine("      despite global incoherence — ARE detected. This is the first TQM");
            ...
            report.AppendLine("      structures in the TQM framework: spatially localized, internally");
        ...
        report.AppendLine("    • TQM-011: Condensate-condensate interactions (proto-particle collisions).");
        report.AppendLine("    • TQM-012: External perturbation response (condensate robustness).");

        report.AppendLine();
        report.AppendLine(new string('=', 100));
        report.AppendLine("  Experiment TQM-010 completed successfully.");
        report.AppendLine(new string('=', 100));
