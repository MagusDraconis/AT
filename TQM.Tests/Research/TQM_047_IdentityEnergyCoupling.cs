...
public class TQM_047_IdentityEnergyCoupling : ResearchTestBase
{
    ...
    public TQM_047_IdentityEnergyCoupling(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQM_047_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("TQM-047 Identity\u2013Energy Coupling Analysis");

        report.AppendLine("TQM-047: Are Resonance Identity and Energy the Same Property?");
        report.AppendLine();
        ...
        report.AppendLine("    A2. Energy proxy = FinalR \u00d7 MeanFreq (consistent with TQM-038/039)");
        ...
        report.AppendLine("  Experiment TQM-047 completed successfully.");
        report.AppendLine(new string('=', 100));
