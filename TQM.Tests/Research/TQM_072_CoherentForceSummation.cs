...
public class TQM_072_CoherentForceSummation : ResearchTestBase
{
    ...
    public TQM_072_CoherentForceSummation(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQM_072_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("TQM-072 Coherent Force Summation");

        sb.AppendLine("TQM-072: Does Net Attraction Emerge from Coherent Summation of Local Forces?");
        sb.AppendLine();

        // ── Section 1: Objective ─────────────────────────────────────
        Sec(sb, "1. Objective");
        sb.AppendLine("  TQM-071: Attraction exists at all R, but grows with coherence.");
        sb.AppendLine();
        ...
        sb.AppendLine("  Experiment TQM-072 completed successfully.");
        sb.AppendLine(new string('=', 100));
