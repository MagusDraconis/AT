...
public class TQM_142_OriginOfThetaOperator : ResearchTestBase
{
    public TQM_142_OriginOfThetaOperator(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQM_142_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("TQM-142 Origin of the Theta Operator");

        Sec(sb, "0. Assumptions");
        sb.AppendLine("  1. Q is the only microscopic degree of freedom.");
        sb.AppendLine("  2. Theta operator L·v=λ·v from TQM-140 may be emergent.");
        ...
        Sec(sb, "1. TQM-140/141 Recap");
        sb.AppendLine("  TQM-140: L·v_k = λ_k·v_k → 10 eigenmodes ≈ species.");
        sb.AppendLine("  TQM-141: Species = eigenmodes + linear pairs of ≤2 modes.");
        ...
        sb.AppendLine("  First 10 eigenvalues of original Theta operator (TQM-140):");
        ...
        sb.AppendLine($"  Experiment TQM-142 completed.");
