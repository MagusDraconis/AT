...
public class TQM_080_NetworkTopologyCoherence : ResearchTestBase
{
    ...
    public TQM_080_NetworkTopologyCoherence(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQM_080_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("TQM-080 Network Topology and Coherence Evolution");

        sb.AppendLine("TQM-080: Does Network Topology Explain the Unexplained dR/dt Variance?");
        sb.AppendLine();

        // ── Section 1: Objective ─────────────────────────────────────
        Sec(sb, "1. Objective");
        sb.AppendLine("  TQM-077-079: ~46% of dR/dt variance explained by R.");
        ...
        sb.AppendLine("  Experiment TQM-080 completed successfully.");
        sb.AppendLine(new string('=', 100));
