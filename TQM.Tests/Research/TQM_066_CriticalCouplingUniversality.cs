...
public class TQM_066_CriticalCouplingUniversality : ResearchTestBase
{
    ...
    public TQM_066_CriticalCouplingUniversality(ITestOutputHelper o):base(o){}

    [Fact]
    public void TQM_066_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("TQM-066 Critical Coupling Universality");
        sb.AppendLine("TQM-066: Is There a Kc Where Coupling Law Becomes Irrelevant?");
        sb.AppendLine();
        Sec(sb,"1. Objective");
        sb.AppendLine("  TQM-065: even symmetry guarantees attraction, odd fails at far range.");
        ...
        sb.AppendLine("  Experiment TQM-066 completed successfully.");
        sb.AppendLine(new string('=',100));
