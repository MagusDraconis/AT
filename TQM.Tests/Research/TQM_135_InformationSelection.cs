...
public class TQM_135_InformationSelection : ResearchTestBase
{
    public TQM_135_InformationSelection(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQM_135_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("TQM-135 Information Selection Under Resource Constraints");
        ...
        sb.AppendLine("  3. Species can reproduce with heritable variation (TQM-134).");
        ...
        // ── Section 1: TQM-134 Recap ──
        Sec(sb, "1. TQM-134 Recap — Information Evolution Layer");
        sb.AppendLine("  TQM-134 demonstrated the first two Darwinian pillars:");
        ...
        sb.AppendLine();
        sb.AppendLine("  TQM-135 addresses the missing pillar: SELECTION.");
        ...
        sb.AppendLine($"  Experiment TQM-135 completed.");
