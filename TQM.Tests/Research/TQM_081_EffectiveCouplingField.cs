...
public class TQM_081_EffectiveCouplingField : ResearchTestBase
{
    ...
    public TQM_081_EffectiveCouplingField(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQM_081_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("TQM-081 Effective Coupling Field");

        sb.AppendLine("TQM-081: Can Network Topology Be Compressed into Effective Field Variables?");
        sb.AppendLine();

        // ── Section 1: Objective ─────────────────────────────────────
        Sec(sb, "1. Objective");
        sb.AppendLine("  TQM-080 demonstrated: topology explains 63% of dR/dt variance.");
        ...
        sb.AppendLine("  Experiment TQM-081 completed successfully.");
        sb.AppendLine(new string('=', 100));
