...
/// <summary>
/// TQM-008: Resonance Family Reproducibility Experiment
///
/// Tests whether the 5 resonance families discovered in TQM-007
...
/// </summary>
public class TQM_008_ResonanceFamilyReproducibilityExperiment : ResearchTestBase
{
    ...
    public TQM_008_ResonanceFamilyReproducibilityExperiment(ITestOutputHelper output)
        : base(output)
    {
    }

    [Fact]
    public void TQM_008_RunReproducibilityExperiment()
    {
    ...
    private void ExecuteExperiment()
    {
        ...
        // ── Header ──────────────────────────────────────────────
        PrintHeader("TQM-008 Resonance Family Reproducibility");
        report.AppendLine("TQM-008: Statistical Reproducibility of Resonance Families");
        report.AppendLine();

        // ── 1. Objective ────────────────────────────────────────
        AppendSection(report, "1. Objective");
        report.AppendLine("  TQM-007 discovered 5 resonance families. This experiment tests whether");
        ...
        report.AppendLine();
        report.AppendLine($"  Reference families (from TQM-007):");
        ...
        report.AppendLine($"  C1. Out of 5 families from TQM-007, {universalFamilies.Count} are Universal,");
        ...
        report.AppendLine("      TQM-007's family structure is not an artifact of a single seed.");
        report.AppendLine();
        ...
        report.AppendLine("    • TQM-009: Cluster-cluster interactions between universal families.");
        report.AppendLine("    • TQM-010: Family response to external perturbations (robustness).");
        report.AppendLine("    • TQM-011: Larger N (500, 1000) to study family scaling behaviour.");

        report.AppendLine();
        report.AppendLine(new string('=', 100));
        report.AppendLine("  Experiment TQM-008 completed successfully.");
        report.AppendLine(new string('=', 100));
