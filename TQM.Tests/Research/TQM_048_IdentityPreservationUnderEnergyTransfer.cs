...
public class TQM_048_IdentityPreservationUnderEnergyTransfer : ResearchTestBase
{
    ...
    public TQM_048_IdentityPreservationUnderEnergyTransfer(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQM_048_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("TQM-048 Identity Preservation Under Energy Transfer");

        report.AppendLine("TQM-048: Does Resonance Identity Survive Energy Exchange?");
        report.AppendLine();

        // ── Section 1: Objective ─────────────────────────────────────
        AppendSection(report, "1. Objective");
        report.AppendLine("  TQM-047 demonstrated identity and energy are statistically");
        ...
        else
        {
            ...
            report.AppendLine("      statistical independence found in TQM-047 does not imply");
            report.AppendLine("      within-condensate independence.");
        }

        report.AppendLine();
        report.AppendLine($"  C3. Combined with TQM-047's cross-sectional independence finding,");
        ...
        report.AppendLine("  Experiment TQM-048 completed successfully.");
        report.AppendLine(new string('=', 100));
