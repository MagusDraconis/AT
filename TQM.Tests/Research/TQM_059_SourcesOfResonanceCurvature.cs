...
public class TQM_059_SourcesOfResonanceCurvature : ResearchTestBase
{
    ...
    public TQM_059_SourcesOfResonanceCurvature(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQM_059_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("TQM-059 Sources of Resonance Curvature");

        report.AppendLine("TQM-059: What Creates Curvature in the Resonance State Space?");
        report.AppendLine();

        // ── Section 1: Objective ─────────────────────────────────────
        AppendSection(report, "1. Objective");
        report.AppendLine("  TQM-058 discovered geometrically dominated curvature.");
        ...
        report.AppendLine($"    Coherence is near-constant (TQM-052) \u2014 it cannot explain curvature variation.");
        ...
        string interp = attr.DominantSource switch
        {
            "Energy Dominated" => "Energy is the primary curvature generator. " +
                ...
                "consistent with TQM-055/056's finding that energy is the dominant organizer.",
        ...
        report.AppendLine("  Experiment TQM-059 completed successfully.");
        report.AppendLine(new string('=', 100));
