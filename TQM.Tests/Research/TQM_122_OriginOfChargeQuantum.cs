...
public class TQM_122_OriginOfChargeQuantum : ResearchTestBase
{
    public TQM_122_OriginOfChargeQuantum(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQM_122_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("TQM-122 Origin of the Charge Quantum");

        // ══════════════════════════════════════════════════════════════
        // ASSUMPTIONS
        // ══════════════════════════════════════════════════════════════
        Sec(sb, "0. Assumptions");
        sb.AppendLine("  1. Q = β₀({R>0.5}) ∈ ℕ exists, is conserved, indivisible (TQM-113..121).");
        sb.AppendLine("  2. Charge quantization is enforced by topology + reaction barrier (TQM-121).");
        ...
        sb.AppendLine("  TQM-121 proved: Q ∈ ℕ (integer by homology) and dQ/dt = 0 (conserved).");
        sb.AppendLine("  TQM-121 did NOT explain: why is Q=1 the MINIMAL non-zero value?");
        ...
        sb.AppendLine("    The transition at w=w_c is the CRITICAL NUCLEUS (TQM-118).");
        sb.AppendLine();
        ...
        sb.AppendLine("    Crossing from Q=0 to Q=1 requires a NUCLEATION EVENT (TQM-118).");
        sb.AppendLine();
        ...
        sb.AppendLine();
        sb.AppendLine("  TQM's charge quantum Q=+1 is EXACTLY the critical droplet:");
        ...
        sb.AppendLine("  Experiment TQM-122 completed successfully.");
