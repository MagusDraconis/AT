...
public class TQM_068_CurvatureCouplingToSpatialDynamics : ResearchTestBase
{
    ...
    public TQM_068_CurvatureCouplingToSpatialDynamics(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQM_068_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("TQM-068 Curvature Coupling to Spatial Dynamics");

        sb.AppendLine("TQM-068: Does Memory-Generated Curvature Influence Spatial Motion?");
        sb.AppendLine();

        // ── Section 1: Objective ─────────────────────────────────────
        Sec(sb, "1. Objective");
        sb.AppendLine("  TQM-059: Memory strongly predicts curvature.");
        sb.AppendLine("  TQM-062: Spatial attraction arises from position dynamics.");
        sb.AppendLine("  TQM-067: Synchronization remains stable at high K.");
        sb.AppendLine();
        ...
        sb.AppendLine("  Experiment TQM-068 completed successfully.");
        sb.AppendLine(new string('=', 100));
