...
public class TQM_034_SpontaneousHierarchicalAssembly : ResearchTestBase
{
    ...
    public TQM_034_SpontaneousHierarchicalAssembly(ITestOutputHelper output) : base(output) { }

    [Fact]
    public void TQM_034_RunSpontaneousAssembly()
    {
    ...
    private void ExecuteExperiment()
    {
        ...
        PrintHeader("TQM-034 Spontaneous Hierarchical Assembly");
        report.AppendLine("TQM-034: Do Hierarchical Structures Self-Assemble?");
        report.AppendLine();

        AppendSection(report, "1. Objective");
        report.AppendLine("  TQM-033 showed manual assemblies are stable. This experiment tests");
        ...
        report.AppendLine("      complexity in the TQM framework.");

        report.AppendLine();
        report.AppendLine(new string('=', 100));
        report.AppendLine("  Experiment TQM-034 completed successfully.");
        report.AppendLine(new string('=', 100));
