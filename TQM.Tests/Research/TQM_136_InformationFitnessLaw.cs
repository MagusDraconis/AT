...
public class TQM_136_InformationFitnessLaw : ResearchTestBase
{
    public TQM_136_InformationFitnessLaw(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQM_136_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("TQM-136 Information Fitness Law");

        // ── Section 0: Assumptions ──
        Sec(sb, "0. Assumptions");
        sb.AppendLine("  1. Theta is an autonomous information layer (TQM-128).");
        sb.AppendLine("  2. 4 information species exist (TQM-133): A, B, C, D.");
        sb.AppendLine("  3. Selection exists under resource constraints (TQM-135).");
        ...
        // ── Section 1: TQM-135 Recap ──
        Sec(sb, "1. TQM-135 Recap — Selection Dynamics");
        sb.AppendLine("  TQM-135 completed the Darwinian triad:");
        sb.AppendLine("    ✓ Reproduction (TQM-134)");
        sb.AppendLine("    ✓ Variation (TQM-134)");
        sb.AppendLine("    ✓ Selection (TQM-135) — 329 extinctions, 8.6× fitness diff");
        sb.AppendLine();
        ...
        Sec(sb, "7. Prediction Validation Against TQM-135");
        ...
        sb.AppendLine($"  Experiment TQM-136 completed.");
