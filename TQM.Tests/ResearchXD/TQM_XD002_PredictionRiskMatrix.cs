...
public class TQM_XD002_PredictionRiskMatrix : ResearchTestBase
{
    public TQM_XD002_PredictionRiskMatrix(ITestOutputHelper o) : base(o) { }
    ...
    private void RunTest()
    {
        ...
        sb.AppendLine("  Prediction falsified     TQM sections killed");
        ...
        sb.AppendLine();
        sb.AppendLine("  TQM is MODULAR: killing one prediction doesn't kill all.");
        ...
        sb.AppendLine($"  TQM is falsifiable, predictive, zero-parameter.");
        sb.AppendLine(new string('=', 100));
