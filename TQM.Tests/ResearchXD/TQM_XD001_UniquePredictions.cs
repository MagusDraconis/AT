...
public class TQM_XD001_UniquePredictions : ResearchTestBase
{
    public TQM_XD001_UniquePredictions(ITestOutputHelper o) : base(o) { }
    ...
    private void RunTest()
    {
        ...
        PrintHeader("ResearchXD-001 Unique Predictions of Zero-Parameter TQM");
        ...
        sb.AppendLine();
        sb.AppendLine($"  {uniqueCount}/{predictions.Count} unique to TQM. {testable}/{predictions.Count} falsifiable.");
        sb.AppendLine();
        ...
        sb.AppendLine($"  TQM is SCIENTIFIC: falsifiable, predictive, zero-parameter.");
        sb.AppendLine(new string('=', 100));
