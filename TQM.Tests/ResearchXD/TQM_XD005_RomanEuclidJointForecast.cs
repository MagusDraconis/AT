...
public class TQM_XD005_RomanEuclidJointForecast : ResearchTestBase
{
    public TQM_XD005_RomanEuclidJointForecast(ITestOutputHelper o) : base(o) { }
    ...
    private void RunTest()
    {
        ...
        // ═══ SECTION A: TQM prediction ═══
        Sec(sb, "Section A — TQM Prediction Recap");
        ...
        // ═══ SECTION E: TQM signature ═══
        Sec(sb, "Section E — The TQM Signature");
        sb.AppendLine(RomanEuclidForecastAnalyzer.TheTqmSignature());
        ...
        sb.AppendLine();
        sb.AppendLine("  TQM makes a CONCRETE, FALSIFIABLE, TESTABLE prediction.");
        sb.AppendLine("  If (w0, wa) = (-1, 0) at high significance: TQM is WRONG.");
        sb.AppendLine("  If (w0, wa) = (-0.985, +0.06): TQM is RIGHT.");
        sb.AppendLine();
