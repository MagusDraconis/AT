...
public class TQM_DATA007_RarNovelPredictionAudit:ResearchTestBase{
    public TQM_DATA007_RarNovelPredictionAudit(ITestOutputHelper o):base(o){}
    [Fact]public void DATA007_Run(){
        ...
        sb.AppendLine("  TQM now has a UNIQUE, FALSIFIABLE prediction: g†(z) INCREASES with redshift.");
        sb.AppendLine("  This distinguishes TQM from MOND (a0=const) and LCDM (no prediction).");
