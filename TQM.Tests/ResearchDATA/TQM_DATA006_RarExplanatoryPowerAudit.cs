...
public class TQM_DATA006_RarExplanatoryPowerAudit : ResearchTestBase
{
    public TQM_DATA006_RarExplanatoryPowerAudit(ITestOutputHelper o) : base(o) { }
    ...
    public void DATA006_Run()
    {
        ...
        sb.AppendLine();
        sb.AppendLine("    DATA-001: Pantheon+SH0ES — TQM consistent, indistinguishable from ΛCDM.");
        ...
        sb.AppendLine("    DATA-004: RAR origin — TQM derives g† and functional form (0 free params).");
        sb.AppendLine("    DATA-005: 2π & scatter — 2π inevitable, scatter budget ~60% closed.");
        sb.AppendLine("    DATA-006: Explanatory power — TQM ranks #1 for RAR explanation.");
        sb.AppendLine();
        sb.AppendLine("  TQM now has the highest explanatory compression (1.67)");
