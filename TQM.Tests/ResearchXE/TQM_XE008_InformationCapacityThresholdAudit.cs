...
public class TQM_XE008_InformationCapacityThresholdAudit : ResearchTestBase
{
    public TQM_XE008_InformationCapacityThresholdAudit(ITestOutputHelper o) : base(o) { }
    ...
    private void RunTest()
    {
        ...
        sb.AppendLine($"  TQM landscape UNDERSTOOD. ResearchXE program COMPLETE.");
        sb.AppendLine(new string('=', 100));
