...
public class TQM_XE009_DimensionalityOptimalityDerivation : ResearchTestBase
{
    public TQM_XE009_DimensionalityOptimalityDerivation(ITestOutputHelper o) : base(o) { }
