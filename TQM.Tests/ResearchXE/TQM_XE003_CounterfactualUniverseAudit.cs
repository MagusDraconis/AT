...
public class TQM_XE003_CounterfactualUniverseAudit : ResearchTestBase
{
    public TQM_XE003_CounterfactualUniverseAudit(ITestOutputHelper o) : base(o) { }
    ...
    private void RunTest()
    {
        ...
        Sec(sb, "TQM's Anthropic Landscape");
        sb.AppendLine("  ┌─────────────────────────────────────────────┐");
        sb.AppendLine("  │  TQM PREDICTS A LANDSCAPE, NOT A POINT       │");
        sb.AppendLine("  │                                               │");
        ...
        sb.AppendLine($"  TQM predicts a LANDSCAPE, not a unique universe.");
        sb.AppendLine(new string('=', 100));
