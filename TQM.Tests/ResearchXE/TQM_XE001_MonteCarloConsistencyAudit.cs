...
public class TQM_XE001_MonteCarloConsistencyAudit : ResearchTestBase
{
    public TQM_XE001_MonteCarloConsistencyAudit(ITestOutputHelper o) : base(o) { }
    ...
    private void RunTest()
    {
        ...
        sb.AppendLine($"  This is EXPECTED — TQM predicts patterns, not precise values.");
        sb.AppendLine(new string('=', 100));
