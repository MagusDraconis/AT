...
public class TQM_XE002_AssumptionDependencyAudit : ResearchTestBase
{
    public TQM_XE002_AssumptionDependencyAudit(ITestOutputHelper o) : base(o) { }
    ...
    private void RunTest()
    {
        ...
        // 8. Minimal core
        Sec(sb, "Minimal TQM Core — Tier by Tier");
