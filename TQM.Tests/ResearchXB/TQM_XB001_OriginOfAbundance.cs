...
public class TQM_XB001_OriginOfAbundance : ResearchTestBase
{
    public TQM_XB001_OriginOfAbundance(ITestOutputHelper o) : base(o) { }
    ...
    private void RunTest()
    {
        ...
        sb.AppendLine($"  Identity (ResearchX) + Abundance (ResearchXB) = COMPLETE TQM.");
        sb.AppendLine(new string('=', 100));
