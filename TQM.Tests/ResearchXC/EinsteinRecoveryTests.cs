...
/// correctness criterion (which the TQM analyzers only assert, never compute).
/// </summary>
public class EinsteinRecoveryTests : ResearchTestBase
{
    ...
    public void FlatMetricProducesZeroCurvature()
    {
        ...
        sb.AppendLine("NOTE: the TQM analyzers ASSERT this ('R=0 for flat') but never compute it.");
        Output.WriteLine(sb.ToString());
    }
