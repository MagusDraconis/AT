...
public class TQM_XC002_OriginOfM2Revisited : ResearchTestBase
{
    public TQM_XC002_OriginOfM2Revisited(ITestOutputHelper o) : base(o) { }
    ...
    private void RunTest()
    {
        ...
        sb.AppendLine($"  TQM: Q + Randomness + (M² ≈ ⟨k⟩ ≈ f(3+1)).");
        sb.AppendLine(new string('=', 100));
