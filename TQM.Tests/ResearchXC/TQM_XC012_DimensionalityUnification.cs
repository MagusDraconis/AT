...
public class TQM_XC012_DimensionalityUnification : ResearchTestBase
{
    public TQM_XC012_DimensionalityUnification(ITestOutputHelper o) : base(o) { }
    ...
    private void RunTest()
    {
        ...
        sb.AppendLine("    TQM now has a single explanation for spacetime dimensionality.");
