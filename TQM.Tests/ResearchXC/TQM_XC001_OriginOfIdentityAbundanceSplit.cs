...
public class TQM_XC001_OriginOfIdentityAbundanceSplit : ResearchTestBase
{
    public TQM_XC001_OriginOfIdentityAbundanceSplit(ITestOutputHelper o) : base(o) { }
    ...
    private void RunTest()
    {
        ...
        sb.AppendLine();
        sb.AppendLine("  The split IS the two-primitive structure of TQM.");
        ...
        // 7. Final TQM
        Sec(sb, "COMPLETE TQM — Three Research Programs");
        ...
        sb.AppendLine("    The split IS TQM. Classification D.");
        sb.AppendLine();
        ...
        sb.AppendLine($"  The split IS the two-primitive structure of TQM.");
        sb.AppendLine($"  ResearchX + ResearchXB + ResearchXC = COMPLETE TQM.");
        sb.AppendLine(new string('=', 100));
