...
public class TQM_XC009_NewtonConstantDerivation : ResearchTestBase
{
    public TQM_XC009_NewtonConstantDerivation(ITestOutputHelper o) : base(o) { }
    ...
    private void RunTest()
    {
        ...
        sb.AppendLine("  TQM HAS ZERO FREE CONTINUOUS FUNDAMENTAL PARAMETERS.");
        sb.AppendLine();
