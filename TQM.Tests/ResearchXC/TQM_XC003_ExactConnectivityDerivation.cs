...
public class TQM_XC003_ExactConnectivityDerivation : ResearchTestBase
{
    public TQM_XC003_ExactConnectivityDerivation(ITestOutputHelper o) : base(o) { }
    ...
    private void RunTest()
    {
        ...
        Sec(sb, "Complete TQM Compression");
        ...
        sb.AppendLine("  TQM postulates (X034)                     5");
        ...
        sb.AppendLine($"  TQM: 2 primitives. ZERO free parameters.");
        sb.AppendLine($"  ~19 (SM) → 0 (TQM). COMPRESSION COMPLETE.");
        sb.AppendLine(new string('=', 100));
