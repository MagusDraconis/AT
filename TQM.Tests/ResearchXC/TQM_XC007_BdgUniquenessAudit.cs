...
public class TQM_XC007_BdgUniquenessAudit : ResearchTestBase
{
    public TQM_XC007_BdgUniquenessAudit(ITestOutputHelper o) : base(o) { }
    ...
    private void RunTest()
    {
        ...
        // ═══ SECTION G: TQM-Native Interpretation ═══
        Sec(sb, "Section G — TQM-Native Interpretation of BDG");
        sb.AppendLine(BdgUniquenessAnalyzer.TqmNativeInterpretation());
