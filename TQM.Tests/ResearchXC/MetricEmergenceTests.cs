...
public class MetricEmergenceTests : ResearchTestBase
{
    ...
    public void MetricEmergence_PresentOrMissing()
    {
        ...
        sb.AppendLine($"full g_μν from Q-events (incl. conformal class): {(!metricStep.IsTqmNative ? "MISSING" : "PRESENT")}     (\"{metricStep.DerivationStatus}\")");

        Assert.False(metricStep.IsTqmNative, "g_μν unexpectedly marked TQM-native");
