...
public class TQM_QM004_MeasurementDecoherenceAudit:ResearchTestBase{
    public TQM_QM004_MeasurementDecoherenceAudit(ITestOutputHelper o):base(o){}
    [Fact]public void QM004_Run(){
        ...
        S(sb,"Section A — Measurement in TQM");sb.AppendLine(r.SA);
