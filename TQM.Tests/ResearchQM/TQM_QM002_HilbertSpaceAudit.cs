...
public class TQM_QM002_HilbertSpaceAudit:ResearchTestBase{
    public TQM_QM002_HilbertSpaceAudit(ITestOutputHelper o):base(o){}
    [Fact]public void QM002_Run(){
        ...
        sb.AppendLine("  With QM-001, TQM now explains the 2 largest QM axioms.");
