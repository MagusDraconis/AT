...
public class TQM_QM001_BornRuleAudit:ResearchTestBase{
    public TQM_QM001_BornRuleAudit(ITestOutputHelper o):base(o){}
    [Fact]public void QM001_Run(){
        ...
        S(sb,"Section A — Probability in TQM");sb.AppendLine(r.SA);
