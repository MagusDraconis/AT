...
public class TQM_X027_FiniteVsInfiniteReality : ResearchTestBase
{
    public TQM_X027_FiniteVsInfiniteReality(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQM_X027_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("TQM-X027 Finite vs Infinite Reality Principle");

        Sec(sb, "0. Assumptions");
        sb.AppendLine("  1. TQM-X026: all finite simulations saturate.");
        ...
        sb.AppendLine("  This IS the deepest boundary in the TQM framework.");
        ...
        Sec(sb, "6. The Complete TQM/L6 Landscape");
        ...
        sb.AppendLine($"  TQM-X027 complete. Classification: {report.Classification}");
