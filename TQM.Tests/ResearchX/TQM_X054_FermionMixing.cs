...
public class TQM_X054_FermionMixing : ResearchTestBase
{
    public TQM_X054_FermionMixing(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQM_X054_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("TQM-X054 Origin of Fermion Mixing");
        ...
        sb.AppendLine("    J_TQM ≈ |V_us|² · sin(φ) ≈ 0.05 · sin(φ).");
        ...
        sb.AppendLine($"  TQM-X054 COMPLETE.");
