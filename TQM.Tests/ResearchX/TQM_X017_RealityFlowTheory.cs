...
public class TQM_X017_RealityFlowTheory : ResearchTestBase
{
    public TQM_X017_RealityFlowTheory(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQM_X017_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("TQM-X017 Reality Flow Theory");

        Sec(sb, "0. Assumptions");
        sb.AppendLine("  1. TQM-X016: static (R,S) classification map.");
        ...
        sb.AppendLine();
        sb.AppendLine("  TQM provides a LANGUAGE for describing reality.");
        sb.AppendLine("  It does NOT provide equations of motion for reality.");
        sb.AppendLine();

        Sec(sb, "6. TQM's Final Role");
        sb.AppendLine("  TQM (the TQM framework after X-series) is:");
        ...
        sb.AppendLine();
        sb.AppendLine("  This is the COMPLETE scope of the TQM framework.");
        ...
        sb.AppendLine(new string('=', 100));
        sb.AppendLine($"  TQM-X017 complete. Classification: {report.Classification}");
