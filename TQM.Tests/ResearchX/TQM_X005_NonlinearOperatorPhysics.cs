...
public class TQM_X005_NonlinearOperatorPhysics : ResearchTestBase
{
    public TQM_X005_NonlinearOperatorPhysics(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQM_X005_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("TQM-X005 Nonlinear Operator Physics");

        Sec(sb, "0. Assumptions");
        sb.AppendLine("  1. TQM-X001: linearity is the #3 untested assumption.");
        sb.AppendLine("  2. All TQM (117-154) uses linear L_Q.");
        ...
        sb.AppendLine("    ✗ Quantum correspondence (all of TQM-149-154)");
        sb.AppendLine();
        ...
        sb.AppendLine($"  TQM-X005 complete. Classification: {report.Classification}");
        sb.AppendLine(new string('=', 100));
