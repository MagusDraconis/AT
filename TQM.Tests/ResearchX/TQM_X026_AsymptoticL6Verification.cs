...
public class TQM_X026_AsymptoticL6Verification : ResearchTestBase
{
    public TQM_X026_AsymptoticL6Verification(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQM_X026_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("TQM-X026 Asymptotic L6 Verification");

        Sec(sb, "0. Assumptions");
        sb.AppendLine("  1. TQM-X025: operator families grew 1→16, no saturation.");
        ...
        sb.AppendLine("  All TQM simulations are FINITE → L6 always saturates.");
        ...
        sb.AppendLine($"  TQM-X026 complete. Classification: {report.Classification}");
        sb.AppendLine(new string('=', 100));
