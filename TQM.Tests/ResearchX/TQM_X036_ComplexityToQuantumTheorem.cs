...
public class TQM_X036_ComplexityToQuantumTheorem : ResearchTestBase
{
    public TQM_X036_ComplexityToQuantumTheorem(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQM_X036_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("TQM-X036 Complexity-to-Quantum Theorem");
        ...
        sb.AppendLine($"  TQM-X036 COMPLETE.");
