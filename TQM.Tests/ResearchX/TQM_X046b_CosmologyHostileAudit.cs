...
public class TQM_X046b_CosmologyHostileAudit : ResearchTestBase
{
    public TQM_X046b_CosmologyHostileAudit(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQM_X046b_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("TQM-X046b Hostile Cosmology Audit");
        ...
        sb.AppendLine("  Test                           ΛCDM              TQM                Pass?");
        sb.AppendLine("  " + new string('─', 85));
        foreach (var t in tests)
        {
            string passes = t.Passes ? "✓" : "✗";
            sb.AppendLine($"  {t.Test,-30}  {t.LcdmPrediction[..Math.Min(18, t.LcdmPrediction.Length)],-18} {t.TqmPrediction[..Math.Min(18, t.TqmPrediction.Length)],-18} {passes}");
        }
        sb.AppendLine();
        ...
        foreach (var t in tests)
        {
            ...
            sb.AppendLine($"  TQM:  {t.TqmPrediction}");
        ...
        sb.AppendLine($"  TQM-X046b COMPLETE.");
