...
public class TQM_X013_InformationPreservationPrinciple : ResearchTestBase
{
    public TQM_X013_InformationPreservationPrinciple(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQM_X013_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("TQM-X013 Information Preservation Principle — Depth Audit");

        Sec(sb, "0. Assumptions");
        sb.AppendLine("  1. TQM-X011/X012: Rev and SC are independent foundations.");
        ...
        sb.AppendLine("  This is the complete foundation audit of TQM.");
        sb.AppendLine();
        ...
        sb.AppendLine($"  TQM-X013 complete. Classification: {report.Classification}");
