...
public class TQM_X031_QuantumRealityNecessity : ResearchTestBase
{
    public TQM_X031_QuantumRealityNecessity(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQM_X031_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("TQM-X031 Quantum Reality Necessity Principle");

        Sec(sb, "0. Assumptions");
        sb.AppendLine("  1. TQM-X030: Quantum Reality is a local maximum.");
        ...
        Sec(sb, "3. Unification: TQM + ResearchX → Quantum Reality");
        sb.AppendLine("  MAIN TQM CHAIN:");
        ...
        sb.AppendLine();
        sb.AppendLine($"  TQM framework: {(report.TQMAndResearchXUnified ? "UNIFIED" : "SEPARATE")}");
        sb.AppendLine();

        Sec(sb, "4. The Deepest Insight of TQM");
        ...
        Sec(sb, "5. The Complete TQM Framework");
        ...
        sb.AppendLine($"  TQM-X031 complete. Classification: {report.Classification}");
