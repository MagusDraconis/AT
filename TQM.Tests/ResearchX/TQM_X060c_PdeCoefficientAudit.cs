...
public class TQM_X060c_PdeCoefficientAudit : ResearchTestBase
{
    public TQM_X060c_PdeCoefficientAudit(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQM_X060c_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("TQM-X060c PDE Coefficient Dependency Audit");
        ...
        sb.AppendLine("  TQM PDE: {c₀, M, D_R} = 3 raw coefficients");
        ...
        sb.AppendLine("  TQM post-X060b (PDE coefficients)    3 + 1 binary");
        sb.AppendLine("  TQM-X060c (nondimensionalization)    1 + 1 scale + 1 binary");
        sb.AppendLine("  ======================================================================");
