...
public class TQM_X009_InformationCarrierFormationPrinciple : ResearchTestBase
{
    public TQM_X009_InformationCarrierFormationPrinciple(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQM_X009_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("TQM-X009 Information Carrier Formation Principle");

        Sec(sb, "0. Assumptions");
        sb.AppendLine("  1. TQM-X008: 16 carrier classes across 5 regimes.");
        ...
        Sec(sb, "4. The Formation Hierarchy (Deepest TQM)");
        ...
        sb.AppendLine();
        sb.AppendLine("  This is the DEEPEST LAYER of TQM: below species, below carriers.");
        ...
        sb.AppendLine($"  TQM-X009 complete. Classification: {report.Classification}");
        sb.AppendLine(new string('=', 100));
