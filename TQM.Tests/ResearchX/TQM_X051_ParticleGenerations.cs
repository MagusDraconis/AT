...
public class TQM_X051_ParticleGenerations : ResearchTestBase
{
    public TQM_X051_ParticleGenerations(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQM_X051_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("TQM-X051 Origin of Particle Generations");
        ...
        sb.AppendLine();
        sb.AppendLine("  TQM PREDICTION: m_n = m_0 + n·Δm·exp(-n/τ)");
        ...
        sb.AppendLine($"  TQM-X051 COMPLETE.");
