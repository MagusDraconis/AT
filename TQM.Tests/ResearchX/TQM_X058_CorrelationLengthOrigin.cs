...
public class TQM_X058_CorrelationLengthOrigin : ResearchTestBase
{
    public TQM_X058_CorrelationLengthOrigin(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQM_X058_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("TQM-X058 Origin of the Defect Correlation Length");
        ...
        sb.AppendLine("  TQM provides TWO fundamental scales:");
        ...
        sb.AppendLine($"  TQM-X058 COMPLETE.");
        ...
        sb.AppendLine($"  ONE mass scale remains as measured input to TQM.");
        sb.AppendLine(new string('=', 100));
