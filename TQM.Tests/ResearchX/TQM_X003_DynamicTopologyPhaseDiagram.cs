...
public class TQM_X003_DynamicTopologyPhaseDiagram : ResearchTestBase
{
    public TQM_X003_DynamicTopologyPhaseDiagram(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQM_X003_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("TQM-X003 Dynamic Topology Phase Diagram");

        Sec(sb, "0. Assumptions");
        sb.AppendLine("  1. TQM-X002: at μ=0.02, quasi-static.");
        ...
        sb.AppendLine($"  TQM-X003 complete. Classification: {diagram.Classification}");
        sb.AppendLine(new string('=', 100));
