...
public class TQM_X044_OriginOfQuantumAction : ResearchTestBase
{
    public TQM_X044_OriginOfQuantumAction(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQM_X044_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("TQM-X044 Origin of the Quantum of Action");
        ...
        sb.AppendLine($"  TQM-X044 COMPLETE.");
