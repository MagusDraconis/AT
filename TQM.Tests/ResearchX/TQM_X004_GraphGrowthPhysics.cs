...
public class TQM_X004_GraphGrowthPhysics : ResearchTestBase
{
    public TQM_X004_GraphGrowthPhysics(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQM_X004_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("TQM-X004 Graph Growth Physics");

        Sec(sb, "0. Assumptions");
        sb.AppendLine("  1. TQM-X002/X003: node motion does NOT produce open-ended innovation.");
        ...
        sb.AppendLine($"  TQM-X004 complete. Classification: {report.Classification}");
        sb.AppendLine(new string('=', 100));
