...
public class TQM_X030_QuantumOptimalityPrinciple : ResearchTestBase
{
    public TQM_X030_QuantumOptimalityPrinciple(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQM_X030_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("TQM-X030 Quantum Optimality Principle");

        Sec(sb, "0. Assumptions");
        sb.AppendLine("  1. TQM-X029: hybrid architectures maximize finite complexity.");
        ...
        sb.AppendLine(new string('=', 100));
        sb.AppendLine($"  TQM-X030 complete. Classification: {report.Classification}");
        sb.AppendLine(new string('=', 100));
