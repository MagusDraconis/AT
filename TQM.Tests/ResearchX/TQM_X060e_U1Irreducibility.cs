...
public class TQM_X060e_U1Irreducibility : ResearchTestBase
{
    public TQM_X060e_U1Irreducibility(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQM_X060e_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("TQM-X060e Is U(1) Really Irreducible?");
        ...
        // 1. The question
        Sec(sb, "The Question");
        sb.AppendLine("  Current TQM: Q + Randomness + M² + U(1)?");
        ...
        sb.AppendLine("  THEOREM: In any TQM universe, U(1) gauge symmetry inevitably exists.");
        sb.AppendLine();
        sb.AppendLine("  PROOF:");
        ...
        sb.AppendLine("  ┌─────────────────────────────────────────────────────┐");
        sb.AppendLine("  │         TQM — ULTIMATE COMPRESSION                   │");
        sb.AppendLine("  ├─────────────────────────────────────────────────────┤");
        ...
        sb.AppendLine($"  TQM-X060e COMPLETE.");
