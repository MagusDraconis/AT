...
public class TQM_X041b_CorrelationMetricEmergence : ResearchTestBase
{
    public TQM_X041b_CorrelationMetricEmergence(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQM_X041b_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("TQM-X041b Metric Emergence from Q-Event Correlations");
        ...
        sb.AppendLine($"  TQM-X041b COMPLETE.");
