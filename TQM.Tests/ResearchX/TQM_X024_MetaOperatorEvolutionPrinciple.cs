...
public class TQM_X024_MetaOperatorEvolutionPrinciple : ResearchTestBase
{
    public TQM_X024_MetaOperatorEvolutionPrinciple(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQM_X024_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("TQM-X024 Meta-Operator Evolution Principle");

        Sec(sb, "0. Assumptions");
        sb.AppendLine("  1. TQM-X023: operator space is mathematically unbounded.");
        ...
        sb.AppendLine();
        sb.AppendLine("  FOR THE FIRST TIME IN TQM: ALL 5 L6 CRITERIA SATISFIED.");
        ...
        sb.AppendLine($"  TQM-X024 complete. Classification: {report.Classification}");
