...
using static TQM.Core.Research.AbundanceIdentityMetrics;

namespace TQM.Tests.ResearchX;

public class TQM_X065b_AbundanceVsIdentityAudit : ResearchTestBase
{
    public TQM_X065b_AbundanceVsIdentityAudit(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQM_X065b_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("TQM-X065b Abundance vs Identity Audit");
        ...
        Sec(sb, "TQM Results — Identity vs Abundance Classification");
        ...
        Sec(sb, "Identity Successes — What TQM Does Best");
        sb.AppendLine("  TQM DERIVES identity (WHAT exists, WHY it exists):");
        ...
        Sec(sb, "Abundance Contingencies — What TQM Cannot Derive");
        sb.AppendLine("  TQM does NOT derive abundance (HOW MUCH, HOW STRONG):");
        ...
        sb.AppendLine("  that TQM partially derives. Why?");
        sb.AppendLine();
        ...
        sb.AppendLine("  TQM can derive it. When it depends on HISTORY,");
        sb.AppendLine("  TQM cannot.");
        sb.AppendLine();
        ...
        sb.AppendLine($"  TQM-X065b COMPLETE.");
        ...
        sb.AppendLine($"  This is THE deepest meta-result of the TQM program.");
        sb.AppendLine(new string('=', 100));
