...
using static TQM.Core.Research.QNecessityMetrics;

namespace TQM.Tests.ResearchX;

public class TQM_X035_OriginOfQPrinciple : ResearchTestBase
{
    public TQM_X035_OriginOfQPrinciple(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQM_X035_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("TQM-X035 Origin of Q Principle");

        var report = OriginOfQAnalyzer.Analyze();

        // 1. TQM-X034 recap
        Sec(sb, "TQM-X034 Recap: The Question");
        ...
        sb.AppendLine("  1. Q as domain count = β₀({R>0.5}) — TQM-117.");
        ...
        sb.AppendLine();
        sb.AppendLine("  3. Q conservation from PDE barrier — TQM-116.");
        ...
        // 9. Final verdict
        sb.AppendLine(new string('=', 100));
        sb.AppendLine($"  TQM-X035 COMPLETE.");
