...
public class TQM_X048_InternalSymmetryEmergence : ResearchTestBase
{
    public TQM_X048_InternalSymmetryEmergence(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQM_X048_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("TQM-X048 Origin of Internal Symmetry");
        ...
        sb.AppendLine("  TQM does not uniquely select these values.");
        ...
        sb.AppendLine($"  TQM-X048 COMPLETE.");
