...
public class TQM_X055_FineStructureConstant : ResearchTestBase
{
    public TQM_X055_FineStructureConstant(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQM_X055_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("TQM-X055 Origin of the Fine-Structure Constant");
        ...
        sb.AppendLine("  which depends on PDE coefficients c₀, M (TQM-010).");
        sb.AppendLine();
        ...
        sb.AppendLine($"  TQM-X055 COMPLETE.");
