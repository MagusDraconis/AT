...
public class TQM_X060b_HiddenDependencyAudit : ResearchTestBase
{
    public TQM_X060b_HiddenDependencyAudit(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQM_X060b_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("TQM-X060b Hidden Dependency Audit");
        ...
        sb.AppendLine($"  TQM-X060b COMPLETE.");
        ...
        sb.AppendLine($"  SM's ~19 → TQM's ~3 (+1). Total reduction: ~80%.");
        sb.AppendLine(new string('=', 100));
