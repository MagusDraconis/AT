...
public class TQM_X053_AnharmonicityParameter : ResearchTestBase
{
    public TQM_X053_AnharmonicityParameter(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQM_X053_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("TQM-X053 Origin of the Anharmonicity Parameter");
        ...
        Sec(sb, "Defect Potentials from TQM PDE");
        ...
        sb.AppendLine("    TQM: 2 parameters (a₀, γ) for ALL mass hierarchies");
        ...
        sb.AppendLine($"  TQM-X053 COMPLETE.");
        ...
        sb.AppendLine($"  17+ SM parameters → 2 TQM parameters. Major reduction.");
        sb.AppendLine(new string('=', 100));
