...
public class TQM_X062_ObservableDeviations : ResearchTestBase
{
    public TQM_X062_ObservableDeviations(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQM_X062_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("TQM-X062 Observable Deviations from GR and ΛCDM");
        ...
        sb.AppendLine();
        sb.AppendLine($"  {unique} unique TQM signatures. {testable5yr} testable in <5yr. {untestable} untestable.");
        sb.AppendLine();

        // 2. Cosmology forecast
        Sec(sb, "Cosmological Forecast — TQM vs ΛCDM");
        ...
        sb.AppendLine("  TQM is HARD TO FALSIFY at currently accessible scales.");
        ...
        sb.AppendLine();
        sb.AppendLine("  The time-varying Λ prediction is TQM's best chance at");
        ...
        sb.AppendLine($"  TQM-X062 COMPLETE.");
        ...
        sb.AppendLine($"  Falsifiable at >3σ by ~2030 if TQM is wrong.");
        sb.AppendLine(new string('=', 100));
