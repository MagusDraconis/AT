...
public class TQM_X065_DefectRelicAbundance : ResearchTestBase
{
    public TQM_X065_DefectRelicAbundance(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQM_X065_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("TQM-X065 Relic Abundance of Defect Dark Matter");
        ...
        // 3. The WIMP miracle
        Sec(sb, "The 'WIMP Miracle' for TQM Defects");
        ...
        sb.AppendLine();
        sb.AppendLine("  TQM explanation: it's NOT a miracle — it's a CONSEQUENCE");
        ...
        sb.AppendLine();
        sb.AppendLine("  TQM HYPOTHESIS: The ratio reflects the relative");
        ...
        sb.AppendLine("  space topology — not fully derived in TQM.");
        sb.AppendLine();
        ...
        sb.AppendLine($"  TQM-X065 COMPLETE.");
