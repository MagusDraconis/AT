...
public class TQM_X012_QuantumInformationCarrierPrinciple : ResearchTestBase
{
    public TQM_X012_QuantumInformationCarrierPrinciple(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQM_X012_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("TQM-X012 Quantum Information Carrier Principle");

        Sec(sb, "0. Assumptions");
        sb.AppendLine("  1. TQM-X011: Reversibility ≠ Self-consistency (independent).");
        ...
        sb.AppendLine();
        sb.AppendLine("  Quantum carriers are the ONLY structures in TQM that simultaneously:");
        ...
        Sec(sb, "5. The TQM Hierarchy — With Quantum Carriers");
        ...
        sb.AppendLine($"  TQM-X012 complete. Classification: {report.Classification}");
