...
public class TQM_X015_MinimalRealityPrinciple : ResearchTestBase
{
    public TQM_X015_MinimalRealityPrinciple(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQM_X015_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("TQM-X015 Minimal Reality Principle");

        Sec(sb, "0. Assumptions");
        sb.AppendLine("  1. TQM-X014: Reality = R + S claimed as minimal.");
        ...
        Sec(sb, "5. Complete TQM Foundations (Final)");
        ...
        sb.AppendLine();
        sb.AppendLine("  MINIMAL FOUNDATION: P1 + P2 + A (= R+S) → Complete TQM.");
        ...
        sb.AppendLine($"  TQM-X015 complete. Classification: {report.Classification}");
