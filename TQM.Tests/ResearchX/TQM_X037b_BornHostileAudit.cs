...
public class TQM_X037b_BornHostileAudit : ResearchTestBase
{
    public TQM_X037b_BornHostileAudit(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQM_X037b_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("TQM-X037b Hostile Audit of the Born Rule Derivation");
        ...
        sb.AppendLine($"  TQM-X037b COMPLETE.");
