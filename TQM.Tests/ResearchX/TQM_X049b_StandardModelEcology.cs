...
public class TQM_X049b_StandardModelEcology : ResearchTestBase
{
    public TQM_X049b_StandardModelEcology(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQM_X049b_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("TQM-X049b Standard Model Selection by Defect Ecology");
        ...
        sb.AppendLine($"  TQM-X049b COMPLETE.");
        sb.AppendLine($"  SM group ranks #{smRank}/{ecologies.Count}.");
