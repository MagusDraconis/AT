...
public class TQM_X029_FiniteComplexityOptimization : ResearchTestBase
{
    public TQM_X029_FiniteComplexityOptimization(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQM_X029_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("TQM-X029 Finite Complexity Optimization Principle");

        Sec(sb, "0. Assumptions");
        sb.AppendLine("  1. TQM-X027: all finite systems saturate.");
        sb.AppendLine("  2. TQM-X028: ceilings are astronomically vast.");
        ...
        sb.AppendLine($"  TQM-X029 complete. Classification: {report.Classification}");
        sb.AppendLine(new string('=', 100));
