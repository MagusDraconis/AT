...
public class TQM_X040_EmergenceOfTime : ResearchTestBase
{
    public TQM_X040_EmergenceOfTime(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQM_X040_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("TQM-X040 Emergence of Time from Q-Actualization Events");
        ...
        sb.AppendLine($"  TQM-X040 COMPLETE.");
