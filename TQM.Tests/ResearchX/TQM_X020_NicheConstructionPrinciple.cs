...
public class TQM_X020_NicheConstructionPrinciple : ResearchTestBase
{
    public TQM_X020_NicheConstructionPrinciple(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQM_X020_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("TQM-X020 Niche Construction Principle");

        Sec(sb, "0. Assumptions");
        sb.AppendLine("  1. TQM-X019: L6 requires new CARRIER CLASSES.");
        ...
        sb.AppendLine(new string('=', 100));
        sb.AppendLine($"  TQM-X020 complete. Classification: {report.Classification}");
