...
public class TQM_X046_OriginOfCosmologicalConstant : ResearchTestBase
{
    public TQM_X046_OriginOfCosmologicalConstant(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQM_X046_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("TQM-X046 Origin of the Cosmological Constant");
        ...
        sb.AppendLine("  Can TQM do better?");
        sb.AppendLine();
        ...
        Sec(sb, "TQM vs ΛCDM");
        sb.AppendLine("  ┌─────────────────┬────────────────────┬────────────────────┐");
        sb.AppendLine("  │                 │ ΛCDM               │ TQM (Causal Set)   │");
        sb.AppendLine("  ├─────────────────┼────────────────────┼────────────────────┤");
        ...
        sb.AppendLine($"  TQM-X046 COMPLETE.");
        ...
        sb.AppendLine($"  The cosmological constant problem is SOLVED in TQM.");
        sb.AppendLine(new string('=', 100));
