...
public class TQM_X021_OperatorEvolutionPrinciple : ResearchTestBase
{
    public TQM_X021_OperatorEvolutionPrinciple(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQM_X021_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("TQM-X021 Operator Evolution Principle");

        Sec(sb, "0. Assumptions");
        sb.AppendLine("  1. TQM-X020: graph evolution ≠ new carrier classes.");
        ...
        sb.AppendLine();
        sb.AppendLine("  NONE of these have been tested in TQM.");
        ...
        sb.AppendLine("  1      | Finite spectrum         | TQM-138");
        sb.AppendLine("  2      | Static graph            | TQM-X001");
        sb.AppendLine("  3      | Fixed carrier classes   | TQM-X019");
        sb.AppendLine("  4      | Graph ≠ operator type   | TQM-X020");
        sb.AppendLine("  5      | OPERATOR FAMILY BARRIER | TQM-X021 ← DEEPEST");
        sb.AppendLine();
        ...
        sb.AppendLine($"  TQM-X021 complete. Classification: {report.Classification}");
        sb.AppendLine(new string('=', 100));
