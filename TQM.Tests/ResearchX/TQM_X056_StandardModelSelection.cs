...
public class TQM_X056_StandardModelSelection : ResearchTestBase
{
    public TQM_X056_StandardModelSelection(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQM_X056_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("TQM-X056 Unique Selection of the Standard Model Gauge Structure");
        ...
        sb.AppendLine($"  TQM-X056 COMPLETE.");
