...
public class TQM_X023_UnboundedOperatorSpace : ResearchTestBase
{
    public TQM_X023_UnboundedOperatorSpace(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQM_X023_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("TQM-X023 Unbounded Operator Space Principle");

        Sec(sb, "0. Assumptions");
        sb.AppendLine("  1. TQM-X022: operator evolution mechanism exists but bounded.");
        ...
        sb.AppendLine("    1. Finite spectrum           → bounded species (TQM-138)");
        ...
        sb.AppendLine($"  TQM-X023 complete. Classification: {report.Classification}");
        sb.AppendLine(new string('=', 100));
