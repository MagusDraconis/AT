...
public class TQM_X060h_GravityEmergenceAudit : ResearchTestBase
{
    public TQM_X060h_GravityEmergenceAudit(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQM_X060h_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("TQM-X060h Gravity Emergence Audit");
        ...
        // 2. The hierarchy
        Sec(sb, "Gravity in the TQM Hierarchy");
        ...
        // 4. The GR gap
        Sec(sb, "The GR Gap — TQM's Weakest Link");
        sb.AppendLine("  TQM PROVIDES:");
        ...
        sb.AppendLine();
        sb.AppendLine("  TQM DOES NOT PROVIDE (external dependency):");
        ...
        sb.AppendLine("  This is the capstone open problem of TQM gravity.");
        sb.AppendLine();

        // 5. Standard vs TQM ordering
        Sec(sb, "Standard Physics vs TQM — Reversed Ordering");
        ...
        sb.AppendLine();
        sb.AppendLine("  This REVERSAL is one of TQM's deepest claims:");
        ...
        sb.AppendLine($"  TQM-X060h COMPLETE.");
