...
public class TQM_X014_RealityStructurePrinciple : ResearchTestBase
{
    public TQM_X014_RealityStructurePrinciple(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQM_X014_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("TQM-X014 Reality Structure Principle");

        Sec(sb, "0. Assumptions");
        sb.AppendLine("  1. Rev and SC are independent (TQM-X011).");
        sb.AppendLine("  2. Rev∩SC = quantum carriers (TQM-X012).");
        ...
        sb.AppendLine("    → This is the COMPLETE TQM hierarchy.");
        sb.AppendLine();
        ...
        Sec(sb, "6. The Complete TQM Foundations");
        ...
        sb.AppendLine();
        sb.AppendLine("  2 postulates + 2 principles → Complete TQM.");
        sb.AppendLine();
        ...
        sb.AppendLine(new string('=', 100));
        sb.AppendLine($"  TQM-X014 complete. Classification: {report.Classification}");
        sb.AppendLine(new string('=', 100));
