...
using static TQM.Core.Research.FinalCoreMetrics;

namespace TQM.Tests.ResearchX;

public class TQM_X060g_FinalCoreConsistencyAudit : ResearchTestBase
{
    public TQM_X060g_FinalCoreConsistencyAudit(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQM_X060g_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("TQM-X060g Consistency Audit of the Final Core");
        ...
        sb.AppendLine("    TQM provides the causal set. External theory provides GR.");
        sb.AppendLine();
        ...
        sb.AppendLine($"  TQM-X060g COMPLETE.");
