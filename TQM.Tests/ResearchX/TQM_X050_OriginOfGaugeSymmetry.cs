...
public class TQM_X050_OriginOfGaugeSymmetry : ResearchTestBase
{
    public TQM_X050_OriginOfGaugeSymmetry(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQM_X050_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("TQM-X050 Origin of Gauge Symmetry from Q-Defect Topology");
        ...
        sb.AppendLine($"  TQM-X050 COMPLETE.");
