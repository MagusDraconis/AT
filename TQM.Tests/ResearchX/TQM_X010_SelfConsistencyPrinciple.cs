...
public class TQM_X010_SelfConsistencyPrinciple : ResearchTestBase
{
    public TQM_X010_SelfConsistencyPrinciple(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQM_X010_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("TQM-X010 Self-Consistency Principle — Depth Analysis");

        Sec(sb, "0. Assumptions");
        sb.AppendLine("  1. TQM-X009: self-consistency + dynamical stability is universal.");
        ...
        Sec(sb, "5. The Complete TQM Reduction (Bottom to Top)");
        ...
        sb.AppendLine($"  TQM-X010 complete. Classification: {report.Classification}");
        sb.AppendLine($"  TQM reduction is COMPLETE — bottoms out at F(x)=x.");
        sb.AppendLine(new string('=', 100));
