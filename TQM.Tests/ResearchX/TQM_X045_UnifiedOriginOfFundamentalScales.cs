...
public class TQM_X045_UnifiedOriginOfFundamentalScales : ResearchTestBase
{
    public TQM_X045_UnifiedOriginOfFundamentalScales(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQM_X045_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("TQM-X045 Unified Origin of c, G, and ħ");
        ...
        sb.AppendLine($"  TQM-X045 COMPLETE.");
