...
public class TQM_X061_EmergentMacroscopicGravity : ResearchTestBase
{
    public TQM_X061_EmergentMacroscopicGravity(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQM_X061_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("TQM-X061 Emergent Macroscopic Gravity");
        ...
        // 1. Gravity tests
        Sec(sb, "Gravitational Phenomena — TQM vs GR");
        ...
        sb.AppendLine("  TQM → G_μν = 8πG_eff T_μν + O(ℓ_P²·R²) + O(1/√V)");
        sb.AppendLine();
        ...
        sb.AppendLine("    • THIS IS THE DISTINCTIVE TQM PREDICTION.");
        sb.AppendLine();

        // 4. Observable predictions
        Sec(sb, "Observable Predictions — Distinctive TQM Signatures");
        ...
        sb.AppendLine($"  TQM-X061 COMPLETE.");
        ...
        sb.AppendLine($"  GR is the LARGE-SCALE LIMIT of TQM gravity.");
        sb.AppendLine(new string('=', 100));
