...
public class TQM_X038_OriginOfMeasurement : ResearchTestBase
{
    public TQM_X038_OriginOfMeasurement(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQM_X038_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("TQM-X038 Origin of Measurement from Individuation");
        ...
        sb.AppendLine($"  TQM-X038 COMPLETE.");
