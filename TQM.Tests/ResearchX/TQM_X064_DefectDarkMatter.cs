...
public class TQM_X064_DefectDarkMatter : ResearchTestBase
{
    public TQM_X064_DefectDarkMatter(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQM_X064_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("TQM-X064 Dark Matter as Hidden Topological Defects");
        ...
        // 1. Candidate defects
        Sec(sb, "TQM Defect Dark Matter Candidates");
        ...
        sb.AppendLine("  STATUS: NATURAL TQM analog of WIMP. No new particles needed.");
        sb.AppendLine();
        ...
        sb.AppendLine("  STATUS: TQM analog of axion. 'TQM-axion' — naturally light");
        sb.AppendLine("          because moduli potential is periodic.");
        sb.AppendLine();

        // 4. Dark matter requirements
        Sec(sb, "Dark Matter Requirements — Does TQM Satisfy?");
        sb.AppendLine("  Requirement                              TQM Satisfies?  Explanation");
        sb.AppendLine("  " + new string('─', 75));
        foreach (var r in requirements)
        {
            string s = r.SatisfiedByDefect ? "✓ YES" : "~ PARTIAL";
            sb.AppendLine($"  {r.Requirement,-40} {s,-14} {r.TQMExplanation.Split('\n')[0]}");
        }
        sb.AppendLine();
        ...
        sb.AppendLine();
        sb.AppendLine("  TQM's COMPLETE gravity sector:");
        ...
        sb.AppendLine("  TQM ALREADY predicts (from Q + Randomness + M²):");
        ...
        sb.AppendLine();
        sb.AppendLine("  DARK MATTER = a SUBSET of TQM's existing defect taxonomy.");
        ...
        sb.AppendLine($"  TQM-X064 COMPLETE.");
        sb.AppendLine($"  Classification: {classification}");
        sb.AppendLine($"  {satisfied}/{requirements.Count} DM requirements satisfied.");
        sb.AppendLine($"  DM = neutral topological defects (already in TQM).");
