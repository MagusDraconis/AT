...
public class TQM_X060f_FinalPrimitiveAudit : ResearchTestBase
{
    public TQM_X060f_FinalPrimitiveAudit(ITestOutputHelper o) : base(o) { }

    [Fact]
    public void TQM_X060f_Run()
    {
    ...
    private void RunTest()
    {
        ...
        PrintHeader("TQM-X060f Final Primitive Audit");
        ...
        sb.AppendLine($"  TQM-X060f COMPLETE.");
