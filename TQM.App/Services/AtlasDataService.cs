...
public static class AtlasDataService
{
    ...
    [
        new(
            ...
            "TQM-QG Milestone · Phases 313–319",
            ...
            true,
            [
                new("TQM-QG 313", "PARTIAL LOCK LAW",
                    "Lock structure universal, lock values domain-specific — the lock law.",
                    "https://github.com/MagusDraconis/AT/blob/TQM_v1.1/Docs/Research/TQMQG_LockUniversalityAudit.md"),
                new("TQM-QG 316", "ORGANIZATION PHASE TRANSITION",
                    "The operator basis completes at the critical parameter g* ≈ 0.31.",
                    "https://github.com/MagusDraconis/AT/blob/TQM_v1.1/Docs/Research/TQMQG_OrganizationPhaseTransitionAudit.md"),
                new("TQM-QG 317", "PREDICTIVE",
                    "Blind protocol: early lock coherence predicts the future HIGH class 8/8.",
                    "https://github.com/MagusDraconis/AT/blob/TQM_v1.1/Docs/Research/TQMQG_BlindOrganizationPrediction.md"),
                new("TQM-QG 318", "PARTIAL ORIGIN",
                    "Lock origin: the moment-chain identity lock1 = lock2 × lock3 holds exactly.",
                    "https://github.com/MagusDraconis/AT/blob/TQM_v1.1/Docs/Research/TQMQG_LockOriginAudit.md"),
                new("TQM-QG 318", "FINAL TQM ARCHITECTURE",
                    "Canonical architecture: 4 layers, acyclic dependency graph, 20 concepts classified.",
                    "https://github.com/MagusDraconis/AT/blob/TQM_v1.1/Docs/Research/TQMQG_FinalTheoryArchitecture.md"),
                new("TQM-QG 319", "NO ADVANTAGE",
                    "Competing predictors: entropy/gini/exponent/gap match or beat the locks (100% vs 83%).",
                    "https://github.com/MagusDraconis/AT/blob/TQM_v1.1/Docs/Research/TQMQG_CompetingPredictorAudit.md"),
            ]),
        new(
            ...
            [
                new("TQM-QG 203", "ABSOLUTE MASS ORIGIN",
                    ...
                    "https://github.com/MagusDraconis/AT/blob/TQM_v1.1/Docs/Research/TQMQG_AbsoluteNeutrinoMassOrigin.md"),
                new("TQM-QG 204", "RUNNING ORIGIN",
                    "Quark MS̄ running: native at natural scale (0.2%); spectral α_s; exponent q = #d/(2·#g).",
                    "https://github.com/MagusDraconis/AT/blob/TQM_v1.1/Docs/Research/TQMQG_QuarkRunningOrigin.md"),
                new("TQM-QG 209", "EXACT LAW",
                    "Lepton hierarchy: m_μ = me·Σm²/√occMom (0.13%), m_τ = me·Σm²·λ₂ (0.28%).",
                    "https://github.com/MagusDraconis/AT/blob/TQM_v1.1/Docs/Research/TQMQG_LeptonHierarchyExactLaw.md"),
            ]),
        new(
            ...
            [
                new("TQM-QG 296", "MINIMAL THEORY",
                    ...
                    "https://github.com/MagusDraconis/AT/blob/TQM_v1.1/Docs/Research/TQMQG_MinimalTheoryAudit.md"),
                new("TQM-QG 297", "INEVITABLE SPECTRUM",
                    "The spectrum is the inevitable output of the actualization attractor.",
                    "https://github.com/MagusDraconis/AT/blob/TQM_v1.1/Docs/Research/TQMQG_SpectrumNecessityAudit.md"),
                new("TQM-QG 298", "COMPLETE RECONSTRUCTION",
                    "The minimal theory reconstructs all major QG223–295 results.",
                    "https://github.com/MagusDraconis/AT/blob/TQM_v1.1/Docs/Research/TQMQG_ReconstructionAudit.md"),
                new("TQM-QG 299", "EXCEPTION REMAINS",
                    "5/4 is a fit, not a derivation or boundary.",
                    "https://github.com/MagusDraconis/AT/blob/TQM_v1.1/Docs/Research/TQMQG_ExceptionAudit.md"),
                new("TQM-QG 300", "FIRST PEAK ORIGIN",
                    "ℓ₁ alone carries the 5/4 boundary projection; peak ratios cancel it.",
                    "https://github.com/MagusDraconis/AT/blob/TQM_v1.1/Docs/Research/TQMQG_FirstPeakOriginAudit.md"),
            ]),
        new(
            ...
            [
                new("TQM-QG 115", "PARTIAL FEEDBACK",
                    ...
                    "https://github.com/MagusDraconis/AT/blob/TQM_v1.1/Docs/Research/TQMQG_StructureFromContent.md"),
                new("TQM-QG 116", "STRUCTURE ORIGIN",
                    ...
                    "https://github.com/MagusDraconis/AT/blob/TQM_v1.1/Docs/Research/TQMQG_ActualizationStructures.md"),
                new("TQM-QG 116b", "DYNAMICAL",
                    ...
                    "https://github.com/MagusDraconis/AT/blob/TQM_v1.1/Docs/Research/TQMQG_UniversalAttractor.md"),
                new("TQM-QG 117", "ATTRACTOR ORIGIN",
                    ...
                    "https://github.com/MagusDraconis/AT/blob/TQM_v1.1/Docs/Research/TQMQG_AttractorParameterOrigin.md"),
            ]),
    ];
