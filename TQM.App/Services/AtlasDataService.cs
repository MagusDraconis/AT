        ...
        new(
            ...
            [
                new("TQM-QG 313", "PARTIAL LOCK LAW",
                    ...
                    "https://github.com/MagusDraconis/TQM/blob/TQM_v1.1/Docs/Research/TQMQG_LockUniversalityAudit.md"),
                new("TQM-QG 316", "ORGANIZATION PHASE TRANSITION",
                    "The operator basis completes at the critical parameter g* ≈ 0.31.",
                    "https://github.com/MagusDraconis/TQM/blob/TQM_v1.1/Docs/Research/TQMQG_OrganizationPhaseTransitionAudit.md"),
                new("TQM-QG 317", "PREDICTIVE",
                    "Blind protocol: early lock coherence predicts the future HIGH class 8/8.",
                    "https://github.com/MagusDraconis/TQM/blob/TQM_v1.1/Docs/Research/TQMQG_BlindOrganizationPrediction.md"),
                new("TQM-QG 318", "PARTIAL ORIGIN",
                    "Lock origin: the moment-chain identity lock1 = lock2 × lock3 holds exactly.",
                    "https://github.com/MagusDraconis/TQM/blob/TQM_v1.1/Docs/Research/TQMQG_LockOriginAudit.md"),
                new("TQM-QG 318", "FINAL TQM ARCHITECTURE",
                    "Canonical architecture: 4 layers, acyclic dependency graph, 20 concepts classified.",
                    "https://github.com/MagusDraconis/TQM/blob/TQM_v1.1/Docs/Research/TQMQG_FinalTheoryArchitecture.md"),
                new("TQM-QG 319", "NO ADVANTAGE",
                    "Competing predictors: entropy/gini/exponent/gap match or beat the locks (100% vs 83%).",
                    "https://github.com/MagusDraconis/TQM/blob/TQM_v1.1/Docs/Research/TQMQG_CompetingPredictorAudit.md"),
            ]),
        new(
            ...
            "The standard-model layer is closed; the broader program now spans 330 phases (212 tested, 12 partial, 12 untested) at 73.2% weighted coverage, with the frontier concentrated in the latest foundation audits and the three pre-registered predictions.",
